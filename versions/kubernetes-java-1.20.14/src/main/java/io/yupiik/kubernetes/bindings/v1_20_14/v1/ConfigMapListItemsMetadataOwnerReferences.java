...
public class ConfigMapListItemsMetadataOwnerReferences {
    ...
    public ConfigMapListItemsMetadataOwnerReferences() {
        // no-op
    }

    public ConfigMapListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ConfigMapListItemsMetadataOwnerReferences)) {
            return false;
        }
        final ConfigMapListItemsMetadataOwnerReferences __otherCasted = (ConfigMapListItemsMetadataOwnerReferences) __other;
