...
public class PodSpecContainersVolumeMounts {
    ...
    public PodSpecContainersVolumeMounts() {
        // no-op
    }

    public PodSpecContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSpecContainersVolumeMounts)) {
            return false;
        }
        final PodSpecContainersVolumeMounts __otherCasted = (PodSpecContainersVolumeMounts) __other;
