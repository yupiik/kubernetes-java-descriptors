...
public class LimitRangeListItemsMetadataOwnerReferences {
    ...
    public LimitRangeListItemsMetadataOwnerReferences() {
        // no-op
    }

    public LimitRangeListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LimitRangeListItemsMetadataOwnerReferences)) {
            return false;
        }
        final LimitRangeListItemsMetadataOwnerReferences __otherCasted = (LimitRangeListItemsMetadataOwnerReferences) __other;
