...
public class APIServiceListItemsMetadataManagedFields {
    ...
    public APIServiceListItemsMetadataManagedFields() {
        // no-op
    }

    public APIServiceListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof APIServiceListItemsMetadataManagedFields)) {
            return false;
        }
        final APIServiceListItemsMetadataManagedFields __otherCasted = (APIServiceListItemsMetadataManagedFields) __other;
