...
public class StatefulSetListItemsSpecTemplateSpecVolumes {
    ...
    private StatefulSetListItemsSpecTemplateSpecVolumesEphemeral ephemeral;
    ...
    public StatefulSetListItemsSpecTemplateSpecVolumes(final StatefulSetListItemsSpecTemplateSpecVolumesAwsElasticBlockStore awsElasticBlockStore,
                                                       ...
                                                       final StatefulSetListItemsSpecTemplateSpecVolumesEphemeral ephemeral,
    ...
    public StatefulSetListItemsSpecTemplateSpecVolumesEphemeral getEphemeral() {
        return ephemeral;
    }

    public void setEphemeral(final StatefulSetListItemsSpecTemplateSpecVolumesEphemeral ephemeral) {
