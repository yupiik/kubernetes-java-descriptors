...
public class ControllerRevisionMetadata {
    ...
    private ControllerRevisionMetadataInitializers initializers;
    ...
    public ControllerRevisionMetadata(final Map<String, String> annotations,
                                      ...
                                      final ControllerRevisionMetadataInitializers initializers,
    ...
    public ControllerRevisionMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ControllerRevisionMetadataInitializers initializers) {
