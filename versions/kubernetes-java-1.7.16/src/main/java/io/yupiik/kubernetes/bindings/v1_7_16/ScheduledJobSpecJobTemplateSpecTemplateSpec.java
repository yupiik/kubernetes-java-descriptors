...
public class ScheduledJobSpecJobTemplateSpecTemplateSpec {
    private Integer activeDeadlineSeconds;
    private ScheduledJobSpecJobTemplateSpecTemplateSpecAffinity affinity;
    ...
    private ScheduledJobSpecJobTemplateSpecTemplateSpecSecurityContext securityContext;
    ...
    public ScheduledJobSpecJobTemplateSpecTemplateSpec() {
        // no-op
    }

    public ScheduledJobSpecJobTemplateSpecTemplateSpec(final Integer activeDeadlineSeconds,
                                                       final ScheduledJobSpecJobTemplateSpecTemplateSpecAffinity affinity,
                                                       ...
                                                       final ScheduledJobSpecJobTemplateSpecTemplateSpecSecurityContext securityContext,
    ...
    public ScheduledJobSpecJobTemplateSpecTemplateSpecAffinity getAffinity() {
        return affinity;
    }

    public void setAffinity(final ScheduledJobSpecJobTemplateSpecTemplateSpecAffinity affinity) {
    ...
    public ScheduledJobSpecJobTemplateSpecTemplateSpecSecurityContext getSecurityContext() {
        return securityContext;
    }

    public void setSecurityContext(final ScheduledJobSpecJobTemplateSpecTemplateSpecSecurityContext securityContext) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ScheduledJobSpecJobTemplateSpecTemplateSpec)) {
            return false;
        }
        final ScheduledJobSpecJobTemplateSpecTemplateSpec __otherCasted = (ScheduledJobSpecJobTemplateSpecTemplateSpec) __other;
