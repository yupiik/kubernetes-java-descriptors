...
public class DaemonSetListItemsSpecTemplateSpecInitContainersStartupProbeHttpGet {
    ...
    private String path;
    private String port;
    private DaemonSetListItemsSpecTemplateSpecInitContainersStartupProbeHttpGetScheme scheme;
    ...
    public DaemonSetListItemsSpecTemplateSpecInitContainersStartupProbeHttpGet(final String host,
                                                                               ...
                                                                               final String path,
                                                                               final String port,
                                                                               final DaemonSetListItemsSpecTemplateSpecInitContainersStartupProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public DaemonSetListItemsSpecTemplateSpecInitContainersStartupProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final DaemonSetListItemsSpecTemplateSpecInitContainersStartupProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
