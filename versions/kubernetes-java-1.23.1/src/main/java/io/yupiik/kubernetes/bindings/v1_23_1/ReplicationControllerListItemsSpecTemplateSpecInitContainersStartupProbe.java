...
public class ReplicationControllerListItemsSpecTemplateSpecInitContainersStartupProbe {
    ...
    private ReplicationControllerListItemsSpecTemplateSpecInitContainersStartupProbeGrpc grpc;
    ...
    public ReplicationControllerListItemsSpecTemplateSpecInitContainersStartupProbe(final ReplicationControllerListItemsSpecTemplateSpecInitContainersStartupProbeExec exec,
                                                                                    ...
                                                                                    final ReplicationControllerListItemsSpecTemplateSpecInitContainersStartupProbeGrpc grpc,
    ...
    public ReplicationControllerListItemsSpecTemplateSpecInitContainersStartupProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final ReplicationControllerListItemsSpecTemplateSpecInitContainersStartupProbeGrpc grpc) {
        this.grpc = grpc;
    }
