...
public class StorageVersionListItemsMetadataManagedFields {
    ...
    public StorageVersionListItemsMetadataManagedFields() {
        // no-op
    }

    public StorageVersionListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StorageVersionListItemsMetadataManagedFields)) {
            return false;
        }
        final StorageVersionListItemsMetadataManagedFields __otherCasted = (StorageVersionListItemsMetadataManagedFields) __other;
