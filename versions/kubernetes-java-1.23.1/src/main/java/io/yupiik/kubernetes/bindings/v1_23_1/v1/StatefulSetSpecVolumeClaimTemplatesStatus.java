...
public class StatefulSetSpecVolumeClaimTemplatesStatus {
    ...
    private StatefulSetSpecVolumeClaimTemplatesStatusPhase phase;
    ...
    public StatefulSetSpecVolumeClaimTemplatesStatus(final List<String> accessModes,
                                                     ...
                                                     final StatefulSetSpecVolumeClaimTemplatesStatusPhase phase,
    ...
    public StatefulSetSpecVolumeClaimTemplatesStatusPhase getPhase() {
        return phase;
    }

    public void setPhase(final StatefulSetSpecVolumeClaimTemplatesStatusPhase phase) {
        this.phase = phase;
    }
