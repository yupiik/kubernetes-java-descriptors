...
public class CustomResourceDefinitionListItemsStatusAcceptedNames {
    ...
    public CustomResourceDefinitionListItemsStatusAcceptedNames() {
        // no-op
    }

    public CustomResourceDefinitionListItemsStatusAcceptedNames(final List<String> categories,
                                                                final String kind,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CustomResourceDefinitionListItemsStatusAcceptedNames)) {
            return false;
        }
        final CustomResourceDefinitionListItemsStatusAcceptedNames __otherCasted = (CustomResourceDefinitionListItemsStatusAcceptedNames) __other;
