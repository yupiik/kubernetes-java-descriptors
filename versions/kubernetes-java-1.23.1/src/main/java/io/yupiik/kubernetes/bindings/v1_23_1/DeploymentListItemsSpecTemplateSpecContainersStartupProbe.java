...
public class DeploymentListItemsSpecTemplateSpecContainersStartupProbe {
    ...
    private DeploymentListItemsSpecTemplateSpecContainersStartupProbeGrpc grpc;
    ...
    public DeploymentListItemsSpecTemplateSpecContainersStartupProbe(final DeploymentListItemsSpecTemplateSpecContainersStartupProbeExec exec,
                                                                     ...
                                                                     final DeploymentListItemsSpecTemplateSpecContainersStartupProbeGrpc grpc,
    ...
    public DeploymentListItemsSpecTemplateSpecContainersStartupProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final DeploymentListItemsSpecTemplateSpecContainersStartupProbeGrpc grpc) {
        this.grpc = grpc;
    }
