...
public class PodSpecEphemeralContainersSecurityContextWindowsOptions {
    private String gmsaCredentialSpec;
    private String gmsaCredentialSpecName;
    private Boolean hostProcess;
    private String runAsUserName;

    public PodSpecEphemeralContainersSecurityContextWindowsOptions() {
        // no-op
    }

    public PodSpecEphemeralContainersSecurityContextWindowsOptions(final String gmsaCredentialSpec,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSpecEphemeralContainersSecurityContextWindowsOptions)) {
            return false;
        }
        final PodSpecEphemeralContainersSecurityContextWindowsOptions __otherCasted = (PodSpecEphemeralContainersSecurityContextWindowsOptions) __other;
