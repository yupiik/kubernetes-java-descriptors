...
public class StatefulSetSpecTemplateSpecInitContainersReadinessProbeHttpGet {
    ...
    private String path;
    private String port;
    private StatefulSetSpecTemplateSpecInitContainersReadinessProbeHttpGetScheme scheme;
    ...
    public StatefulSetSpecTemplateSpecInitContainersReadinessProbeHttpGet(final String host,
                                                                          ...
                                                                          final String path,
                                                                          final String port,
                                                                          final StatefulSetSpecTemplateSpecInitContainersReadinessProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public StatefulSetSpecTemplateSpecInitContainersReadinessProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final StatefulSetSpecTemplateSpecInitContainersReadinessProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
