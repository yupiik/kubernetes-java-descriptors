...
public class CronJobListItemsSpecJobTemplateSpecTemplateSpecInitContainersStartupProbeHttpGet {
    ...
    private String path;
    private String port;
    private CronJobListItemsSpecJobTemplateSpecTemplateSpecInitContainersStartupProbeHttpGetScheme scheme;
    ...
    public CronJobListItemsSpecJobTemplateSpecTemplateSpecInitContainersStartupProbeHttpGet(final String host,
                                                                                            ...
                                                                                            final String path,
                                                                                            final String port,
                                                                                            final CronJobListItemsSpecJobTemplateSpecTemplateSpecInitContainersStartupProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public CronJobListItemsSpecJobTemplateSpecTemplateSpecInitContainersStartupProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final CronJobListItemsSpecJobTemplateSpecTemplateSpecInitContainersStartupProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
