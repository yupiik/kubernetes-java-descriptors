...
public class PodSpecVolumesAzureDisk {
    ...
    public PodSpecVolumesAzureDisk() {
        // no-op
    }

    public PodSpecVolumesAzureDisk(final String cachingMode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSpecVolumesAzureDisk)) {
            return false;
        }
        final PodSpecVolumesAzureDisk __otherCasted = (PodSpecVolumesAzureDisk) __other;
