...
public class PodSpecContainersLivenessProbe {
    ...
    private PodSpecContainersLivenessProbeGrpc grpc;
    ...
    public PodSpecContainersLivenessProbe(final PodSpecContainersLivenessProbeExec exec,
                                          ...
                                          final PodSpecContainersLivenessProbeGrpc grpc,
    ...
    public PodSpecContainersLivenessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final PodSpecContainersLivenessProbeGrpc grpc) {
        this.grpc = grpc;
    }
