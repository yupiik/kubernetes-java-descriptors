...
public class StatefulSetListItemsSpecTemplateSpecEphemeralContainersPorts {
    ...
    private String name;
    private StatefulSetListItemsSpecTemplateSpecEphemeralContainersPortsProtocol protocol;
    ...
    public StatefulSetListItemsSpecTemplateSpecEphemeralContainersPorts(final int containerPort,
                                                                        ...
                                                                        final String name,
                                                                        final StatefulSetListItemsSpecTemplateSpecEphemeralContainersPortsProtocol protocol) {
        // no-op
    }
    ...
    public StatefulSetListItemsSpecTemplateSpecEphemeralContainersPortsProtocol getProtocol() {
        return protocol;
    }

    public void setProtocol(final StatefulSetListItemsSpecTemplateSpecEphemeralContainersPortsProtocol protocol) {
