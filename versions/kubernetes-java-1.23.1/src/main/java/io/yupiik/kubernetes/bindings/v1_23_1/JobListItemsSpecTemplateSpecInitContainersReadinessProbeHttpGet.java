...
public class JobListItemsSpecTemplateSpecInitContainersReadinessProbeHttpGet {
    ...
    private String path;
    private String port;
    private JobListItemsSpecTemplateSpecInitContainersReadinessProbeHttpGetScheme scheme;
    ...
    public JobListItemsSpecTemplateSpecInitContainersReadinessProbeHttpGet(final String host,
                                                                           ...
                                                                           final String path,
                                                                           final String port,
                                                                           final JobListItemsSpecTemplateSpecInitContainersReadinessProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public JobListItemsSpecTemplateSpecInitContainersReadinessProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final JobListItemsSpecTemplateSpecInitContainersReadinessProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
