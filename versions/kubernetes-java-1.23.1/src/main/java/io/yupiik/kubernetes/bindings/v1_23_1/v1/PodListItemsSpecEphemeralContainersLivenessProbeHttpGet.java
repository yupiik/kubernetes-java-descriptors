...
public class PodListItemsSpecEphemeralContainersLivenessProbeHttpGet {
    ...
    private String path;
    private String port;
    private PodListItemsSpecEphemeralContainersLivenessProbeHttpGetScheme scheme;
    ...
    public PodListItemsSpecEphemeralContainersLivenessProbeHttpGet(final String host,
                                                                   ...
                                                                   final String path,
                                                                   final String port,
                                                                   final PodListItemsSpecEphemeralContainersLivenessProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public PodListItemsSpecEphemeralContainersLivenessProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final PodListItemsSpecEphemeralContainersLivenessProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
