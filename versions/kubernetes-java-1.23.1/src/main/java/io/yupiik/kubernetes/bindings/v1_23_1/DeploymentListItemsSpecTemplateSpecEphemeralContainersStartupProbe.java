...
public class DeploymentListItemsSpecTemplateSpecEphemeralContainersStartupProbe {
    ...
    private DeploymentListItemsSpecTemplateSpecEphemeralContainersStartupProbeGrpc grpc;
    ...
    public DeploymentListItemsSpecTemplateSpecEphemeralContainersStartupProbe(final DeploymentListItemsSpecTemplateSpecEphemeralContainersStartupProbeExec exec,
                                                                              ...
                                                                              final DeploymentListItemsSpecTemplateSpecEphemeralContainersStartupProbeGrpc grpc,
    ...
    public DeploymentListItemsSpecTemplateSpecEphemeralContainersStartupProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final DeploymentListItemsSpecTemplateSpecEphemeralContainersStartupProbeGrpc grpc) {
        this.grpc = grpc;
    }
