...
public class ReplicaSetSpecTemplateSpecInitContainersLifecyclePreStopHttpGet {
    ...
    private String path;
    private String port;
    private ReplicaSetSpecTemplateSpecInitContainersLifecyclePreStopHttpGetScheme scheme;
    ...
    public ReplicaSetSpecTemplateSpecInitContainersLifecyclePreStopHttpGet(final String host,
                                                                           ...
                                                                           final String path,
                                                                           final String port,
                                                                           final ReplicaSetSpecTemplateSpecInitContainersLifecyclePreStopHttpGetScheme scheme) {
        // no-op
    }
    ...
    public ReplicaSetSpecTemplateSpecInitContainersLifecyclePreStopHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final ReplicaSetSpecTemplateSpecInitContainersLifecyclePreStopHttpGetScheme scheme) {
        this.scheme = scheme;
    }
