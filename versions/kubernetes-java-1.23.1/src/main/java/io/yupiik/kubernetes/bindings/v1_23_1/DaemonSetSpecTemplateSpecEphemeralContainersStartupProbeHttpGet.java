...
public class DaemonSetSpecTemplateSpecEphemeralContainersStartupProbeHttpGet {
    ...
    private String path;
    private String port;
    private DaemonSetSpecTemplateSpecEphemeralContainersStartupProbeHttpGetScheme scheme;
    ...
    public DaemonSetSpecTemplateSpecEphemeralContainersStartupProbeHttpGet(final String host,
                                                                           ...
                                                                           final String path,
                                                                           final String port,
                                                                           final DaemonSetSpecTemplateSpecEphemeralContainersStartupProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public DaemonSetSpecTemplateSpecEphemeralContainersStartupProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final DaemonSetSpecTemplateSpecEphemeralContainersStartupProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
