...
public class DaemonSetSpecTemplateSpecTopologySpreadConstraints {
    ...
    private DaemonSetSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable whenUnsatisfiable;
    ...
    public DaemonSetSpecTemplateSpecTopologySpreadConstraints(final DaemonSetSpecTemplateSpecTopologySpreadConstraintsLabelSelector labelSelector,
                                                              ...
                                                              final DaemonSetSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable whenUnsatisfiable) {
        // no-op
    }
    ...
    public DaemonSetSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable getWhenUnsatisfiable() {
        return whenUnsatisfiable;
    }

    public void setWhenUnsatisfiable(final DaemonSetSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable whenUnsatisfiable) {
