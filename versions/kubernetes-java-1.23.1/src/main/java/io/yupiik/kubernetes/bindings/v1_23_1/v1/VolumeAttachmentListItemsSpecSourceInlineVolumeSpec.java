...
public class VolumeAttachmentListItemsSpecSourceInlineVolumeSpec {
    ...
    private VolumeAttachmentListItemsSpecSourceInlineVolumeSpecPersistentVolumeReclaimPolicy persistentVolumeReclaimPolicy;
    ...
    public VolumeAttachmentListItemsSpecSourceInlineVolumeSpec(final List<String> accessModes,
                                                               ...
                                                               final VolumeAttachmentListItemsSpecSourceInlineVolumeSpecPersistentVolumeReclaimPolicy persistentVolumeReclaimPolicy,
    ...
    public VolumeAttachmentListItemsSpecSourceInlineVolumeSpecPersistentVolumeReclaimPolicy getPersistentVolumeReclaimPolicy() {
        return persistentVolumeReclaimPolicy;
    }

    public void setPersistentVolumeReclaimPolicy(final VolumeAttachmentListItemsSpecSourceInlineVolumeSpecPersistentVolumeReclaimPolicy persistentVolumeReclaimPolicy) {
