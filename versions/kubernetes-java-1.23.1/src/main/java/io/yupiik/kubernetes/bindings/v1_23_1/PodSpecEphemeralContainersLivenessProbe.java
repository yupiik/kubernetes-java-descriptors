...
public class PodSpecEphemeralContainersLivenessProbe {
    ...
    private PodSpecEphemeralContainersLivenessProbeGrpc grpc;
    ...
    public PodSpecEphemeralContainersLivenessProbe(final PodSpecEphemeralContainersLivenessProbeExec exec,
                                                   ...
                                                   final PodSpecEphemeralContainersLivenessProbeGrpc grpc,
    ...
    public PodSpecEphemeralContainersLivenessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final PodSpecEphemeralContainersLivenessProbeGrpc grpc) {
        this.grpc = grpc;
    }
