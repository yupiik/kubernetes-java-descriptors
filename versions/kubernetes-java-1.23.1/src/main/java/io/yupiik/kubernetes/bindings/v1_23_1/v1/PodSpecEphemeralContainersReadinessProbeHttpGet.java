...
public class PodSpecEphemeralContainersReadinessProbeHttpGet {
    ...
    private String path;
    private String port;
    private PodSpecEphemeralContainersReadinessProbeHttpGetScheme scheme;
    ...
    public PodSpecEphemeralContainersReadinessProbeHttpGet(final String host,
                                                           ...
                                                           final String path,
                                                           final String port,
                                                           final PodSpecEphemeralContainersReadinessProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public PodSpecEphemeralContainersReadinessProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final PodSpecEphemeralContainersReadinessProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
