...
public class ServiceListItemsSpecPorts {
    ...
    private int port;
    private ServiceListItemsSpecPortsProtocol protocol;
    ...
    public ServiceListItemsSpecPorts(final String appProtocol,
                                     ...
                                     final int port,
                                     final ServiceListItemsSpecPortsProtocol protocol,
    ...
    public ServiceListItemsSpecPortsProtocol getProtocol() {
        return protocol;
    }

    public void setProtocol(final ServiceListItemsSpecPortsProtocol protocol) {
