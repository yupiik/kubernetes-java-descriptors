...
public class JobSpecTemplateSpec {
    ...
    private JobSpecTemplateSpecDnsPolicy dnsPolicy;
    ...
    public JobSpecTemplateSpec(final Integer activeDeadlineSeconds,
                               ...
                               final JobSpecTemplateSpecDnsPolicy dnsPolicy,
                               ...
                               final JobSpecTemplateSpecOs os,
                               ...
                               final JobSpecTemplateSpecRestartPolicy restartPolicy,
    ...
    public JobSpecTemplateSpecDnsPolicy getDnsPolicy() {
        return dnsPolicy;
    }

    public void setDnsPolicy(final JobSpecTemplateSpecDnsPolicy dnsPolicy) {
    ...
    public JobSpecTemplateSpecOs getOs() {
        return os;
    }

    public void setOs(final JobSpecTemplateSpecOs os) {
        this.os = os;
    }
    ...
    public JobSpecTemplateSpecRestartPolicy getRestartPolicy() {
        return restartPolicy;
    }

    public void setRestartPolicy(final JobSpecTemplateSpecRestartPolicy restartPolicy) {
