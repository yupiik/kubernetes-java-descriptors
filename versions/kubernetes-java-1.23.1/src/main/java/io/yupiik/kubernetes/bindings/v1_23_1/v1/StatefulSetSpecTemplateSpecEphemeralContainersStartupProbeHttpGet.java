...
public class StatefulSetSpecTemplateSpecEphemeralContainersStartupProbeHttpGet {
    ...
    private String path;
    private String port;
    private StatefulSetSpecTemplateSpecEphemeralContainersStartupProbeHttpGetScheme scheme;
    ...
    public StatefulSetSpecTemplateSpecEphemeralContainersStartupProbeHttpGet(final String host,
                                                                             ...
                                                                             final String path,
                                                                             final String port,
                                                                             final StatefulSetSpecTemplateSpecEphemeralContainersStartupProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public StatefulSetSpecTemplateSpecEphemeralContainersStartupProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final StatefulSetSpecTemplateSpecEphemeralContainersStartupProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
