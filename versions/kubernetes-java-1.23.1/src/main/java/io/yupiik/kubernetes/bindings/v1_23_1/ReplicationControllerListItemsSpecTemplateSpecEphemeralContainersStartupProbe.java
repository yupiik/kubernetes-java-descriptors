...
public class ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersStartupProbe {
    ...
    private ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersStartupProbeGrpc grpc;
    ...
    public ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersStartupProbe(final ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersStartupProbeExec exec,
                                                                                         ...
                                                                                         final ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersStartupProbeGrpc grpc,
    ...
    public ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersStartupProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersStartupProbeGrpc grpc) {
        this.grpc = grpc;
    }
