...
public class PodTemplateListItemsTemplateSpecInitContainers {
    ...
    private PodTemplateListItemsTemplateSpecInitContainersImagePullPolicy imagePullPolicy;
    ...
    private PodTemplateListItemsTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public PodTemplateListItemsTemplateSpecInitContainers(final List<String> args,
                                                          ...
                                                          final String image,
                                                          final PodTemplateListItemsTemplateSpecInitContainersImagePullPolicy imagePullPolicy,
                                                          ...
                                                          final PodTemplateListItemsTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy,
                                                          final Boolean tty,
    ...
    public PodTemplateListItemsTemplateSpecInitContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final PodTemplateListItemsTemplateSpecInitContainersImagePullPolicy imagePullPolicy) {
    ...
    public PodTemplateListItemsTemplateSpecInitContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final PodTemplateListItemsTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy) {
