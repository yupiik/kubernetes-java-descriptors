...
public class PodTemplateListItemsTemplateSpecContainers {
    ...
    private PodTemplateListItemsTemplateSpecContainersImagePullPolicy imagePullPolicy;
    ...
    private PodTemplateListItemsTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public PodTemplateListItemsTemplateSpecContainers(final List<String> args,
                                                      ...
                                                      final String image,
                                                      final PodTemplateListItemsTemplateSpecContainersImagePullPolicy imagePullPolicy,
                                                      ...
                                                      final PodTemplateListItemsTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy,
                                                      final Boolean tty,
    ...
    public PodTemplateListItemsTemplateSpecContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final PodTemplateListItemsTemplateSpecContainersImagePullPolicy imagePullPolicy) {
    ...
    public PodTemplateListItemsTemplateSpecContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final PodTemplateListItemsTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy) {
