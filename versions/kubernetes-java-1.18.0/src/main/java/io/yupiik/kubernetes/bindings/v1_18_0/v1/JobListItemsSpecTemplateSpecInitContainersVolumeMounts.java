...
public class JobListItemsSpecTemplateSpecInitContainersVolumeMounts {
    ...
    public JobListItemsSpecTemplateSpecInitContainersVolumeMounts() {
        // no-op
    }

    public JobListItemsSpecTemplateSpecInitContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobListItemsSpecTemplateSpecInitContainersVolumeMounts)) {
            return false;
        }
        final JobListItemsSpecTemplateSpecInitContainersVolumeMounts __otherCasted = (JobListItemsSpecTemplateSpecInitContainersVolumeMounts) __other;
