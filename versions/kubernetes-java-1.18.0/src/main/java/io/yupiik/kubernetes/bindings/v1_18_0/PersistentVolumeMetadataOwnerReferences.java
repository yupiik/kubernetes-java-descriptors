...
public class PersistentVolumeMetadataOwnerReferences {
    ...
    public PersistentVolumeMetadataOwnerReferences() {
        // no-op
    }

    public PersistentVolumeMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PersistentVolumeMetadataOwnerReferences)) {
            return false;
        }
        final PersistentVolumeMetadataOwnerReferences __otherCasted = (PersistentVolumeMetadataOwnerReferences) __other;
