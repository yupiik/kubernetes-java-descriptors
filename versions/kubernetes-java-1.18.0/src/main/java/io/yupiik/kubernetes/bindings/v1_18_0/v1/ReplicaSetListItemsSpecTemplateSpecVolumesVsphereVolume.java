...
public class ReplicaSetListItemsSpecTemplateSpecVolumesVsphereVolume {
    private String fsType;
    private String storagePolicyID;
    private String storagePolicyName;
    private String volumePath;

    public ReplicaSetListItemsSpecTemplateSpecVolumesVsphereVolume() {
        // no-op
    }

    public ReplicaSetListItemsSpecTemplateSpecVolumesVsphereVolume(final String fsType,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicaSetListItemsSpecTemplateSpecVolumesVsphereVolume)) {
            return false;
        }
        final ReplicaSetListItemsSpecTemplateSpecVolumesVsphereVolume __otherCasted = (ReplicaSetListItemsSpecTemplateSpecVolumesVsphereVolume) __other;
