...
public class DeploymentSpecTemplateSpecEphemeralContainersVolumeMounts {
    ...
    public DeploymentSpecTemplateSpecEphemeralContainersVolumeMounts() {
        // no-op
    }

    public DeploymentSpecTemplateSpecEphemeralContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentSpecTemplateSpecEphemeralContainersVolumeMounts)) {
            return false;
        }
        final DeploymentSpecTemplateSpecEphemeralContainersVolumeMounts __otherCasted = (DeploymentSpecTemplateSpecEphemeralContainersVolumeMounts) __other;
