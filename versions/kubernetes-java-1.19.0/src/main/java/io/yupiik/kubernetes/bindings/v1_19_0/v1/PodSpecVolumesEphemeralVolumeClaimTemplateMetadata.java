...
public class PodSpecVolumesEphemeralVolumeClaimTemplateMetadata {
    ...
    private List<PodSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PodSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PodSpecVolumesEphemeralVolumeClaimTemplateMetadata() {
        // no-op
    }

    public PodSpecVolumesEphemeralVolumeClaimTemplateMetadata(final Map<String, String> annotations,
                                                              ...
                                                              final List<PodSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> managedFields,
                                                              final String name,
                                                              final String namespace,
                                                              final List<PodSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public List<PodSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PodSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> managedFields) {
    ...
    public List<PodSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PodSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSpecVolumesEphemeralVolumeClaimTemplateMetadata)) {
            return false;
        }
        final PodSpecVolumesEphemeralVolumeClaimTemplateMetadata __otherCasted = (PodSpecVolumesEphemeralVolumeClaimTemplateMetadata) __other;
