...
public class PriorityLevelConfigurationListItemsMetadata {
    ...
    private List<PriorityLevelConfigurationListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PriorityLevelConfigurationListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PriorityLevelConfigurationListItemsMetadata() {
        // no-op
    }

    public PriorityLevelConfigurationListItemsMetadata(final Map<String, String> annotations,
                                                       ...
                                                       final List<PriorityLevelConfigurationListItemsMetadataManagedFields> managedFields,
                                                       final String name,
                                                       final String namespace,
                                                       final List<PriorityLevelConfigurationListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public List<PriorityLevelConfigurationListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PriorityLevelConfigurationListItemsMetadataManagedFields> managedFields) {
    ...
    public List<PriorityLevelConfigurationListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PriorityLevelConfigurationListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PriorityLevelConfigurationListItemsMetadata)) {
            return false;
        }
        final PriorityLevelConfigurationListItemsMetadata __otherCasted = (PriorityLevelConfigurationListItemsMetadata) __other;
