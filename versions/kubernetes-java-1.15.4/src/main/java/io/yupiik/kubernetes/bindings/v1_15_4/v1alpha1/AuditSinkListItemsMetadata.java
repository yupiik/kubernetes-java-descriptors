...
public class AuditSinkListItemsMetadata {
    ...
    private AuditSinkListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<AuditSinkListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<AuditSinkListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public AuditSinkListItemsMetadata() {
        // no-op
    }

    public AuditSinkListItemsMetadata(final Map<String, String> annotations,
                                      ...
                                      final AuditSinkListItemsMetadataInitializers initializers,
                                      final Map<String, String> labels,
                                      final List<AuditSinkListItemsMetadataManagedFields> managedFields,
                                      final String name,
                                      final String namespace,
                                      final List<AuditSinkListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public AuditSinkListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final AuditSinkListItemsMetadataInitializers initializers) {
    ...
    public List<AuditSinkListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<AuditSinkListItemsMetadataManagedFields> managedFields) {
    ...
    public List<AuditSinkListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<AuditSinkListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof AuditSinkListItemsMetadata)) {
            return false;
        }
        final AuditSinkListItemsMetadata __otherCasted = (AuditSinkListItemsMetadata) __other;
