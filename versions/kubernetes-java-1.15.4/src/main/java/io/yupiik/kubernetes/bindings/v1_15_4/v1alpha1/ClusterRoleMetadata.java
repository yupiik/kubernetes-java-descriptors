...
public class ClusterRoleMetadata {
    ...
    private ClusterRoleMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ClusterRoleMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ClusterRoleMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ClusterRoleMetadata() {
        // no-op
    }

    public ClusterRoleMetadata(final Map<String, String> annotations,
                               ...
                               final ClusterRoleMetadataInitializers initializers,
                               final Map<String, String> labels,
                               final List<ClusterRoleMetadataManagedFields> managedFields,
                               final String name,
                               final String namespace,
                               final List<ClusterRoleMetadataOwnerReferences> ownerReferences,
    ...
    public ClusterRoleMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ClusterRoleMetadataInitializers initializers) {
    ...
    public List<ClusterRoleMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ClusterRoleMetadataManagedFields> managedFields) {
    ...
    public List<ClusterRoleMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ClusterRoleMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ClusterRoleMetadata)) {
            return false;
        }
        final ClusterRoleMetadata __otherCasted = (ClusterRoleMetadata) __other;
