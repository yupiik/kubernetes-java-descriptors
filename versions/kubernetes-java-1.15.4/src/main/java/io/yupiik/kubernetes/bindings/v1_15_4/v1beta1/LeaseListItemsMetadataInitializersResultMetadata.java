...
public class LeaseListItemsMetadataInitializersResultMetadata {
    ...
    public LeaseListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public LeaseListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LeaseListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final LeaseListItemsMetadataInitializersResultMetadata __otherCasted = (LeaseListItemsMetadataInitializersResultMetadata) __other;
