...
public class DeploymentSpecTemplateMetadata {
    ...
    private DeploymentSpecTemplateMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<DeploymentSpecTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<DeploymentSpecTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public DeploymentSpecTemplateMetadata() {
        // no-op
    }

    public DeploymentSpecTemplateMetadata(final Map<String, String> annotations,
                                          ...
                                          final DeploymentSpecTemplateMetadataInitializers initializers,
                                          final Map<String, String> labels,
                                          final List<DeploymentSpecTemplateMetadataManagedFields> managedFields,
                                          final String name,
                                          final String namespace,
                                          final List<DeploymentSpecTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public DeploymentSpecTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final DeploymentSpecTemplateMetadataInitializers initializers) {
    ...
    public List<DeploymentSpecTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<DeploymentSpecTemplateMetadataManagedFields> managedFields) {
    ...
    public List<DeploymentSpecTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<DeploymentSpecTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentSpecTemplateMetadata)) {
            return false;
        }
        final DeploymentSpecTemplateMetadata __otherCasted = (DeploymentSpecTemplateMetadata) __other;
