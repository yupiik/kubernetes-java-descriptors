...
public class AuditSinkMetadataInitializersResultMetadata {
    ...
    public AuditSinkMetadataInitializersResultMetadata() {
        // no-op
    }

    public AuditSinkMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof AuditSinkMetadataInitializersResultMetadata)) {
            return false;
        }
        final AuditSinkMetadataInitializersResultMetadata __otherCasted = (AuditSinkMetadataInitializersResultMetadata) __other;
