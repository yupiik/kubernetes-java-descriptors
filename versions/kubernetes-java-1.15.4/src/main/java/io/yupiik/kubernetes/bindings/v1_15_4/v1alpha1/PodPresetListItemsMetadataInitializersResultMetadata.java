...
public class PodPresetListItemsMetadataInitializersResultMetadata {
    ...
    public PodPresetListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public PodPresetListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodPresetListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final PodPresetListItemsMetadataInitializersResultMetadata __otherCasted = (PodPresetListItemsMetadataInitializersResultMetadata) __other;
