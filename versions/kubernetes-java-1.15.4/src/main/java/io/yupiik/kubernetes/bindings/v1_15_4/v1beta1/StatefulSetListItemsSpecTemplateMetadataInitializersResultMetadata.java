...
public class StatefulSetListItemsSpecTemplateMetadataInitializersResultMetadata {
    ...
    public StatefulSetListItemsSpecTemplateMetadataInitializersResultMetadata() {
        // no-op
    }

    public StatefulSetListItemsSpecTemplateMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetListItemsSpecTemplateMetadataInitializersResultMetadata)) {
            return false;
        }
        final StatefulSetListItemsSpecTemplateMetadataInitializersResultMetadata __otherCasted = (StatefulSetListItemsSpecTemplateMetadataInitializersResultMetadata) __other;
