...
public class HorizontalPodAutoscalerMetadata {
    ...
    private HorizontalPodAutoscalerMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<HorizontalPodAutoscalerMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<HorizontalPodAutoscalerMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public HorizontalPodAutoscalerMetadata() {
        // no-op
    }

    public HorizontalPodAutoscalerMetadata(final Map<String, String> annotations,
                                           ...
                                           final HorizontalPodAutoscalerMetadataInitializers initializers,
                                           final Map<String, String> labels,
                                           final List<HorizontalPodAutoscalerMetadataManagedFields> managedFields,
                                           final String name,
                                           final String namespace,
                                           final List<HorizontalPodAutoscalerMetadataOwnerReferences> ownerReferences,
    ...
    public HorizontalPodAutoscalerMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final HorizontalPodAutoscalerMetadataInitializers initializers) {
    ...
    public List<HorizontalPodAutoscalerMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<HorizontalPodAutoscalerMetadataManagedFields> managedFields) {
    ...
    public List<HorizontalPodAutoscalerMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<HorizontalPodAutoscalerMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof HorizontalPodAutoscalerMetadata)) {
            return false;
        }
        final HorizontalPodAutoscalerMetadata __otherCasted = (HorizontalPodAutoscalerMetadata) __other;
