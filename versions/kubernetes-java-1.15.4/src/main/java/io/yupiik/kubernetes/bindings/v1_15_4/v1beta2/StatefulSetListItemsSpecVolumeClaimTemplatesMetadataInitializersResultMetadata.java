...
public class StatefulSetListItemsSpecVolumeClaimTemplatesMetadataInitializersResultMetadata {
    ...
    public StatefulSetListItemsSpecVolumeClaimTemplatesMetadataInitializersResultMetadata() {
        // no-op
    }

    public StatefulSetListItemsSpecVolumeClaimTemplatesMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetListItemsSpecVolumeClaimTemplatesMetadataInitializersResultMetadata)) {
            return false;
        }
        final StatefulSetListItemsSpecVolumeClaimTemplatesMetadataInitializersResultMetadata __otherCasted = (StatefulSetListItemsSpecVolumeClaimTemplatesMetadataInitializersResultMetadata) __other;
