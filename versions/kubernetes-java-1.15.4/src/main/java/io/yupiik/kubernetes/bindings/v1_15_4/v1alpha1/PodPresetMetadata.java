...
public class PodPresetMetadata {
    ...
    private PodPresetMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PodPresetMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PodPresetMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PodPresetMetadata() {
        // no-op
    }

    public PodPresetMetadata(final Map<String, String> annotations,
                             ...
                             final PodPresetMetadataInitializers initializers,
                             final Map<String, String> labels,
                             final List<PodPresetMetadataManagedFields> managedFields,
                             final String name,
                             final String namespace,
                             final List<PodPresetMetadataOwnerReferences> ownerReferences,
    ...
    public PodPresetMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PodPresetMetadataInitializers initializers) {
    ...
    public List<PodPresetMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PodPresetMetadataManagedFields> managedFields) {
    ...
    public List<PodPresetMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PodPresetMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodPresetMetadata)) {
            return false;
        }
        final PodPresetMetadata __otherCasted = (PodPresetMetadata) __other;
