...
public class PodDisruptionBudgetListItemsMetadata {
    ...
    private PodDisruptionBudgetListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PodDisruptionBudgetListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PodDisruptionBudgetListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PodDisruptionBudgetListItemsMetadata() {
        // no-op
    }

    public PodDisruptionBudgetListItemsMetadata(final Map<String, String> annotations,
                                                ...
                                                final PodDisruptionBudgetListItemsMetadataInitializers initializers,
                                                final Map<String, String> labels,
                                                final List<PodDisruptionBudgetListItemsMetadataManagedFields> managedFields,
                                                final String name,
                                                final String namespace,
                                                final List<PodDisruptionBudgetListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public PodDisruptionBudgetListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PodDisruptionBudgetListItemsMetadataInitializers initializers) {
    ...
    public List<PodDisruptionBudgetListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PodDisruptionBudgetListItemsMetadataManagedFields> managedFields) {
    ...
    public List<PodDisruptionBudgetListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PodDisruptionBudgetListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodDisruptionBudgetListItemsMetadata)) {
            return false;
        }
        final PodDisruptionBudgetListItemsMetadata __otherCasted = (PodDisruptionBudgetListItemsMetadata) __other;
