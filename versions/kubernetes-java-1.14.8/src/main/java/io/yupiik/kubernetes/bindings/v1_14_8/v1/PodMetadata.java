...
public class PodMetadata {
    ...
    private PodMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PodMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PodMetadataOwnerReferences> ownerReferences;
    ...
    public PodMetadata(final Map<String, String> annotations,
                       ...
                       final PodMetadataInitializers initializers,
                       final Map<String, String> labels,
                       final List<PodMetadataManagedFields> managedFields,
                       final String name,
                       final String namespace,
                       final List<PodMetadataOwnerReferences> ownerReferences,
    ...
    public PodMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PodMetadataInitializers initializers) {
    ...
    public List<PodMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PodMetadataManagedFields> managedFields) {
    ...
    public List<PodMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PodMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodMetadata)) {
            return false;
        }
        final PodMetadata __otherCasted = (PodMetadata) __other;
