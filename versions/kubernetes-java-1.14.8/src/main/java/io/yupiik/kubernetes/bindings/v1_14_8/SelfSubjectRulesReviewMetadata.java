...
public class SelfSubjectRulesReviewMetadata {
    ...
    private SelfSubjectRulesReviewMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<SelfSubjectRulesReviewMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<SelfSubjectRulesReviewMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public SelfSubjectRulesReviewMetadata() {
        // no-op
    }

    public SelfSubjectRulesReviewMetadata(final Map<String, String> annotations,
                                          ...
                                          final SelfSubjectRulesReviewMetadataInitializers initializers,
                                          final Map<String, String> labels,
                                          final List<SelfSubjectRulesReviewMetadataManagedFields> managedFields,
                                          final String name,
                                          final String namespace,
                                          final List<SelfSubjectRulesReviewMetadataOwnerReferences> ownerReferences,
    ...
    public SelfSubjectRulesReviewMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final SelfSubjectRulesReviewMetadataInitializers initializers) {
    ...
    public List<SelfSubjectRulesReviewMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<SelfSubjectRulesReviewMetadataManagedFields> managedFields) {
    ...
    public List<SelfSubjectRulesReviewMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<SelfSubjectRulesReviewMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof SelfSubjectRulesReviewMetadata)) {
            return false;
        }
        final SelfSubjectRulesReviewMetadata __otherCasted = (SelfSubjectRulesReviewMetadata) __other;
