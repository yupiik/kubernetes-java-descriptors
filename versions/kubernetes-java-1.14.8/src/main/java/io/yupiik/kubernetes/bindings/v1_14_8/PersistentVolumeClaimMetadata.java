...
public class PersistentVolumeClaimMetadata {
    ...
    private PersistentVolumeClaimMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PersistentVolumeClaimMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PersistentVolumeClaimMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PersistentVolumeClaimMetadata() {
        // no-op
    }

    public PersistentVolumeClaimMetadata(final Map<String, String> annotations,
                                         ...
                                         final PersistentVolumeClaimMetadataInitializers initializers,
                                         final Map<String, String> labels,
                                         final List<PersistentVolumeClaimMetadataManagedFields> managedFields,
                                         final String name,
                                         final String namespace,
                                         final List<PersistentVolumeClaimMetadataOwnerReferences> ownerReferences,
    ...
    public PersistentVolumeClaimMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PersistentVolumeClaimMetadataInitializers initializers) {
    ...
    public List<PersistentVolumeClaimMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PersistentVolumeClaimMetadataManagedFields> managedFields) {
    ...
    public List<PersistentVolumeClaimMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PersistentVolumeClaimMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PersistentVolumeClaimMetadata)) {
            return false;
        }
        final PersistentVolumeClaimMetadata __otherCasted = (PersistentVolumeClaimMetadata) __other;
