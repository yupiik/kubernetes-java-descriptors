...
public class NodeMetadata {
    ...
    private NodeMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<NodeMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<NodeMetadataOwnerReferences> ownerReferences;
    ...
    public NodeMetadata(final Map<String, String> annotations,
                        ...
                        final NodeMetadataInitializers initializers,
                        final Map<String, String> labels,
                        final List<NodeMetadataManagedFields> managedFields,
                        final String name,
                        final String namespace,
                        final List<NodeMetadataOwnerReferences> ownerReferences,
    ...
    public NodeMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final NodeMetadataInitializers initializers) {
    ...
    public List<NodeMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<NodeMetadataManagedFields> managedFields) {
    ...
    public List<NodeMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<NodeMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NodeMetadata)) {
            return false;
        }
        final NodeMetadata __otherCasted = (NodeMetadata) __other;
