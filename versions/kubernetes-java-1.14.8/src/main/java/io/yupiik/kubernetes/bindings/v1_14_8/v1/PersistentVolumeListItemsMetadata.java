...
public class PersistentVolumeListItemsMetadata {
    ...
    private PersistentVolumeListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PersistentVolumeListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PersistentVolumeListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PersistentVolumeListItemsMetadata() {
        // no-op
    }

    public PersistentVolumeListItemsMetadata(final Map<String, String> annotations,
                                             ...
                                             final PersistentVolumeListItemsMetadataInitializers initializers,
                                             final Map<String, String> labels,
                                             final List<PersistentVolumeListItemsMetadataManagedFields> managedFields,
                                             final String name,
                                             final String namespace,
                                             final List<PersistentVolumeListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public PersistentVolumeListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PersistentVolumeListItemsMetadataInitializers initializers) {
    ...
    public List<PersistentVolumeListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PersistentVolumeListItemsMetadataManagedFields> managedFields) {
    ...
    public List<PersistentVolumeListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PersistentVolumeListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PersistentVolumeListItemsMetadata)) {
            return false;
        }
        final PersistentVolumeListItemsMetadata __otherCasted = (PersistentVolumeListItemsMetadata) __other;
