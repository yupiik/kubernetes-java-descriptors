...
public class CertificateSigningRequestMetadata {
    ...
    private CertificateSigningRequestMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<CertificateSigningRequestMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<CertificateSigningRequestMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public CertificateSigningRequestMetadata() {
        // no-op
    }

    public CertificateSigningRequestMetadata(final Map<String, String> annotations,
                                             ...
                                             final CertificateSigningRequestMetadataInitializers initializers,
                                             final Map<String, String> labels,
                                             final List<CertificateSigningRequestMetadataManagedFields> managedFields,
                                             final String name,
                                             final String namespace,
                                             final List<CertificateSigningRequestMetadataOwnerReferences> ownerReferences,
    ...
    public CertificateSigningRequestMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final CertificateSigningRequestMetadataInitializers initializers) {
    ...
    public List<CertificateSigningRequestMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<CertificateSigningRequestMetadataManagedFields> managedFields) {
    ...
    public List<CertificateSigningRequestMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<CertificateSigningRequestMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CertificateSigningRequestMetadata)) {
            return false;
        }
        final CertificateSigningRequestMetadata __otherCasted = (CertificateSigningRequestMetadata) __other;
