...
public class StatefulSetSpecVolumeClaimTemplatesMetadata {
    ...
    private StatefulSetSpecVolumeClaimTemplatesMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<StatefulSetSpecVolumeClaimTemplatesMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<StatefulSetSpecVolumeClaimTemplatesMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public StatefulSetSpecVolumeClaimTemplatesMetadata() {
        // no-op
    }

    public StatefulSetSpecVolumeClaimTemplatesMetadata(final Map<String, String> annotations,
                                                       ...
                                                       final StatefulSetSpecVolumeClaimTemplatesMetadataInitializers initializers,
                                                       final Map<String, String> labels,
                                                       final List<StatefulSetSpecVolumeClaimTemplatesMetadataManagedFields> managedFields,
                                                       final String name,
                                                       final String namespace,
                                                       final List<StatefulSetSpecVolumeClaimTemplatesMetadataOwnerReferences> ownerReferences,
    ...
    public StatefulSetSpecVolumeClaimTemplatesMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final StatefulSetSpecVolumeClaimTemplatesMetadataInitializers initializers) {
    ...
    public List<StatefulSetSpecVolumeClaimTemplatesMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<StatefulSetSpecVolumeClaimTemplatesMetadataManagedFields> managedFields) {
    ...
    public List<StatefulSetSpecVolumeClaimTemplatesMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<StatefulSetSpecVolumeClaimTemplatesMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetSpecVolumeClaimTemplatesMetadata)) {
            return false;
        }
        final StatefulSetSpecVolumeClaimTemplatesMetadata __otherCasted = (StatefulSetSpecVolumeClaimTemplatesMetadata) __other;
