...
public class ServiceListItemsMetadataOwnerReferences {
    ...
    public ServiceListItemsMetadataOwnerReferences() {
        // no-op
    }

    public ServiceListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ServiceListItemsMetadataOwnerReferences)) {
            return false;
        }
        final ServiceListItemsMetadataOwnerReferences __otherCasted = (ServiceListItemsMetadataOwnerReferences) __other;
