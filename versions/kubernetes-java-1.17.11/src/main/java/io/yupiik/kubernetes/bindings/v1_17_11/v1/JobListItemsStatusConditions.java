...
public class JobListItemsStatusConditions {
    ...
    public JobListItemsStatusConditions() {
        // no-op
    }

    public JobListItemsStatusConditions(final String lastProbeTime,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobListItemsStatusConditions)) {
            return false;
        }
        final JobListItemsStatusConditions __otherCasted = (JobListItemsStatusConditions) __other;
