...
public class CronJobMetadataManagedFields {
    ...
    public CronJobMetadataManagedFields() {
        // no-op
    }

    public CronJobMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CronJobMetadataManagedFields)) {
            return false;
        }
        final CronJobMetadataManagedFields __otherCasted = (CronJobMetadataManagedFields) __other;
