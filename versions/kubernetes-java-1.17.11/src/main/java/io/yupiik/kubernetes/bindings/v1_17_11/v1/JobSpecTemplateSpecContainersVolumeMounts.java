...
public class JobSpecTemplateSpecContainersVolumeMounts {
    ...
    public JobSpecTemplateSpecContainersVolumeMounts() {
        // no-op
    }

    public JobSpecTemplateSpecContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobSpecTemplateSpecContainersVolumeMounts)) {
            return false;
        }
        final JobSpecTemplateSpecContainersVolumeMounts __otherCasted = (JobSpecTemplateSpecContainersVolumeMounts) __other;
