...
public class DaemonSetListItemsSpecTemplateSpecInitContainersSecurityContext {
    ...
    private DaemonSetListItemsSpecTemplateSpecInitContainersSecurityContextSeccompProfile seccompProfile;
    ...
    public DaemonSetListItemsSpecTemplateSpecInitContainersSecurityContext(final Boolean allowPrivilegeEscalation,
                                                                           ...
                                                                           final DaemonSetListItemsSpecTemplateSpecInitContainersSecurityContextSeccompProfile seccompProfile,
    ...
    public DaemonSetListItemsSpecTemplateSpecInitContainersSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final DaemonSetListItemsSpecTemplateSpecInitContainersSecurityContextSeccompProfile seccompProfile) {
