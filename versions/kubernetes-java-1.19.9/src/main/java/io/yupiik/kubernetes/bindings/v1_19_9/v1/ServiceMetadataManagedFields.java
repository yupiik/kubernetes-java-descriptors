...
public class ServiceMetadataManagedFields {
    ...
    public ServiceMetadataManagedFields() {
        // no-op
    }

    public ServiceMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ServiceMetadataManagedFields)) {
            return false;
        }
        final ServiceMetadataManagedFields __otherCasted = (ServiceMetadataManagedFields) __other;
