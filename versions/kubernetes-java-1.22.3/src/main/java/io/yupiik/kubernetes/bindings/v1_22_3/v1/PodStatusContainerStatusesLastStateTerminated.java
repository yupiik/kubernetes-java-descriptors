...
public class PodStatusContainerStatusesLastStateTerminated {
    ...
    public PodStatusContainerStatusesLastStateTerminated() {
        // no-op
    }

    public PodStatusContainerStatusesLastStateTerminated(final String containerID,
                                                         final int exitCode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodStatusContainerStatusesLastStateTerminated)) {
            return false;
        }
        final PodStatusContainerStatusesLastStateTerminated __otherCasted = (PodStatusContainerStatusesLastStateTerminated) __other;
