...
public class StatefulSetSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields {
    ...
    public StatefulSetSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields() {
        // no-op
    }

    public StatefulSetSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields)) {
            return false;
        }
        final StatefulSetSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields __otherCasted = (StatefulSetSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields) __other;
