...
public class DeploymentSpecTemplateSpecVolumesFc {
    ...
    public DeploymentSpecTemplateSpecVolumesFc() {
        // no-op
    }

    public DeploymentSpecTemplateSpecVolumesFc(final String fsType,
                                               final Integer lun,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentSpecTemplateSpecVolumesFc)) {
            return false;
        }
        final DeploymentSpecTemplateSpecVolumesFc __otherCasted = (DeploymentSpecTemplateSpecVolumesFc) __other;
