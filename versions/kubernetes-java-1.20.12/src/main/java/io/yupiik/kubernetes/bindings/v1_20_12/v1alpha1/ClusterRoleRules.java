...
public class ClusterRoleRules {
    ...
    public ClusterRoleRules() {
        // no-op
    }

    public ClusterRoleRules(final List<String> apiGroups,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ClusterRoleRules)) {
            return false;
        }
        final ClusterRoleRules __otherCasted = (ClusterRoleRules) __other;
