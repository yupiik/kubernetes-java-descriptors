...
public class IngressClassListItemsMetadata {
    ...
    private List<IngressClassListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<IngressClassListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public IngressClassListItemsMetadata() {
        // no-op
    }

    public IngressClassListItemsMetadata(final Map<String, String> annotations,
                                         ...
                                         final List<IngressClassListItemsMetadataManagedFields> managedFields,
                                         final String name,
                                         final String namespace,
                                         final List<IngressClassListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public List<IngressClassListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<IngressClassListItemsMetadataManagedFields> managedFields) {
    ...
    public List<IngressClassListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<IngressClassListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof IngressClassListItemsMetadata)) {
            return false;
        }
        final IngressClassListItemsMetadata __otherCasted = (IngressClassListItemsMetadata) __other;
