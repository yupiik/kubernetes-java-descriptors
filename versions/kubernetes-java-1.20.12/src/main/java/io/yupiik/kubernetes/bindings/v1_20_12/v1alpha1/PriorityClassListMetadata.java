...
public class PriorityClassListMetadata {
    ...
    public PriorityClassListMetadata() {
        // no-op
    }

    public PriorityClassListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PriorityClassListMetadata)) {
            return false;
        }
        final PriorityClassListMetadata __otherCasted = (PriorityClassListMetadata) __other;
