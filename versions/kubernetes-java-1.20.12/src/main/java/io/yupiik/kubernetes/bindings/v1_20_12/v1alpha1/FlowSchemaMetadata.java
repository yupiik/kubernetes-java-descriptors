...
public class FlowSchemaMetadata {
    ...
    private List<FlowSchemaMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<FlowSchemaMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public FlowSchemaMetadata() {
        // no-op
    }

    public FlowSchemaMetadata(final Map<String, String> annotations,
                              ...
                              final List<FlowSchemaMetadataManagedFields> managedFields,
                              final String name,
                              final String namespace,
                              final List<FlowSchemaMetadataOwnerReferences> ownerReferences,
    ...
    public List<FlowSchemaMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<FlowSchemaMetadataManagedFields> managedFields) {
    ...
    public List<FlowSchemaMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<FlowSchemaMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof FlowSchemaMetadata)) {
            return false;
        }
        final FlowSchemaMetadata __otherCasted = (FlowSchemaMetadata) __other;
