...
public class DeviceToleration implements Validable<DeviceToleration>, Exportable {
    ...
    public DeviceToleration(final String effect,
                            final String key,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeviceToleration)) {
            return false;
        }
        final DeviceToleration __otherCasted = (DeviceToleration) __other;
    ...
    public DeviceToleration effect(final String effect) {
        this.effect = effect;
        return this;
    }

    public DeviceToleration key(final String key) {
        this.key = key;
        return this;
    }

    public DeviceToleration operator(final String operator) {
        this.operator = operator;
        return this;
    }

    public DeviceToleration tolerationSeconds(final Integer tolerationSeconds) {
        this.tolerationSeconds = tolerationSeconds;
        return this;
    }

    public DeviceToleration value(final String value) {
        this.value = value;
        return this;
    }

    @Override
    public DeviceToleration validate() {
        return this;
    }
