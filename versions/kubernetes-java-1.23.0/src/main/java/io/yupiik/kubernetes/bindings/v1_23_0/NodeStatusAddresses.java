...
public class NodeStatusAddresses {
    ...
    private NodeStatusAddressesType type;
    ...
    public NodeStatusAddresses(final String address,
                               final NodeStatusAddressesType type) {
        // no-op
    }
    ...
    public NodeStatusAddressesType getType() {
        return type;
    }

    public void setType(final NodeStatusAddressesType type) {
        this.type = type;
    }
