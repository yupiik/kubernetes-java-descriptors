...
public class PersistentVolumeClaimListItemsStatus {
    ...
    private PersistentVolumeClaimListItemsStatusPhase phase;
    ...
    public PersistentVolumeClaimListItemsStatus(final List<String> accessModes,
                                                ...
                                                final PersistentVolumeClaimListItemsStatusPhase phase,
    ...
    public PersistentVolumeClaimListItemsStatusPhase getPhase() {
        return phase;
    }

    public void setPhase(final PersistentVolumeClaimListItemsStatusPhase phase) {
        this.phase = phase;
    }
