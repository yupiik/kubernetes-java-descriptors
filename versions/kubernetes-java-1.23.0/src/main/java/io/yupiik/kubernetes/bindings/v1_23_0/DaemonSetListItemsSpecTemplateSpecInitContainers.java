...
public class DaemonSetListItemsSpecTemplateSpecInitContainers {
    ...
    private DaemonSetListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy;
    ...
    private DaemonSetListItemsSpecTemplateSpecInitContainersStartupProbe startupProbe;
    private Boolean stdin;
    private Boolean stdinOnce;
    private String terminationMessagePath;
    private DaemonSetListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public DaemonSetListItemsSpecTemplateSpecInitContainers(final List<String> args,
                                                            ...
                                                            final String image,
                                                            final DaemonSetListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy,
                                                            ...
                                                            final DaemonSetListItemsSpecTemplateSpecInitContainersStartupProbe startupProbe,
                                                            final Boolean stdin,
                                                            final Boolean stdinOnce,
                                                            final String terminationMessagePath,
                                                            final DaemonSetListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy,
                                                            final Boolean tty,
    ...
    public DaemonSetListItemsSpecTemplateSpecInitContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final DaemonSetListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy) {
    ...
    public DaemonSetListItemsSpecTemplateSpecInitContainersStartupProbe getStartupProbe() {
        return startupProbe;
    }

    public void setStartupProbe(final DaemonSetListItemsSpecTemplateSpecInitContainersStartupProbe startupProbe) {
    ...
    public DaemonSetListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final DaemonSetListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy) {
