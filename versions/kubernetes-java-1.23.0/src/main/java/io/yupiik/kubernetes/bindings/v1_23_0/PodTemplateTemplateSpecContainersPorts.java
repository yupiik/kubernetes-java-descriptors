...
public class PodTemplateTemplateSpecContainersPorts {
    ...
    private String name;
    private PodTemplateTemplateSpecContainersPortsProtocol protocol;
    ...
    public PodTemplateTemplateSpecContainersPorts(final int containerPort,
                                                  ...
                                                  final String name,
                                                  final PodTemplateTemplateSpecContainersPortsProtocol protocol) {
        // no-op
    }
    ...
    public PodTemplateTemplateSpecContainersPortsProtocol getProtocol() {
        return protocol;
    }

    public void setProtocol(final PodTemplateTemplateSpecContainersPortsProtocol protocol) {
