...
public class DaemonSetSpecTemplateSpecContainersStartupProbe {
    ...
    private DaemonSetSpecTemplateSpecContainersStartupProbeGrpc grpc;
    ...
    public DaemonSetSpecTemplateSpecContainersStartupProbe(final DaemonSetSpecTemplateSpecContainersStartupProbeExec exec,
                                                           ...
                                                           final DaemonSetSpecTemplateSpecContainersStartupProbeGrpc grpc,
    ...
    public DaemonSetSpecTemplateSpecContainersStartupProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final DaemonSetSpecTemplateSpecContainersStartupProbeGrpc grpc) {
        this.grpc = grpc;
    }
