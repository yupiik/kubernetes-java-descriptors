...
public class DaemonSetListItemsSpecTemplateSpec {
    ...
    private DaemonSetListItemsSpecTemplateSpecDnsPolicy dnsPolicy;
    ...
    private DaemonSetListItemsSpecTemplateSpecOs os;
    ...
    private DaemonSetListItemsSpecTemplateSpecRestartPolicy restartPolicy;
    ...
    public DaemonSetListItemsSpecTemplateSpec(final Integer activeDeadlineSeconds,
                                              ...
                                              final DaemonSetListItemsSpecTemplateSpecDnsPolicy dnsPolicy,
                                              ...
                                              final DaemonSetListItemsSpecTemplateSpecOs os,
                                              ...
                                              final DaemonSetListItemsSpecTemplateSpecRestartPolicy restartPolicy,
    ...
    public DaemonSetListItemsSpecTemplateSpecDnsPolicy getDnsPolicy() {
        return dnsPolicy;
    }

    public void setDnsPolicy(final DaemonSetListItemsSpecTemplateSpecDnsPolicy dnsPolicy) {
    ...
    public DaemonSetListItemsSpecTemplateSpecOs getOs() {
        return os;
    }

    public void setOs(final DaemonSetListItemsSpecTemplateSpecOs os) {
        this.os = os;
    }
    ...
    public DaemonSetListItemsSpecTemplateSpecRestartPolicy getRestartPolicy() {
        return restartPolicy;
    }

    public void setRestartPolicy(final DaemonSetListItemsSpecTemplateSpecRestartPolicy restartPolicy) {
