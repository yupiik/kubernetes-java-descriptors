...
public class StatefulSetListItemsSpecTemplateSpecEphemeralContainersSecurityContext {
    ...
    private StatefulSetListItemsSpecTemplateSpecEphemeralContainersSecurityContextSeccompProfile seccompProfile;
    ...
    public StatefulSetListItemsSpecTemplateSpecEphemeralContainersSecurityContext(final Boolean allowPrivilegeEscalation,
                                                                                  ...
                                                                                  final StatefulSetListItemsSpecTemplateSpecEphemeralContainersSecurityContextSeccompProfile seccompProfile,
    ...
    public StatefulSetListItemsSpecTemplateSpecEphemeralContainersSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final StatefulSetListItemsSpecTemplateSpecEphemeralContainersSecurityContextSeccompProfile seccompProfile) {
