...
public class PodTemplateTemplateMetadataOwnerReferences {
    ...
    public PodTemplateTemplateMetadataOwnerReferences() {
        // no-op
    }

    public PodTemplateTemplateMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateTemplateMetadataOwnerReferences)) {
            return false;
        }
        final PodTemplateTemplateMetadataOwnerReferences __otherCasted = (PodTemplateTemplateMetadataOwnerReferences) __other;
