...
public class StatefulSetSpecTemplateSpecInitContainers {
    ...
    private StatefulSetSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy;
    ...
    private StatefulSetSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public StatefulSetSpecTemplateSpecInitContainers(final List<String> args,
                                                     ...
                                                     final String image,
                                                     final StatefulSetSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy,
                                                     ...
                                                     final StatefulSetSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy,
                                                     final Boolean tty,
    ...
    public StatefulSetSpecTemplateSpecInitContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final StatefulSetSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy) {
    ...
    public StatefulSetSpecTemplateSpecInitContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final StatefulSetSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy) {
