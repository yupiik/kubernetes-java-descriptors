...
public class PodListItemsSpecEphemeralContainers {
    ...
    private PodListItemsSpecEphemeralContainersImagePullPolicy imagePullPolicy;
    ...
    private PodListItemsSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public PodListItemsSpecEphemeralContainers(final List<String> args,
                                               ...
                                               final String image,
                                               final PodListItemsSpecEphemeralContainersImagePullPolicy imagePullPolicy,
                                               ...
                                               final PodListItemsSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy,
                                               final Boolean tty,
    ...
    public PodListItemsSpecEphemeralContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final PodListItemsSpecEphemeralContainersImagePullPolicy imagePullPolicy) {
    ...
    public PodListItemsSpecEphemeralContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final PodListItemsSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy) {
