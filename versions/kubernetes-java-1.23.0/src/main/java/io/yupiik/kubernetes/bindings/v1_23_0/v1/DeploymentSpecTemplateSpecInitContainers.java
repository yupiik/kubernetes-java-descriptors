...
public class DeploymentSpecTemplateSpecInitContainers {
    ...
    private DeploymentSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy;
    ...
    private DeploymentSpecTemplateSpecInitContainersStartupProbe startupProbe;
    private Boolean stdin;
    private Boolean stdinOnce;
    private String terminationMessagePath;
    private DeploymentSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public DeploymentSpecTemplateSpecInitContainers(final List<String> args,
                                                    ...
                                                    final String image,
                                                    final DeploymentSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy,
                                                    ...
                                                    final DeploymentSpecTemplateSpecInitContainersStartupProbe startupProbe,
                                                    final Boolean stdin,
                                                    final Boolean stdinOnce,
                                                    final String terminationMessagePath,
                                                    final DeploymentSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy,
                                                    final Boolean tty,
    ...
    public DeploymentSpecTemplateSpecInitContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final DeploymentSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy) {
    ...
    public DeploymentSpecTemplateSpecInitContainersStartupProbe getStartupProbe() {
        return startupProbe;
    }

    public void setStartupProbe(final DeploymentSpecTemplateSpecInitContainersStartupProbe startupProbe) {
    ...
    public DeploymentSpecTemplateSpecInitContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final DeploymentSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy) {
