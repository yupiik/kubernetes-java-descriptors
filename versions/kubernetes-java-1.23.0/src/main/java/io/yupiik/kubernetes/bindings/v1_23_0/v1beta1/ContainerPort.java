...
public class ContainerPort implements Validable<ContainerPort>, Exportable {
    ...
    public ContainerPort(final int containerPort,
                         ...
                         final String name,
                         final ContainerPortProtocol protocol) {
    ...
    public void setProtocol(final ContainerPortProtocol protocol) {
        this.protocol = protocol;
    }
    ...
    public ContainerPort protocol(final ContainerPortProtocol protocol) {
        this.protocol = protocol;
        return this;
    }
