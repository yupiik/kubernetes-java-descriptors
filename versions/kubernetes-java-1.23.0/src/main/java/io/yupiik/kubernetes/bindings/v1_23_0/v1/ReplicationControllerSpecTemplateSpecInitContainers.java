...
public class ReplicationControllerSpecTemplateSpecInitContainers {
    ...
    private ReplicationControllerSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy;
    ...
    private ReplicationControllerSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public ReplicationControllerSpecTemplateSpecInitContainers(final List<String> args,
                                                               ...
                                                               final String image,
                                                               final ReplicationControllerSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy,
                                                               ...
                                                               final ReplicationControllerSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy,
                                                               final Boolean tty,
    ...
    public ReplicationControllerSpecTemplateSpecInitContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final ReplicationControllerSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy) {
    ...
    public ReplicationControllerSpecTemplateSpecInitContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final ReplicationControllerSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy) {
