...
public class PersistentVolumeListItemsSpec {
    ...
    private PersistentVolumeListItemsSpecPersistentVolumeReclaimPolicy persistentVolumeReclaimPolicy;
    ...
    public PersistentVolumeListItemsSpec(final List<String> accessModes,
                                         ...
                                         final PersistentVolumeListItemsSpecPersistentVolumeReclaimPolicy persistentVolumeReclaimPolicy,
    ...
    public PersistentVolumeListItemsSpecPersistentVolumeReclaimPolicy getPersistentVolumeReclaimPolicy() {
        return persistentVolumeReclaimPolicy;
    }

    public void setPersistentVolumeReclaimPolicy(final PersistentVolumeListItemsSpecPersistentVolumeReclaimPolicy persistentVolumeReclaimPolicy) {
