...
public class CronJobSpecJobTemplateSpecTemplateSpecInitContainers {
    ...
    private CronJobSpecJobTemplateSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy;
    ...
    private CronJobSpecJobTemplateSpecTemplateSpecInitContainersStartupProbe startupProbe;
    private Boolean stdin;
    private Boolean stdinOnce;
    private String terminationMessagePath;
    private CronJobSpecJobTemplateSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecInitContainers(final List<String> args,
                                                                ...
                                                                final String image,
                                                                final CronJobSpecJobTemplateSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy,
                                                                ...
                                                                final CronJobSpecJobTemplateSpecTemplateSpecInitContainersStartupProbe startupProbe,
                                                                final Boolean stdin,
                                                                final Boolean stdinOnce,
                                                                final String terminationMessagePath,
                                                                final CronJobSpecJobTemplateSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy,
                                                                final Boolean tty,
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecInitContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final CronJobSpecJobTemplateSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy) {
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecInitContainersStartupProbe getStartupProbe() {
        return startupProbe;
    }

    public void setStartupProbe(final CronJobSpecJobTemplateSpecTemplateSpecInitContainersStartupProbe startupProbe) {
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecInitContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final CronJobSpecJobTemplateSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy) {
