...
public class StatefulSetSpecTemplateSpecContainersReadinessProbe {
    ...
    private StatefulSetSpecTemplateSpecContainersReadinessProbeGrpc grpc;
    ...
    public StatefulSetSpecTemplateSpecContainersReadinessProbe(final StatefulSetSpecTemplateSpecContainersReadinessProbeExec exec,
                                                               ...
                                                               final StatefulSetSpecTemplateSpecContainersReadinessProbeGrpc grpc,
    ...
    public StatefulSetSpecTemplateSpecContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final StatefulSetSpecTemplateSpecContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
