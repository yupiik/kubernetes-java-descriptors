...
public class DeploymentListItemsSpecTemplateSpecInitContainers {
    ...
    private DeploymentListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy;
    ...
    private DeploymentListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public DeploymentListItemsSpecTemplateSpecInitContainers(final List<String> args,
                                                             ...
                                                             final String image,
                                                             final DeploymentListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy,
                                                             ...
                                                             final DeploymentListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy,
                                                             final Boolean tty,
    ...
    public DeploymentListItemsSpecTemplateSpecInitContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final DeploymentListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy) {
    ...
    public DeploymentListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final DeploymentListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy) {
