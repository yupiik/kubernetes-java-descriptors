...
public class ReplicaSetListItemsSpecTemplateSpecContainersLifecyclePreStopHttpGet {
    ...
    private String path;
    private String port;
    private ReplicaSetListItemsSpecTemplateSpecContainersLifecyclePreStopHttpGetScheme scheme;
    ...
    public ReplicaSetListItemsSpecTemplateSpecContainersLifecyclePreStopHttpGet(final String host,
                                                                                ...
                                                                                final String path,
                                                                                final String port,
                                                                                final ReplicaSetListItemsSpecTemplateSpecContainersLifecyclePreStopHttpGetScheme scheme) {
        // no-op
    }
    ...
    public ReplicaSetListItemsSpecTemplateSpecContainersLifecyclePreStopHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final ReplicaSetListItemsSpecTemplateSpecContainersLifecyclePreStopHttpGetScheme scheme) {
        this.scheme = scheme;
    }
