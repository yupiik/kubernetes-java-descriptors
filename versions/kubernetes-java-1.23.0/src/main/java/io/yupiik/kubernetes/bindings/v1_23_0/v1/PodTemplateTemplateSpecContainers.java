...
public class PodTemplateTemplateSpecContainers {
    ...
    private PodTemplateTemplateSpecContainersImagePullPolicy imagePullPolicy;
    ...
    private PodTemplateTemplateSpecContainersStartupProbe startupProbe;
    private Boolean stdin;
    private Boolean stdinOnce;
    private String terminationMessagePath;
    private PodTemplateTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public PodTemplateTemplateSpecContainers(final List<String> args,
                                             ...
                                             final String image,
                                             final PodTemplateTemplateSpecContainersImagePullPolicy imagePullPolicy,
                                             ...
                                             final PodTemplateTemplateSpecContainersStartupProbe startupProbe,
                                             final Boolean stdin,
                                             final Boolean stdinOnce,
                                             final String terminationMessagePath,
                                             final PodTemplateTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy,
                                             final Boolean tty,
    ...
    public PodTemplateTemplateSpecContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final PodTemplateTemplateSpecContainersImagePullPolicy imagePullPolicy) {
    ...
    public PodTemplateTemplateSpecContainersStartupProbe getStartupProbe() {
        return startupProbe;
    }

    public void setStartupProbe(final PodTemplateTemplateSpecContainersStartupProbe startupProbe) {
    ...
    public PodTemplateTemplateSpecContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final PodTemplateTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy) {
