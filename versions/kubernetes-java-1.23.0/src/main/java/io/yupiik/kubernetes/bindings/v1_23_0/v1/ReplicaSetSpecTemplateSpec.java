...
public class ReplicaSetSpecTemplateSpec {
    ...
    private ReplicaSetSpecTemplateSpecDnsPolicy dnsPolicy;
    ...
    public ReplicaSetSpecTemplateSpec(final Integer activeDeadlineSeconds,
                                      ...
                                      final ReplicaSetSpecTemplateSpecDnsPolicy dnsPolicy,
                                      ...
                                      final ReplicaSetSpecTemplateSpecOs os,
                                      ...
                                      final ReplicaSetSpecTemplateSpecRestartPolicy restartPolicy,
    ...
    public ReplicaSetSpecTemplateSpecDnsPolicy getDnsPolicy() {
        return dnsPolicy;
    }

    public void setDnsPolicy(final ReplicaSetSpecTemplateSpecDnsPolicy dnsPolicy) {
    ...
    public ReplicaSetSpecTemplateSpecOs getOs() {
        return os;
    }

    public void setOs(final ReplicaSetSpecTemplateSpecOs os) {
        this.os = os;
    }
    ...
    public ReplicaSetSpecTemplateSpecRestartPolicy getRestartPolicy() {
        return restartPolicy;
    }

    public void setRestartPolicy(final ReplicaSetSpecTemplateSpecRestartPolicy restartPolicy) {
