...
public class DaemonSetSpecTemplateSpec {
    ...
    private DaemonSetSpecTemplateSpecDnsPolicy dnsPolicy;
    ...
    public DaemonSetSpecTemplateSpec(final Integer activeDeadlineSeconds,
                                     ...
                                     final DaemonSetSpecTemplateSpecDnsPolicy dnsPolicy,
                                     ...
                                     final DaemonSetSpecTemplateSpecOs os,
                                     ...
                                     final DaemonSetSpecTemplateSpecRestartPolicy restartPolicy,
    ...
    public DaemonSetSpecTemplateSpecDnsPolicy getDnsPolicy() {
        return dnsPolicy;
    }

    public void setDnsPolicy(final DaemonSetSpecTemplateSpecDnsPolicy dnsPolicy) {
    ...
    public DaemonSetSpecTemplateSpecOs getOs() {
        return os;
    }

    public void setOs(final DaemonSetSpecTemplateSpecOs os) {
        this.os = os;
    }
    ...
    public DaemonSetSpecTemplateSpecRestartPolicy getRestartPolicy() {
        return restartPolicy;
    }

    public void setRestartPolicy(final DaemonSetSpecTemplateSpecRestartPolicy restartPolicy) {
