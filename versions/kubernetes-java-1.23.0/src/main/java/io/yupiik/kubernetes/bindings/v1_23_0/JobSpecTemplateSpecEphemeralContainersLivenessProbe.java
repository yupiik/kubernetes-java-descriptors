...
public class JobSpecTemplateSpecEphemeralContainersLivenessProbe {
    ...
    private JobSpecTemplateSpecEphemeralContainersLivenessProbeGrpc grpc;
    ...
    public JobSpecTemplateSpecEphemeralContainersLivenessProbe(final JobSpecTemplateSpecEphemeralContainersLivenessProbeExec exec,
                                                               ...
                                                               final JobSpecTemplateSpecEphemeralContainersLivenessProbeGrpc grpc,
    ...
    public JobSpecTemplateSpecEphemeralContainersLivenessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final JobSpecTemplateSpecEphemeralContainersLivenessProbeGrpc grpc) {
        this.grpc = grpc;
    }
