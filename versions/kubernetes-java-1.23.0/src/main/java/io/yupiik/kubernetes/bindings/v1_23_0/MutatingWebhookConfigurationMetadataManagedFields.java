...
public class MutatingWebhookConfigurationMetadataManagedFields {
    ...
    public MutatingWebhookConfigurationMetadataManagedFields() {
        // no-op
    }

    public MutatingWebhookConfigurationMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof MutatingWebhookConfigurationMetadataManagedFields)) {
            return false;
        }
        final MutatingWebhookConfigurationMetadataManagedFields __otherCasted = (MutatingWebhookConfigurationMetadataManagedFields) __other;
