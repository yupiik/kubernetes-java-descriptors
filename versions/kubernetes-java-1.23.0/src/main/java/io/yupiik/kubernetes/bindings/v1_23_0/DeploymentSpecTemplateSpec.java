...
public class DeploymentSpecTemplateSpec {
    ...
    private DeploymentSpecTemplateSpecDnsPolicy dnsPolicy;
    ...
    private DeploymentSpecTemplateSpecRestartPolicy restartPolicy;
    ...
    public DeploymentSpecTemplateSpec(final Integer activeDeadlineSeconds,
                                      ...
                                      final DeploymentSpecTemplateSpecDnsPolicy dnsPolicy,
                                      ...
                                      final DeploymentSpecTemplateSpecRestartPolicy restartPolicy,
    ...
    public DeploymentSpecTemplateSpecDnsPolicy getDnsPolicy() {
        return dnsPolicy;
    }

    public void setDnsPolicy(final DeploymentSpecTemplateSpecDnsPolicy dnsPolicy) {
    ...
    public DeploymentSpecTemplateSpecRestartPolicy getRestartPolicy() {
        return restartPolicy;
    }

    public void setRestartPolicy(final DeploymentSpecTemplateSpecRestartPolicy restartPolicy) {
