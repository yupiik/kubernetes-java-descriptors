...
public class ReplicaSetSpecTemplateSpecInitContainersSecurityContext {
    ...
    private ReplicaSetSpecTemplateSpecInitContainersSecurityContextSeccompProfile seccompProfile;
    ...
    public ReplicaSetSpecTemplateSpecInitContainersSecurityContext(final Boolean allowPrivilegeEscalation,
                                                                   ...
                                                                   final ReplicaSetSpecTemplateSpecInitContainersSecurityContextSeccompProfile seccompProfile,
    ...
    public ReplicaSetSpecTemplateSpecInitContainersSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final ReplicaSetSpecTemplateSpecInitContainersSecurityContextSeccompProfile seccompProfile) {
