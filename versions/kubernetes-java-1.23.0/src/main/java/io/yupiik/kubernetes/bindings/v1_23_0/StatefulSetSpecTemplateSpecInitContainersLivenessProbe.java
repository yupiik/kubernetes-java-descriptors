...
public class StatefulSetSpecTemplateSpecInitContainersLivenessProbe {
    ...
    private StatefulSetSpecTemplateSpecInitContainersLivenessProbeGrpc grpc;
    ...
    public StatefulSetSpecTemplateSpecInitContainersLivenessProbe(final StatefulSetSpecTemplateSpecInitContainersLivenessProbeExec exec,
                                                                  ...
                                                                  final StatefulSetSpecTemplateSpecInitContainersLivenessProbeGrpc grpc,
    ...
    public StatefulSetSpecTemplateSpecInitContainersLivenessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final StatefulSetSpecTemplateSpecInitContainersLivenessProbeGrpc grpc) {
        this.grpc = grpc;
    }
