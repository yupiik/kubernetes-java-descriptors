...
public class DaemonSetListItemsSpecTemplateSpecInitContainersPorts {
    ...
    private String name;
    private DaemonSetListItemsSpecTemplateSpecInitContainersPortsProtocol protocol;
    ...
    public DaemonSetListItemsSpecTemplateSpecInitContainersPorts(final int containerPort,
                                                                 ...
                                                                 final String name,
                                                                 final DaemonSetListItemsSpecTemplateSpecInitContainersPortsProtocol protocol) {
        // no-op
    }
    ...
    public DaemonSetListItemsSpecTemplateSpecInitContainersPortsProtocol getProtocol() {
        return protocol;
    }

    public void setProtocol(final DaemonSetListItemsSpecTemplateSpecInitContainersPortsProtocol protocol) {
