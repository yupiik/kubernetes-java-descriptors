...
public class PodStatus implements Validable<PodStatus>, Exportable {
    ...
    private PodStatusPhase phase;
    private String podIP;
    private List<PodIP> podIPs;
    private PodStatusQosClass qosClass;
    ...
    public PodStatus(final List<PodCondition> conditions,
                     ...
                     final PodStatusPhase phase,
                     final String podIP,
                     final List<PodIP> podIPs,
                     final PodStatusQosClass qosClass,
                     final String reason,
    ...
    public PodStatusPhase getPhase() {
        return phase;
    }

    public void setPhase(final PodStatusPhase phase) {
        this.phase = phase;
    }
    ...
    public PodStatusQosClass getQosClass() {
        return qosClass;
    }

    public void setQosClass(final PodStatusQosClass qosClass) {
        this.qosClass = qosClass;
    }
    ...
    public PodStatus phase(final PodStatusPhase phase) {
        this.phase = phase;
        return this;
    }
    ...
    public PodStatus qosClass(final PodStatusQosClass qosClass) {
        this.qosClass = qosClass;
        return this;
    }
    ...
    public String asJson() {
        return Stream.of(
                    ...
                    (qosClass != null ? "\"qosClass\":" + qosClass.asJson() : ""),
