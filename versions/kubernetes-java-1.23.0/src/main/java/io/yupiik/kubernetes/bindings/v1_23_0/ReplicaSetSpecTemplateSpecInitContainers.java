...
public class ReplicaSetSpecTemplateSpecInitContainers {
    ...
    private ReplicaSetSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy;
    ...
    private ReplicaSetSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public ReplicaSetSpecTemplateSpecInitContainers(final List<String> args,
                                                    ...
                                                    final String image,
                                                    final ReplicaSetSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy,
                                                    ...
                                                    final ReplicaSetSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy,
                                                    final Boolean tty,
    ...
    public ReplicaSetSpecTemplateSpecInitContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final ReplicaSetSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy) {
    ...
    public ReplicaSetSpecTemplateSpecInitContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final ReplicaSetSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy) {
