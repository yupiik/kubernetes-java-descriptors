...
public class PodSecurityPolicyMetadata {
    ...
    private PodSecurityPolicyMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PodSecurityPolicyMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PodSecurityPolicyMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PodSecurityPolicyMetadata() {
        // no-op
    }

    public PodSecurityPolicyMetadata(final Map<String, String> annotations,
                                     ...
                                     final PodSecurityPolicyMetadataInitializers initializers,
                                     final Map<String, String> labels,
                                     final List<PodSecurityPolicyMetadataManagedFields> managedFields,
                                     final String name,
                                     final String namespace,
                                     final List<PodSecurityPolicyMetadataOwnerReferences> ownerReferences,
    ...
    public PodSecurityPolicyMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PodSecurityPolicyMetadataInitializers initializers) {
    ...
    public List<PodSecurityPolicyMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PodSecurityPolicyMetadataManagedFields> managedFields) {
    ...
    public List<PodSecurityPolicyMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PodSecurityPolicyMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSecurityPolicyMetadata)) {
            return false;
        }
        final PodSecurityPolicyMetadata __otherCasted = (PodSecurityPolicyMetadata) __other;
