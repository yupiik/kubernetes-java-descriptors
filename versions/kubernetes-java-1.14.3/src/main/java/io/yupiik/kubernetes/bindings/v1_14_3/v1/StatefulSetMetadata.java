...
public class StatefulSetMetadata {
    ...
    private StatefulSetMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<StatefulSetMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<StatefulSetMetadataOwnerReferences> ownerReferences;
    ...
    public StatefulSetMetadata(final Map<String, String> annotations,
                               ...
                               final StatefulSetMetadataInitializers initializers,
                               final Map<String, String> labels,
                               final List<StatefulSetMetadataManagedFields> managedFields,
                               final String name,
                               final String namespace,
                               final List<StatefulSetMetadataOwnerReferences> ownerReferences,
    ...
    public StatefulSetMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final StatefulSetMetadataInitializers initializers) {
    ...
    public List<StatefulSetMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<StatefulSetMetadataManagedFields> managedFields) {
    ...
    public List<StatefulSetMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<StatefulSetMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetMetadata)) {
            return false;
        }
        final StatefulSetMetadata __otherCasted = (StatefulSetMetadata) __other;
