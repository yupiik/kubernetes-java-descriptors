...
public class ScaleMetadata {
    ...
    private ScaleMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ScaleMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ScaleMetadataOwnerReferences> ownerReferences;
    ...
    public ScaleMetadata(final Map<String, String> annotations,
                         ...
                         final ScaleMetadataInitializers initializers,
                         final Map<String, String> labels,
                         final List<ScaleMetadataManagedFields> managedFields,
                         final String name,
                         final String namespace,
                         final List<ScaleMetadataOwnerReferences> ownerReferences,
    ...
    public ScaleMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ScaleMetadataInitializers initializers) {
    ...
    public List<ScaleMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ScaleMetadataManagedFields> managedFields) {
    ...
    public List<ScaleMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ScaleMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ScaleMetadata)) {
            return false;
        }
        final ScaleMetadata __otherCasted = (ScaleMetadata) __other;
