...
public class PodSecurityPolicyListItemsMetadata {
    ...
    private PodSecurityPolicyListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PodSecurityPolicyListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PodSecurityPolicyListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PodSecurityPolicyListItemsMetadata() {
        // no-op
    }

    public PodSecurityPolicyListItemsMetadata(final Map<String, String> annotations,
                                              ...
                                              final PodSecurityPolicyListItemsMetadataInitializers initializers,
                                              final Map<String, String> labels,
                                              final List<PodSecurityPolicyListItemsMetadataManagedFields> managedFields,
                                              final String name,
                                              final String namespace,
                                              final List<PodSecurityPolicyListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public PodSecurityPolicyListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PodSecurityPolicyListItemsMetadataInitializers initializers) {
    ...
    public List<PodSecurityPolicyListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PodSecurityPolicyListItemsMetadataManagedFields> managedFields) {
    ...
    public List<PodSecurityPolicyListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PodSecurityPolicyListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSecurityPolicyListItemsMetadata)) {
            return false;
        }
        final PodSecurityPolicyListItemsMetadata __otherCasted = (PodSecurityPolicyListItemsMetadata) __other;
