package io.yupiik.kubernetes.bindings.v1_14_3.v1alpha1;

import java.util.List;
import java.util.Map;
import java.util.Objects;

public class ClusterRoleBindingMetadata {
    ...
    private ClusterRoleBindingMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ClusterRoleBindingMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ClusterRoleBindingMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ClusterRoleBindingMetadata() {
        // no-op
    }

    public ClusterRoleBindingMetadata(final Map<String, String> annotations,
                                      ...
                                      final ClusterRoleBindingMetadataInitializers initializers,
                                      final Map<String, String> labels,
                                      final List<ClusterRoleBindingMetadataManagedFields> managedFields,
                                      final String name,
                                      final String namespace,
                                      final List<ClusterRoleBindingMetadataOwnerReferences> ownerReferences,
    ...
    public ClusterRoleBindingMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ClusterRoleBindingMetadataInitializers initializers) {
    ...
    public List<ClusterRoleBindingMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ClusterRoleBindingMetadataManagedFields> managedFields) {
    ...
    public List<ClusterRoleBindingMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ClusterRoleBindingMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ClusterRoleBindingMetadata)) {
            return false;
        }
        final ClusterRoleBindingMetadata __otherCasted = (ClusterRoleBindingMetadata) __other;
