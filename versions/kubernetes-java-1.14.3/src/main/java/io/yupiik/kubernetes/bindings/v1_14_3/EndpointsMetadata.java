...
public class EndpointsMetadata {
    ...
    private EndpointsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<EndpointsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<EndpointsMetadataOwnerReferences> ownerReferences;
    ...
    public EndpointsMetadata(final Map<String, String> annotations,
                             ...
                             final EndpointsMetadataInitializers initializers,
                             final Map<String, String> labels,
                             final List<EndpointsMetadataManagedFields> managedFields,
                             final String name,
                             final String namespace,
                             final List<EndpointsMetadataOwnerReferences> ownerReferences,
    ...
    public EndpointsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final EndpointsMetadataInitializers initializers) {
    ...
    public List<EndpointsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<EndpointsMetadataManagedFields> managedFields) {
    ...
    public List<EndpointsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<EndpointsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EndpointsMetadata)) {
            return false;
        }
        final EndpointsMetadata __otherCasted = (EndpointsMetadata) __other;
