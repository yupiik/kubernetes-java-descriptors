...
public class EndpointsMetadataInitializersResultDetails {
    private List<EndpointsMetadataInitializersResultDetailsCauses> causes;
    ...
    public EndpointsMetadataInitializersResultDetails(final List<EndpointsMetadataInitializersResultDetailsCauses> causes,
                                                      final String group,
                                                      final String kind,
                                                      final String name,
    ...
    public List<EndpointsMetadataInitializersResultDetailsCauses> getCauses() {
        return causes;
    }

    public void setCauses(final List<EndpointsMetadataInitializersResultDetailsCauses> causes) {
        this.causes = causes;
    }
