...
public class PodPresetSpecVolumesScaleIO {
    private String fsType;
    private String gateway;
    private String protectionDomain;
    private Boolean readOnly;
    private PodPresetSpecVolumesScaleIOSecretRef secretRef;
    ...
    public PodPresetSpecVolumesScaleIO() {
        // no-op
    }

    public PodPresetSpecVolumesScaleIO(final String fsType,
                                       final String gateway,
                                       final String protectionDomain,
                                       final Boolean readOnly,
                                       final PodPresetSpecVolumesScaleIOSecretRef secretRef,
    ...
    public PodPresetSpecVolumesScaleIOSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final PodPresetSpecVolumesScaleIOSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodPresetSpecVolumesScaleIO)) {
            return false;
        }
        final PodPresetSpecVolumesScaleIO __otherCasted = (PodPresetSpecVolumesScaleIO) __other;
