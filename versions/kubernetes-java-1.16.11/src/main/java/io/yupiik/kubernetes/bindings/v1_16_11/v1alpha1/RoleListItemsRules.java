...
public class RoleListItemsRules {
    ...
    public RoleListItemsRules() {
        // no-op
    }

    public RoleListItemsRules(final List<String> apiGroups,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RoleListItemsRules)) {
            return false;
        }
        final RoleListItemsRules __otherCasted = (RoleListItemsRules) __other;
