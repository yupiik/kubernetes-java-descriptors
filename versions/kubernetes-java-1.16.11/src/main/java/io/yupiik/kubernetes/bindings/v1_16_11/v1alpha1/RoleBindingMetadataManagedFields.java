...
public class RoleBindingMetadataManagedFields {
    ...
    public RoleBindingMetadataManagedFields() {
        // no-op
    }

    public RoleBindingMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RoleBindingMetadataManagedFields)) {
            return false;
        }
        final RoleBindingMetadataManagedFields __otherCasted = (RoleBindingMetadataManagedFields) __other;
