...
public class PodPresetSpecVolumesAzureDisk {
    ...
    public PodPresetSpecVolumesAzureDisk() {
        // no-op
    }

    public PodPresetSpecVolumesAzureDisk(final String cachingMode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodPresetSpecVolumesAzureDisk)) {
            return false;
        }
        final PodPresetSpecVolumesAzureDisk __otherCasted = (PodPresetSpecVolumesAzureDisk) __other;
