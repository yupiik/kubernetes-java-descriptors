...
public class PodPresetListItemsSpecVolumesFc {
    ...
    public PodPresetListItemsSpecVolumesFc() {
        // no-op
    }

    public PodPresetListItemsSpecVolumesFc(final String fsType,
                                           final Integer lun,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodPresetListItemsSpecVolumesFc)) {
            return false;
        }
        final PodPresetListItemsSpecVolumesFc __otherCasted = (PodPresetListItemsSpecVolumesFc) __other;
