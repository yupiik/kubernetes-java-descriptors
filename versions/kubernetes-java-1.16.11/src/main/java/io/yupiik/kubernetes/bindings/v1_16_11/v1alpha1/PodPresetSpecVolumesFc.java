...
public class PodPresetSpecVolumesFc {
    ...
    public PodPresetSpecVolumesFc() {
        // no-op
    }

    public PodPresetSpecVolumesFc(final String fsType,
                                  final Integer lun,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodPresetSpecVolumesFc)) {
            return false;
        }
        final PodPresetSpecVolumesFc __otherCasted = (PodPresetSpecVolumesFc) __other;
