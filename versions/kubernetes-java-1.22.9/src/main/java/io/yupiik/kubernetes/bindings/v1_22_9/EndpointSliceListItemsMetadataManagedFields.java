...
public class EndpointSliceListItemsMetadataManagedFields {
    ...
    public EndpointSliceListItemsMetadataManagedFields() {
        // no-op
    }

    public EndpointSliceListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EndpointSliceListItemsMetadataManagedFields)) {
            return false;
        }
        final EndpointSliceListItemsMetadataManagedFields __otherCasted = (EndpointSliceListItemsMetadataManagedFields) __other;
