...
public class JobListItemsMetadataInitializersResultMetadata {
    ...
    public JobListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public JobListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final JobListItemsMetadataInitializersResultMetadata __otherCasted = (JobListItemsMetadataInitializersResultMetadata) __other;
