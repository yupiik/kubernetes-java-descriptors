...
public class PodSecurityPolicyListItemsMetadataInitializersResultMetadata {
    ...
    public PodSecurityPolicyListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public PodSecurityPolicyListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSecurityPolicyListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final PodSecurityPolicyListItemsMetadataInitializersResultMetadata __otherCasted = (PodSecurityPolicyListItemsMetadataInitializersResultMetadata) __other;
