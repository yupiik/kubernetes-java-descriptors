...
public class ComponentStatusListItemsMetadataInitializersResultMetadata {
    ...
    public ComponentStatusListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public ComponentStatusListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ComponentStatusListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final ComponentStatusListItemsMetadataInitializersResultMetadata __otherCasted = (ComponentStatusListItemsMetadataInitializersResultMetadata) __other;
