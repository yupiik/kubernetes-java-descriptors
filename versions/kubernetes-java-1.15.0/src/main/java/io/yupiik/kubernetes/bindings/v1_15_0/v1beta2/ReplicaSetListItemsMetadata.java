...
public class ReplicaSetListItemsMetadata {
    ...
    private ReplicaSetListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ReplicaSetListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ReplicaSetListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ReplicaSetListItemsMetadata() {
        // no-op
    }

    public ReplicaSetListItemsMetadata(final Map<String, String> annotations,
                                       ...
                                       final ReplicaSetListItemsMetadataInitializers initializers,
                                       final Map<String, String> labels,
                                       final List<ReplicaSetListItemsMetadataManagedFields> managedFields,
                                       final String name,
                                       final String namespace,
                                       final List<ReplicaSetListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public ReplicaSetListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ReplicaSetListItemsMetadataInitializers initializers) {
    ...
    public List<ReplicaSetListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ReplicaSetListItemsMetadataManagedFields> managedFields) {
    ...
    public List<ReplicaSetListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ReplicaSetListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicaSetListItemsMetadata)) {
            return false;
        }
        final ReplicaSetListItemsMetadata __otherCasted = (ReplicaSetListItemsMetadata) __other;
