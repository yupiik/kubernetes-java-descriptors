...
public class StatefulSetSpecVolumeClaimTemplatesMetadataInitializersResultMetadata {
    ...
    public StatefulSetSpecVolumeClaimTemplatesMetadataInitializersResultMetadata() {
        // no-op
    }

    public StatefulSetSpecVolumeClaimTemplatesMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetSpecVolumeClaimTemplatesMetadataInitializersResultMetadata)) {
            return false;
        }
        final StatefulSetSpecVolumeClaimTemplatesMetadataInitializersResultMetadata __otherCasted = (StatefulSetSpecVolumeClaimTemplatesMetadataInitializersResultMetadata) __other;
