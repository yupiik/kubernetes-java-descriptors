...
public class NamespaceMetadata {
    ...
    private NamespaceMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<NamespaceMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<NamespaceMetadataOwnerReferences> ownerReferences;
    ...
    public NamespaceMetadata(final Map<String, String> annotations,
                             ...
                             final NamespaceMetadataInitializers initializers,
                             final Map<String, String> labels,
                             final List<NamespaceMetadataManagedFields> managedFields,
                             final String name,
                             final String namespace,
                             final List<NamespaceMetadataOwnerReferences> ownerReferences,
    ...
    public NamespaceMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final NamespaceMetadataInitializers initializers) {
    ...
    public List<NamespaceMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<NamespaceMetadataManagedFields> managedFields) {
    ...
    public List<NamespaceMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<NamespaceMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NamespaceMetadata)) {
            return false;
        }
        final NamespaceMetadata __otherCasted = (NamespaceMetadata) __other;
