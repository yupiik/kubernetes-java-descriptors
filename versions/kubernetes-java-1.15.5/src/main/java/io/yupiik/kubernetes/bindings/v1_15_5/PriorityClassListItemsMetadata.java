...
public class PriorityClassListItemsMetadata {
    ...
    private PriorityClassListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PriorityClassListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PriorityClassListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PriorityClassListItemsMetadata() {
        // no-op
    }

    public PriorityClassListItemsMetadata(final Map<String, String> annotations,
                                          ...
                                          final PriorityClassListItemsMetadataInitializers initializers,
                                          final Map<String, String> labels,
                                          final List<PriorityClassListItemsMetadataManagedFields> managedFields,
                                          final String name,
                                          final String namespace,
                                          final List<PriorityClassListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public PriorityClassListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PriorityClassListItemsMetadataInitializers initializers) {
    ...
    public List<PriorityClassListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PriorityClassListItemsMetadataManagedFields> managedFields) {
    ...
    public List<PriorityClassListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PriorityClassListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PriorityClassListItemsMetadata)) {
            return false;
        }
        final PriorityClassListItemsMetadata __otherCasted = (PriorityClassListItemsMetadata) __other;
