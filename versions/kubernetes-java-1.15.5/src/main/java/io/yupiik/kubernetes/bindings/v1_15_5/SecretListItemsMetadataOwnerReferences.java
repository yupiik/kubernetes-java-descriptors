...
public class SecretListItemsMetadataOwnerReferences {
    ...
    public SecretListItemsMetadataOwnerReferences() {
        // no-op
    }

    public SecretListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof SecretListItemsMetadataOwnerReferences)) {
            return false;
        }
        final SecretListItemsMetadataOwnerReferences __otherCasted = (SecretListItemsMetadataOwnerReferences) __other;
