...
public class StorageClassListItemsMetadataInitializersResultMetadata {
    ...
    public StorageClassListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public StorageClassListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StorageClassListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final StorageClassListItemsMetadataInitializersResultMetadata __otherCasted = (StorageClassListItemsMetadataInitializersResultMetadata) __other;
