...
public class PodSpecInitContainersVolumeMounts {
    ...
    public PodSpecInitContainersVolumeMounts() {
        // no-op
    }

    public PodSpecInitContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSpecInitContainersVolumeMounts)) {
            return false;
        }
        final PodSpecInitContainersVolumeMounts __otherCasted = (PodSpecInitContainersVolumeMounts) __other;
