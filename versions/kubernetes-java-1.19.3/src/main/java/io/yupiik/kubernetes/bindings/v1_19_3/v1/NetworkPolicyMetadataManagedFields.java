...
public class NetworkPolicyMetadataManagedFields {
    ...
    public NetworkPolicyMetadataManagedFields() {
        // no-op
    }

    public NetworkPolicyMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NetworkPolicyMetadataManagedFields)) {
            return false;
        }
        final NetworkPolicyMetadataManagedFields __otherCasted = (NetworkPolicyMetadataManagedFields) __other;
