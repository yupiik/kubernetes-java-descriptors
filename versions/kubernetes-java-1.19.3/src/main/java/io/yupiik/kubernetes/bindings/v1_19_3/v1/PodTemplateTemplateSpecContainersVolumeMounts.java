...
public class PodTemplateTemplateSpecContainersVolumeMounts {
    ...
    public PodTemplateTemplateSpecContainersVolumeMounts() {
        // no-op
    }

    public PodTemplateTemplateSpecContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateTemplateSpecContainersVolumeMounts)) {
            return false;
        }
        final PodTemplateTemplateSpecContainersVolumeMounts __otherCasted = (PodTemplateTemplateSpecContainersVolumeMounts) __other;
