...
public class ResourceQuotaListItemsMetadataManagedFields {
    ...
    public ResourceQuotaListItemsMetadataManagedFields() {
        // no-op
    }

    public ResourceQuotaListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ResourceQuotaListItemsMetadataManagedFields)) {
            return false;
        }
        final ResourceQuotaListItemsMetadataManagedFields __otherCasted = (ResourceQuotaListItemsMetadataManagedFields) __other;
