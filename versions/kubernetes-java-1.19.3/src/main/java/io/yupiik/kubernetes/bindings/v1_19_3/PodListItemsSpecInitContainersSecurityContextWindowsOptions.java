...
public class PodListItemsSpecInitContainersSecurityContextWindowsOptions {
    private String gmsaCredentialSpec;
    private String gmsaCredentialSpecName;
    private String runAsUserName;

    public PodListItemsSpecInitContainersSecurityContextWindowsOptions() {
        // no-op
    }

    public PodListItemsSpecInitContainersSecurityContextWindowsOptions(final String gmsaCredentialSpec,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodListItemsSpecInitContainersSecurityContextWindowsOptions)) {
            return false;
        }
        final PodListItemsSpecInitContainersSecurityContextWindowsOptions __otherCasted = (PodListItemsSpecInitContainersSecurityContextWindowsOptions) __other;
