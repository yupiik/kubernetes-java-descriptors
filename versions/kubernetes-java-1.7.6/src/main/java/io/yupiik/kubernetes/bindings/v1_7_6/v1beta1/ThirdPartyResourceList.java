...
public class ThirdPartyResourceList {
    private String apiVersion;
    private List<JsonValue> items;
    private String kind;
    private ThirdPartyResourceListMetadata metadata;
    ...
    public ThirdPartyResourceList(final String apiVersion,
                                  ...
                                  final String kind,
                                  final ThirdPartyResourceListMetadata metadata) {
        // no-op
    }
    ...
    public ThirdPartyResourceListMetadata getMetadata() {
        return metadata;
    }

    public void setMetadata(final ThirdPartyResourceListMetadata metadata) {
