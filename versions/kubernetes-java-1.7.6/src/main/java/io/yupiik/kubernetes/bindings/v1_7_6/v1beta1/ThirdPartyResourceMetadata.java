...
public class ThirdPartyResourceMetadata {
    ...
    private ThirdPartyResourceMetadataInitializers initializers;
    ...
    public ThirdPartyResourceMetadata() {
        // no-op
    }

    public ThirdPartyResourceMetadata(final Map<String, String> annotations,
                                      ...
                                      final ThirdPartyResourceMetadataInitializers initializers,
    ...
    public ThirdPartyResourceMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ThirdPartyResourceMetadataInitializers initializers) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ThirdPartyResourceMetadata)) {
            return false;
        }
        final ThirdPartyResourceMetadata __otherCasted = (ThirdPartyResourceMetadata) __other;
