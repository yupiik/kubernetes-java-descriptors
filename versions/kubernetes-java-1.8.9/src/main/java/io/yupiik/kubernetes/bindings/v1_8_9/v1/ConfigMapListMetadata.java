...
public class ConfigMapListMetadata {
    @JsonbProperty("continue")
    private String continueValue;
    private String resourceVersion;
    private String selfLink;

    public ConfigMapListMetadata() {
        // no-op
    }

    public ConfigMapListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ConfigMapListMetadata)) {
            return false;
        }
        final ConfigMapListMetadata __otherCasted = (ConfigMapListMetadata) __other;
