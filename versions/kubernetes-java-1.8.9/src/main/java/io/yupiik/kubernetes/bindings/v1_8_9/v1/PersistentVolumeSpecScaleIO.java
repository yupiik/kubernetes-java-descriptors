...
public class PersistentVolumeSpecScaleIO {
    private String fsType;
    private String gateway;
    private String protectionDomain;
    private Boolean readOnly;
    private PersistentVolumeSpecScaleIOSecretRef secretRef;
    ...
    public PersistentVolumeSpecScaleIO() {
        // no-op
    }

    public PersistentVolumeSpecScaleIO(final String fsType,
                                       final String gateway,
                                       final String protectionDomain,
                                       final Boolean readOnly,
                                       final PersistentVolumeSpecScaleIOSecretRef secretRef,
    ...
    public PersistentVolumeSpecScaleIOSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final PersistentVolumeSpecScaleIOSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PersistentVolumeSpecScaleIO)) {
            return false;
        }
        final PersistentVolumeSpecScaleIO __otherCasted = (PersistentVolumeSpecScaleIO) __other;
