...
public class TokenRequestMetadata {
    ...
    private List<TokenRequestMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<TokenRequestMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public TokenRequestMetadata() {
        // no-op
    }

    public TokenRequestMetadata(final Map<String, String> annotations,
                                ...
                                final List<TokenRequestMetadataManagedFields> managedFields,
                                final String name,
                                final String namespace,
                                final List<TokenRequestMetadataOwnerReferences> ownerReferences,
    ...
    public List<TokenRequestMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<TokenRequestMetadataManagedFields> managedFields) {
    ...
    public List<TokenRequestMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<TokenRequestMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof TokenRequestMetadata)) {
            return false;
        }
        final TokenRequestMetadata __otherCasted = (TokenRequestMetadata) __other;
