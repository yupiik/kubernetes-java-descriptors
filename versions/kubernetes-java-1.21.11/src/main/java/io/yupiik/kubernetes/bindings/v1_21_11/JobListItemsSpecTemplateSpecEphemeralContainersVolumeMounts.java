...
public class JobListItemsSpecTemplateSpecEphemeralContainersVolumeMounts {
    ...
    public JobListItemsSpecTemplateSpecEphemeralContainersVolumeMounts() {
        // no-op
    }

    public JobListItemsSpecTemplateSpecEphemeralContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobListItemsSpecTemplateSpecEphemeralContainersVolumeMounts)) {
            return false;
        }
        final JobListItemsSpecTemplateSpecEphemeralContainersVolumeMounts __otherCasted = (JobListItemsSpecTemplateSpecEphemeralContainersVolumeMounts) __other;
