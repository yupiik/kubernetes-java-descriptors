...
public class PodTemplateTemplateSpecVolumesAzureDisk {
    ...
    public PodTemplateTemplateSpecVolumesAzureDisk() {
        // no-op
    }

    public PodTemplateTemplateSpecVolumesAzureDisk(final String cachingMode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateTemplateSpecVolumesAzureDisk)) {
            return false;
        }
        final PodTemplateTemplateSpecVolumesAzureDisk __otherCasted = (PodTemplateTemplateSpecVolumesAzureDisk) __other;
