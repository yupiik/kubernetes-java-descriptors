...
public class IngressClassMetadataManagedFields {
    ...
    public IngressClassMetadataManagedFields() {
        // no-op
    }

    public IngressClassMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof IngressClassMetadataManagedFields)) {
            return false;
        }
        final IngressClassMetadataManagedFields __otherCasted = (IngressClassMetadataManagedFields) __other;
