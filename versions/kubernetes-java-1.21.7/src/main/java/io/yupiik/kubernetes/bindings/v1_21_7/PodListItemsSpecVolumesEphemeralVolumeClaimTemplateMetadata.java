...
public class PodListItemsSpecVolumesEphemeralVolumeClaimTemplateMetadata {
    ...
    private List<PodListItemsSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PodListItemsSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PodListItemsSpecVolumesEphemeralVolumeClaimTemplateMetadata() {
        // no-op
    }

    public PodListItemsSpecVolumesEphemeralVolumeClaimTemplateMetadata(final Map<String, String> annotations,
                                                                       ...
                                                                       final List<PodListItemsSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> managedFields,
                                                                       final String name,
                                                                       final String namespace,
                                                                       final List<PodListItemsSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public List<PodListItemsSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PodListItemsSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> managedFields) {
    ...
    public List<PodListItemsSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PodListItemsSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodListItemsSpecVolumesEphemeralVolumeClaimTemplateMetadata)) {
            return false;
        }
        final PodListItemsSpecVolumesEphemeralVolumeClaimTemplateMetadata __otherCasted = (PodListItemsSpecVolumesEphemeralVolumeClaimTemplateMetadata) __other;
