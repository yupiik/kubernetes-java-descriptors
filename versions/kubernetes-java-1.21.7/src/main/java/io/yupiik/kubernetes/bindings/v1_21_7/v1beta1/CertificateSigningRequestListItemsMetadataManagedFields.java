...
public class CertificateSigningRequestListItemsMetadataManagedFields {
    ...
    public CertificateSigningRequestListItemsMetadataManagedFields() {
        // no-op
    }

    public CertificateSigningRequestListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CertificateSigningRequestListItemsMetadataManagedFields)) {
            return false;
        }
        final CertificateSigningRequestListItemsMetadataManagedFields __otherCasted = (CertificateSigningRequestListItemsMetadataManagedFields) __other;
