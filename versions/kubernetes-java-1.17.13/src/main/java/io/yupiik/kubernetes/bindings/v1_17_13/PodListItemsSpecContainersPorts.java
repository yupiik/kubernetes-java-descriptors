...
public class PodListItemsSpecContainersPorts {
    ...
    public PodListItemsSpecContainersPorts() {
        // no-op
    }

    public PodListItemsSpecContainersPorts(final int containerPort,
                                           final String hostIP,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodListItemsSpecContainersPorts)) {
            return false;
        }
        final PodListItemsSpecContainersPorts __otherCasted = (PodListItemsSpecContainersPorts) __other;
