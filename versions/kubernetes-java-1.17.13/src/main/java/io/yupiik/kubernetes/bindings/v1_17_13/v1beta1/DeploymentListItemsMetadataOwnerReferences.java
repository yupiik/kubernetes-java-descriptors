...
public class DeploymentListItemsMetadataOwnerReferences {
    ...
    public DeploymentListItemsMetadataOwnerReferences() {
        // no-op
    }

    public DeploymentListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentListItemsMetadataOwnerReferences)) {
            return false;
        }
        final DeploymentListItemsMetadataOwnerReferences __otherCasted = (DeploymentListItemsMetadataOwnerReferences) __other;
