...
public class IngressMetadataOwnerReferences {
    ...
    public IngressMetadataOwnerReferences() {
        // no-op
    }

    public IngressMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof IngressMetadataOwnerReferences)) {
            return false;
        }
        final IngressMetadataOwnerReferences __otherCasted = (IngressMetadataOwnerReferences) __other;
