...
public class TokenReviewMetadata {
    ...
    private TokenReviewMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<TokenReviewMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<TokenReviewMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public TokenReviewMetadata() {
        // no-op
    }

    public TokenReviewMetadata(final Map<String, String> annotations,
                               ...
                               final TokenReviewMetadataInitializers initializers,
                               final Map<String, String> labels,
                               final List<TokenReviewMetadataManagedFields> managedFields,
                               final String name,
                               final String namespace,
                               final List<TokenReviewMetadataOwnerReferences> ownerReferences,
    ...
    public TokenReviewMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final TokenReviewMetadataInitializers initializers) {
    ...
    public List<TokenReviewMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<TokenReviewMetadataManagedFields> managedFields) {
    ...
    public List<TokenReviewMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<TokenReviewMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof TokenReviewMetadata)) {
            return false;
        }
        final TokenReviewMetadata __otherCasted = (TokenReviewMetadata) __other;
