...
public class StatefulSetMetadataInitializersResultDetails {
    private List<StatefulSetMetadataInitializersResultDetailsCauses> causes;
    ...
    public StatefulSetMetadataInitializersResultDetails(final List<StatefulSetMetadataInitializersResultDetailsCauses> causes,
                                                        final String group,
                                                        final String kind,
                                                        final String name,
    ...
    public List<StatefulSetMetadataInitializersResultDetailsCauses> getCauses() {
        return causes;
    }

    public void setCauses(final List<StatefulSetMetadataInitializersResultDetailsCauses> causes) {
        this.causes = causes;
    }
