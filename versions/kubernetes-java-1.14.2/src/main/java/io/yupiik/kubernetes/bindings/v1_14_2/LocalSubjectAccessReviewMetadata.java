...
public class LocalSubjectAccessReviewMetadata {
    ...
    private LocalSubjectAccessReviewMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<LocalSubjectAccessReviewMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<LocalSubjectAccessReviewMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public LocalSubjectAccessReviewMetadata() {
        // no-op
    }

    public LocalSubjectAccessReviewMetadata(final Map<String, String> annotations,
                                            ...
                                            final LocalSubjectAccessReviewMetadataInitializers initializers,
                                            final Map<String, String> labels,
                                            final List<LocalSubjectAccessReviewMetadataManagedFields> managedFields,
                                            final String name,
                                            final String namespace,
                                            final List<LocalSubjectAccessReviewMetadataOwnerReferences> ownerReferences,
    ...
    public LocalSubjectAccessReviewMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final LocalSubjectAccessReviewMetadataInitializers initializers) {
    ...
    public List<LocalSubjectAccessReviewMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<LocalSubjectAccessReviewMetadataManagedFields> managedFields) {
    ...
    public List<LocalSubjectAccessReviewMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<LocalSubjectAccessReviewMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LocalSubjectAccessReviewMetadata)) {
            return false;
        }
        final LocalSubjectAccessReviewMetadata __otherCasted = (LocalSubjectAccessReviewMetadata) __other;
