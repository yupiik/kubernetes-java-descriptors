...
public class NamespaceListItemsMetadata {
    ...
    private NamespaceListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<NamespaceListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<NamespaceListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public NamespaceListItemsMetadata() {
        // no-op
    }

    public NamespaceListItemsMetadata(final Map<String, String> annotations,
                                      ...
                                      final NamespaceListItemsMetadataInitializers initializers,
                                      final Map<String, String> labels,
                                      final List<NamespaceListItemsMetadataManagedFields> managedFields,
                                      final String name,
                                      final String namespace,
                                      final List<NamespaceListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public NamespaceListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final NamespaceListItemsMetadataInitializers initializers) {
    ...
    public List<NamespaceListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<NamespaceListItemsMetadataManagedFields> managedFields) {
    ...
    public List<NamespaceListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<NamespaceListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NamespaceListItemsMetadata)) {
            return false;
        }
        final NamespaceListItemsMetadata __otherCasted = (NamespaceListItemsMetadata) __other;
