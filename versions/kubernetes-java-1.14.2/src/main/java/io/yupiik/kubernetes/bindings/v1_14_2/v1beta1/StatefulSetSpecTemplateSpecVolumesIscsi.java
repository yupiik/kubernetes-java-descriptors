...
public class StatefulSetSpecTemplateSpecVolumesIscsi {
    ...
    private StatefulSetSpecTemplateSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public StatefulSetSpecTemplateSpecVolumesIscsi() {
        // no-op
    }

    public StatefulSetSpecTemplateSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                                   ...
                                                   final StatefulSetSpecTemplateSpecVolumesIscsiSecretRef secretRef,
    ...
    public StatefulSetSpecTemplateSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final StatefulSetSpecTemplateSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetSpecTemplateSpecVolumesIscsi)) {
            return false;
        }
        final StatefulSetSpecTemplateSpecVolumesIscsi __otherCasted = (StatefulSetSpecTemplateSpecVolumesIscsi) __other;
