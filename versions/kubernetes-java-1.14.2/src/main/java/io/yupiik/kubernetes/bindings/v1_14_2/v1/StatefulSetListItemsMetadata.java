...
public class StatefulSetListItemsMetadata {
    ...
    private StatefulSetListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<StatefulSetListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<StatefulSetListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public StatefulSetListItemsMetadata() {
        // no-op
    }

    public StatefulSetListItemsMetadata(final Map<String, String> annotations,
                                        ...
                                        final StatefulSetListItemsMetadataInitializers initializers,
                                        final Map<String, String> labels,
                                        final List<StatefulSetListItemsMetadataManagedFields> managedFields,
                                        final String name,
                                        final String namespace,
                                        final List<StatefulSetListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public StatefulSetListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final StatefulSetListItemsMetadataInitializers initializers) {
    ...
    public List<StatefulSetListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<StatefulSetListItemsMetadataManagedFields> managedFields) {
    ...
    public List<StatefulSetListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<StatefulSetListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetListItemsMetadata)) {
            return false;
        }
        final StatefulSetListItemsMetadata __otherCasted = (StatefulSetListItemsMetadata) __other;
