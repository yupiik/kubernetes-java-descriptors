...
public class EventMetadata {
    ...
    private EventMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<EventMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<EventMetadataOwnerReferences> ownerReferences;
    ...
    public EventMetadata(final Map<String, String> annotations,
                         ...
                         final EventMetadataInitializers initializers,
                         final Map<String, String> labels,
                         final List<EventMetadataManagedFields> managedFields,
                         final String name,
                         final String namespace,
                         final List<EventMetadataOwnerReferences> ownerReferences,
    ...
    public EventMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final EventMetadataInitializers initializers) {
    ...
    public List<EventMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<EventMetadataManagedFields> managedFields) {
    ...
    public List<EventMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<EventMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EventMetadata)) {
            return false;
        }
        final EventMetadata __otherCasted = (EventMetadata) __other;
