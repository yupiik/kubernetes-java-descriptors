...
public class StatefulSetSpecVolumeClaimTemplatesMetadataManagedFields {
    ...
    public StatefulSetSpecVolumeClaimTemplatesMetadataManagedFields() {
        // no-op
    }

    public StatefulSetSpecVolumeClaimTemplatesMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetSpecVolumeClaimTemplatesMetadataManagedFields)) {
            return false;
        }
        final StatefulSetSpecVolumeClaimTemplatesMetadataManagedFields __otherCasted = (StatefulSetSpecVolumeClaimTemplatesMetadataManagedFields) __other;
