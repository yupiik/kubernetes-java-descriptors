...
public class DeploymentMetadataOwnerReferences {
    ...
    public DeploymentMetadataOwnerReferences() {
        // no-op
    }

    public DeploymentMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentMetadataOwnerReferences)) {
            return false;
        }
        final DeploymentMetadataOwnerReferences __otherCasted = (DeploymentMetadataOwnerReferences) __other;
