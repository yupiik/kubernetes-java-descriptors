...
public class DaemonSetListItemsMetadataOwnerReferences {
    ...
    public DaemonSetListItemsMetadataOwnerReferences() {
        // no-op
    }

    public DaemonSetListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetListItemsMetadataOwnerReferences)) {
            return false;
        }
        final DaemonSetListItemsMetadataOwnerReferences __otherCasted = (DaemonSetListItemsMetadataOwnerReferences) __other;
