...
public class StatefulSetMetadataOwnerReferences {
    ...
    public StatefulSetMetadataOwnerReferences() {
        // no-op
    }

    public StatefulSetMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetMetadataOwnerReferences)) {
            return false;
        }
        final StatefulSetMetadataOwnerReferences __otherCasted = (StatefulSetMetadataOwnerReferences) __other;
