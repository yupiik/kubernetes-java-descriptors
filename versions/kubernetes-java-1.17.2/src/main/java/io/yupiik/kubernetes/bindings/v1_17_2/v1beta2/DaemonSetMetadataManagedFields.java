...
public class DaemonSetMetadataManagedFields {
    ...
    public DaemonSetMetadataManagedFields() {
        // no-op
    }

    public DaemonSetMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetMetadataManagedFields)) {
            return false;
        }
        final DaemonSetMetadataManagedFields __otherCasted = (DaemonSetMetadataManagedFields) __other;
