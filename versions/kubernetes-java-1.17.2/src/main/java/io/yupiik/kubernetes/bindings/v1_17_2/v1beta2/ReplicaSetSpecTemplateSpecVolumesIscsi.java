...
public class ReplicaSetSpecTemplateSpecVolumesIscsi {
    ...
    private ReplicaSetSpecTemplateSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public ReplicaSetSpecTemplateSpecVolumesIscsi() {
        // no-op
    }

    public ReplicaSetSpecTemplateSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                                  ...
                                                  final ReplicaSetSpecTemplateSpecVolumesIscsiSecretRef secretRef,
    ...
    public ReplicaSetSpecTemplateSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final ReplicaSetSpecTemplateSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicaSetSpecTemplateSpecVolumesIscsi)) {
            return false;
        }
        final ReplicaSetSpecTemplateSpecVolumesIscsi __otherCasted = (ReplicaSetSpecTemplateSpecVolumesIscsi) __other;
