...
public class DaemonSetListItemsMetadataManagedFields {
    ...
    public DaemonSetListItemsMetadataManagedFields() {
        // no-op
    }

    public DaemonSetListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetListItemsMetadataManagedFields)) {
            return false;
        }
        final DaemonSetListItemsMetadataManagedFields __otherCasted = (DaemonSetListItemsMetadataManagedFields) __other;
