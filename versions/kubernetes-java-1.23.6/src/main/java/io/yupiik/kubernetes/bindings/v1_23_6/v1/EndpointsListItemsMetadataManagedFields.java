...
public class EndpointsListItemsMetadataManagedFields {
    ...
    public EndpointsListItemsMetadataManagedFields() {
        // no-op
    }

    public EndpointsListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EndpointsListItemsMetadataManagedFields)) {
            return false;
        }
        final EndpointsListItemsMetadataManagedFields __otherCasted = (EndpointsListItemsMetadataManagedFields) __other;
