...
public class DeploymentSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields {
    ...
    public DeploymentSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields() {
        // no-op
    }

    public DeploymentSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields)) {
            return false;
        }
        final DeploymentSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields __otherCasted = (DeploymentSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields) __other;
