...
public class ReplicaSetListItemsSpecTemplateSpecInitContainersStartupProbe {
    ...
    private ReplicaSetListItemsSpecTemplateSpecInitContainersStartupProbeGrpc grpc;
    ...
    public ReplicaSetListItemsSpecTemplateSpecInitContainersStartupProbe(final ReplicaSetListItemsSpecTemplateSpecInitContainersStartupProbeExec exec,
                                                                         ...
                                                                         final ReplicaSetListItemsSpecTemplateSpecInitContainersStartupProbeGrpc grpc,
    ...
    public ReplicaSetListItemsSpecTemplateSpecInitContainersStartupProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final ReplicaSetListItemsSpecTemplateSpecInitContainersStartupProbeGrpc grpc) {
        this.grpc = grpc;
    }
