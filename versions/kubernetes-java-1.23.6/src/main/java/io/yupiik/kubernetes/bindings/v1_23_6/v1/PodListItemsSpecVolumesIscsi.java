...
public class PodListItemsSpecVolumesIscsi {
    ...
    private PodListItemsSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public PodListItemsSpecVolumesIscsi() {
        // no-op
    }

    public PodListItemsSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                        ...
                                        final PodListItemsSpecVolumesIscsiSecretRef secretRef,
    ...
    public PodListItemsSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final PodListItemsSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodListItemsSpecVolumesIscsi)) {
            return false;
        }
        final PodListItemsSpecVolumesIscsi __otherCasted = (PodListItemsSpecVolumesIscsi) __other;
