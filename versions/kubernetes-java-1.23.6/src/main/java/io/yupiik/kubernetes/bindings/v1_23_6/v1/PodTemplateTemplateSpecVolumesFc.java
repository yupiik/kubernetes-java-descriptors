...
public class PodTemplateTemplateSpecVolumesFc {
    ...
    public PodTemplateTemplateSpecVolumesFc() {
        // no-op
    }

    public PodTemplateTemplateSpecVolumesFc(final String fsType,
                                            final Integer lun,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateTemplateSpecVolumesFc)) {
            return false;
        }
        final PodTemplateTemplateSpecVolumesFc __otherCasted = (PodTemplateTemplateSpecVolumesFc) __other;
