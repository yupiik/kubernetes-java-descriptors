...
public class PodListItemsMetadataOwnerReferences {
    ...
    public PodListItemsMetadataOwnerReferences() {
        // no-op
    }

    public PodListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodListItemsMetadataOwnerReferences)) {
            return false;
        }
        final PodListItemsMetadataOwnerReferences __otherCasted = (PodListItemsMetadataOwnerReferences) __other;
