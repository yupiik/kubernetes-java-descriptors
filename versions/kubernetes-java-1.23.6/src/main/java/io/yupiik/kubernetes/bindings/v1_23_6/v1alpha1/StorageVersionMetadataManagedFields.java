...
public class StorageVersionMetadataManagedFields {
    ...
    public StorageVersionMetadataManagedFields() {
        // no-op
    }

    public StorageVersionMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StorageVersionMetadataManagedFields)) {
            return false;
        }
        final StorageVersionMetadataManagedFields __otherCasted = (StorageVersionMetadataManagedFields) __other;
