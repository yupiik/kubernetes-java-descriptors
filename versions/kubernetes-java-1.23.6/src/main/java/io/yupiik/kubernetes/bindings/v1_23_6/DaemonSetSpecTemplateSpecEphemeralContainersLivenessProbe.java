...
public class DaemonSetSpecTemplateSpecEphemeralContainersLivenessProbe {
    ...
    private DaemonSetSpecTemplateSpecEphemeralContainersLivenessProbeGrpc grpc;
    ...
    public DaemonSetSpecTemplateSpecEphemeralContainersLivenessProbe(final DaemonSetSpecTemplateSpecEphemeralContainersLivenessProbeExec exec,
                                                                     ...
                                                                     final DaemonSetSpecTemplateSpecEphemeralContainersLivenessProbeGrpc grpc,
    ...
    public DaemonSetSpecTemplateSpecEphemeralContainersLivenessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final DaemonSetSpecTemplateSpecEphemeralContainersLivenessProbeGrpc grpc) {
        this.grpc = grpc;
    }
