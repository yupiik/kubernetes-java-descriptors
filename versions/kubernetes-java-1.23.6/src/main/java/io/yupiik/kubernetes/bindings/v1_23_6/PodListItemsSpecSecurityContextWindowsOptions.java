...
public class PodListItemsSpecSecurityContextWindowsOptions {
    private String gmsaCredentialSpec;
    private String gmsaCredentialSpecName;
    private Boolean hostProcess;
    private String runAsUserName;

    public PodListItemsSpecSecurityContextWindowsOptions() {
        // no-op
    }

    public PodListItemsSpecSecurityContextWindowsOptions(final String gmsaCredentialSpec,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodListItemsSpecSecurityContextWindowsOptions)) {
            return false;
        }
        final PodListItemsSpecSecurityContextWindowsOptions __otherCasted = (PodListItemsSpecSecurityContextWindowsOptions) __other;
