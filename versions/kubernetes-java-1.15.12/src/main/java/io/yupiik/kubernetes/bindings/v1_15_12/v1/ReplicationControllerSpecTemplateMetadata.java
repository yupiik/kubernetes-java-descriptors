...
public class ReplicationControllerSpecTemplateMetadata {
    ...
    private ReplicationControllerSpecTemplateMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ReplicationControllerSpecTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ReplicationControllerSpecTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ReplicationControllerSpecTemplateMetadata() {
        // no-op
    }

    public ReplicationControllerSpecTemplateMetadata(final Map<String, String> annotations,
                                                     ...
                                                     final ReplicationControllerSpecTemplateMetadataInitializers initializers,
                                                     final Map<String, String> labels,
                                                     final List<ReplicationControllerSpecTemplateMetadataManagedFields> managedFields,
                                                     final String name,
                                                     final String namespace,
                                                     final List<ReplicationControllerSpecTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public ReplicationControllerSpecTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ReplicationControllerSpecTemplateMetadataInitializers initializers) {
    ...
    public List<ReplicationControllerSpecTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ReplicationControllerSpecTemplateMetadataManagedFields> managedFields) {
    ...
    public List<ReplicationControllerSpecTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ReplicationControllerSpecTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicationControllerSpecTemplateMetadata)) {
            return false;
        }
        final ReplicationControllerSpecTemplateMetadata __otherCasted = (ReplicationControllerSpecTemplateMetadata) __other;
