...
public class PersistentVolumeClaimListItemsMetadataInitializersResultMetadata {
    ...
    public PersistentVolumeClaimListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public PersistentVolumeClaimListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PersistentVolumeClaimListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final PersistentVolumeClaimListItemsMetadataInitializersResultMetadata __otherCasted = (PersistentVolumeClaimListItemsMetadataInitializersResultMetadata) __other;
