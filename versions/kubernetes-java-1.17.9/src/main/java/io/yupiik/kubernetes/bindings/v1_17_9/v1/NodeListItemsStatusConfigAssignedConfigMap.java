...
public class NodeListItemsStatusConfigAssignedConfigMap {
    ...
    public NodeListItemsStatusConfigAssignedConfigMap() {
        // no-op
    }

    public NodeListItemsStatusConfigAssignedConfigMap(final String kubeletConfigKey,
                                                      final String name,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NodeListItemsStatusConfigAssignedConfigMap)) {
            return false;
        }
        final NodeListItemsStatusConfigAssignedConfigMap __otherCasted = (NodeListItemsStatusConfigAssignedConfigMap) __other;
