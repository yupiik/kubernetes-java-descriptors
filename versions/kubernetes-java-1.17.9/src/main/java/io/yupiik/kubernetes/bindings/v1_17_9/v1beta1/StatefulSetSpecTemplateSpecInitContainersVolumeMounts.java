...
public class StatefulSetSpecTemplateSpecInitContainersVolumeMounts {
    ...
    public StatefulSetSpecTemplateSpecInitContainersVolumeMounts() {
        // no-op
    }

    public StatefulSetSpecTemplateSpecInitContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetSpecTemplateSpecInitContainersVolumeMounts)) {
            return false;
        }
        final StatefulSetSpecTemplateSpecInitContainersVolumeMounts __otherCasted = (StatefulSetSpecTemplateSpecInitContainersVolumeMounts) __other;
