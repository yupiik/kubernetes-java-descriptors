...
public class PodListItemsSpecEphemeralContainersVolumeMounts {
    ...
    public PodListItemsSpecEphemeralContainersVolumeMounts() {
        // no-op
    }

    public PodListItemsSpecEphemeralContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodListItemsSpecEphemeralContainersVolumeMounts)) {
            return false;
        }
        final PodListItemsSpecEphemeralContainersVolumeMounts __otherCasted = (PodListItemsSpecEphemeralContainersVolumeMounts) __other;
