...
public class CSIDriverListMetadata {
    ...
    public CSIDriverListMetadata() {
        // no-op
    }

    public CSIDriverListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSIDriverListMetadata)) {
            return false;
        }
        final CSIDriverListMetadata __otherCasted = (CSIDriverListMetadata) __other;
