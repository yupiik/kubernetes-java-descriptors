...
public class APIServiceMetadataOwnerReferences {
    ...
    public APIServiceMetadataOwnerReferences() {
        // no-op
    }

    public APIServiceMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof APIServiceMetadataOwnerReferences)) {
            return false;
        }
        final APIServiceMetadataOwnerReferences __otherCasted = (APIServiceMetadataOwnerReferences) __other;
