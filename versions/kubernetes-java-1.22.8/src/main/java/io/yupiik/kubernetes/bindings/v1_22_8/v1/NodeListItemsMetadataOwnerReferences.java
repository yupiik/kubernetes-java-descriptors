...
public class NodeListItemsMetadataOwnerReferences {
    ...
    public NodeListItemsMetadataOwnerReferences() {
        // no-op
    }

    public NodeListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NodeListItemsMetadataOwnerReferences)) {
            return false;
        }
        final NodeListItemsMetadataOwnerReferences __otherCasted = (NodeListItemsMetadataOwnerReferences) __other;
