...
public class ReplicationControllerListItemsSpecTemplateSpecInitContainersReadinessProbe {
    ...
    private ReplicationControllerListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc grpc;
    ...
    public ReplicationControllerListItemsSpecTemplateSpecInitContainersReadinessProbe(final ReplicationControllerListItemsSpecTemplateSpecInitContainersReadinessProbeExec exec,
                                                                                      ...
                                                                                      final ReplicationControllerListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc grpc,
    ...
    public ReplicationControllerListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final ReplicationControllerListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
