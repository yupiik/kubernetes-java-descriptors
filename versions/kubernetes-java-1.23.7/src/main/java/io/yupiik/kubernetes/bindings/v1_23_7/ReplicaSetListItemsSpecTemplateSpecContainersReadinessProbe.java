...
public class ReplicaSetListItemsSpecTemplateSpecContainersReadinessProbe {
    ...
    private ReplicaSetListItemsSpecTemplateSpecContainersReadinessProbeGrpc grpc;
    ...
    public ReplicaSetListItemsSpecTemplateSpecContainersReadinessProbe(final ReplicaSetListItemsSpecTemplateSpecContainersReadinessProbeExec exec,
                                                                       ...
                                                                       final ReplicaSetListItemsSpecTemplateSpecContainersReadinessProbeGrpc grpc,
    ...
    public ReplicaSetListItemsSpecTemplateSpecContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final ReplicaSetListItemsSpecTemplateSpecContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
