...
public class PodSpecInitContainersReadinessProbe {
    ...
    private PodSpecInitContainersReadinessProbeGrpc grpc;
    ...
    public PodSpecInitContainersReadinessProbe(final PodSpecInitContainersReadinessProbeExec exec,
                                               ...
                                               final PodSpecInitContainersReadinessProbeGrpc grpc,
    ...
    public PodSpecInitContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final PodSpecInitContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
