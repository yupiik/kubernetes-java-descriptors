...
public class DeploymentSpecTemplateSpecInitContainersReadinessProbe {
    ...
    private DeploymentSpecTemplateSpecInitContainersReadinessProbeGrpc grpc;
    ...
    public DeploymentSpecTemplateSpecInitContainersReadinessProbe(final DeploymentSpecTemplateSpecInitContainersReadinessProbeExec exec,
                                                                  ...
                                                                  final DeploymentSpecTemplateSpecInitContainersReadinessProbeGrpc grpc,
    ...
    public DeploymentSpecTemplateSpecInitContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final DeploymentSpecTemplateSpecInitContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
