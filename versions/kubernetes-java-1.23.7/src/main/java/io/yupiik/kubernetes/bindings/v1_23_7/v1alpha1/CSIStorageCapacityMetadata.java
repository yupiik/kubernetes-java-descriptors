...
public class CSIStorageCapacityMetadata {
    ...
    private List<CSIStorageCapacityMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<CSIStorageCapacityMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public CSIStorageCapacityMetadata() {
        // no-op
    }

    public CSIStorageCapacityMetadata(final Map<String, String> annotations,
                                      ...
                                      final List<CSIStorageCapacityMetadataManagedFields> managedFields,
                                      final String name,
                                      final String namespace,
                                      final List<CSIStorageCapacityMetadataOwnerReferences> ownerReferences,
    ...
    public List<CSIStorageCapacityMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<CSIStorageCapacityMetadataManagedFields> managedFields) {
    ...
    public List<CSIStorageCapacityMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<CSIStorageCapacityMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSIStorageCapacityMetadata)) {
            return false;
        }
        final CSIStorageCapacityMetadata __otherCasted = (CSIStorageCapacityMetadata) __other;
