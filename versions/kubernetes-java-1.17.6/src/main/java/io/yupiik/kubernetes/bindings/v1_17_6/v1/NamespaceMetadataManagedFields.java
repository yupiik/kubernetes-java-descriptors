...
public class NamespaceMetadataManagedFields {
    ...
    public NamespaceMetadataManagedFields() {
        // no-op
    }

    public NamespaceMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NamespaceMetadataManagedFields)) {
            return false;
        }
        final NamespaceMetadataManagedFields __otherCasted = (NamespaceMetadataManagedFields) __other;
