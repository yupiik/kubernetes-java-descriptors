...
public class JobSpecTemplateSpecVolumesScaleIO {
    private String fsType;
    private String gateway;
    private String protectionDomain;
    private Boolean readOnly;
    private JobSpecTemplateSpecVolumesScaleIOSecretRef secretRef;
    ...
    public JobSpecTemplateSpecVolumesScaleIO() {
        // no-op
    }

    public JobSpecTemplateSpecVolumesScaleIO(final String fsType,
                                             final String gateway,
                                             final String protectionDomain,
                                             final Boolean readOnly,
                                             final JobSpecTemplateSpecVolumesScaleIOSecretRef secretRef,
    ...
    public JobSpecTemplateSpecVolumesScaleIOSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final JobSpecTemplateSpecVolumesScaleIOSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobSpecTemplateSpecVolumesScaleIO)) {
            return false;
        }
        final JobSpecTemplateSpecVolumesScaleIO __otherCasted = (JobSpecTemplateSpecVolumesScaleIO) __other;
