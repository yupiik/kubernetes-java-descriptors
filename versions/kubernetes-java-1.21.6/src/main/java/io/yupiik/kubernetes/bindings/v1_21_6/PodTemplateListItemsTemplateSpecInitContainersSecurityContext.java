...
public class PodTemplateListItemsTemplateSpecInitContainersSecurityContext {
    ...
    private PodTemplateListItemsTemplateSpecInitContainersSecurityContextSeccompProfile seccompProfile;
    ...
    public PodTemplateListItemsTemplateSpecInitContainersSecurityContext(final Boolean allowPrivilegeEscalation,
                                                                         ...
                                                                         final PodTemplateListItemsTemplateSpecInitContainersSecurityContextSeccompProfile seccompProfile,
    ...
    public PodTemplateListItemsTemplateSpecInitContainersSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final PodTemplateListItemsTemplateSpecInitContainersSecurityContextSeccompProfile seccompProfile) {
