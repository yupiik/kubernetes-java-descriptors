...
public class NamespaceListItemsMetadataOwnerReferences {
    ...
    public NamespaceListItemsMetadataOwnerReferences() {
        // no-op
    }

    public NamespaceListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NamespaceListItemsMetadataOwnerReferences)) {
            return false;
        }
        final NamespaceListItemsMetadataOwnerReferences __otherCasted = (NamespaceListItemsMetadataOwnerReferences) __other;
