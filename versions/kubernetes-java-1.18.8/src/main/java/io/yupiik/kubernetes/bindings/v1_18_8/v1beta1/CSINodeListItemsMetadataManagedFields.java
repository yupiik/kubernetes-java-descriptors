...
public class CSINodeListItemsMetadataManagedFields {
    ...
    public CSINodeListItemsMetadataManagedFields() {
        // no-op
    }

    public CSINodeListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSINodeListItemsMetadataManagedFields)) {
            return false;
        }
        final CSINodeListItemsMetadataManagedFields __otherCasted = (CSINodeListItemsMetadataManagedFields) __other;
