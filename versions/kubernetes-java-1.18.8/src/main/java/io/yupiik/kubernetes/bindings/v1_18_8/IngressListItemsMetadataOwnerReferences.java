...
public class IngressListItemsMetadataOwnerReferences {
    ...
    public IngressListItemsMetadataOwnerReferences() {
        // no-op
    }

    public IngressListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof IngressListItemsMetadataOwnerReferences)) {
            return false;
        }
        final IngressListItemsMetadataOwnerReferences __otherCasted = (IngressListItemsMetadataOwnerReferences) __other;
