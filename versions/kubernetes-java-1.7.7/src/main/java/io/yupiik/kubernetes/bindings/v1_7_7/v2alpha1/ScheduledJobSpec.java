...
public class ScheduledJobSpec {
    ...
    private ScheduledJobSpecJobTemplate jobTemplate;
    private String schedule;
    private Integer startingDeadlineSeconds;
    private Integer successfulJobsHistoryLimit;
    private Boolean suspend;

    public ScheduledJobSpec() {
        // no-op
    }

    public ScheduledJobSpec(final String concurrencyPolicy,
                            final Integer failedJobsHistoryLimit,
                            final ScheduledJobSpecJobTemplate jobTemplate,
    ...
    public ScheduledJobSpecJobTemplate getJobTemplate() {
        return jobTemplate;
    }

    public void setJobTemplate(final ScheduledJobSpecJobTemplate jobTemplate) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ScheduledJobSpec)) {
            return false;
        }
        final ScheduledJobSpec __otherCasted = (ScheduledJobSpec) __other;
