...
public class PodTemplateListItemsTemplateSpecEphemeralContainersSecurityContext {
    ...
    private PodTemplateListItemsTemplateSpecEphemeralContainersSecurityContextSeccompProfile seccompProfile;
    ...
    public PodTemplateListItemsTemplateSpecEphemeralContainersSecurityContext(final Boolean allowPrivilegeEscalation,
                                                                              ...
                                                                              final PodTemplateListItemsTemplateSpecEphemeralContainersSecurityContextSeccompProfile seccompProfile,
    ...
    public PodTemplateListItemsTemplateSpecEphemeralContainersSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final PodTemplateListItemsTemplateSpecEphemeralContainersSecurityContextSeccompProfile seccompProfile) {
