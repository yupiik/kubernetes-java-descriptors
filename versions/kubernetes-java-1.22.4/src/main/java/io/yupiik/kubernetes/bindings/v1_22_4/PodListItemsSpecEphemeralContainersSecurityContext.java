...
public class PodListItemsSpecEphemeralContainersSecurityContext {
    ...
    private PodListItemsSpecEphemeralContainersSecurityContextSeccompProfile seccompProfile;
    ...
    public PodListItemsSpecEphemeralContainersSecurityContext(final Boolean allowPrivilegeEscalation,
                                                              ...
                                                              final PodListItemsSpecEphemeralContainersSecurityContextSeccompProfile seccompProfile,
    ...
    public PodListItemsSpecEphemeralContainersSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final PodListItemsSpecEphemeralContainersSecurityContextSeccompProfile seccompProfile) {
