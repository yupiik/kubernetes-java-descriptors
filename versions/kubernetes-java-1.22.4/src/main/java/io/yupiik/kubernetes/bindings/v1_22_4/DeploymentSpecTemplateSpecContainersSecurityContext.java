...
public class DeploymentSpecTemplateSpecContainersSecurityContext {
    ...
    private DeploymentSpecTemplateSpecContainersSecurityContextSeccompProfile seccompProfile;
    ...
    public DeploymentSpecTemplateSpecContainersSecurityContext(final Boolean allowPrivilegeEscalation,
                                                               ...
                                                               final DeploymentSpecTemplateSpecContainersSecurityContextSeccompProfile seccompProfile,
    ...
    public DeploymentSpecTemplateSpecContainersSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final DeploymentSpecTemplateSpecContainersSecurityContextSeccompProfile seccompProfile) {
