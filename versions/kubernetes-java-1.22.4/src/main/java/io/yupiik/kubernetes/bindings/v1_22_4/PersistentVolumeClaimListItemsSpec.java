...
public class PersistentVolumeClaimListItemsSpec {
    ...
    private PersistentVolumeClaimListItemsSpecDataSourceRef dataSourceRef;
    ...
    public PersistentVolumeClaimListItemsSpec(final List<String> accessModes,
                                              ...
                                              final PersistentVolumeClaimListItemsSpecDataSourceRef dataSourceRef,
    ...
    public PersistentVolumeClaimListItemsSpecDataSourceRef getDataSourceRef() {
        return dataSourceRef;
    }

    public void setDataSourceRef(final PersistentVolumeClaimListItemsSpecDataSourceRef dataSourceRef) {
