...
public class ConfigMapListItemsMetadataManagedFields {
    ...
    public ConfigMapListItemsMetadataManagedFields() {
        // no-op
    }

    public ConfigMapListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ConfigMapListItemsMetadataManagedFields)) {
            return false;
        }
        final ConfigMapListItemsMetadataManagedFields __otherCasted = (ConfigMapListItemsMetadataManagedFields) __other;
