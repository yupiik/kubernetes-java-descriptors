...
public class ReplicationControllerSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateSpec {
    ...
    private ReplicationControllerSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateSpecDataSourceRef dataSourceRef;
    ...
    public ReplicationControllerSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateSpec(final List<String> accessModes,
                                                                                        ...
                                                                                        final ReplicationControllerSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateSpecDataSourceRef dataSourceRef,
    ...
    public ReplicationControllerSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateSpecDataSourceRef getDataSourceRef() {
        return dataSourceRef;
    }

    public void setDataSourceRef(final ReplicationControllerSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateSpecDataSourceRef dataSourceRef) {
