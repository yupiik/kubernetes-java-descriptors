...
public class JobSpecTemplateSpecVolumes {
    ...
    private JobSpecTemplateSpecVolumesEphemeral ephemeral;
    ...
    public JobSpecTemplateSpecVolumes(final JobSpecTemplateSpecVolumesAwsElasticBlockStore awsElasticBlockStore,
                                      ...
                                      final JobSpecTemplateSpecVolumesEphemeral ephemeral,
    ...
    public JobSpecTemplateSpecVolumesEphemeral getEphemeral() {
        return ephemeral;
    }

    public void setEphemeral(final JobSpecTemplateSpecVolumesEphemeral ephemeral) {
