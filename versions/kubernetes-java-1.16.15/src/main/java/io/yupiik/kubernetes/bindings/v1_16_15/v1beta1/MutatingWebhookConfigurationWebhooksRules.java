...
public class MutatingWebhookConfigurationWebhooksRules {
    ...
    public MutatingWebhookConfigurationWebhooksRules() {
        // no-op
    }

    public MutatingWebhookConfigurationWebhooksRules(final List<String> apiGroups,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof MutatingWebhookConfigurationWebhooksRules)) {
            return false;
        }
        final MutatingWebhookConfigurationWebhooksRules __otherCasted = (MutatingWebhookConfigurationWebhooksRules) __other;
