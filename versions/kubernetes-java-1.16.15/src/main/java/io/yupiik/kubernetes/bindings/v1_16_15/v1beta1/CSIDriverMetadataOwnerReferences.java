...
public class CSIDriverMetadataOwnerReferences {
    ...
    public CSIDriverMetadataOwnerReferences() {
        // no-op
    }

    public CSIDriverMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSIDriverMetadataOwnerReferences)) {
            return false;
        }
        final CSIDriverMetadataOwnerReferences __otherCasted = (CSIDriverMetadataOwnerReferences) __other;
