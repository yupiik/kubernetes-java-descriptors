...
public class JobSpecTemplateSpecVolumesFc {
    ...
    public JobSpecTemplateSpecVolumesFc() {
        // no-op
    }

    public JobSpecTemplateSpecVolumesFc(final String fsType,
                                        final Integer lun,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobSpecTemplateSpecVolumesFc)) {
            return false;
        }
        final JobSpecTemplateSpecVolumesFc __otherCasted = (JobSpecTemplateSpecVolumesFc) __other;
