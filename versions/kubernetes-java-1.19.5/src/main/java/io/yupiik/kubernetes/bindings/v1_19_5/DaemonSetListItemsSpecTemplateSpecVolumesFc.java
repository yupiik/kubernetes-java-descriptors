...
public class DaemonSetListItemsSpecTemplateSpecVolumesFc {
    ...
    public DaemonSetListItemsSpecTemplateSpecVolumesFc() {
        // no-op
    }

    public DaemonSetListItemsSpecTemplateSpecVolumesFc(final String fsType,
                                                       final Integer lun,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetListItemsSpecTemplateSpecVolumesFc)) {
            return false;
        }
        final DaemonSetListItemsSpecTemplateSpecVolumesFc __otherCasted = (DaemonSetListItemsSpecTemplateSpecVolumesFc) __other;
