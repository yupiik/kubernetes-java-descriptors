...
public class MutatingWebhookConfigurationMetadata {
    ...
    private MutatingWebhookConfigurationMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<MutatingWebhookConfigurationMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<MutatingWebhookConfigurationMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public MutatingWebhookConfigurationMetadata() {
        // no-op
    }

    public MutatingWebhookConfigurationMetadata(final Map<String, String> annotations,
                                                ...
                                                final MutatingWebhookConfigurationMetadataInitializers initializers,
                                                final Map<String, String> labels,
                                                final List<MutatingWebhookConfigurationMetadataManagedFields> managedFields,
                                                final String name,
                                                final String namespace,
                                                final List<MutatingWebhookConfigurationMetadataOwnerReferences> ownerReferences,
    ...
    public MutatingWebhookConfigurationMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final MutatingWebhookConfigurationMetadataInitializers initializers) {
    ...
    public List<MutatingWebhookConfigurationMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<MutatingWebhookConfigurationMetadataManagedFields> managedFields) {
    ...
    public List<MutatingWebhookConfigurationMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<MutatingWebhookConfigurationMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof MutatingWebhookConfigurationMetadata)) {
            return false;
        }
        final MutatingWebhookConfigurationMetadata __otherCasted = (MutatingWebhookConfigurationMetadata) __other;
