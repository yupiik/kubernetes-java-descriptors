...
public class PersistentVolumeMetadata {
    ...
    private PersistentVolumeMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PersistentVolumeMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PersistentVolumeMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PersistentVolumeMetadata() {
        // no-op
    }

    public PersistentVolumeMetadata(final Map<String, String> annotations,
                                    ...
                                    final PersistentVolumeMetadataInitializers initializers,
                                    final Map<String, String> labels,
                                    final List<PersistentVolumeMetadataManagedFields> managedFields,
                                    final String name,
                                    final String namespace,
                                    final List<PersistentVolumeMetadataOwnerReferences> ownerReferences,
    ...
    public PersistentVolumeMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PersistentVolumeMetadataInitializers initializers) {
    ...
    public List<PersistentVolumeMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PersistentVolumeMetadataManagedFields> managedFields) {
    ...
    public List<PersistentVolumeMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PersistentVolumeMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PersistentVolumeMetadata)) {
            return false;
        }
        final PersistentVolumeMetadata __otherCasted = (PersistentVolumeMetadata) __other;
