...
public class SecretMetadata {
    ...
    private SecretMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<SecretMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<SecretMetadataOwnerReferences> ownerReferences;
    ...
    public SecretMetadata(final Map<String, String> annotations,
                          ...
                          final SecretMetadataInitializers initializers,
                          final Map<String, String> labels,
                          final List<SecretMetadataManagedFields> managedFields,
                          final String name,
                          final String namespace,
                          final List<SecretMetadataOwnerReferences> ownerReferences,
    ...
    public SecretMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final SecretMetadataInitializers initializers) {
    ...
    public List<SecretMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<SecretMetadataManagedFields> managedFields) {
    ...
    public List<SecretMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<SecretMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof SecretMetadata)) {
            return false;
        }
        final SecretMetadata __otherCasted = (SecretMetadata) __other;
