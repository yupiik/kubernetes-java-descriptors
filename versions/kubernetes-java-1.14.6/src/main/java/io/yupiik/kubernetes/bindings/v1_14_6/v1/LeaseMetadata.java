...
public class LeaseMetadata {
    ...
    private LeaseMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<LeaseMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<LeaseMetadataOwnerReferences> ownerReferences;
    ...
    public LeaseMetadata(final Map<String, String> annotations,
                         ...
                         final LeaseMetadataInitializers initializers,
                         final Map<String, String> labels,
                         final List<LeaseMetadataManagedFields> managedFields,
                         final String name,
                         final String namespace,
                         final List<LeaseMetadataOwnerReferences> ownerReferences,
    ...
    public LeaseMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final LeaseMetadataInitializers initializers) {
    ...
    public List<LeaseMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<LeaseMetadataManagedFields> managedFields) {
    ...
    public List<LeaseMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<LeaseMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LeaseMetadata)) {
            return false;
        }
        final LeaseMetadata __otherCasted = (LeaseMetadata) __other;
