...
public class ClusterRoleListItemsMetadata {
    ...
    private ClusterRoleListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ClusterRoleListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ClusterRoleListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ClusterRoleListItemsMetadata() {
        // no-op
    }

    public ClusterRoleListItemsMetadata(final Map<String, String> annotations,
                                        ...
                                        final ClusterRoleListItemsMetadataInitializers initializers,
                                        final Map<String, String> labels,
                                        final List<ClusterRoleListItemsMetadataManagedFields> managedFields,
                                        final String name,
                                        final String namespace,
                                        final List<ClusterRoleListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public ClusterRoleListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ClusterRoleListItemsMetadataInitializers initializers) {
    ...
    public List<ClusterRoleListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ClusterRoleListItemsMetadataManagedFields> managedFields) {
    ...
    public List<ClusterRoleListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ClusterRoleListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ClusterRoleListItemsMetadata)) {
            return false;
        }
        final ClusterRoleListItemsMetadata __otherCasted = (ClusterRoleListItemsMetadata) __other;
