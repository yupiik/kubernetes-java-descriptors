...
public class ReplicationControllerListItemsMetadata {
    ...
    private ReplicationControllerListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ReplicationControllerListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ReplicationControllerListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ReplicationControllerListItemsMetadata() {
        // no-op
    }

    public ReplicationControllerListItemsMetadata(final Map<String, String> annotations,
                                                  ...
                                                  final ReplicationControllerListItemsMetadataInitializers initializers,
                                                  final Map<String, String> labels,
                                                  final List<ReplicationControllerListItemsMetadataManagedFields> managedFields,
                                                  final String name,
                                                  final String namespace,
                                                  final List<ReplicationControllerListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public ReplicationControllerListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ReplicationControllerListItemsMetadataInitializers initializers) {
    ...
    public List<ReplicationControllerListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ReplicationControllerListItemsMetadataManagedFields> managedFields) {
    ...
    public List<ReplicationControllerListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ReplicationControllerListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicationControllerListItemsMetadata)) {
            return false;
        }
        final ReplicationControllerListItemsMetadata __otherCasted = (ReplicationControllerListItemsMetadata) __other;
