...
public class CustomResourceDefinitionListItemsMetadata {
    ...
    private CustomResourceDefinitionListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<CustomResourceDefinitionListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<CustomResourceDefinitionListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public CustomResourceDefinitionListItemsMetadata() {
        // no-op
    }

    public CustomResourceDefinitionListItemsMetadata(final Map<String, String> annotations,
                                                     ...
                                                     final CustomResourceDefinitionListItemsMetadataInitializers initializers,
                                                     final Map<String, String> labels,
                                                     final List<CustomResourceDefinitionListItemsMetadataManagedFields> managedFields,
                                                     final String name,
                                                     final String namespace,
                                                     final List<CustomResourceDefinitionListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public CustomResourceDefinitionListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final CustomResourceDefinitionListItemsMetadataInitializers initializers) {
    ...
    public List<CustomResourceDefinitionListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<CustomResourceDefinitionListItemsMetadataManagedFields> managedFields) {
    ...
    public List<CustomResourceDefinitionListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<CustomResourceDefinitionListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CustomResourceDefinitionListItemsMetadata)) {
            return false;
        }
        final CustomResourceDefinitionListItemsMetadata __otherCasted = (CustomResourceDefinitionListItemsMetadata) __other;
