...
public class HorizontalPodAutoscalerListItemsSpecMetrics {
    private HorizontalPodAutoscalerListItemsSpecMetricsContainerResource containerResource;
    ...
    public HorizontalPodAutoscalerListItemsSpecMetrics(final HorizontalPodAutoscalerListItemsSpecMetricsContainerResource containerResource,
                                                       final HorizontalPodAutoscalerListItemsSpecMetricsExternal external,
    ...
    public HorizontalPodAutoscalerListItemsSpecMetricsContainerResource getContainerResource() {
        return containerResource;
    }

    public void setContainerResource(final HorizontalPodAutoscalerListItemsSpecMetricsContainerResource containerResource) {
