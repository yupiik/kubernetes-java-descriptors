...
public class NodeStatusConditions {
    ...
    public NodeStatusConditions() {
        // no-op
    }

    public NodeStatusConditions(final String lastHeartbeatTime,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NodeStatusConditions)) {
            return false;
        }
        final NodeStatusConditions __otherCasted = (NodeStatusConditions) __other;
