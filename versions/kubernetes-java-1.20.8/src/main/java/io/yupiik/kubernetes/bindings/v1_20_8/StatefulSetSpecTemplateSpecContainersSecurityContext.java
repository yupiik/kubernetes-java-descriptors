...
public class StatefulSetSpecTemplateSpecContainersSecurityContext {
    ...
    private StatefulSetSpecTemplateSpecContainersSecurityContextSeccompProfile seccompProfile;
    ...
    public StatefulSetSpecTemplateSpecContainersSecurityContext(final Boolean allowPrivilegeEscalation,
                                                                ...
                                                                final StatefulSetSpecTemplateSpecContainersSecurityContextSeccompProfile seccompProfile,
    ...
    public StatefulSetSpecTemplateSpecContainersSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final StatefulSetSpecTemplateSpecContainersSecurityContextSeccompProfile seccompProfile) {
