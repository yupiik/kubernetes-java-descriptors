...
public class JobListItemsSpecTemplateSpecContainersVolumeMounts {
    ...
    public JobListItemsSpecTemplateSpecContainersVolumeMounts() {
        // no-op
    }

    public JobListItemsSpecTemplateSpecContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobListItemsSpecTemplateSpecContainersVolumeMounts)) {
            return false;
        }
        final JobListItemsSpecTemplateSpecContainersVolumeMounts __otherCasted = (JobListItemsSpecTemplateSpecContainersVolumeMounts) __other;
