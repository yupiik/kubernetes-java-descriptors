...
public class SecretMetadataManagedFields {
    ...
    public SecretMetadataManagedFields() {
        // no-op
    }

    public SecretMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof SecretMetadataManagedFields)) {
            return false;
        }
        final SecretMetadataManagedFields __otherCasted = (SecretMetadataManagedFields) __other;
