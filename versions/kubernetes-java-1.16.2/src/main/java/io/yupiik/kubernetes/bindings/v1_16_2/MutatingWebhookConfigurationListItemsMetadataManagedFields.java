...
public class MutatingWebhookConfigurationListItemsMetadataManagedFields {
    ...
    public MutatingWebhookConfigurationListItemsMetadataManagedFields() {
        // no-op
    }

    public MutatingWebhookConfigurationListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof MutatingWebhookConfigurationListItemsMetadataManagedFields)) {
            return false;
        }
        final MutatingWebhookConfigurationListItemsMetadataManagedFields __otherCasted = (MutatingWebhookConfigurationListItemsMetadataManagedFields) __other;
