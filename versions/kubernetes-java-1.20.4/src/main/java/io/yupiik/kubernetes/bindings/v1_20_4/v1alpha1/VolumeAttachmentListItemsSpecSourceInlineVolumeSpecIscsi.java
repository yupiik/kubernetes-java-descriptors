...
public class VolumeAttachmentListItemsSpecSourceInlineVolumeSpecIscsi {
    ...
    private VolumeAttachmentListItemsSpecSourceInlineVolumeSpecIscsiSecretRef secretRef;
    private String targetPortal;

    public VolumeAttachmentListItemsSpecSourceInlineVolumeSpecIscsi() {
        // no-op
    }

    public VolumeAttachmentListItemsSpecSourceInlineVolumeSpecIscsi(final Boolean chapAuthDiscovery,
                                                                    ...
                                                                    final VolumeAttachmentListItemsSpecSourceInlineVolumeSpecIscsiSecretRef secretRef,
    ...
    public VolumeAttachmentListItemsSpecSourceInlineVolumeSpecIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final VolumeAttachmentListItemsSpecSourceInlineVolumeSpecIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof VolumeAttachmentListItemsSpecSourceInlineVolumeSpecIscsi)) {
            return false;
        }
        final VolumeAttachmentListItemsSpecSourceInlineVolumeSpecIscsi __otherCasted = (VolumeAttachmentListItemsSpecSourceInlineVolumeSpecIscsi) __other;
