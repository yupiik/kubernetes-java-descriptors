...
public class ReplicaSetMetadataOwnerReferences {
    ...
    public ReplicaSetMetadataOwnerReferences() {
        // no-op
    }

    public ReplicaSetMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicaSetMetadataOwnerReferences)) {
            return false;
        }
        final ReplicaSetMetadataOwnerReferences __otherCasted = (ReplicaSetMetadataOwnerReferences) __other;
