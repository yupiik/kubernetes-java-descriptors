...
public class PriorityLevelConfigurationMetadata {
    ...
    private List<PriorityLevelConfigurationMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PriorityLevelConfigurationMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PriorityLevelConfigurationMetadata() {
        // no-op
    }

    public PriorityLevelConfigurationMetadata(final Map<String, String> annotations,
                                              ...
                                              final List<PriorityLevelConfigurationMetadataManagedFields> managedFields,
                                              final String name,
                                              final String namespace,
                                              final List<PriorityLevelConfigurationMetadataOwnerReferences> ownerReferences,
    ...
    public List<PriorityLevelConfigurationMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PriorityLevelConfigurationMetadataManagedFields> managedFields) {
    ...
    public List<PriorityLevelConfigurationMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PriorityLevelConfigurationMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PriorityLevelConfigurationMetadata)) {
            return false;
        }
        final PriorityLevelConfigurationMetadata __otherCasted = (PriorityLevelConfigurationMetadata) __other;
