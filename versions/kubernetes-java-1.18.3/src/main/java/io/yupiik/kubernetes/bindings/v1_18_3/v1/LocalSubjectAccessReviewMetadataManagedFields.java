...
public class LocalSubjectAccessReviewMetadataManagedFields {
    ...
    public LocalSubjectAccessReviewMetadataManagedFields() {
        // no-op
    }

    public LocalSubjectAccessReviewMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LocalSubjectAccessReviewMetadataManagedFields)) {
            return false;
        }
        final LocalSubjectAccessReviewMetadataManagedFields __otherCasted = (LocalSubjectAccessReviewMetadataManagedFields) __other;
