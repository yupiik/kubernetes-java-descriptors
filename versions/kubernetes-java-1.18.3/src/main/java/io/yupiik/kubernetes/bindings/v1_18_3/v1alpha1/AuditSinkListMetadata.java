...
public class AuditSinkListMetadata {
    ...
    public AuditSinkListMetadata() {
        // no-op
    }

    public AuditSinkListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof AuditSinkListMetadata)) {
            return false;
        }
        final AuditSinkListMetadata __otherCasted = (AuditSinkListMetadata) __other;
