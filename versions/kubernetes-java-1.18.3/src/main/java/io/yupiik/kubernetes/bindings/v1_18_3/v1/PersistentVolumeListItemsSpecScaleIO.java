...
public class PersistentVolumeListItemsSpecScaleIO {
    private String fsType;
    private String gateway;
    private String protectionDomain;
    private Boolean readOnly;
    private PersistentVolumeListItemsSpecScaleIOSecretRef secretRef;
    ...
    public PersistentVolumeListItemsSpecScaleIO() {
        // no-op
    }

    public PersistentVolumeListItemsSpecScaleIO(final String fsType,
                                                final String gateway,
                                                final String protectionDomain,
                                                final Boolean readOnly,
                                                final PersistentVolumeListItemsSpecScaleIOSecretRef secretRef,
    ...
    public PersistentVolumeListItemsSpecScaleIOSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final PersistentVolumeListItemsSpecScaleIOSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PersistentVolumeListItemsSpecScaleIO)) {
            return false;
        }
        final PersistentVolumeListItemsSpecScaleIO __otherCasted = (PersistentVolumeListItemsSpecScaleIO) __other;
