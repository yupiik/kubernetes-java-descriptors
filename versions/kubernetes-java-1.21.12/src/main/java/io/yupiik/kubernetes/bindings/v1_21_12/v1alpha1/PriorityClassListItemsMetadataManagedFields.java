...
public class PriorityClassListItemsMetadataManagedFields {
    ...
    public PriorityClassListItemsMetadataManagedFields() {
        // no-op
    }

    public PriorityClassListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PriorityClassListItemsMetadataManagedFields)) {
            return false;
        }
        final PriorityClassListItemsMetadataManagedFields __otherCasted = (PriorityClassListItemsMetadataManagedFields) __other;
