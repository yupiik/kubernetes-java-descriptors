...
public class PriorityClassMetadataManagedFields {
    ...
    public PriorityClassMetadataManagedFields() {
        // no-op
    }

    public PriorityClassMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PriorityClassMetadataManagedFields)) {
            return false;
        }
        final PriorityClassMetadataManagedFields __otherCasted = (PriorityClassMetadataManagedFields) __other;
