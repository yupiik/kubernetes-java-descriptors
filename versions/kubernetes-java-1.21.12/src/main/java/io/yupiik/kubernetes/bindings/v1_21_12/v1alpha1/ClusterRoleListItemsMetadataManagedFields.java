...
public class ClusterRoleListItemsMetadataManagedFields {
    ...
    public ClusterRoleListItemsMetadataManagedFields() {
        // no-op
    }

    public ClusterRoleListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ClusterRoleListItemsMetadataManagedFields)) {
            return false;
        }
        final ClusterRoleListItemsMetadataManagedFields __otherCasted = (ClusterRoleListItemsMetadataManagedFields) __other;
