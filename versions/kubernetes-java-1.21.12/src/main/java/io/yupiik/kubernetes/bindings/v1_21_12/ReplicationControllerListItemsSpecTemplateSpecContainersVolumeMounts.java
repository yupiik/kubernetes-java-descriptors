...
public class ReplicationControllerListItemsSpecTemplateSpecContainersVolumeMounts {
    ...
    public ReplicationControllerListItemsSpecTemplateSpecContainersVolumeMounts() {
        // no-op
    }

    public ReplicationControllerListItemsSpecTemplateSpecContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicationControllerListItemsSpecTemplateSpecContainersVolumeMounts)) {
            return false;
        }
        final ReplicationControllerListItemsSpecTemplateSpecContainersVolumeMounts __otherCasted = (ReplicationControllerListItemsSpecTemplateSpecContainersVolumeMounts) __other;
