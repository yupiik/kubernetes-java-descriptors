...
public class VolumeAttachmentSpecSourceInlineVolumeSpecIscsi {
    ...
    private VolumeAttachmentSpecSourceInlineVolumeSpecIscsiSecretRef secretRef;
    private String targetPortal;

    public VolumeAttachmentSpecSourceInlineVolumeSpecIscsi() {
        // no-op
    }

    public VolumeAttachmentSpecSourceInlineVolumeSpecIscsi(final Boolean chapAuthDiscovery,
                                                           ...
                                                           final VolumeAttachmentSpecSourceInlineVolumeSpecIscsiSecretRef secretRef,
    ...
    public VolumeAttachmentSpecSourceInlineVolumeSpecIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final VolumeAttachmentSpecSourceInlineVolumeSpecIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof VolumeAttachmentSpecSourceInlineVolumeSpecIscsi)) {
            return false;
        }
        final VolumeAttachmentSpecSourceInlineVolumeSpecIscsi __otherCasted = (VolumeAttachmentSpecSourceInlineVolumeSpecIscsi) __other;
