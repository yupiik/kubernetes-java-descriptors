...
public class StorageVersionListItemsMetadata {
    ...
    private List<StorageVersionListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<StorageVersionListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public StorageVersionListItemsMetadata() {
        // no-op
    }

    public StorageVersionListItemsMetadata(final Map<String, String> annotations,
                                           ...
                                           final List<StorageVersionListItemsMetadataManagedFields> managedFields,
                                           final String name,
                                           final String namespace,
                                           final List<StorageVersionListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public List<StorageVersionListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<StorageVersionListItemsMetadataManagedFields> managedFields) {
    ...
    public List<StorageVersionListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<StorageVersionListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StorageVersionListItemsMetadata)) {
            return false;
        }
        final StorageVersionListItemsMetadata __otherCasted = (StorageVersionListItemsMetadata) __other;
