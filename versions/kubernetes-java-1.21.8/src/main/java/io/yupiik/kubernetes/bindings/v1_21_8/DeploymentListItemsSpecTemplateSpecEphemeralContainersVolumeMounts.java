...
public class DeploymentListItemsSpecTemplateSpecEphemeralContainersVolumeMounts {
    ...
    public DeploymentListItemsSpecTemplateSpecEphemeralContainersVolumeMounts() {
        // no-op
    }

    public DeploymentListItemsSpecTemplateSpecEphemeralContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentListItemsSpecTemplateSpecEphemeralContainersVolumeMounts)) {
            return false;
        }
        final DeploymentListItemsSpecTemplateSpecEphemeralContainersVolumeMounts __otherCasted = (DeploymentListItemsSpecTemplateSpecEphemeralContainersVolumeMounts) __other;
