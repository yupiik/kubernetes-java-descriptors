...
public class EphemeralContainersMetadataOwnerReferences {
    ...
    public EphemeralContainersMetadataOwnerReferences() {
        // no-op
    }

    public EphemeralContainersMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EphemeralContainersMetadataOwnerReferences)) {
            return false;
        }
        final EphemeralContainersMetadataOwnerReferences __otherCasted = (EphemeralContainersMetadataOwnerReferences) __other;
