...
public class DeploymentListItemsSpecTemplateSpecContainersVolumeMounts {
    ...
    public DeploymentListItemsSpecTemplateSpecContainersVolumeMounts() {
        // no-op
    }

    public DeploymentListItemsSpecTemplateSpecContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentListItemsSpecTemplateSpecContainersVolumeMounts)) {
            return false;
        }
        final DeploymentListItemsSpecTemplateSpecContainersVolumeMounts __otherCasted = (DeploymentListItemsSpecTemplateSpecContainersVolumeMounts) __other;
