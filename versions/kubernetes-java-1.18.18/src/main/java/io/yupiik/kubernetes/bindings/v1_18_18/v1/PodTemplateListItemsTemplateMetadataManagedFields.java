...
public class PodTemplateListItemsTemplateMetadataManagedFields {
    ...
    public PodTemplateListItemsTemplateMetadataManagedFields() {
        // no-op
    }

    public PodTemplateListItemsTemplateMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateListItemsTemplateMetadataManagedFields)) {
            return false;
        }
        final PodTemplateListItemsTemplateMetadataManagedFields __otherCasted = (PodTemplateListItemsTemplateMetadataManagedFields) __other;
