...
public class CronJobListItemsSpecJobTemplateSpecTemplateSpecVolumesIscsi {
    ...
    private CronJobListItemsSpecJobTemplateSpecTemplateSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public CronJobListItemsSpecJobTemplateSpecTemplateSpecVolumesIscsi() {
        // no-op
    }

    public CronJobListItemsSpecJobTemplateSpecTemplateSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                                                       ...
                                                                       final CronJobListItemsSpecJobTemplateSpecTemplateSpecVolumesIscsiSecretRef secretRef,
    ...
    public CronJobListItemsSpecJobTemplateSpecTemplateSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final CronJobListItemsSpecJobTemplateSpecTemplateSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CronJobListItemsSpecJobTemplateSpecTemplateSpecVolumesIscsi)) {
            return false;
        }
        final CronJobListItemsSpecJobTemplateSpecTemplateSpecVolumesIscsi __otherCasted = (CronJobListItemsSpecJobTemplateSpecTemplateSpecVolumesIscsi) __other;
