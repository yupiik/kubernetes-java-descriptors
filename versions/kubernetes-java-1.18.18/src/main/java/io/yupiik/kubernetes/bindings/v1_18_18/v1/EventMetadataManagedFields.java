...
public class EventMetadataManagedFields {
    ...
    public EventMetadataManagedFields() {
        // no-op
    }

    public EventMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EventMetadataManagedFields)) {
            return false;
        }
        final EventMetadataManagedFields __otherCasted = (EventMetadataManagedFields) __other;
