...
public class JobListItemsMetadata {
    ...
    private JobListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<JobListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<JobListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public JobListItemsMetadata() {
        // no-op
    }

    public JobListItemsMetadata(final Map<String, String> annotations,
                                ...
                                final JobListItemsMetadataInitializers initializers,
                                final Map<String, String> labels,
                                final List<JobListItemsMetadataManagedFields> managedFields,
                                final String name,
                                final String namespace,
                                final List<JobListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public JobListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final JobListItemsMetadataInitializers initializers) {
    ...
    public List<JobListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<JobListItemsMetadataManagedFields> managedFields) {
    ...
    public List<JobListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<JobListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobListItemsMetadata)) {
            return false;
        }
        final JobListItemsMetadata __otherCasted = (JobListItemsMetadata) __other;
