...
public class ReplicationControllerMetadata {
    ...
    private ReplicationControllerMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ReplicationControllerMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ReplicationControllerMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ReplicationControllerMetadata() {
        // no-op
    }

    public ReplicationControllerMetadata(final Map<String, String> annotations,
                                         ...
                                         final ReplicationControllerMetadataInitializers initializers,
                                         final Map<String, String> labels,
                                         final List<ReplicationControllerMetadataManagedFields> managedFields,
                                         final String name,
                                         final String namespace,
                                         final List<ReplicationControllerMetadataOwnerReferences> ownerReferences,
    ...
    public ReplicationControllerMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ReplicationControllerMetadataInitializers initializers) {
    ...
    public List<ReplicationControllerMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ReplicationControllerMetadataManagedFields> managedFields) {
    ...
    public List<ReplicationControllerMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ReplicationControllerMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicationControllerMetadata)) {
            return false;
        }
        final ReplicationControllerMetadata __otherCasted = (ReplicationControllerMetadata) __other;
