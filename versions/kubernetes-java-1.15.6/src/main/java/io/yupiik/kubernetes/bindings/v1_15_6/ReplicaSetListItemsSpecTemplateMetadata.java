...
public class ReplicaSetListItemsSpecTemplateMetadata {
    ...
    private ReplicaSetListItemsSpecTemplateMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ReplicaSetListItemsSpecTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ReplicaSetListItemsSpecTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ReplicaSetListItemsSpecTemplateMetadata() {
        // no-op
    }

    public ReplicaSetListItemsSpecTemplateMetadata(final Map<String, String> annotations,
                                                   ...
                                                   final ReplicaSetListItemsSpecTemplateMetadataInitializers initializers,
                                                   final Map<String, String> labels,
                                                   final List<ReplicaSetListItemsSpecTemplateMetadataManagedFields> managedFields,
                                                   final String name,
                                                   final String namespace,
                                                   final List<ReplicaSetListItemsSpecTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public ReplicaSetListItemsSpecTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ReplicaSetListItemsSpecTemplateMetadataInitializers initializers) {
    ...
    public List<ReplicaSetListItemsSpecTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ReplicaSetListItemsSpecTemplateMetadataManagedFields> managedFields) {
    ...
    public List<ReplicaSetListItemsSpecTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ReplicaSetListItemsSpecTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicaSetListItemsSpecTemplateMetadata)) {
            return false;
        }
        final ReplicaSetListItemsSpecTemplateMetadata __otherCasted = (ReplicaSetListItemsSpecTemplateMetadata) __other;
