...
public class EventListItemsMetadataInitializersResultMetadata {
    ...
    public EventListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public EventListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EventListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final EventListItemsMetadataInitializersResultMetadata __otherCasted = (EventListItemsMetadataInitializersResultMetadata) __other;
