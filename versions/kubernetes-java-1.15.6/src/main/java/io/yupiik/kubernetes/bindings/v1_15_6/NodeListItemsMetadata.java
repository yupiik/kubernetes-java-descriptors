...
public class NodeListItemsMetadata {
    ...
    private NodeListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<NodeListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<NodeListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public NodeListItemsMetadata() {
        // no-op
    }

    public NodeListItemsMetadata(final Map<String, String> annotations,
                                 ...
                                 final NodeListItemsMetadataInitializers initializers,
                                 final Map<String, String> labels,
                                 final List<NodeListItemsMetadataManagedFields> managedFields,
                                 final String name,
                                 final String namespace,
                                 final List<NodeListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public NodeListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final NodeListItemsMetadataInitializers initializers) {
    ...
    public List<NodeListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<NodeListItemsMetadataManagedFields> managedFields) {
    ...
    public List<NodeListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<NodeListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NodeListItemsMetadata)) {
            return false;
        }
        final NodeListItemsMetadata __otherCasted = (NodeListItemsMetadata) __other;
