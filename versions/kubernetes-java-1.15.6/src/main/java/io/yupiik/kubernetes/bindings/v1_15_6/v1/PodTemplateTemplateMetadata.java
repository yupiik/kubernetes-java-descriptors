...
public class PodTemplateTemplateMetadata {
    ...
    private PodTemplateTemplateMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PodTemplateTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PodTemplateTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PodTemplateTemplateMetadata() {
        // no-op
    }

    public PodTemplateTemplateMetadata(final Map<String, String> annotations,
                                       ...
                                       final PodTemplateTemplateMetadataInitializers initializers,
                                       final Map<String, String> labels,
                                       final List<PodTemplateTemplateMetadataManagedFields> managedFields,
                                       final String name,
                                       final String namespace,
                                       final List<PodTemplateTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public PodTemplateTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PodTemplateTemplateMetadataInitializers initializers) {
    ...
    public List<PodTemplateTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PodTemplateTemplateMetadataManagedFields> managedFields) {
    ...
    public List<PodTemplateTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PodTemplateTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateTemplateMetadata)) {
            return false;
        }
        final PodTemplateTemplateMetadata __otherCasted = (PodTemplateTemplateMetadata) __other;
