...
public class NetworkPolicyListItemsMetadataInitializersResultMetadata {
    ...
    public NetworkPolicyListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public NetworkPolicyListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NetworkPolicyListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final NetworkPolicyListItemsMetadataInitializersResultMetadata __otherCasted = (NetworkPolicyListItemsMetadataInitializersResultMetadata) __other;
