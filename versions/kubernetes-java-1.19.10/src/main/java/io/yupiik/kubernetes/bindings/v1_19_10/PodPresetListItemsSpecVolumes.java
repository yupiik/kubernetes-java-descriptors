...
public class PodPresetListItemsSpecVolumes {
    ...
    private PodPresetListItemsSpecVolumesEphemeral ephemeral;
    ...
    public PodPresetListItemsSpecVolumes(final PodPresetListItemsSpecVolumesAwsElasticBlockStore awsElasticBlockStore,
                                         ...
                                         final PodPresetListItemsSpecVolumesEphemeral ephemeral,
    ...
    public PodPresetListItemsSpecVolumesEphemeral getEphemeral() {
        return ephemeral;
    }

    public void setEphemeral(final PodPresetListItemsSpecVolumesEphemeral ephemeral) {
