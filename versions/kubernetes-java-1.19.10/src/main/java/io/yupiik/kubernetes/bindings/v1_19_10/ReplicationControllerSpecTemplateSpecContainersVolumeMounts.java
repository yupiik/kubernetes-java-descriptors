...
public class ReplicationControllerSpecTemplateSpecContainersVolumeMounts {
    ...
    public ReplicationControllerSpecTemplateSpecContainersVolumeMounts() {
        // no-op
    }

    public ReplicationControllerSpecTemplateSpecContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicationControllerSpecTemplateSpecContainersVolumeMounts)) {
            return false;
        }
        final ReplicationControllerSpecTemplateSpecContainersVolumeMounts __otherCasted = (ReplicationControllerSpecTemplateSpecContainersVolumeMounts) __other;
