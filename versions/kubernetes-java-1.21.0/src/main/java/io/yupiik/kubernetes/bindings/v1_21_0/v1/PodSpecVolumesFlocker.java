...
public class PodSpecVolumesFlocker {
    private String datasetName;
    private String datasetUUID;

    public PodSpecVolumesFlocker() {
        // no-op
    }

    public PodSpecVolumesFlocker(final String datasetName,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSpecVolumesFlocker)) {
            return false;
        }
        final PodSpecVolumesFlocker __otherCasted = (PodSpecVolumesFlocker) __other;
