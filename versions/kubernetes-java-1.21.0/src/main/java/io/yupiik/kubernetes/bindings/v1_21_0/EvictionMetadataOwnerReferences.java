...
public class EvictionMetadataOwnerReferences {
    ...
    public EvictionMetadataOwnerReferences() {
        // no-op
    }

    public EvictionMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EvictionMetadataOwnerReferences)) {
            return false;
        }
        final EvictionMetadataOwnerReferences __otherCasted = (EvictionMetadataOwnerReferences) __other;
