...
public class PodTemplateTemplateSpecVolumesScaleIO {
    private String fsType;
    private String gateway;
    private String protectionDomain;
    private Boolean readOnly;
    private PodTemplateTemplateSpecVolumesScaleIOSecretRef secretRef;
    ...
    public PodTemplateTemplateSpecVolumesScaleIO() {
        // no-op
    }

    public PodTemplateTemplateSpecVolumesScaleIO(final String fsType,
                                                 final String gateway,
                                                 final String protectionDomain,
                                                 final Boolean readOnly,
                                                 final PodTemplateTemplateSpecVolumesScaleIOSecretRef secretRef,
    ...
    public PodTemplateTemplateSpecVolumesScaleIOSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final PodTemplateTemplateSpecVolumesScaleIOSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateTemplateSpecVolumesScaleIO)) {
            return false;
        }
        final PodTemplateTemplateSpecVolumesScaleIO __otherCasted = (PodTemplateTemplateSpecVolumesScaleIO) __other;
