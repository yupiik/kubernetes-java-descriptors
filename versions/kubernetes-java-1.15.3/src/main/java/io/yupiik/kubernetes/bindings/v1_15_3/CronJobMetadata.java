...
public class CronJobMetadata {
    ...
    private CronJobMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<CronJobMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<CronJobMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public CronJobMetadata() {
        // no-op
    }

    public CronJobMetadata(final Map<String, String> annotations,
                           ...
                           final CronJobMetadataInitializers initializers,
                           final Map<String, String> labels,
                           final List<CronJobMetadataManagedFields> managedFields,
                           final String name,
                           final String namespace,
                           final List<CronJobMetadataOwnerReferences> ownerReferences,
    ...
    public CronJobMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final CronJobMetadataInitializers initializers) {
    ...
    public List<CronJobMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<CronJobMetadataManagedFields> managedFields) {
    ...
    public List<CronJobMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<CronJobMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CronJobMetadata)) {
            return false;
        }
        final CronJobMetadata __otherCasted = (CronJobMetadata) __other;
