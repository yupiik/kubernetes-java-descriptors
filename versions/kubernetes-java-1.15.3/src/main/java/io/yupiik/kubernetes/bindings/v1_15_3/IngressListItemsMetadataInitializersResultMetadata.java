...
public class IngressListItemsMetadataInitializersResultMetadata {
    ...
    public IngressListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public IngressListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof IngressListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final IngressListItemsMetadataInitializersResultMetadata __otherCasted = (IngressListItemsMetadataInitializersResultMetadata) __other;
