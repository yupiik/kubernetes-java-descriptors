...
public class PersistentVolumeListItemsSpecAzureDisk {
    ...
    public PersistentVolumeListItemsSpecAzureDisk() {
        // no-op
    }

    public PersistentVolumeListItemsSpecAzureDisk(final String cachingMode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PersistentVolumeListItemsSpecAzureDisk)) {
            return false;
        }
        final PersistentVolumeListItemsSpecAzureDisk __otherCasted = (PersistentVolumeListItemsSpecAzureDisk) __other;
