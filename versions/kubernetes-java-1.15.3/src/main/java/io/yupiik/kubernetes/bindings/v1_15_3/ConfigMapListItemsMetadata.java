...
public class ConfigMapListItemsMetadata {
    ...
    private ConfigMapListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ConfigMapListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ConfigMapListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ConfigMapListItemsMetadata() {
        // no-op
    }

    public ConfigMapListItemsMetadata(final Map<String, String> annotations,
                                      ...
                                      final ConfigMapListItemsMetadataInitializers initializers,
                                      final Map<String, String> labels,
                                      final List<ConfigMapListItemsMetadataManagedFields> managedFields,
                                      final String name,
                                      final String namespace,
                                      final List<ConfigMapListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public ConfigMapListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ConfigMapListItemsMetadataInitializers initializers) {
    ...
    public List<ConfigMapListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ConfigMapListItemsMetadataManagedFields> managedFields) {
    ...
    public List<ConfigMapListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ConfigMapListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ConfigMapListItemsMetadata)) {
            return false;
        }
        final ConfigMapListItemsMetadata __otherCasted = (ConfigMapListItemsMetadata) __other;
