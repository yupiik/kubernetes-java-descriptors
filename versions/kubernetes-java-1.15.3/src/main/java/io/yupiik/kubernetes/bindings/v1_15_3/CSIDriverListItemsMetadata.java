...
public class CSIDriverListItemsMetadata {
    ...
    private CSIDriverListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<CSIDriverListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<CSIDriverListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public CSIDriverListItemsMetadata() {
        // no-op
    }

    public CSIDriverListItemsMetadata(final Map<String, String> annotations,
                                      ...
                                      final CSIDriverListItemsMetadataInitializers initializers,
                                      final Map<String, String> labels,
                                      final List<CSIDriverListItemsMetadataManagedFields> managedFields,
                                      final String name,
                                      final String namespace,
                                      final List<CSIDriverListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public CSIDriverListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final CSIDriverListItemsMetadataInitializers initializers) {
    ...
    public List<CSIDriverListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<CSIDriverListItemsMetadataManagedFields> managedFields) {
    ...
    public List<CSIDriverListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<CSIDriverListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSIDriverListItemsMetadata)) {
            return false;
        }
        final CSIDriverListItemsMetadata __otherCasted = (CSIDriverListItemsMetadata) __other;
