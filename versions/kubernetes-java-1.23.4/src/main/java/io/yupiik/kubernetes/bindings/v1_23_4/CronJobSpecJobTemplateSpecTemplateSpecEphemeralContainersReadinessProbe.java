...
public class CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainersReadinessProbe {
    ...
    private CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainersReadinessProbeGrpc grpc;
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainersReadinessProbe(final CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainersReadinessProbeExec exec,
                                                                                   ...
                                                                                   final CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainersReadinessProbeGrpc grpc,
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
