...
public class PodTemplateTemplateSpecContainersLifecyclePostStartHttpGet {
    ...
    private String path;
    private String port;
    private PodTemplateTemplateSpecContainersLifecyclePostStartHttpGetScheme scheme;
    ...
    public PodTemplateTemplateSpecContainersLifecyclePostStartHttpGet(final String host,
                                                                      ...
                                                                      final String path,
                                                                      final String port,
                                                                      final PodTemplateTemplateSpecContainersLifecyclePostStartHttpGetScheme scheme) {
        // no-op
    }
    ...
    public PodTemplateTemplateSpecContainersLifecyclePostStartHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final PodTemplateTemplateSpecContainersLifecyclePostStartHttpGetScheme scheme) {
        this.scheme = scheme;
    }
