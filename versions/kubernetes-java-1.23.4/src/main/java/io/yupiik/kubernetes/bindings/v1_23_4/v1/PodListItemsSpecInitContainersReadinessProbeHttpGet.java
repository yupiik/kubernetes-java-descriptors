...
public class PodListItemsSpecInitContainersReadinessProbeHttpGet {
    ...
    private String path;
    private String port;
    private PodListItemsSpecInitContainersReadinessProbeHttpGetScheme scheme;
    ...
    public PodListItemsSpecInitContainersReadinessProbeHttpGet(final String host,
                                                               ...
                                                               final String path,
                                                               final String port,
                                                               final PodListItemsSpecInitContainersReadinessProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public PodListItemsSpecInitContainersReadinessProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final PodListItemsSpecInitContainersReadinessProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
