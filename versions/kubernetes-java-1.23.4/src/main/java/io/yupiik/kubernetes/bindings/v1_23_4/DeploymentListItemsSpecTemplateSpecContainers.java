...
public class DeploymentListItemsSpecTemplateSpecContainers {
    ...
    private DeploymentListItemsSpecTemplateSpecContainersImagePullPolicy imagePullPolicy;
    ...
    private DeploymentListItemsSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public DeploymentListItemsSpecTemplateSpecContainers(final List<String> args,
                                                         ...
                                                         final String image,
                                                         final DeploymentListItemsSpecTemplateSpecContainersImagePullPolicy imagePullPolicy,
                                                         ...
                                                         final DeploymentListItemsSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy,
                                                         final Boolean tty,
    ...
    public DeploymentListItemsSpecTemplateSpecContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final DeploymentListItemsSpecTemplateSpecContainersImagePullPolicy imagePullPolicy) {
    ...
    public DeploymentListItemsSpecTemplateSpecContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final DeploymentListItemsSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy) {
