...
public class PodSpecInitContainersLivenessProbe {
    ...
    private PodSpecInitContainersLivenessProbeGrpc grpc;
    ...
    public PodSpecInitContainersLivenessProbe(final PodSpecInitContainersLivenessProbeExec exec,
                                              ...
                                              final PodSpecInitContainersLivenessProbeGrpc grpc,
    ...
    public PodSpecInitContainersLivenessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final PodSpecInitContainersLivenessProbeGrpc grpc) {
        this.grpc = grpc;
    }
