...
public class JobSpecTemplateSpecContainers {
    ...
    private JobSpecTemplateSpecContainersImagePullPolicy imagePullPolicy;
    ...
    private JobSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public JobSpecTemplateSpecContainers(final List<String> args,
                                         ...
                                         final String image,
                                         final JobSpecTemplateSpecContainersImagePullPolicy imagePullPolicy,
                                         ...
                                         final JobSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy,
                                         final Boolean tty,
    ...
    public JobSpecTemplateSpecContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final JobSpecTemplateSpecContainersImagePullPolicy imagePullPolicy) {
    ...
    public JobSpecTemplateSpecContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final JobSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy) {
