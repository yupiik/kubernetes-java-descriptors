...
public class VolumeAttachmentSpecSourceInlineVolumeSpec {
    ...
    private VolumeAttachmentSpecSourceInlineVolumeSpecPersistentVolumeReclaimPolicy persistentVolumeReclaimPolicy;
    ...
    public VolumeAttachmentSpecSourceInlineVolumeSpec(final List<String> accessModes,
                                                      ...
                                                      final VolumeAttachmentSpecSourceInlineVolumeSpecPersistentVolumeReclaimPolicy persistentVolumeReclaimPolicy,
    ...
    public VolumeAttachmentSpecSourceInlineVolumeSpecPersistentVolumeReclaimPolicy getPersistentVolumeReclaimPolicy() {
        return persistentVolumeReclaimPolicy;
    }

    public void setPersistentVolumeReclaimPolicy(final VolumeAttachmentSpecSourceInlineVolumeSpecPersistentVolumeReclaimPolicy persistentVolumeReclaimPolicy) {
