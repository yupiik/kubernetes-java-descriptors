...
public class ServiceSpec implements Validable<ServiceSpec>, Exportable {
    ...
    private ServiceSpecExternalTrafficPolicy externalTrafficPolicy;
    ...
    private ServiceSpecSessionAffinity sessionAffinity;
    private SessionAffinityConfig sessionAffinityConfig;
    private ServiceSpecType type;
    ...
    public ServiceSpec(final Boolean allocateLoadBalancerNodePorts,
                       ...
                       final ServiceSpecExternalTrafficPolicy externalTrafficPolicy,
                       ...
                       final ServiceSpecSessionAffinity sessionAffinity,
                       final SessionAffinityConfig sessionAffinityConfig,
                       final ServiceSpecType type) {
    ...
    public ServiceSpecExternalTrafficPolicy getExternalTrafficPolicy() {
        return externalTrafficPolicy;
    }

    public void setExternalTrafficPolicy(final ServiceSpecExternalTrafficPolicy externalTrafficPolicy) {
        this.externalTrafficPolicy = externalTrafficPolicy;
    }
    ...
    public ServiceSpecSessionAffinity getSessionAffinity() {
        return sessionAffinity;
    }

    public void setSessionAffinity(final ServiceSpecSessionAffinity sessionAffinity) {
        this.sessionAffinity = sessionAffinity;
    }
    ...
    public void setType(final ServiceSpecType type) {
        this.type = type;
    }
    ...
    public ServiceSpec externalTrafficPolicy(final ServiceSpecExternalTrafficPolicy externalTrafficPolicy) {
        this.externalTrafficPolicy = externalTrafficPolicy;
        return this;
    }
    ...
    public ServiceSpec sessionAffinity(final ServiceSpecSessionAffinity sessionAffinity) {
        this.sessionAffinity = sessionAffinity;
        return this;
    }
    ...
    public ServiceSpec type(final ServiceSpecType type) {
        this.type = type;
        return this;
    }
    ...
    public String asJson() {
        return Stream.of(
                    ...
                    (externalTrafficPolicy != null ? "\"externalTrafficPolicy\":" + externalTrafficPolicy.asJson() : ""),
                    ...
                    (selector != null ? "\"selector\":" + selector.entrySet().stream()
                        ...
                        .collect(joining(",", "{", "}")) : ""),
                    (sessionAffinity != null ? "\"sessionAffinity\":" + sessionAffinity.asJson() : ""),
