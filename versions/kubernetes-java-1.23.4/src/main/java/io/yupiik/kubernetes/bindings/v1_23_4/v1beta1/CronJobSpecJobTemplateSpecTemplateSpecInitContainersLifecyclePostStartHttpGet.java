...
public class CronJobSpecJobTemplateSpecTemplateSpecInitContainersLifecyclePostStartHttpGet {
    ...
    private String path;
    private String port;
    private CronJobSpecJobTemplateSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme scheme;
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecInitContainersLifecyclePostStartHttpGet(final String host,
                                                                                         ...
                                                                                         final String path,
                                                                                         final String port,
                                                                                         final CronJobSpecJobTemplateSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme scheme) {
        // no-op
    }
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final CronJobSpecJobTemplateSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme scheme) {
        this.scheme = scheme;
    }
