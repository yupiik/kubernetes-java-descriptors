...
public class CronJobSpecJobTemplateSpecTemplateSpecContainers {
    ...
    private CronJobSpecJobTemplateSpecTemplateSpecContainersImagePullPolicy imagePullPolicy;
    ...
    private CronJobSpecJobTemplateSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecContainers(final List<String> args,
                                                            ...
                                                            final String image,
                                                            final CronJobSpecJobTemplateSpecTemplateSpecContainersImagePullPolicy imagePullPolicy,
                                                            ...
                                                            final CronJobSpecJobTemplateSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy,
                                                            final Boolean tty,
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final CronJobSpecJobTemplateSpecTemplateSpecContainersImagePullPolicy imagePullPolicy) {
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final CronJobSpecJobTemplateSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy) {
