...
public class PodTemplateTemplateSpecEphemeralContainersLivenessProbeHttpGet {
    ...
    private String path;
    private String port;
    private PodTemplateTemplateSpecEphemeralContainersLivenessProbeHttpGetScheme scheme;
    ...
    public PodTemplateTemplateSpecEphemeralContainersLivenessProbeHttpGet(final String host,
                                                                          ...
                                                                          final String path,
                                                                          final String port,
                                                                          final PodTemplateTemplateSpecEphemeralContainersLivenessProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public PodTemplateTemplateSpecEphemeralContainersLivenessProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final PodTemplateTemplateSpecEphemeralContainersLivenessProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
