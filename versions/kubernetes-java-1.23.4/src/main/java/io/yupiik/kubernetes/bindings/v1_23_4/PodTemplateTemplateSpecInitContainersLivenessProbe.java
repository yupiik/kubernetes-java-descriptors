...
public class PodTemplateTemplateSpecInitContainersLivenessProbe {
    ...
    private PodTemplateTemplateSpecInitContainersLivenessProbeGrpc grpc;
    ...
    public PodTemplateTemplateSpecInitContainersLivenessProbe(final PodTemplateTemplateSpecInitContainersLivenessProbeExec exec,
                                                              ...
                                                              final PodTemplateTemplateSpecInitContainersLivenessProbeGrpc grpc,
    ...
    public PodTemplateTemplateSpecInitContainersLivenessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final PodTemplateTemplateSpecInitContainersLivenessProbeGrpc grpc) {
        this.grpc = grpc;
    }
