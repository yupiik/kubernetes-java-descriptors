...
public class CertificateSigningRequestStatusConditions {
    ...
    private CertificateSigningRequestStatusConditionsType type;
    ...
    public CertificateSigningRequestStatusConditions(final String lastTransitionTime,
                                                     ...
                                                     final String reason,
                                                     final String status,
                                                     final CertificateSigningRequestStatusConditionsType type) {
        // no-op
    }
    ...
    public CertificateSigningRequestStatusConditionsType getType() {
        return type;
    }

    public void setType(final CertificateSigningRequestStatusConditionsType type) {
        this.type = type;
    }
