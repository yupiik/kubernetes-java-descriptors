...
public class EndpointSliceListItems {
    private EndpointSliceListItemsAddressType addressType;
    ...
    public EndpointSliceListItems(final EndpointSliceListItemsAddressType addressType,
    ...
    public EndpointSliceListItemsAddressType getAddressType() {
        return addressType;
    }

    public void setAddressType(final EndpointSliceListItemsAddressType addressType) {
