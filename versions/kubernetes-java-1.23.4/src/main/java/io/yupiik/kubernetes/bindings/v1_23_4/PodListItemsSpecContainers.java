...
public class PodListItemsSpecContainers {
    ...
    private PodListItemsSpecContainersImagePullPolicy imagePullPolicy;
    ...
    private PodListItemsSpecContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public PodListItemsSpecContainers(final List<String> args,
                                      ...
                                      final String image,
                                      final PodListItemsSpecContainersImagePullPolicy imagePullPolicy,
                                      ...
                                      final PodListItemsSpecContainersTerminationMessagePolicy terminationMessagePolicy,
                                      final Boolean tty,
    ...
    public PodListItemsSpecContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final PodListItemsSpecContainersImagePullPolicy imagePullPolicy) {
    ...
    public PodListItemsSpecContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final PodListItemsSpecContainersTerminationMessagePolicy terminationMessagePolicy) {
