...
public class DaemonSetListItemsSpecTemplateSpecEphemeralContainers {
    ...
    private DaemonSetListItemsSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy;
    ...
    private DaemonSetListItemsSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public DaemonSetListItemsSpecTemplateSpecEphemeralContainers(final List<String> args,
                                                                 ...
                                                                 final String image,
                                                                 final DaemonSetListItemsSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy,
                                                                 ...
                                                                 final DaemonSetListItemsSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy,
                                                                 final Boolean tty,
    ...
    public DaemonSetListItemsSpecTemplateSpecEphemeralContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final DaemonSetListItemsSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy) {
    ...
    public DaemonSetListItemsSpecTemplateSpecEphemeralContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final DaemonSetListItemsSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy) {
