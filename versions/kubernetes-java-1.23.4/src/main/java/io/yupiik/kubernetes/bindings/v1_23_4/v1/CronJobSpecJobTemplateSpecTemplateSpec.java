...
public class CronJobSpecJobTemplateSpecTemplateSpec {
    ...
    private CronJobSpecJobTemplateSpecTemplateSpecDnsPolicy dnsPolicy;
    private Boolean enableServiceLinks;
    private List<CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainers> ephemeralContainers;
    ...
    private CronJobSpecJobTemplateSpecTemplateSpecOs os;
    ...
    private CronJobSpecJobTemplateSpecTemplateSpecRestartPolicy restartPolicy;
    ...
    private List<CronJobSpecJobTemplateSpecTemplateSpecTopologySpreadConstraints> topologySpreadConstraints;
    ...
    public CronJobSpecJobTemplateSpecTemplateSpec(final Integer activeDeadlineSeconds,
                                                  ...
                                                  final CronJobSpecJobTemplateSpecTemplateSpecDnsPolicy dnsPolicy,
                                                  final Boolean enableServiceLinks,
                                                  final List<CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainers> ephemeralContainers,
                                                  ...
                                                  final CronJobSpecJobTemplateSpecTemplateSpecOs os,
                                                  ...
                                                  final CronJobSpecJobTemplateSpecTemplateSpecRestartPolicy restartPolicy,
                                                  ...
                                                  final List<CronJobSpecJobTemplateSpecTemplateSpecTopologySpreadConstraints> topologySpreadConstraints,
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecDnsPolicy getDnsPolicy() {
        return dnsPolicy;
    }

    public void setDnsPolicy(final CronJobSpecJobTemplateSpecTemplateSpecDnsPolicy dnsPolicy) {
    ...
    public List<CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainers> getEphemeralContainers() {
        return ephemeralContainers;
    }

    public void setEphemeralContainers(final List<CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainers> ephemeralContainers) {
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecOs getOs() {
        return os;
    }

    public void setOs(final CronJobSpecJobTemplateSpecTemplateSpecOs os) {
        this.os = os;
    }
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecRestartPolicy getRestartPolicy() {
        return restartPolicy;
    }

    public void setRestartPolicy(final CronJobSpecJobTemplateSpecTemplateSpecRestartPolicy restartPolicy) {
    ...
    public List<CronJobSpecJobTemplateSpecTemplateSpecTopologySpreadConstraints> getTopologySpreadConstraints() {
        return topologySpreadConstraints;
    }

    public void setTopologySpreadConstraints(final List<CronJobSpecJobTemplateSpecTemplateSpecTopologySpreadConstraints> topologySpreadConstraints) {
