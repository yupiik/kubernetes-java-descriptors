...
public class JobSpecTemplateSpecTopologySpreadConstraints {
    ...
    private JobSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable whenUnsatisfiable;
    ...
    public JobSpecTemplateSpecTopologySpreadConstraints(final JobSpecTemplateSpecTopologySpreadConstraintsLabelSelector labelSelector,
                                                        ...
                                                        final JobSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable whenUnsatisfiable) {
        // no-op
    }
    ...
    public JobSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable getWhenUnsatisfiable() {
        return whenUnsatisfiable;
    }

    public void setWhenUnsatisfiable(final JobSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable whenUnsatisfiable) {
