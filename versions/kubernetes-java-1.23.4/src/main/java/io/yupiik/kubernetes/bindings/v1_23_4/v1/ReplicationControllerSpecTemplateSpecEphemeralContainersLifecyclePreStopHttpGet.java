...
public class ReplicationControllerSpecTemplateSpecEphemeralContainersLifecyclePreStopHttpGet {
    ...
    private String path;
    private String port;
    private ReplicationControllerSpecTemplateSpecEphemeralContainersLifecyclePreStopHttpGetScheme scheme;
    ...
    public ReplicationControllerSpecTemplateSpecEphemeralContainersLifecyclePreStopHttpGet(final String host,
                                                                                           ...
                                                                                           final String path,
                                                                                           final String port,
                                                                                           final ReplicationControllerSpecTemplateSpecEphemeralContainersLifecyclePreStopHttpGetScheme scheme) {
        // no-op
    }
    ...
    public ReplicationControllerSpecTemplateSpecEphemeralContainersLifecyclePreStopHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final ReplicationControllerSpecTemplateSpecEphemeralContainersLifecyclePreStopHttpGetScheme scheme) {
        this.scheme = scheme;
    }
