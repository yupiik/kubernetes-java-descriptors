...
public class DeploymentSpecTemplateSpecInitContainersLivenessProbeHttpGet {
    ...
    private String path;
    private String port;
    private DeploymentSpecTemplateSpecInitContainersLivenessProbeHttpGetScheme scheme;
    ...
    public DeploymentSpecTemplateSpecInitContainersLivenessProbeHttpGet(final String host,
                                                                        ...
                                                                        final String path,
                                                                        final String port,
                                                                        final DeploymentSpecTemplateSpecInitContainersLivenessProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public DeploymentSpecTemplateSpecInitContainersLivenessProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final DeploymentSpecTemplateSpecInitContainersLivenessProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
