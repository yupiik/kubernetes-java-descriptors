...
public class DeploymentListItemsSpecTemplateSpecEphemeralContainersLivenessProbe {
    ...
    private DeploymentListItemsSpecTemplateSpecEphemeralContainersLivenessProbeGrpc grpc;
    ...
    public DeploymentListItemsSpecTemplateSpecEphemeralContainersLivenessProbe(final DeploymentListItemsSpecTemplateSpecEphemeralContainersLivenessProbeExec exec,
                                                                               ...
                                                                               final DeploymentListItemsSpecTemplateSpecEphemeralContainersLivenessProbeGrpc grpc,
    ...
    public DeploymentListItemsSpecTemplateSpecEphemeralContainersLivenessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final DeploymentListItemsSpecTemplateSpecEphemeralContainersLivenessProbeGrpc grpc) {
        this.grpc = grpc;
    }
