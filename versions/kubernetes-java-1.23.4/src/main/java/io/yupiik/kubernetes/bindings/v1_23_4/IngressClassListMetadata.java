...
public class IngressClassListMetadata {
    ...
    public IngressClassListMetadata() {
        // no-op
    }

    public IngressClassListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof IngressClassListMetadata)) {
            return false;
        }
        final IngressClassListMetadata __otherCasted = (IngressClassListMetadata) __other;
