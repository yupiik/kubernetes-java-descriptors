...
public class NodeListItemsStatusConditions {
    ...
    private NodeListItemsStatusConditionsType type;
    ...
    public NodeListItemsStatusConditions(final String lastHeartbeatTime,
                                         ...
                                         final String reason,
                                         final String status,
                                         final NodeListItemsStatusConditionsType type) {
        // no-op
    }
    ...
    public NodeListItemsStatusConditionsType getType() {
        return type;
    }

    public void setType(final NodeListItemsStatusConditionsType type) {
        this.type = type;
    }
