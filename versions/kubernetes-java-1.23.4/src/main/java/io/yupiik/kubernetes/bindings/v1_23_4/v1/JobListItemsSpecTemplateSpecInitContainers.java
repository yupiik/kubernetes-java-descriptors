...
public class JobListItemsSpecTemplateSpecInitContainers {
    ...
    private JobListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy;
    ...
    private JobListItemsSpecTemplateSpecInitContainersStartupProbe startupProbe;
    private Boolean stdin;
    private Boolean stdinOnce;
    private String terminationMessagePath;
    private JobListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public JobListItemsSpecTemplateSpecInitContainers(final List<String> args,
                                                      ...
                                                      final String image,
                                                      final JobListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy,
                                                      ...
                                                      final JobListItemsSpecTemplateSpecInitContainersStartupProbe startupProbe,
                                                      final Boolean stdin,
                                                      final Boolean stdinOnce,
                                                      final String terminationMessagePath,
                                                      final JobListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy,
                                                      final Boolean tty,
    ...
    public JobListItemsSpecTemplateSpecInitContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final JobListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy) {
    ...
    public JobListItemsSpecTemplateSpecInitContainersStartupProbe getStartupProbe() {
        return startupProbe;
    }

    public void setStartupProbe(final JobListItemsSpecTemplateSpecInitContainersStartupProbe startupProbe) {
    ...
    public JobListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final JobListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy) {
