...
public class StatefulSetSpecTemplateSpecEphemeralContainers {
    ...
    private StatefulSetSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy;
    ...
    private StatefulSetSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public StatefulSetSpecTemplateSpecEphemeralContainers(final List<String> args,
                                                          ...
                                                          final String image,
                                                          final StatefulSetSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy,
                                                          ...
                                                          final StatefulSetSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy,
                                                          final Boolean tty,
    ...
    public StatefulSetSpecTemplateSpecEphemeralContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final StatefulSetSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy) {
    ...
    public StatefulSetSpecTemplateSpecEphemeralContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final StatefulSetSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy) {
