...
public class PodSpecInitContainers {
    ...
    private PodSpecInitContainersImagePullPolicy imagePullPolicy;
    ...
    private PodSpecInitContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public PodSpecInitContainers(final List<String> args,
                                 ...
                                 final String image,
                                 final PodSpecInitContainersImagePullPolicy imagePullPolicy,
                                 ...
                                 final PodSpecInitContainersTerminationMessagePolicy terminationMessagePolicy,
                                 final Boolean tty,
    ...
    public PodSpecInitContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final PodSpecInitContainersImagePullPolicy imagePullPolicy) {
    ...
    public PodSpecInitContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final PodSpecInitContainersTerminationMessagePolicy terminationMessagePolicy) {
