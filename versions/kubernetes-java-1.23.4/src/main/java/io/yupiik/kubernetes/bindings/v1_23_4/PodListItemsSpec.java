...
public class PodListItemsSpec {
    ...
    private PodListItemsSpecDnsPolicy dnsPolicy;
    ...
    private PodListItemsSpecRestartPolicy restartPolicy;
    ...
    public PodListItemsSpec(final Integer activeDeadlineSeconds,
                            ...
                            final PodListItemsSpecDnsPolicy dnsPolicy,
                            ...
                            final PodListItemsSpecRestartPolicy restartPolicy,
    ...
    public PodListItemsSpecDnsPolicy getDnsPolicy() {
        return dnsPolicy;
    }

    public void setDnsPolicy(final PodListItemsSpecDnsPolicy dnsPolicy) {
    ...
    public PodListItemsSpecRestartPolicy getRestartPolicy() {
        return restartPolicy;
    }

    public void setRestartPolicy(final PodListItemsSpecRestartPolicy restartPolicy) {
