...
public class StatefulSetListItemsSpecTemplateSpecVolumesIscsi {
    ...
    private StatefulSetListItemsSpecTemplateSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public StatefulSetListItemsSpecTemplateSpecVolumesIscsi() {
        // no-op
    }

    public StatefulSetListItemsSpecTemplateSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                                            ...
                                                            final StatefulSetListItemsSpecTemplateSpecVolumesIscsiSecretRef secretRef,
    ...
    public StatefulSetListItemsSpecTemplateSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final StatefulSetListItemsSpecTemplateSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetListItemsSpecTemplateSpecVolumesIscsi)) {
            return false;
        }
        final StatefulSetListItemsSpecTemplateSpecVolumesIscsi __otherCasted = (StatefulSetListItemsSpecTemplateSpecVolumesIscsi) __other;
