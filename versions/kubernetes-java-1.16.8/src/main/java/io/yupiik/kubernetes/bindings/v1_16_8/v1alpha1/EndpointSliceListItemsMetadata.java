package io.yupiik.kubernetes.bindings.v1_16_8.v1alpha1;

import java.util.List;
import java.util.Map;
import java.util.Objects;

public class EndpointSliceListItemsMetadata {
    ...
    private List<EndpointSliceListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<EndpointSliceListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public EndpointSliceListItemsMetadata() {
        // no-op
    }

    public EndpointSliceListItemsMetadata(final Map<String, String> annotations,
                                          ...
                                          final List<EndpointSliceListItemsMetadataManagedFields> managedFields,
                                          final String name,
                                          final String namespace,
                                          final List<EndpointSliceListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public List<EndpointSliceListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<EndpointSliceListItemsMetadataManagedFields> managedFields) {
    ...
    public List<EndpointSliceListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<EndpointSliceListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EndpointSliceListItemsMetadata)) {
            return false;
        }
        final EndpointSliceListItemsMetadata __otherCasted = (EndpointSliceListItemsMetadata) __other;
