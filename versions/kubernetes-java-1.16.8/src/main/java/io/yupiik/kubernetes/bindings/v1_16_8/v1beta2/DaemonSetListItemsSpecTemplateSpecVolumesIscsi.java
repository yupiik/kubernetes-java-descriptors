...
public class DaemonSetListItemsSpecTemplateSpecVolumesIscsi {
    ...
    private DaemonSetListItemsSpecTemplateSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public DaemonSetListItemsSpecTemplateSpecVolumesIscsi() {
        // no-op
    }

    public DaemonSetListItemsSpecTemplateSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                                          ...
                                                          final DaemonSetListItemsSpecTemplateSpecVolumesIscsiSecretRef secretRef,
    ...
    public DaemonSetListItemsSpecTemplateSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final DaemonSetListItemsSpecTemplateSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetListItemsSpecTemplateSpecVolumesIscsi)) {
            return false;
        }
        final DaemonSetListItemsSpecTemplateSpecVolumesIscsi __otherCasted = (DaemonSetListItemsSpecTemplateSpecVolumesIscsi) __other;
