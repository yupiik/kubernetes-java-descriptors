...
public class ReplicaSetSpecTemplateSpecInitContainersVolumeMounts {
    ...
    public ReplicaSetSpecTemplateSpecInitContainersVolumeMounts() {
        // no-op
    }

    public ReplicaSetSpecTemplateSpecInitContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicaSetSpecTemplateSpecInitContainersVolumeMounts)) {
            return false;
        }
        final ReplicaSetSpecTemplateSpecInitContainersVolumeMounts __otherCasted = (ReplicaSetSpecTemplateSpecInitContainersVolumeMounts) __other;
