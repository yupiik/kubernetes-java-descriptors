...
public class DeploymentSpecTemplateSpecContainersVolumeMounts {
    ...
    public DeploymentSpecTemplateSpecContainersVolumeMounts() {
        // no-op
    }

    public DeploymentSpecTemplateSpecContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentSpecTemplateSpecContainersVolumeMounts)) {
            return false;
        }
        final DeploymentSpecTemplateSpecContainersVolumeMounts __otherCasted = (DeploymentSpecTemplateSpecContainersVolumeMounts) __other;
