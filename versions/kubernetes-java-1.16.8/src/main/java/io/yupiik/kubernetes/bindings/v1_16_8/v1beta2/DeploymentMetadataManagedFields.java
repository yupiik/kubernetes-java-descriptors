...
public class DeploymentMetadataManagedFields {
    ...
    public DeploymentMetadataManagedFields() {
        // no-op
    }

    public DeploymentMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentMetadataManagedFields)) {
            return false;
        }
        final DeploymentMetadataManagedFields __otherCasted = (DeploymentMetadataManagedFields) __other;
