...
public class PodPresetSpecVolumesIscsi {
    ...
    private PodPresetSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public PodPresetSpecVolumesIscsi() {
        // no-op
    }

    public PodPresetSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                     ...
                                     final PodPresetSpecVolumesIscsiSecretRef secretRef,
    ...
    public PodPresetSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final PodPresetSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodPresetSpecVolumesIscsi)) {
            return false;
        }
        final PodPresetSpecVolumesIscsi __otherCasted = (PodPresetSpecVolumesIscsi) __other;
