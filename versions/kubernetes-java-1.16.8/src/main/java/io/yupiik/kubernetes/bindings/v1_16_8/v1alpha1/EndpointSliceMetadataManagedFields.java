...
public class EndpointSliceMetadataManagedFields {
    ...
    public EndpointSliceMetadataManagedFields() {
        // no-op
    }

    public EndpointSliceMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EndpointSliceMetadataManagedFields)) {
            return false;
        }
        final EndpointSliceMetadataManagedFields __otherCasted = (EndpointSliceMetadataManagedFields) __other;
