...
public class ReplicaSetSpecTemplateSpecDnsConfig {
    ...
    private List<ReplicaSetSpecTemplateSpecDnsConfigOptions> options;
    ...
    public ReplicaSetSpecTemplateSpecDnsConfig(final List<String> nameservers,
                                               final List<ReplicaSetSpecTemplateSpecDnsConfigOptions> options,
    ...
    public List<ReplicaSetSpecTemplateSpecDnsConfigOptions> getOptions() {
        return options;
    }

    public void setOptions(final List<ReplicaSetSpecTemplateSpecDnsConfigOptions> options) {
