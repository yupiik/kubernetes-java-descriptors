...
public class PodTemplateTemplateSpecVolumesVsphereVolume {
    private String fsType;
    private String storagePolicyID;
    private String storagePolicyName;
    private String volumePath;

    public PodTemplateTemplateSpecVolumesVsphereVolume() {
        // no-op
    }

    public PodTemplateTemplateSpecVolumesVsphereVolume(final String fsType,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateTemplateSpecVolumesVsphereVolume)) {
            return false;
        }
        final PodTemplateTemplateSpecVolumesVsphereVolume __otherCasted = (PodTemplateTemplateSpecVolumesVsphereVolume) __other;
