...
public class StatefulSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts {
    ...
    public StatefulSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts() {
        // no-op
    }

    public StatefulSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts)) {
            return false;
        }
        final StatefulSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts __otherCasted = (StatefulSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts) __other;
