...
public class PersistentVolumeListItemsMetadataManagedFields {
    ...
    public PersistentVolumeListItemsMetadataManagedFields() {
        // no-op
    }

    public PersistentVolumeListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PersistentVolumeListItemsMetadataManagedFields)) {
            return false;
        }
        final PersistentVolumeListItemsMetadataManagedFields __otherCasted = (PersistentVolumeListItemsMetadataManagedFields) __other;
