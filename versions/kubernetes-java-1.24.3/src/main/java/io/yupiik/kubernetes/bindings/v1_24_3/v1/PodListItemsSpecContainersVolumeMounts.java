...
public class PodListItemsSpecContainersVolumeMounts {
    ...
    public PodListItemsSpecContainersVolumeMounts() {
        // no-op
    }

    public PodListItemsSpecContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodListItemsSpecContainersVolumeMounts)) {
            return false;
        }
        final PodListItemsSpecContainersVolumeMounts __otherCasted = (PodListItemsSpecContainersVolumeMounts) __other;
