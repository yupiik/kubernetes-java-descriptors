...
public class ScaleMetadataManagedFields {
    ...
    public ScaleMetadataManagedFields() {
        // no-op
    }

    public ScaleMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ScaleMetadataManagedFields)) {
            return false;
        }
        final ScaleMetadataManagedFields __otherCasted = (ScaleMetadataManagedFields) __other;
