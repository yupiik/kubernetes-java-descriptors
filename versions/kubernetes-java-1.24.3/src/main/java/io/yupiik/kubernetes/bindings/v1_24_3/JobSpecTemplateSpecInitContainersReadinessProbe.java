...
public class JobSpecTemplateSpecInitContainersReadinessProbe {
    ...
    private JobSpecTemplateSpecInitContainersReadinessProbeGrpc grpc;
    ...
    public JobSpecTemplateSpecInitContainersReadinessProbe(final JobSpecTemplateSpecInitContainersReadinessProbeExec exec,
                                                           ...
                                                           final JobSpecTemplateSpecInitContainersReadinessProbeGrpc grpc,
    ...
    public JobSpecTemplateSpecInitContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final JobSpecTemplateSpecInitContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
