...
public class StatefulSetSpecTemplateSpecContainersLivenessProbe {
    ...
    private StatefulSetSpecTemplateSpecContainersLivenessProbeGrpc grpc;
    ...
    public StatefulSetSpecTemplateSpecContainersLivenessProbe(final StatefulSetSpecTemplateSpecContainersLivenessProbeExec exec,
                                                              ...
                                                              final StatefulSetSpecTemplateSpecContainersLivenessProbeGrpc grpc,
    ...
    public StatefulSetSpecTemplateSpecContainersLivenessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final StatefulSetSpecTemplateSpecContainersLivenessProbeGrpc grpc) {
        this.grpc = grpc;
    }
