...
public class JobMetadataManagedFields {
    ...
    public JobMetadataManagedFields() {
        // no-op
    }

    public JobMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobMetadataManagedFields)) {
            return false;
        }
        final JobMetadataManagedFields __otherCasted = (JobMetadataManagedFields) __other;
