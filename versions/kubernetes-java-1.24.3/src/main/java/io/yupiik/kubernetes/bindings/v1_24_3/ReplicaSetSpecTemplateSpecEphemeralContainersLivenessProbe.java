...
public class ReplicaSetSpecTemplateSpecEphemeralContainersLivenessProbe {
    ...
    private ReplicaSetSpecTemplateSpecEphemeralContainersLivenessProbeGrpc grpc;
    ...
    public ReplicaSetSpecTemplateSpecEphemeralContainersLivenessProbe(final ReplicaSetSpecTemplateSpecEphemeralContainersLivenessProbeExec exec,
                                                                      ...
                                                                      final ReplicaSetSpecTemplateSpecEphemeralContainersLivenessProbeGrpc grpc,
    ...
    public ReplicaSetSpecTemplateSpecEphemeralContainersLivenessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final ReplicaSetSpecTemplateSpecEphemeralContainersLivenessProbeGrpc grpc) {
        this.grpc = grpc;
    }
