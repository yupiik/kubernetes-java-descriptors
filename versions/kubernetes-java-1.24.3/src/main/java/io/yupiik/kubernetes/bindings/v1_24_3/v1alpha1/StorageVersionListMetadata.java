...
public class StorageVersionListMetadata {
    ...
    public StorageVersionListMetadata() {
        // no-op
    }

    public StorageVersionListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StorageVersionListMetadata)) {
            return false;
        }
        final StorageVersionListMetadata __otherCasted = (StorageVersionListMetadata) __other;
