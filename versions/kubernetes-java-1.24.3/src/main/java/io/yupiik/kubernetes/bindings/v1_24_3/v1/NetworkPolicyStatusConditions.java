...
public class NetworkPolicyStatusConditions {
    ...
    public NetworkPolicyStatusConditions() {
        // no-op
    }

    public NetworkPolicyStatusConditions(final String lastTransitionTime,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NetworkPolicyStatusConditions)) {
            return false;
        }
        final NetworkPolicyStatusConditions __otherCasted = (NetworkPolicyStatusConditions) __other;
