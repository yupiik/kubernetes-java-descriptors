...
public class ControllerRevisionListItemsMetadata {
    ...
    private ControllerRevisionListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ControllerRevisionListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ControllerRevisionListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ControllerRevisionListItemsMetadata() {
        // no-op
    }

    public ControllerRevisionListItemsMetadata(final Map<String, String> annotations,
                                               ...
                                               final ControllerRevisionListItemsMetadataInitializers initializers,
                                               final Map<String, String> labels,
                                               final List<ControllerRevisionListItemsMetadataManagedFields> managedFields,
                                               final String name,
                                               final String namespace,
                                               final List<ControllerRevisionListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public ControllerRevisionListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ControllerRevisionListItemsMetadataInitializers initializers) {
    ...
    public List<ControllerRevisionListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ControllerRevisionListItemsMetadataManagedFields> managedFields) {
    ...
    public List<ControllerRevisionListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ControllerRevisionListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ControllerRevisionListItemsMetadata)) {
            return false;
        }
        final ControllerRevisionListItemsMetadata __otherCasted = (ControllerRevisionListItemsMetadata) __other;
