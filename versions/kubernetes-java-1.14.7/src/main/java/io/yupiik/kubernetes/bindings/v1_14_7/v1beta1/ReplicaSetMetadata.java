...
public class ReplicaSetMetadata {
    ...
    private ReplicaSetMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ReplicaSetMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ReplicaSetMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ReplicaSetMetadata() {
        // no-op
    }

    public ReplicaSetMetadata(final Map<String, String> annotations,
                              ...
                              final ReplicaSetMetadataInitializers initializers,
                              final Map<String, String> labels,
                              final List<ReplicaSetMetadataManagedFields> managedFields,
                              final String name,
                              final String namespace,
                              final List<ReplicaSetMetadataOwnerReferences> ownerReferences,
    ...
    public ReplicaSetMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ReplicaSetMetadataInitializers initializers) {
    ...
    public List<ReplicaSetMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ReplicaSetMetadataManagedFields> managedFields) {
    ...
    public List<ReplicaSetMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ReplicaSetMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicaSetMetadata)) {
            return false;
        }
        final ReplicaSetMetadata __otherCasted = (ReplicaSetMetadata) __other;
