...
public class ComponentStatusMetadata {
    ...
    private ComponentStatusMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ComponentStatusMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ComponentStatusMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ComponentStatusMetadata() {
        // no-op
    }

    public ComponentStatusMetadata(final Map<String, String> annotations,
                                   ...
                                   final ComponentStatusMetadataInitializers initializers,
                                   final Map<String, String> labels,
                                   final List<ComponentStatusMetadataManagedFields> managedFields,
                                   final String name,
                                   final String namespace,
                                   final List<ComponentStatusMetadataOwnerReferences> ownerReferences,
    ...
    public ComponentStatusMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ComponentStatusMetadataInitializers initializers) {
    ...
    public List<ComponentStatusMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ComponentStatusMetadataManagedFields> managedFields) {
    ...
    public List<ComponentStatusMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ComponentStatusMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ComponentStatusMetadata)) {
            return false;
        }
        final ComponentStatusMetadata __otherCasted = (ComponentStatusMetadata) __other;
