...
public class DeploymentSpecTemplateMetadataInitializersResultDetails {
    private List<DeploymentSpecTemplateMetadataInitializersResultDetailsCauses> causes;
    ...
    public DeploymentSpecTemplateMetadataInitializersResultDetails(final List<DeploymentSpecTemplateMetadataInitializersResultDetailsCauses> causes,
                                                                   final String group,
                                                                   final String kind,
                                                                   final String name,
    ...
    public List<DeploymentSpecTemplateMetadataInitializersResultDetailsCauses> getCauses() {
        return causes;
    }

    public void setCauses(final List<DeploymentSpecTemplateMetadataInitializersResultDetailsCauses> causes) {
        this.causes = causes;
    }
