...
public class RoleListItemsMetadata {
    ...
    private RoleListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<RoleListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<RoleListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public RoleListItemsMetadata() {
        // no-op
    }

    public RoleListItemsMetadata(final Map<String, String> annotations,
                                 ...
                                 final RoleListItemsMetadataInitializers initializers,
                                 final Map<String, String> labels,
                                 final List<RoleListItemsMetadataManagedFields> managedFields,
                                 final String name,
                                 final String namespace,
                                 final List<RoleListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public RoleListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final RoleListItemsMetadataInitializers initializers) {
    ...
    public List<RoleListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<RoleListItemsMetadataManagedFields> managedFields) {
    ...
    public List<RoleListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<RoleListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RoleListItemsMetadata)) {
            return false;
        }
        final RoleListItemsMetadata __otherCasted = (RoleListItemsMetadata) __other;
