...
public class DaemonSetSpecTemplateMetadata {
    ...
    private DaemonSetSpecTemplateMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<DaemonSetSpecTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<DaemonSetSpecTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public DaemonSetSpecTemplateMetadata() {
        // no-op
    }

    public DaemonSetSpecTemplateMetadata(final Map<String, String> annotations,
                                         ...
                                         final DaemonSetSpecTemplateMetadataInitializers initializers,
                                         final Map<String, String> labels,
                                         final List<DaemonSetSpecTemplateMetadataManagedFields> managedFields,
                                         final String name,
                                         final String namespace,
                                         final List<DaemonSetSpecTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public DaemonSetSpecTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final DaemonSetSpecTemplateMetadataInitializers initializers) {
    ...
    public List<DaemonSetSpecTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<DaemonSetSpecTemplateMetadataManagedFields> managedFields) {
    ...
    public List<DaemonSetSpecTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<DaemonSetSpecTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetSpecTemplateMetadata)) {
            return false;
        }
        final DaemonSetSpecTemplateMetadata __otherCasted = (DaemonSetSpecTemplateMetadata) __other;
