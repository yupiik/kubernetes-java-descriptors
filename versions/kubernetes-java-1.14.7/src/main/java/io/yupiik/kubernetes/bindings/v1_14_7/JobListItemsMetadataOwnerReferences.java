...
public class JobListItemsMetadataOwnerReferences {
    ...
    public JobListItemsMetadataOwnerReferences() {
        // no-op
    }

    public JobListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobListItemsMetadataOwnerReferences)) {
            return false;
        }
        final JobListItemsMetadataOwnerReferences __otherCasted = (JobListItemsMetadataOwnerReferences) __other;
