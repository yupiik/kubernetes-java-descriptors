...
public class CustomResourceDefinitionMetadata {
    ...
    private CustomResourceDefinitionMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<CustomResourceDefinitionMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<CustomResourceDefinitionMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public CustomResourceDefinitionMetadata() {
        // no-op
    }

    public CustomResourceDefinitionMetadata(final Map<String, String> annotations,
                                            ...
                                            final CustomResourceDefinitionMetadataInitializers initializers,
                                            final Map<String, String> labels,
                                            final List<CustomResourceDefinitionMetadataManagedFields> managedFields,
                                            final String name,
                                            final String namespace,
                                            final List<CustomResourceDefinitionMetadataOwnerReferences> ownerReferences,
    ...
    public CustomResourceDefinitionMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final CustomResourceDefinitionMetadataInitializers initializers) {
    ...
    public List<CustomResourceDefinitionMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<CustomResourceDefinitionMetadataManagedFields> managedFields) {
    ...
    public List<CustomResourceDefinitionMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<CustomResourceDefinitionMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CustomResourceDefinitionMetadata)) {
            return false;
        }
        final CustomResourceDefinitionMetadata __otherCasted = (CustomResourceDefinitionMetadata) __other;
