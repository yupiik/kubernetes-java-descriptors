...
public class EndpointsMetadataOwnerReferences {
    ...
    public EndpointsMetadataOwnerReferences() {
        // no-op
    }

    public EndpointsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EndpointsMetadataOwnerReferences)) {
            return false;
        }
        final EndpointsMetadataOwnerReferences __otherCasted = (EndpointsMetadataOwnerReferences) __other;
