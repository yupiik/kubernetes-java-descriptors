...
public class SecretListItemsMetadata {
    ...
    private SecretListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<SecretListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<SecretListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public SecretListItemsMetadata() {
        // no-op
    }

    public SecretListItemsMetadata(final Map<String, String> annotations,
                                   ...
                                   final SecretListItemsMetadataInitializers initializers,
                                   final Map<String, String> labels,
                                   final List<SecretListItemsMetadataManagedFields> managedFields,
                                   final String name,
                                   final String namespace,
                                   final List<SecretListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public SecretListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final SecretListItemsMetadataInitializers initializers) {
    ...
    public List<SecretListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<SecretListItemsMetadataManagedFields> managedFields) {
    ...
    public List<SecretListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<SecretListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof SecretListItemsMetadata)) {
            return false;
        }
        final SecretListItemsMetadata __otherCasted = (SecretListItemsMetadata) __other;
