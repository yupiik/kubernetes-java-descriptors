...
public class PodPresetMetadataManagedFields {
    ...
    public PodPresetMetadataManagedFields() {
        // no-op
    }

    public PodPresetMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodPresetMetadataManagedFields)) {
            return false;
        }
        final PodPresetMetadataManagedFields __otherCasted = (PodPresetMetadataManagedFields) __other;
