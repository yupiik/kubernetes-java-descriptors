...
public class CronJobListItemsMetadataManagedFields {
    ...
    public CronJobListItemsMetadataManagedFields() {
        // no-op
    }

    public CronJobListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CronJobListItemsMetadataManagedFields)) {
            return false;
        }
        final CronJobListItemsMetadataManagedFields __otherCasted = (CronJobListItemsMetadataManagedFields) __other;
