...
public class FlowSchemaMetadataManagedFields {
    ...
    public FlowSchemaMetadataManagedFields() {
        // no-op
    }

    public FlowSchemaMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof FlowSchemaMetadataManagedFields)) {
            return false;
        }
        final FlowSchemaMetadataManagedFields __otherCasted = (FlowSchemaMetadataManagedFields) __other;
