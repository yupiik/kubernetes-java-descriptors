...
public class PodTemplateTemplateSpecContainersSecurityContext {
    ...
    private PodTemplateTemplateSpecContainersSecurityContextSeccompProfile seccompProfile;
    private PodTemplateTemplateSpecContainersSecurityContextWindowsOptions windowsOptions;
    ...
    public PodTemplateTemplateSpecContainersSecurityContext(final Boolean allowPrivilegeEscalation,
                                                            ...
                                                            final PodTemplateTemplateSpecContainersSecurityContextSeccompProfile seccompProfile,
                                                            final PodTemplateTemplateSpecContainersSecurityContextWindowsOptions windowsOptions) {
        // no-op
    }
    ...
    public PodTemplateTemplateSpecContainersSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final PodTemplateTemplateSpecContainersSecurityContextSeccompProfile seccompProfile) {
        this.seccompProfile = seccompProfile;
    }

    public PodTemplateTemplateSpecContainersSecurityContextWindowsOptions getWindowsOptions() {
        return windowsOptions;
    }

    public void setWindowsOptions(final PodTemplateTemplateSpecContainersSecurityContextWindowsOptions windowsOptions) {
