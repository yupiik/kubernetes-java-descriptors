...
public class NodeMetadataOwnerReferences {
    ...
    public NodeMetadataOwnerReferences() {
        // no-op
    }

    public NodeMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NodeMetadataOwnerReferences)) {
            return false;
        }
        final NodeMetadataOwnerReferences __otherCasted = (NodeMetadataOwnerReferences) __other;
