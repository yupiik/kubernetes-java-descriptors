...
public class TokenReviewMetadataOwnerReferences {
    ...
    public TokenReviewMetadataOwnerReferences() {
        // no-op
    }

    public TokenReviewMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof TokenReviewMetadataOwnerReferences)) {
            return false;
        }
        final TokenReviewMetadataOwnerReferences __otherCasted = (TokenReviewMetadataOwnerReferences) __other;
