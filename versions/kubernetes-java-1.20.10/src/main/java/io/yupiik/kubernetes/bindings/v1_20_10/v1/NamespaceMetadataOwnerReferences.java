...
public class NamespaceMetadataOwnerReferences {
    ...
    public NamespaceMetadataOwnerReferences() {
        // no-op
    }

    public NamespaceMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NamespaceMetadataOwnerReferences)) {
            return false;
        }
        final NamespaceMetadataOwnerReferences __otherCasted = (NamespaceMetadataOwnerReferences) __other;
