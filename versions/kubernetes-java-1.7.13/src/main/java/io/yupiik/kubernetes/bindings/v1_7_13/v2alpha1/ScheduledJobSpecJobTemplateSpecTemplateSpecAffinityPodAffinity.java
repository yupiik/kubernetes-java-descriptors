...
public class ScheduledJobSpecJobTemplateSpecTemplateSpecAffinityPodAffinity {
    ...
    public ScheduledJobSpecJobTemplateSpecTemplateSpecAffinityPodAffinity() {
        // no-op
    }

    public ScheduledJobSpecJobTemplateSpecTemplateSpecAffinityPodAffinity(final List<JsonValue> preferredDuringSchedulingIgnoredDuringExecution,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ScheduledJobSpecJobTemplateSpecTemplateSpecAffinityPodAffinity)) {
            return false;
        }
        final ScheduledJobSpecJobTemplateSpecTemplateSpecAffinityPodAffinity __otherCasted = (ScheduledJobSpecJobTemplateSpecTemplateSpecAffinityPodAffinity) __other;
