...
public class JobListItemsSpecTemplateSpec {
    ...
    private JobListItemsSpecTemplateSpecDnsPolicy dnsPolicy;
    ...
    private JobListItemsSpecTemplateSpecRestartPolicy restartPolicy;
    ...
    public JobListItemsSpecTemplateSpec(final Integer activeDeadlineSeconds,
                                        ...
                                        final JobListItemsSpecTemplateSpecDnsPolicy dnsPolicy,
                                        ...
                                        final JobListItemsSpecTemplateSpecRestartPolicy restartPolicy,
    ...
    public JobListItemsSpecTemplateSpecDnsPolicy getDnsPolicy() {
        return dnsPolicy;
    }

    public void setDnsPolicy(final JobListItemsSpecTemplateSpecDnsPolicy dnsPolicy) {
    ...
    public JobListItemsSpecTemplateSpecRestartPolicy getRestartPolicy() {
        return restartPolicy;
    }

    public void setRestartPolicy(final JobListItemsSpecTemplateSpecRestartPolicy restartPolicy) {
