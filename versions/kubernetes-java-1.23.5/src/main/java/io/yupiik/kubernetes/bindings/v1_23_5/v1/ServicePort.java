...
public class ServicePort implements Validable<ServicePort>, Exportable {
    ...
    public ServicePort(final String appProtocol,
                       ...
                       final int port,
                       final ServicePortProtocol protocol,
    ...
    public void setProtocol(final ServicePortProtocol protocol) {
        this.protocol = protocol;
    }
    ...
    public ServicePort protocol(final ServicePortProtocol protocol) {
        this.protocol = protocol;
        return this;
    }
