...
public class DaemonSetSpecTemplateSpecInitContainersLivenessProbe {
    ...
    private DaemonSetSpecTemplateSpecInitContainersLivenessProbeGrpc grpc;
    ...
    public DaemonSetSpecTemplateSpecInitContainersLivenessProbe(final DaemonSetSpecTemplateSpecInitContainersLivenessProbeExec exec,
                                                                ...
                                                                final DaemonSetSpecTemplateSpecInitContainersLivenessProbeGrpc grpc,
    ...
    public DaemonSetSpecTemplateSpecInitContainersLivenessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final DaemonSetSpecTemplateSpecInitContainersLivenessProbeGrpc grpc) {
        this.grpc = grpc;
    }
