...
public class DeploymentListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGet {
    ...
    private String path;
    private String port;
    private DeploymentListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme scheme;
    ...
    public DeploymentListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGet(final String host,
                                                                                      ...
                                                                                      final String path,
                                                                                      final String port,
                                                                                      final DeploymentListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme scheme) {
        // no-op
    }
    ...
    public DeploymentListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final DeploymentListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme scheme) {
        this.scheme = scheme;
    }
