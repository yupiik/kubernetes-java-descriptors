...
public class PodStatusConditions {
    ...
    private PodStatusConditionsType type;
    ...
    public PodStatusConditions(final String lastProbeTime,
                               ...
                               final String reason,
                               final String status,
                               final PodStatusConditionsType type) {
        // no-op
    }
    ...
    public PodStatusConditionsType getType() {
        return type;
    }

    public void setType(final PodStatusConditionsType type) {
        this.type = type;
    }
