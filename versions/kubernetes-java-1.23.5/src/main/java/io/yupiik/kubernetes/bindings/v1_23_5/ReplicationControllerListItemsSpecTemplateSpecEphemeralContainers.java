...
public class ReplicationControllerListItemsSpecTemplateSpecEphemeralContainers {
    ...
    private ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy;
    ...
    private ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public ReplicationControllerListItemsSpecTemplateSpecEphemeralContainers(final List<String> args,
                                                                             ...
                                                                             final String image,
                                                                             final ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy,
                                                                             ...
                                                                             final ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy,
                                                                             final Boolean tty,
    ...
    public ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy) {
    ...
    public ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy) {
