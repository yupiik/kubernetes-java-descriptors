...
public class JobListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGet {
    ...
    private String path;
    private String port;
    private JobListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme scheme;
    ...
    public JobListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGet(final String host,
                                                                               ...
                                                                               final String path,
                                                                               final String port,
                                                                               final JobListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme scheme) {
        // no-op
    }
    ...
    public JobListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final JobListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme scheme) {
        this.scheme = scheme;
    }
