...
public class ReplicationControllerListItemsSpecTemplateSpec {
    ...
    private ReplicationControllerListItemsSpecTemplateSpecDnsPolicy dnsPolicy;
    ...
    private ReplicationControllerListItemsSpecTemplateSpecOs os;
    ...
    private ReplicationControllerListItemsSpecTemplateSpecRestartPolicy restartPolicy;
    ...
    public ReplicationControllerListItemsSpecTemplateSpec(final Integer activeDeadlineSeconds,
                                                          ...
                                                          final ReplicationControllerListItemsSpecTemplateSpecDnsPolicy dnsPolicy,
                                                          ...
                                                          final ReplicationControllerListItemsSpecTemplateSpecOs os,
                                                          ...
                                                          final ReplicationControllerListItemsSpecTemplateSpecRestartPolicy restartPolicy,
    ...
    public ReplicationControllerListItemsSpecTemplateSpecDnsPolicy getDnsPolicy() {
        return dnsPolicy;
    }

    public void setDnsPolicy(final ReplicationControllerListItemsSpecTemplateSpecDnsPolicy dnsPolicy) {
    ...
    public ReplicationControllerListItemsSpecTemplateSpecOs getOs() {
        return os;
    }

    public void setOs(final ReplicationControllerListItemsSpecTemplateSpecOs os) {
        this.os = os;
    }
    ...
    public ReplicationControllerListItemsSpecTemplateSpecRestartPolicy getRestartPolicy() {
        return restartPolicy;
    }

    public void setRestartPolicy(final ReplicationControllerListItemsSpecTemplateSpecRestartPolicy restartPolicy) {
