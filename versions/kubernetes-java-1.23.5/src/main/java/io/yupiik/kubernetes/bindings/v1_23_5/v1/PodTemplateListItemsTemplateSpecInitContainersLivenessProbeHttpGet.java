...
public class PodTemplateListItemsTemplateSpecInitContainersLivenessProbeHttpGet {
    ...
    private String path;
    private String port;
    private PodTemplateListItemsTemplateSpecInitContainersLivenessProbeHttpGetScheme scheme;
    ...
    public PodTemplateListItemsTemplateSpecInitContainersLivenessProbeHttpGet(final String host,
                                                                              ...
                                                                              final String path,
                                                                              final String port,
                                                                              final PodTemplateListItemsTemplateSpecInitContainersLivenessProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public PodTemplateListItemsTemplateSpecInitContainersLivenessProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final PodTemplateListItemsTemplateSpecInitContainersLivenessProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
