...
public class ReplicaSetListItemsSpecTemplateSpecInitContainersReadinessProbe {
    ...
    private ReplicaSetListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc grpc;
    ...
    public ReplicaSetListItemsSpecTemplateSpecInitContainersReadinessProbe(final ReplicaSetListItemsSpecTemplateSpecInitContainersReadinessProbeExec exec,
                                                                           ...
                                                                           final ReplicaSetListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc grpc,
    ...
    public ReplicaSetListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final ReplicaSetListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
