...
public class PersistentVolumeListItemsStatus {
    ...
    private PersistentVolumeListItemsStatusPhase phase;
    ...
    public PersistentVolumeListItemsStatus(final String message,
                                           final PersistentVolumeListItemsStatusPhase phase,
                                           final String reason) {
        // no-op
    }
    ...
    public PersistentVolumeListItemsStatusPhase getPhase() {
        return phase;
    }

    public void setPhase(final PersistentVolumeListItemsStatusPhase phase) {
        this.phase = phase;
    }
