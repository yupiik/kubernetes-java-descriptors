...
public class StatefulSetListItemsSpecTemplateSpecInitContainers {
    ...
    private StatefulSetListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy;
    ...
    private StatefulSetListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public StatefulSetListItemsSpecTemplateSpecInitContainers(final List<String> args,
                                                              ...
                                                              final String image,
                                                              final StatefulSetListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy,
                                                              ...
                                                              final StatefulSetListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy,
                                                              final Boolean tty,
    ...
    public StatefulSetListItemsSpecTemplateSpecInitContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final StatefulSetListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy) {
    ...
    public StatefulSetListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final StatefulSetListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy) {
