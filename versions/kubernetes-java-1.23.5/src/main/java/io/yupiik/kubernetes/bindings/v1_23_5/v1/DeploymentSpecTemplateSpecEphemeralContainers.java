...
public class DeploymentSpecTemplateSpecEphemeralContainers {
    ...
    private DeploymentSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy;
    ...
    private DeploymentSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public DeploymentSpecTemplateSpecEphemeralContainers(final List<String> args,
                                                         ...
                                                         final String image,
                                                         final DeploymentSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy,
                                                         ...
                                                         final DeploymentSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy,
                                                         final Boolean tty,
    ...
    public DeploymentSpecTemplateSpecEphemeralContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final DeploymentSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy) {
    ...
    public DeploymentSpecTemplateSpecEphemeralContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final DeploymentSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy) {
