...
public class PodTemplateListItemsTemplateSpecVolumesEphemeralVolumeClaimTemplateSpec {
    ...
    private PodTemplateListItemsTemplateSpecVolumesEphemeralVolumeClaimTemplateSpecDataSourceRef dataSourceRef;
    ...
    public PodTemplateListItemsTemplateSpecVolumesEphemeralVolumeClaimTemplateSpec(final List<String> accessModes,
                                                                                   ...
                                                                                   final PodTemplateListItemsTemplateSpecVolumesEphemeralVolumeClaimTemplateSpecDataSourceRef dataSourceRef,
    ...
    public PodTemplateListItemsTemplateSpecVolumesEphemeralVolumeClaimTemplateSpecDataSourceRef getDataSourceRef() {
        return dataSourceRef;
    }

    public void setDataSourceRef(final PodTemplateListItemsTemplateSpecVolumesEphemeralVolumeClaimTemplateSpecDataSourceRef dataSourceRef) {
