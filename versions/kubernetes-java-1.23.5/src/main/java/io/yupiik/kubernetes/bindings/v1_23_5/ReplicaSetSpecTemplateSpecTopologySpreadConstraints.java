...
public class ReplicaSetSpecTemplateSpecTopologySpreadConstraints {
    ...
    private ReplicaSetSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable whenUnsatisfiable;
    ...
    public ReplicaSetSpecTemplateSpecTopologySpreadConstraints(final ReplicaSetSpecTemplateSpecTopologySpreadConstraintsLabelSelector labelSelector,
                                                               ...
                                                               final ReplicaSetSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable whenUnsatisfiable) {
        // no-op
    }
    ...
    public ReplicaSetSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable getWhenUnsatisfiable() {
        return whenUnsatisfiable;
    }

    public void setWhenUnsatisfiable(final ReplicaSetSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable whenUnsatisfiable) {
