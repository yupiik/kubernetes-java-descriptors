...
public class CronJobListItemsSpecJobTemplateSpecTemplateSpecContainers {
    ...
    private CronJobListItemsSpecJobTemplateSpecTemplateSpecContainersImagePullPolicy imagePullPolicy;
    ...
    private CronJobListItemsSpecJobTemplateSpecTemplateSpecContainersStartupProbe startupProbe;
    private Boolean stdin;
    private Boolean stdinOnce;
    private String terminationMessagePath;
    private CronJobListItemsSpecJobTemplateSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public CronJobListItemsSpecJobTemplateSpecTemplateSpecContainers(final List<String> args,
                                                                     ...
                                                                     final String image,
                                                                     final CronJobListItemsSpecJobTemplateSpecTemplateSpecContainersImagePullPolicy imagePullPolicy,
                                                                     ...
                                                                     final CronJobListItemsSpecJobTemplateSpecTemplateSpecContainersStartupProbe startupProbe,
                                                                     final Boolean stdin,
                                                                     final Boolean stdinOnce,
                                                                     final String terminationMessagePath,
                                                                     final CronJobListItemsSpecJobTemplateSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy,
                                                                     final Boolean tty,
    ...
    public CronJobListItemsSpecJobTemplateSpecTemplateSpecContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final CronJobListItemsSpecJobTemplateSpecTemplateSpecContainersImagePullPolicy imagePullPolicy) {
    ...
    public CronJobListItemsSpecJobTemplateSpecTemplateSpecContainersStartupProbe getStartupProbe() {
        return startupProbe;
    }

    public void setStartupProbe(final CronJobListItemsSpecJobTemplateSpecTemplateSpecContainersStartupProbe startupProbe) {
    ...
    public CronJobListItemsSpecJobTemplateSpecTemplateSpecContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final CronJobListItemsSpecJobTemplateSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy) {
