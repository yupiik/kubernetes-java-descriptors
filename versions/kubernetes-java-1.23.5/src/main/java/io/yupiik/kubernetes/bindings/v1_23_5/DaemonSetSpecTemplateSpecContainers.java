...
public class DaemonSetSpecTemplateSpecContainers {
    ...
    private DaemonSetSpecTemplateSpecContainersImagePullPolicy imagePullPolicy;
    ...
    private DaemonSetSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public DaemonSetSpecTemplateSpecContainers(final List<String> args,
                                               ...
                                               final String image,
                                               final DaemonSetSpecTemplateSpecContainersImagePullPolicy imagePullPolicy,
                                               ...
                                               final DaemonSetSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy,
                                               final Boolean tty,
    ...
    public DaemonSetSpecTemplateSpecContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final DaemonSetSpecTemplateSpecContainersImagePullPolicy imagePullPolicy) {
    ...
    public DaemonSetSpecTemplateSpecContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final DaemonSetSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy) {
