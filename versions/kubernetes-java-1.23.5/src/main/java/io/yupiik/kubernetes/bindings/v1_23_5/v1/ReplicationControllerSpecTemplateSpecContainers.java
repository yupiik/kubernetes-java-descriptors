...
public class ReplicationControllerSpecTemplateSpecContainers {
    ...
    private ReplicationControllerSpecTemplateSpecContainersImagePullPolicy imagePullPolicy;
    ...
    private ReplicationControllerSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public ReplicationControllerSpecTemplateSpecContainers(final List<String> args,
                                                           ...
                                                           final String image,
                                                           final ReplicationControllerSpecTemplateSpecContainersImagePullPolicy imagePullPolicy,
                                                           ...
                                                           final ReplicationControllerSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy,
                                                           final Boolean tty,
    ...
    public ReplicationControllerSpecTemplateSpecContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final ReplicationControllerSpecTemplateSpecContainersImagePullPolicy imagePullPolicy) {
    ...
    public ReplicationControllerSpecTemplateSpecContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final ReplicationControllerSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy) {
