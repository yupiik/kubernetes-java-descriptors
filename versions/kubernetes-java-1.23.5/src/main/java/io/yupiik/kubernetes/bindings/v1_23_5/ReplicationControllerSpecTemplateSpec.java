...
public class ReplicationControllerSpecTemplateSpec {
    ...
    private ReplicationControllerSpecTemplateSpecDnsPolicy dnsPolicy;
    ...
    private ReplicationControllerSpecTemplateSpecRestartPolicy restartPolicy;
    ...
    public ReplicationControllerSpecTemplateSpec(final Integer activeDeadlineSeconds,
                                                 ...
                                                 final ReplicationControllerSpecTemplateSpecDnsPolicy dnsPolicy,
                                                 ...
                                                 final ReplicationControllerSpecTemplateSpecRestartPolicy restartPolicy,
    ...
    public ReplicationControllerSpecTemplateSpecDnsPolicy getDnsPolicy() {
        return dnsPolicy;
    }

    public void setDnsPolicy(final ReplicationControllerSpecTemplateSpecDnsPolicy dnsPolicy) {
    ...
    public ReplicationControllerSpecTemplateSpecRestartPolicy getRestartPolicy() {
        return restartPolicy;
    }

    public void setRestartPolicy(final ReplicationControllerSpecTemplateSpecRestartPolicy restartPolicy) {
