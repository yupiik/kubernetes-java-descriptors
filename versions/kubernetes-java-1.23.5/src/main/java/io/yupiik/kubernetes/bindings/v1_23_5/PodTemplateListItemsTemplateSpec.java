...
public class PodTemplateListItemsTemplateSpec {
    ...
    private PodTemplateListItemsTemplateSpecDnsPolicy dnsPolicy;
    ...
    private PodTemplateListItemsTemplateSpecRestartPolicy restartPolicy;
    ...
    public PodTemplateListItemsTemplateSpec(final Integer activeDeadlineSeconds,
                                            ...
                                            final PodTemplateListItemsTemplateSpecDnsPolicy dnsPolicy,
                                            ...
                                            final PodTemplateListItemsTemplateSpecRestartPolicy restartPolicy,
    ...
    public PodTemplateListItemsTemplateSpecDnsPolicy getDnsPolicy() {
        return dnsPolicy;
    }

    public void setDnsPolicy(final PodTemplateListItemsTemplateSpecDnsPolicy dnsPolicy) {
    ...
    public PodTemplateListItemsTemplateSpecRestartPolicy getRestartPolicy() {
        return restartPolicy;
    }

    public void setRestartPolicy(final PodTemplateListItemsTemplateSpecRestartPolicy restartPolicy) {
