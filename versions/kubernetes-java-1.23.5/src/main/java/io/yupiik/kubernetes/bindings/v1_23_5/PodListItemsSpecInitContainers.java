...
public class PodListItemsSpecInitContainers {
    ...
    private PodListItemsSpecInitContainersImagePullPolicy imagePullPolicy;
    ...
    private PodListItemsSpecInitContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public PodListItemsSpecInitContainers(final List<String> args,
                                          ...
                                          final String image,
                                          final PodListItemsSpecInitContainersImagePullPolicy imagePullPolicy,
                                          ...
                                          final PodListItemsSpecInitContainersTerminationMessagePolicy terminationMessagePolicy,
                                          final Boolean tty,
    ...
    public PodListItemsSpecInitContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final PodListItemsSpecInitContainersImagePullPolicy imagePullPolicy) {
    ...
    public PodListItemsSpecInitContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final PodListItemsSpecInitContainersTerminationMessagePolicy terminationMessagePolicy) {
