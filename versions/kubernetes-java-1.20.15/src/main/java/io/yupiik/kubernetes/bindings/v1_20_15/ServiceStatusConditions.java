...
public class ServiceStatusConditions {
    ...
    public ServiceStatusConditions() {
        // no-op
    }

    public ServiceStatusConditions(final String lastTransitionTime,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ServiceStatusConditions)) {
            return false;
        }
        final ServiceStatusConditions __otherCasted = (ServiceStatusConditions) __other;
