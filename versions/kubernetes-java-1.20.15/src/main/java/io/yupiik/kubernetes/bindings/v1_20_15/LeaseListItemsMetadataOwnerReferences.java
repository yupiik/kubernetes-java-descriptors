...
public class LeaseListItemsMetadataOwnerReferences {
    ...
    public LeaseListItemsMetadataOwnerReferences() {
        // no-op
    }

    public LeaseListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LeaseListItemsMetadataOwnerReferences)) {
            return false;
        }
        final LeaseListItemsMetadataOwnerReferences __otherCasted = (LeaseListItemsMetadataOwnerReferences) __other;
