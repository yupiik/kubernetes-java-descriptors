...
public class ComponentStatusMetadataOwnerReferences {
    ...
    public ComponentStatusMetadataOwnerReferences() {
        // no-op
    }

    public ComponentStatusMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ComponentStatusMetadataOwnerReferences)) {
            return false;
        }
        final ComponentStatusMetadataOwnerReferences __otherCasted = (ComponentStatusMetadataOwnerReferences) __other;
