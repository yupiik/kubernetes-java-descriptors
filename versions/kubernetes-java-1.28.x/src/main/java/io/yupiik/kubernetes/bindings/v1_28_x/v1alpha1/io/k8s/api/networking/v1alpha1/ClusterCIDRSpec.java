...
public class io.k8s.api.networking.v1alpha1.ClusterCIDRSpec implements Validable<io.k8s.api.networking.v1alpha1.ClusterCIDRSpec>, Exportable {
    private String ipv4;
    private String ipv6;
    private NodeSelector nodeSelector;
    private int perNodeHostBits;

    public io.k8s.api.networking.v1alpha1.ClusterCIDRSpec() {
        // no-op
    }

    public io.k8s.api.networking.v1alpha1.ClusterCIDRSpec(final String ipv4,
                                                          final String ipv6,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.networking.v1alpha1.ClusterCIDRSpec)) {
            return false;
        }
        final io.k8s.api.networking.v1alpha1.ClusterCIDRSpec __otherCasted = (io.k8s.api.networking.v1alpha1.ClusterCIDRSpec) __other;
    ...
    public io.k8s.api.networking.v1alpha1.ClusterCIDRSpec ipv4(final String ipv4) {
        this.ipv4 = ipv4;
        return this;
    }

    public io.k8s.api.networking.v1alpha1.ClusterCIDRSpec ipv6(final String ipv6) {
        this.ipv6 = ipv6;
        return this;
    }

    public io.k8s.api.networking.v1alpha1.ClusterCIDRSpec nodeSelector(final NodeSelector nodeSelector) {
        this.nodeSelector = nodeSelector;
        return this;
    }

    public io.k8s.api.networking.v1alpha1.ClusterCIDRSpec perNodeHostBits(final int perNodeHostBits) {
        this.perNodeHostBits = perNodeHostBits;
        return this;
    }

    @Override
    public io.k8s.api.networking.v1alpha1.ClusterCIDRSpec validate() {
        return this;
    }
