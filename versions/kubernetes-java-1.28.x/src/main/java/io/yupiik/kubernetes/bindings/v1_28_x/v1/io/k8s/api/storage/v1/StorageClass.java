...
public class io.k8s.api.storage.v1.StorageClass implements Validable<io.k8s.api.storage.v1.StorageClass>, Exportable {
    ...
    public io.k8s.api.storage.v1.StorageClass() {
        // no-op
    }

    public io.k8s.api.storage.v1.StorageClass(final Boolean allowVolumeExpansion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.storage.v1.StorageClass)) {
            return false;
        }
        final io.k8s.api.storage.v1.StorageClass __otherCasted = (io.k8s.api.storage.v1.StorageClass) __other;
    ...
    public io.k8s.api.storage.v1.StorageClass allowVolumeExpansion(final Boolean allowVolumeExpansion) {
        this.allowVolumeExpansion = allowVolumeExpansion;
        return this;
    }

    public io.k8s.api.storage.v1.StorageClass allowedTopologies(final List<TopologySelectorTerm> allowedTopologies) {
        this.allowedTopologies = allowedTopologies;
        return this;
    }

    public io.k8s.api.storage.v1.StorageClass apiVersion(final String apiVersion) {
        this.apiVersion = apiVersion;
        return this;
    }

    public io.k8s.api.storage.v1.StorageClass kind(final String kind) {
        this.kind = kind;
        return this;
    }

    public io.k8s.api.storage.v1.StorageClass metadata(final ObjectMeta metadata) {
        this.metadata = metadata;
        return this;
    }

    public io.k8s.api.storage.v1.StorageClass mountOptions(final List<String> mountOptions) {
        this.mountOptions = mountOptions;
        return this;
    }

    public io.k8s.api.storage.v1.StorageClass parameters(final Map<String, String> parameters) {
        this.parameters = parameters;
        return this;
    }

    public io.k8s.api.storage.v1.StorageClass provisioner(final String provisioner) {
        this.provisioner = provisioner;
        return this;
    }

    public io.k8s.api.storage.v1.StorageClass reclaimPolicy(final String reclaimPolicy) {
        this.reclaimPolicy = reclaimPolicy;
        return this;
    }

    public io.k8s.api.storage.v1.StorageClass volumeBindingMode(final String volumeBindingMode) {
        this.volumeBindingMode = volumeBindingMode;
        return this;
    }

    @Override
    public io.k8s.api.storage.v1.StorageClass validate() {
        if (kind == null) {
            kind = "StorageClass";
        }
        if (apiVersion == null) {
