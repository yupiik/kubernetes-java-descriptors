...
public class io.k8s.api.core.v1.Lifecycle implements Validable<io.k8s.api.core.v1.Lifecycle>, Exportable {
    private LifecycleHandler postStart;
    private LifecycleHandler preStop;

    public io.k8s.api.core.v1.Lifecycle() {
        // no-op
    }

    public io.k8s.api.core.v1.Lifecycle(final LifecycleHandler postStart,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.Lifecycle)) {
            return false;
        }
        final io.k8s.api.core.v1.Lifecycle __otherCasted = (io.k8s.api.core.v1.Lifecycle) __other;
        return Objects.equals(postStart, __otherCasted.postStart) &&
            Objects.equals(preStop, __otherCasted.preStop);
    }

    public io.k8s.api.core.v1.Lifecycle postStart(final LifecycleHandler postStart) {
        this.postStart = postStart;
        return this;
    }

    public io.k8s.api.core.v1.Lifecycle preStop(final LifecycleHandler preStop) {
        this.preStop = preStop;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.Lifecycle validate() {
        return this;
    }
