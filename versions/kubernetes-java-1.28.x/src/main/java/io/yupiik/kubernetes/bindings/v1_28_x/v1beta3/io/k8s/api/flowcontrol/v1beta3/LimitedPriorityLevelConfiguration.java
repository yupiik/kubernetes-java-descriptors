...
public class io.k8s.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration implements Validable<io.k8s.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration>, Exportable {
    ...
    public io.k8s.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration() {
        // no-op
    }

    public io.k8s.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration(final Integer borrowingLimitPercent,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration)) {
            return false;
        }
        final io.k8s.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration __otherCasted = (io.k8s.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration) __other;
    ...
    public io.k8s.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration borrowingLimitPercent(final Integer borrowingLimitPercent) {
        this.borrowingLimitPercent = borrowingLimitPercent;
        return this;
    }

    public io.k8s.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration lendablePercent(final Integer lendablePercent) {
        this.lendablePercent = lendablePercent;
        return this;
    }

    public io.k8s.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration limitResponse(final LimitResponse limitResponse) {
        this.limitResponse = limitResponse;
        return this;
    }

    public io.k8s.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration nominalConcurrencyShares(final Integer nominalConcurrencyShares) {
        this.nominalConcurrencyShares = nominalConcurrencyShares;
        return this;
    }

    @Override
    public io.k8s.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration validate() {
        return this;
    }
