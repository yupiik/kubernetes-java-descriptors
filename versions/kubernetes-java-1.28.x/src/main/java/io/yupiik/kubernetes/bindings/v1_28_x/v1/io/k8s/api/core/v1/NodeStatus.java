...
public class io.k8s.api.core.v1.NodeStatus implements Validable<io.k8s.api.core.v1.NodeStatus>, Exportable {
    ...
    public io.k8s.api.core.v1.NodeStatus() {
        // no-op
    }

    public io.k8s.api.core.v1.NodeStatus(final List<NodeAddress> addresses,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.NodeStatus)) {
            return false;
        }
        final io.k8s.api.core.v1.NodeStatus __otherCasted = (io.k8s.api.core.v1.NodeStatus) __other;
    ...
    public io.k8s.api.core.v1.NodeStatus addresses(final List<NodeAddress> addresses) {
        this.addresses = addresses;
        return this;
    }

    public io.k8s.api.core.v1.NodeStatus allocatable(final JsonObject allocatable) {
        this.allocatable = allocatable;
        return this;
    }

    public io.k8s.api.core.v1.NodeStatus capacity(final JsonObject capacity) {
        this.capacity = capacity;
        return this;
    }

    public io.k8s.api.core.v1.NodeStatus conditions(final List<NodeCondition> conditions) {
        this.conditions = conditions;
        return this;
    }

    public io.k8s.api.core.v1.NodeStatus config(final NodeConfigStatus config) {
        this.config = config;
        return this;
    }

    public io.k8s.api.core.v1.NodeStatus daemonEndpoints(final NodeDaemonEndpoints daemonEndpoints) {
        this.daemonEndpoints = daemonEndpoints;
        return this;
    }

    public io.k8s.api.core.v1.NodeStatus images(final List<ContainerImage> images) {
        this.images = images;
        return this;
    }

    public io.k8s.api.core.v1.NodeStatus nodeInfo(final NodeSystemInfo nodeInfo) {
        this.nodeInfo = nodeInfo;
        return this;
    }

    public io.k8s.api.core.v1.NodeStatus phase(final String phase) {
        this.phase = phase;
        return this;
    }

    public io.k8s.api.core.v1.NodeStatus volumesAttached(final List<AttachedVolume> volumesAttached) {
        this.volumesAttached = volumesAttached;
        return this;
    }

    public io.k8s.api.core.v1.NodeStatus volumesInUse(final List<String> volumesInUse) {
        this.volumesInUse = volumesInUse;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.NodeStatus validate() {
        return this;
    }
