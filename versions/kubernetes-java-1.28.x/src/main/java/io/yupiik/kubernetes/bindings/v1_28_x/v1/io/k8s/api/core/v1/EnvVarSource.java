...
public class io.k8s.api.core.v1.EnvVarSource implements Validable<io.k8s.api.core.v1.EnvVarSource>, Exportable {
    private ConfigMapKeySelector configMapKeyRef;
    private ObjectFieldSelector fieldRef;
    private ResourceFieldSelector resourceFieldRef;
    private SecretKeySelector secretKeyRef;

    public io.k8s.api.core.v1.EnvVarSource() {
        // no-op
    }

    public io.k8s.api.core.v1.EnvVarSource(final ConfigMapKeySelector configMapKeyRef,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.EnvVarSource)) {
            return false;
        }
        final io.k8s.api.core.v1.EnvVarSource __otherCasted = (io.k8s.api.core.v1.EnvVarSource) __other;
    ...
    public io.k8s.api.core.v1.EnvVarSource configMapKeyRef(final ConfigMapKeySelector configMapKeyRef) {
        this.configMapKeyRef = configMapKeyRef;
        return this;
    }

    public io.k8s.api.core.v1.EnvVarSource fieldRef(final ObjectFieldSelector fieldRef) {
        this.fieldRef = fieldRef;
        return this;
    }

    public io.k8s.api.core.v1.EnvVarSource resourceFieldRef(final ResourceFieldSelector resourceFieldRef) {
        this.resourceFieldRef = resourceFieldRef;
        return this;
    }

    public io.k8s.api.core.v1.EnvVarSource secretKeyRef(final SecretKeySelector secretKeyRef) {
        this.secretKeyRef = secretKeyRef;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.EnvVarSource validate() {
        return this;
    }
