...
public class io.k8s.api.apiserverinternal.v1alpha1.StorageVersionStatus implements Validable<io.k8s.api.apiserverinternal.v1alpha1.StorageVersionStatus>, Exportable {
    ...
    public io.k8s.api.apiserverinternal.v1alpha1.StorageVersionStatus() {
        // no-op
    }

    public io.k8s.api.apiserverinternal.v1alpha1.StorageVersionStatus(final String commonEncodingVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.apiserverinternal.v1alpha1.StorageVersionStatus)) {
            return false;
        }
        final io.k8s.api.apiserverinternal.v1alpha1.StorageVersionStatus __otherCasted = (io.k8s.api.apiserverinternal.v1alpha1.StorageVersionStatus) __other;
    ...
    public io.k8s.api.apiserverinternal.v1alpha1.StorageVersionStatus commonEncodingVersion(final String commonEncodingVersion) {
        this.commonEncodingVersion = commonEncodingVersion;
        return this;
    }

    public io.k8s.api.apiserverinternal.v1alpha1.StorageVersionStatus conditions(final List<StorageVersionCondition> conditions) {
        this.conditions = conditions;
        return this;
    }

    public io.k8s.api.apiserverinternal.v1alpha1.StorageVersionStatus storageVersions(final List<ServerStorageVersion> storageVersions) {
        this.storageVersions = storageVersions;
        return this;
    }

    @Override
    public io.k8s.api.apiserverinternal.v1alpha1.StorageVersionStatus validate() {
        return this;
    }
