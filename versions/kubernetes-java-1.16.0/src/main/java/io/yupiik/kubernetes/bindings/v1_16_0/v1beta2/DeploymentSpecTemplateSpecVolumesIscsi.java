...
public class DeploymentSpecTemplateSpecVolumesIscsi {
    ...
    private DeploymentSpecTemplateSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public DeploymentSpecTemplateSpecVolumesIscsi() {
        // no-op
    }

    public DeploymentSpecTemplateSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                                  ...
                                                  final DeploymentSpecTemplateSpecVolumesIscsiSecretRef secretRef,
    ...
    public DeploymentSpecTemplateSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final DeploymentSpecTemplateSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentSpecTemplateSpecVolumesIscsi)) {
            return false;
        }
        final DeploymentSpecTemplateSpecVolumesIscsi __otherCasted = (DeploymentSpecTemplateSpecVolumesIscsi) __other;
