...
public class JobSpecTemplateSpecVolumesVsphereVolume {
    private String fsType;
    private String storagePolicyID;
    private String storagePolicyName;
    private String volumePath;

    public JobSpecTemplateSpecVolumesVsphereVolume() {
        // no-op
    }

    public JobSpecTemplateSpecVolumesVsphereVolume(final String fsType,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobSpecTemplateSpecVolumesVsphereVolume)) {
            return false;
        }
        final JobSpecTemplateSpecVolumesVsphereVolume __otherCasted = (JobSpecTemplateSpecVolumesVsphereVolume) __other;
