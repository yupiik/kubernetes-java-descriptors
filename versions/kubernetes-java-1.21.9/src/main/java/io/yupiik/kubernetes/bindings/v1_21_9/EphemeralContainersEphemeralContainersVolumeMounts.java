...
public class EphemeralContainersEphemeralContainersVolumeMounts {
    ...
    public EphemeralContainersEphemeralContainersVolumeMounts() {
        // no-op
    }

    public EphemeralContainersEphemeralContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EphemeralContainersEphemeralContainersVolumeMounts)) {
            return false;
        }
        final EphemeralContainersEphemeralContainersVolumeMounts __otherCasted = (EphemeralContainersEphemeralContainersVolumeMounts) __other;
