...
public class EventListItemsMetadataManagedFields {
    ...
    public EventListItemsMetadataManagedFields() {
        // no-op
    }

    public EventListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EventListItemsMetadataManagedFields)) {
            return false;
        }
        final EventListItemsMetadataManagedFields __otherCasted = (EventListItemsMetadataManagedFields) __other;
