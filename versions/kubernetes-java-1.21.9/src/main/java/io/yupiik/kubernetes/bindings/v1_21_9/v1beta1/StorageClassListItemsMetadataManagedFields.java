...
public class StorageClassListItemsMetadataManagedFields {
    ...
    public StorageClassListItemsMetadataManagedFields() {
        // no-op
    }

    public StorageClassListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StorageClassListItemsMetadataManagedFields)) {
            return false;
        }
        final StorageClassListItemsMetadataManagedFields __otherCasted = (StorageClassListItemsMetadataManagedFields) __other;
