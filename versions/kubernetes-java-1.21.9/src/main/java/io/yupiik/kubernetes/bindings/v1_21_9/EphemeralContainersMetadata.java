...
public class EphemeralContainersMetadata {
    ...
    private List<EphemeralContainersMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<EphemeralContainersMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public EphemeralContainersMetadata() {
        // no-op
    }

    public EphemeralContainersMetadata(final Map<String, String> annotations,
                                       ...
                                       final List<EphemeralContainersMetadataManagedFields> managedFields,
                                       final String name,
                                       final String namespace,
                                       final List<EphemeralContainersMetadataOwnerReferences> ownerReferences,
    ...
    public List<EphemeralContainersMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<EphemeralContainersMetadataManagedFields> managedFields) {
    ...
    public List<EphemeralContainersMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<EphemeralContainersMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EphemeralContainersMetadata)) {
            return false;
        }
        final EphemeralContainersMetadata __otherCasted = (EphemeralContainersMetadata) __other;
