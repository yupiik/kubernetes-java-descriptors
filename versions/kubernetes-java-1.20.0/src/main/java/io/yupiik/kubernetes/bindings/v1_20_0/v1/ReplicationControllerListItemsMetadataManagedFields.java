...
public class ReplicationControllerListItemsMetadataManagedFields {
    ...
    public ReplicationControllerListItemsMetadataManagedFields() {
        // no-op
    }

    public ReplicationControllerListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicationControllerListItemsMetadataManagedFields)) {
            return false;
        }
        final ReplicationControllerListItemsMetadataManagedFields __otherCasted = (ReplicationControllerListItemsMetadataManagedFields) __other;
