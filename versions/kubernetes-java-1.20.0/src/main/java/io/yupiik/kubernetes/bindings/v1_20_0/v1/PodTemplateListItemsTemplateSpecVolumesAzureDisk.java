...
public class PodTemplateListItemsTemplateSpecVolumesAzureDisk {
    ...
    public PodTemplateListItemsTemplateSpecVolumesAzureDisk() {
        // no-op
    }

    public PodTemplateListItemsTemplateSpecVolumesAzureDisk(final String cachingMode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateListItemsTemplateSpecVolumesAzureDisk)) {
            return false;
        }
        final PodTemplateListItemsTemplateSpecVolumesAzureDisk __otherCasted = (PodTemplateListItemsTemplateSpecVolumesAzureDisk) __other;
