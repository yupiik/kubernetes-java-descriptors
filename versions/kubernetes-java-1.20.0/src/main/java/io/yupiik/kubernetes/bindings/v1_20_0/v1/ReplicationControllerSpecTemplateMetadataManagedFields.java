...
public class ReplicationControllerSpecTemplateMetadataManagedFields {
    ...
    public ReplicationControllerSpecTemplateMetadataManagedFields() {
        // no-op
    }

    public ReplicationControllerSpecTemplateMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicationControllerSpecTemplateMetadataManagedFields)) {
            return false;
        }
        final ReplicationControllerSpecTemplateMetadataManagedFields __otherCasted = (ReplicationControllerSpecTemplateMetadataManagedFields) __other;
