...
public class RuntimeClassListMetadata {
    ...
    public RuntimeClassListMetadata() {
        // no-op
    }

    public RuntimeClassListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RuntimeClassListMetadata)) {
            return false;
        }
        final RuntimeClassListMetadata __otherCasted = (RuntimeClassListMetadata) __other;
