...
public class PodStatusInitContainerStatusesStateTerminated {
    ...
    public PodStatusInitContainerStatusesStateTerminated() {
        // no-op
    }

    public PodStatusInitContainerStatusesStateTerminated(final String containerID,
                                                         final int exitCode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodStatusInitContainerStatusesStateTerminated)) {
            return false;
        }
        final PodStatusInitContainerStatusesStateTerminated __otherCasted = (PodStatusInitContainerStatusesStateTerminated) __other;
