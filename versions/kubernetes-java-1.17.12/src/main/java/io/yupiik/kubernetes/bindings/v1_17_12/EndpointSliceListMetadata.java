...
public class EndpointSliceListMetadata {
    ...
    public EndpointSliceListMetadata() {
        // no-op
    }

    public EndpointSliceListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EndpointSliceListMetadata)) {
            return false;
        }
        final EndpointSliceListMetadata __otherCasted = (EndpointSliceListMetadata) __other;
