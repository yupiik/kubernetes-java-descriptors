...
public class PodTemplateListItemsTemplateSpecContainersSecurityContext {
    ...
    private PodTemplateListItemsTemplateSpecContainersSecurityContextSeccompProfile seccompProfile;
    ...
    public PodTemplateListItemsTemplateSpecContainersSecurityContext(final Boolean allowPrivilegeEscalation,
                                                                     ...
                                                                     final PodTemplateListItemsTemplateSpecContainersSecurityContextSeccompProfile seccompProfile,
    ...
    public PodTemplateListItemsTemplateSpecContainersSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final PodTemplateListItemsTemplateSpecContainersSecurityContextSeccompProfile seccompProfile) {
