...
public class DaemonSetSpecTemplateSpecInitContainersVolumeMounts {
    ...
    public DaemonSetSpecTemplateSpecInitContainersVolumeMounts() {
        // no-op
    }

    public DaemonSetSpecTemplateSpecInitContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetSpecTemplateSpecInitContainersVolumeMounts)) {
            return false;
        }
        final DaemonSetSpecTemplateSpecInitContainersVolumeMounts __otherCasted = (DaemonSetSpecTemplateSpecInitContainersVolumeMounts) __other;
