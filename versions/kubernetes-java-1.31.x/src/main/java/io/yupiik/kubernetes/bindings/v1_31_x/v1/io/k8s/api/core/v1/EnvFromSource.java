...
public class io.k8s.api.core.v1.EnvFromSource implements Validable<io.k8s.api.core.v1.EnvFromSource>, Exportable {
    private ConfigMapEnvSource configMapRef;
    private String prefix;
    private SecretEnvSource secretRef;

    public io.k8s.api.core.v1.EnvFromSource() {
        // no-op
    }

    public io.k8s.api.core.v1.EnvFromSource(final ConfigMapEnvSource configMapRef,
                                            final String prefix,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.EnvFromSource)) {
            return false;
        }
        final io.k8s.api.core.v1.EnvFromSource __otherCasted = (io.k8s.api.core.v1.EnvFromSource) __other;
        return Objects.equals(configMapRef, __otherCasted.configMapRef) &&
            Objects.equals(prefix, __otherCasted.prefix) &&
            Objects.equals(secretRef, __otherCasted.secretRef);
    }

    public io.k8s.api.core.v1.EnvFromSource configMapRef(final ConfigMapEnvSource configMapRef) {
        this.configMapRef = configMapRef;
        return this;
    }

    public io.k8s.api.core.v1.EnvFromSource prefix(final String prefix) {
        this.prefix = prefix;
        return this;
    }

    public io.k8s.api.core.v1.EnvFromSource secretRef(final SecretEnvSource secretRef) {
        this.secretRef = secretRef;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.EnvFromSource validate() {
        return this;
    }
