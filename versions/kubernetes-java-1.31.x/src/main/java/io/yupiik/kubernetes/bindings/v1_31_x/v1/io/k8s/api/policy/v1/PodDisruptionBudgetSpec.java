...
public class io.k8s.api.policy.v1.PodDisruptionBudgetSpec implements Validable<io.k8s.api.policy.v1.PodDisruptionBudgetSpec>, Exportable {
    private String maxUnavailable;
    private String minAvailable;
    private LabelSelector selector;
    private String unhealthyPodEvictionPolicy;

    public io.k8s.api.policy.v1.PodDisruptionBudgetSpec() {
        // no-op
    }

    public io.k8s.api.policy.v1.PodDisruptionBudgetSpec(final String maxUnavailable,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.policy.v1.PodDisruptionBudgetSpec)) {
            return false;
        }
        final io.k8s.api.policy.v1.PodDisruptionBudgetSpec __otherCasted = (io.k8s.api.policy.v1.PodDisruptionBudgetSpec) __other;
    ...
    public io.k8s.api.policy.v1.PodDisruptionBudgetSpec maxUnavailable(final String maxUnavailable) {
        this.maxUnavailable = maxUnavailable;
        return this;
    }

    public io.k8s.api.policy.v1.PodDisruptionBudgetSpec minAvailable(final String minAvailable) {
        this.minAvailable = minAvailable;
        return this;
    }

    public io.k8s.api.policy.v1.PodDisruptionBudgetSpec selector(final LabelSelector selector) {
        this.selector = selector;
        return this;
    }

    public io.k8s.api.policy.v1.PodDisruptionBudgetSpec unhealthyPodEvictionPolicy(final String unhealthyPodEvictionPolicy) {
        this.unhealthyPodEvictionPolicy = unhealthyPodEvictionPolicy;
        return this;
    }

    @Override
    public io.k8s.api.policy.v1.PodDisruptionBudgetSpec validate() {
        return this;
    }
