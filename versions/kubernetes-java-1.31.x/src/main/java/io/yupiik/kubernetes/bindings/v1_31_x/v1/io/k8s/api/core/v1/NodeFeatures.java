...
public class io.k8s.api.core.v1.NodeFeatures implements Validable<io.k8s.api.core.v1.NodeFeatures>, Exportable {
    private Boolean supplementalGroupsPolicy;

    public io.k8s.api.core.v1.NodeFeatures() {
        // no-op
    }

    public io.k8s.api.core.v1.NodeFeatures(final Boolean supplementalGroupsPolicy) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.NodeFeatures)) {
            return false;
        }
        final io.k8s.api.core.v1.NodeFeatures __otherCasted = (io.k8s.api.core.v1.NodeFeatures) __other;
        return Objects.equals(supplementalGroupsPolicy, __otherCasted.supplementalGroupsPolicy);
    }

    public io.k8s.api.core.v1.NodeFeatures supplementalGroupsPolicy(final Boolean supplementalGroupsPolicy) {
        this.supplementalGroupsPolicy = supplementalGroupsPolicy;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.NodeFeatures validate() {
        return this;
    }
