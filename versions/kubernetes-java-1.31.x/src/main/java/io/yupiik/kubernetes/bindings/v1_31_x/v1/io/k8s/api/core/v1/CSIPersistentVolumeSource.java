...
public class io.k8s.api.core.v1.CSIPersistentVolumeSource implements Validable<io.k8s.api.core.v1.CSIPersistentVolumeSource>, Exportable {
    ...
    public io.k8s.api.core.v1.CSIPersistentVolumeSource() {
        // no-op
    }

    public io.k8s.api.core.v1.CSIPersistentVolumeSource(final SecretReference controllerExpandSecretRef,
    ...
    public void setNodeExpandSecretRef(final SecretReference nodeExpandSecretRef) {
        this.nodeExpandSecretRef = nodeExpandSecretRef;
    }
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.CSIPersistentVolumeSource)) {
            return false;
        }
        final io.k8s.api.core.v1.CSIPersistentVolumeSource __otherCasted = (io.k8s.api.core.v1.CSIPersistentVolumeSource) __other;
        return Objects.equals(controllerExpandSecretRef, __otherCasted.controllerExpandSecretRef) &&
            ...
            Objects.equals(nodeExpandSecretRef, __otherCasted.nodeExpandSecretRef) &&
    ...
    public io.k8s.api.core.v1.CSIPersistentVolumeSource controllerExpandSecretRef(final SecretReference controllerExpandSecretRef) {
        this.controllerExpandSecretRef = controllerExpandSecretRef;
        return this;
    }

    public io.k8s.api.core.v1.CSIPersistentVolumeSource controllerPublishSecretRef(final SecretReference controllerPublishSecretRef) {
        this.controllerPublishSecretRef = controllerPublishSecretRef;
        return this;
    }

    public io.k8s.api.core.v1.CSIPersistentVolumeSource driver(final String driver) {
        this.driver = driver;
        return this;
    }

    public io.k8s.api.core.v1.CSIPersistentVolumeSource fsType(final String fsType) {
        this.fsType = fsType;
        return this;
    }

    public io.k8s.api.core.v1.CSIPersistentVolumeSource nodeExpandSecretRef(final SecretReference nodeExpandSecretRef) {
        this.nodeExpandSecretRef = nodeExpandSecretRef;
        return this;
    }

    public io.k8s.api.core.v1.CSIPersistentVolumeSource nodePublishSecretRef(final SecretReference nodePublishSecretRef) {
        this.nodePublishSecretRef = nodePublishSecretRef;
        return this;
    }

    public io.k8s.api.core.v1.CSIPersistentVolumeSource nodeStageSecretRef(final SecretReference nodeStageSecretRef) {
        this.nodeStageSecretRef = nodeStageSecretRef;
        return this;
    }

    public io.k8s.api.core.v1.CSIPersistentVolumeSource readOnly(final Boolean readOnly) {
        this.readOnly = readOnly;
        return this;
    }

    public io.k8s.api.core.v1.CSIPersistentVolumeSource volumeAttributes(final Map<String, String> volumeAttributes) {
        this.volumeAttributes = volumeAttributes;
        return this;
    }

    public io.k8s.api.core.v1.CSIPersistentVolumeSource volumeHandle(final String volumeHandle) {
        this.volumeHandle = volumeHandle;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.CSIPersistentVolumeSource validate() {
    ...
    public String asJson() {
        return Stream.of(
                    ...
                    (nodeExpandSecretRef != null ? "\"nodeExpandSecretRef\":" + nodeExpandSecretRef.asJson() : ""),
