...
public class io.k8s.api.apps.v1.ReplicaSetStatus implements Validable<io.k8s.api.apps.v1.ReplicaSetStatus>, Exportable {
    ...
    public io.k8s.api.apps.v1.ReplicaSetStatus() {
        // no-op
    }

    public io.k8s.api.apps.v1.ReplicaSetStatus(final Integer availableReplicas,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.apps.v1.ReplicaSetStatus)) {
            return false;
        }
        final io.k8s.api.apps.v1.ReplicaSetStatus __otherCasted = (io.k8s.api.apps.v1.ReplicaSetStatus) __other;
    ...
    public io.k8s.api.apps.v1.ReplicaSetStatus availableReplicas(final Integer availableReplicas) {
        this.availableReplicas = availableReplicas;
        return this;
    }

    public io.k8s.api.apps.v1.ReplicaSetStatus conditions(final List<ReplicaSetCondition> conditions) {
        this.conditions = conditions;
        return this;
    }

    public io.k8s.api.apps.v1.ReplicaSetStatus fullyLabeledReplicas(final Integer fullyLabeledReplicas) {
        this.fullyLabeledReplicas = fullyLabeledReplicas;
        return this;
    }

    public io.k8s.api.apps.v1.ReplicaSetStatus observedGeneration(final Integer observedGeneration) {
        this.observedGeneration = observedGeneration;
        return this;
    }

    public io.k8s.api.apps.v1.ReplicaSetStatus readyReplicas(final Integer readyReplicas) {
        this.readyReplicas = readyReplicas;
        return this;
    }

    public io.k8s.api.apps.v1.ReplicaSetStatus replicas(final int replicas) {
        this.replicas = replicas;
        return this;
    }

    @Override
    public io.k8s.api.apps.v1.ReplicaSetStatus validate() {
        return this;
    }
