...
public class io.k8s.api.resource.v1alpha3.DeviceClassSpec implements Validable<io.k8s.api.resource.v1alpha3.DeviceClassSpec>, Exportable {
    private List<DeviceClassConfiguration> config;
    private List<DeviceSelector> selectors;
    private NodeSelector suitableNodes;

    public io.k8s.api.resource.v1alpha3.DeviceClassSpec() {
        // no-op
    }

    public io.k8s.api.resource.v1alpha3.DeviceClassSpec(final List<DeviceClassConfiguration> config,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.resource.v1alpha3.DeviceClassSpec)) {
            return false;
        }
        final io.k8s.api.resource.v1alpha3.DeviceClassSpec __otherCasted = (io.k8s.api.resource.v1alpha3.DeviceClassSpec) __other;
    ...
    public io.k8s.api.resource.v1alpha3.DeviceClassSpec config(final List<DeviceClassConfiguration> config) {
        this.config = config;
        return this;
    }

    public io.k8s.api.resource.v1alpha3.DeviceClassSpec selectors(final List<DeviceSelector> selectors) {
        this.selectors = selectors;
        return this;
    }

    public io.k8s.api.resource.v1alpha3.DeviceClassSpec suitableNodes(final NodeSelector suitableNodes) {
        this.suitableNodes = suitableNodes;
        return this;
    }

    @Override
    public io.k8s.api.resource.v1alpha3.DeviceClassSpec validate() {
        return this;
    }
