...
public class io.k8s.api.core.v1.NodeConfigStatus implements Validable<io.k8s.api.core.v1.NodeConfigStatus>, Exportable {
    private NodeConfigSource active;
    private NodeConfigSource assigned;
    private String error;
    private NodeConfigSource lastKnownGood;

    public io.k8s.api.core.v1.NodeConfigStatus() {
        // no-op
    }

    public io.k8s.api.core.v1.NodeConfigStatus(final NodeConfigSource active,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.NodeConfigStatus)) {
            return false;
        }
        final io.k8s.api.core.v1.NodeConfigStatus __otherCasted = (io.k8s.api.core.v1.NodeConfigStatus) __other;
    ...
    public io.k8s.api.core.v1.NodeConfigStatus active(final NodeConfigSource active) {
        this.active = active;
        return this;
    }

    public io.k8s.api.core.v1.NodeConfigStatus assigned(final NodeConfigSource assigned) {
        this.assigned = assigned;
        return this;
    }

    public io.k8s.api.core.v1.NodeConfigStatus error(final String error) {
        this.error = error;
        return this;
    }

    public io.k8s.api.core.v1.NodeConfigStatus lastKnownGood(final NodeConfigSource lastKnownGood) {
        this.lastKnownGood = lastKnownGood;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.NodeConfigStatus validate() {
        return this;
    }
