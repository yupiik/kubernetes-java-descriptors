...
public class io.k8s.api.resource.v1alpha3.AllocationResult implements Validable<io.k8s.api.resource.v1alpha3.AllocationResult>, Exportable {
    private String controller;
    private DeviceAllocationResult devices;
    private NodeSelector nodeSelector;

    public io.k8s.api.resource.v1alpha3.AllocationResult() {
        // no-op
    }

    public io.k8s.api.resource.v1alpha3.AllocationResult(final String controller,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.resource.v1alpha3.AllocationResult)) {
            return false;
        }
        final io.k8s.api.resource.v1alpha3.AllocationResult __otherCasted = (io.k8s.api.resource.v1alpha3.AllocationResult) __other;
    ...
    public io.k8s.api.resource.v1alpha3.AllocationResult controller(final String controller) {
        this.controller = controller;
        return this;
    }

    public io.k8s.api.resource.v1alpha3.AllocationResult devices(final DeviceAllocationResult devices) {
        this.devices = devices;
        return this;
    }

    public io.k8s.api.resource.v1alpha3.AllocationResult nodeSelector(final NodeSelector nodeSelector) {
        this.nodeSelector = nodeSelector;
        return this;
    }

    @Override
    public io.k8s.api.resource.v1alpha3.AllocationResult validate() {
        return this;
    }
