...
public class io.k8s.api.resource.v1alpha3.ResourceClaimStatus implements Validable<io.k8s.api.resource.v1alpha3.ResourceClaimStatus>, Exportable {
    ...
    public io.k8s.api.resource.v1alpha3.ResourceClaimStatus() {
        // no-op
    }

    public io.k8s.api.resource.v1alpha3.ResourceClaimStatus(final AllocationResult allocation,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.resource.v1alpha3.ResourceClaimStatus)) {
            return false;
        }
        final io.k8s.api.resource.v1alpha3.ResourceClaimStatus __otherCasted = (io.k8s.api.resource.v1alpha3.ResourceClaimStatus) __other;
    ...
    public io.k8s.api.resource.v1alpha3.ResourceClaimStatus allocation(final AllocationResult allocation) {
        this.allocation = allocation;
        return this;
    }

    public io.k8s.api.resource.v1alpha3.ResourceClaimStatus deallocationRequested(final Boolean deallocationRequested) {
        this.deallocationRequested = deallocationRequested;
        return this;
    }

    public io.k8s.api.resource.v1alpha3.ResourceClaimStatus reservedFor(final List<ResourceClaimConsumerReference> reservedFor) {
        this.reservedFor = reservedFor;
        return this;
    }

    @Override
    public io.k8s.api.resource.v1alpha3.ResourceClaimStatus validate() {
        return this;
    }
