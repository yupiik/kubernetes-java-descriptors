...
public class EventListItemsMetadataOwnerReferences {
    ...
    public EventListItemsMetadataOwnerReferences() {
        // no-op
    }

    public EventListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EventListItemsMetadataOwnerReferences)) {
            return false;
        }
        final EventListItemsMetadataOwnerReferences __otherCasted = (EventListItemsMetadataOwnerReferences) __other;
