...
public class PodSecurityPolicyMetadataOwnerReferences {
    ...
    public PodSecurityPolicyMetadataOwnerReferences() {
        // no-op
    }

    public PodSecurityPolicyMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSecurityPolicyMetadataOwnerReferences)) {
            return false;
        }
        final PodSecurityPolicyMetadataOwnerReferences __otherCasted = (PodSecurityPolicyMetadataOwnerReferences) __other;
