...
public class JobSpecTemplateMetadataOwnerReferences {
    ...
    public JobSpecTemplateMetadataOwnerReferences() {
        // no-op
    }

    public JobSpecTemplateMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobSpecTemplateMetadataOwnerReferences)) {
            return false;
        }
        final JobSpecTemplateMetadataOwnerReferences __otherCasted = (JobSpecTemplateMetadataOwnerReferences) __other;
