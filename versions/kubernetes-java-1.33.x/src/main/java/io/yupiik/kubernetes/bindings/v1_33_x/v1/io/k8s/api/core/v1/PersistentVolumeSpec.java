...
public class io.k8s.api.core.v1.PersistentVolumeSpec implements Validable<io.k8s.api.core.v1.PersistentVolumeSpec>, Exportable {
    ...
    public io.k8s.api.core.v1.PersistentVolumeSpec() {
        // no-op
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec(final List<String> accessModes,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.PersistentVolumeSpec)) {
            return false;
        }
        final io.k8s.api.core.v1.PersistentVolumeSpec __otherCasted = (io.k8s.api.core.v1.PersistentVolumeSpec) __other;
    ...
    public io.k8s.api.core.v1.PersistentVolumeSpec accessModes(final List<String> accessModes) {
        this.accessModes = accessModes;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec awsElasticBlockStore(final AWSElasticBlockStoreVolumeSource awsElasticBlockStore) {
        this.awsElasticBlockStore = awsElasticBlockStore;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec azureDisk(final AzureDiskVolumeSource azureDisk) {
        this.azureDisk = azureDisk;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec azureFile(final AzureFilePersistentVolumeSource azureFile) {
        this.azureFile = azureFile;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec capacity(final JsonObject capacity) {
        this.capacity = capacity;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec cephfs(final CephFSPersistentVolumeSource cephfs) {
        this.cephfs = cephfs;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec cinder(final CinderPersistentVolumeSource cinder) {
        this.cinder = cinder;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec claimRef(final ObjectReference claimRef) {
        this.claimRef = claimRef;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec csi(final CSIPersistentVolumeSource csi) {
        this.csi = csi;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec fc(final FCVolumeSource fc) {
        this.fc = fc;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec flexVolume(final FlexPersistentVolumeSource flexVolume) {
        this.flexVolume = flexVolume;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec flocker(final FlockerVolumeSource flocker) {
        this.flocker = flocker;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec gcePersistentDisk(final GCEPersistentDiskVolumeSource gcePersistentDisk) {
        this.gcePersistentDisk = gcePersistentDisk;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec glusterfs(final GlusterfsPersistentVolumeSource glusterfs) {
        this.glusterfs = glusterfs;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec hostPath(final HostPathVolumeSource hostPath) {
        this.hostPath = hostPath;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec iscsi(final ISCSIPersistentVolumeSource iscsi) {
        this.iscsi = iscsi;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec local(final LocalVolumeSource local) {
        this.local = local;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec mountOptions(final List<String> mountOptions) {
        this.mountOptions = mountOptions;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec nfs(final NFSVolumeSource nfs) {
        this.nfs = nfs;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec nodeAffinity(final VolumeNodeAffinity nodeAffinity) {
        this.nodeAffinity = nodeAffinity;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec persistentVolumeReclaimPolicy(final String persistentVolumeReclaimPolicy) {
        this.persistentVolumeReclaimPolicy = persistentVolumeReclaimPolicy;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec photonPersistentDisk(final PhotonPersistentDiskVolumeSource photonPersistentDisk) {
        this.photonPersistentDisk = photonPersistentDisk;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec portworxVolume(final PortworxVolumeSource portworxVolume) {
        this.portworxVolume = portworxVolume;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec quobyte(final QuobyteVolumeSource quobyte) {
        this.quobyte = quobyte;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec rbd(final RBDPersistentVolumeSource rbd) {
        this.rbd = rbd;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec scaleIO(final ScaleIOPersistentVolumeSource scaleIO) {
        this.scaleIO = scaleIO;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec storageClassName(final String storageClassName) {
        this.storageClassName = storageClassName;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec storageos(final StorageOSPersistentVolumeSource storageos) {
        this.storageos = storageos;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec volumeAttributesClassName(final String volumeAttributesClassName) {
        this.volumeAttributesClassName = volumeAttributesClassName;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec volumeMode(final String volumeMode) {
        this.volumeMode = volumeMode;
        return this;
    }

    public io.k8s.api.core.v1.PersistentVolumeSpec vsphereVolume(final VsphereVirtualDiskVolumeSource vsphereVolume) {
        this.vsphereVolume = vsphereVolume;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.PersistentVolumeSpec validate() {
        return this;
    }
