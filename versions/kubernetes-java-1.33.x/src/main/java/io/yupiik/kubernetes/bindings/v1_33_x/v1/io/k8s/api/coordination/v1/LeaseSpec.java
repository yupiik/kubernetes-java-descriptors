...
public class io.k8s.api.coordination.v1.LeaseSpec implements Validable<io.k8s.api.coordination.v1.LeaseSpec>, Exportable {
    ...
    public io.k8s.api.coordination.v1.LeaseSpec preferredHolder(final String preferredHolder) {
        this.preferredHolder = preferredHolder;
        return this;
    }
    ...
    public io.k8s.api.coordination.v1.LeaseSpec strategy(final String strategy) {
        this.strategy = strategy;
        return this;
    }
