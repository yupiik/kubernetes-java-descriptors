...
public class io.k8s.api.core.v1.PodAffinity implements Validable<io.k8s.api.core.v1.PodAffinity>, Exportable {
    ...
    public io.k8s.api.core.v1.PodAffinity() {
        // no-op
    }

    public io.k8s.api.core.v1.PodAffinity(final List<WeightedPodAffinityTerm> preferredDuringSchedulingIgnoredDuringExecution,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.PodAffinity)) {
            return false;
        }
        final io.k8s.api.core.v1.PodAffinity __otherCasted = (io.k8s.api.core.v1.PodAffinity) __other;
        return Objects.equals(preferredDuringSchedulingIgnoredDuringExecution, __otherCasted.preferredDuringSchedulingIgnoredDuringExecution) &&
            Objects.equals(requiredDuringSchedulingIgnoredDuringExecution, __otherCasted.requiredDuringSchedulingIgnoredDuringExecution);
    }

    public io.k8s.api.core.v1.PodAffinity preferredDuringSchedulingIgnoredDuringExecution(final List<WeightedPodAffinityTerm> preferredDuringSchedulingIgnoredDuringExecution) {
        this.preferredDuringSchedulingIgnoredDuringExecution = preferredDuringSchedulingIgnoredDuringExecution;
        return this;
    }

    public io.k8s.api.core.v1.PodAffinity requiredDuringSchedulingIgnoredDuringExecution(final List<PodAffinityTerm> requiredDuringSchedulingIgnoredDuringExecution) {
        this.requiredDuringSchedulingIgnoredDuringExecution = requiredDuringSchedulingIgnoredDuringExecution;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.PodAffinity validate() {
        return this;
    }
