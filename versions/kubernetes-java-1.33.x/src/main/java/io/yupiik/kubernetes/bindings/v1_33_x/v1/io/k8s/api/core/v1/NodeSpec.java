...
public class io.k8s.api.core.v1.NodeSpec implements Validable<io.k8s.api.core.v1.NodeSpec>, Exportable {
    ...
    public io.k8s.api.core.v1.NodeSpec() {
        // no-op
    }

    public io.k8s.api.core.v1.NodeSpec(final NodeConfigSource configSource,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.NodeSpec)) {
            return false;
        }
        final io.k8s.api.core.v1.NodeSpec __otherCasted = (io.k8s.api.core.v1.NodeSpec) __other;
    ...
    public io.k8s.api.core.v1.NodeSpec configSource(final NodeConfigSource configSource) {
        this.configSource = configSource;
        return this;
    }

    public io.k8s.api.core.v1.NodeSpec externalID(final String externalID) {
        this.externalID = externalID;
        return this;
    }

    public io.k8s.api.core.v1.NodeSpec podCIDR(final String podCIDR) {
        this.podCIDR = podCIDR;
        return this;
    }

    public io.k8s.api.core.v1.NodeSpec podCIDRs(final List<String> podCIDRs) {
        this.podCIDRs = podCIDRs;
        return this;
    }

    public io.k8s.api.core.v1.NodeSpec providerID(final String providerID) {
        this.providerID = providerID;
        return this;
    }

    public io.k8s.api.core.v1.NodeSpec taints(final List<Taint> taints) {
        this.taints = taints;
        return this;
    }

    public io.k8s.api.core.v1.NodeSpec unschedulable(final Boolean unschedulable) {
        this.unschedulable = unschedulable;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.NodeSpec validate() {
        return this;
    }
