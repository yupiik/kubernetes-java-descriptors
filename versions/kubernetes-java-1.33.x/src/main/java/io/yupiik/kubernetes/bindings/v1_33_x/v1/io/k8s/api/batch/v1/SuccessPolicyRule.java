...
public class io.k8s.api.batch.v1.SuccessPolicyRule implements Validable<io.k8s.api.batch.v1.SuccessPolicyRule>, Exportable {
    private Integer succeededCount;
    private String succeededIndexes;

    public io.k8s.api.batch.v1.SuccessPolicyRule() {
        // no-op
    }

    public io.k8s.api.batch.v1.SuccessPolicyRule(final Integer succeededCount,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.batch.v1.SuccessPolicyRule)) {
            return false;
        }
        final io.k8s.api.batch.v1.SuccessPolicyRule __otherCasted = (io.k8s.api.batch.v1.SuccessPolicyRule) __other;
    ...
    public io.k8s.api.batch.v1.SuccessPolicyRule succeededCount(final Integer succeededCount) {
        this.succeededCount = succeededCount;
        return this;
    }

    public io.k8s.api.batch.v1.SuccessPolicyRule succeededIndexes(final String succeededIndexes) {
        this.succeededIndexes = succeededIndexes;
        return this;
    }

    @Override
    public io.k8s.api.batch.v1.SuccessPolicyRule validate() {
        return this;
    }
