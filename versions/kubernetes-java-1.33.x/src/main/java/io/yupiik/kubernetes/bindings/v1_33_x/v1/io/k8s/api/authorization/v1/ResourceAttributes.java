...
public class io.k8s.api.authorization.v1.ResourceAttributes implements Validable<io.k8s.api.authorization.v1.ResourceAttributes>, Exportable {
    ...
    public io.k8s.api.authorization.v1.ResourceAttributes() {
        // no-op
    }

    public io.k8s.api.authorization.v1.ResourceAttributes(final FieldSelectorAttributes fieldSelector,
                                                          final String group,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.authorization.v1.ResourceAttributes)) {
            return false;
        }
        final io.k8s.api.authorization.v1.ResourceAttributes __otherCasted = (io.k8s.api.authorization.v1.ResourceAttributes) __other;
    ...
    public io.k8s.api.authorization.v1.ResourceAttributes fieldSelector(final FieldSelectorAttributes fieldSelector) {
        this.fieldSelector = fieldSelector;
        return this;
    }

    public io.k8s.api.authorization.v1.ResourceAttributes group(final String group) {
        this.group = group;
        return this;
    }

    public io.k8s.api.authorization.v1.ResourceAttributes labelSelector(final LabelSelectorAttributes labelSelector) {
        this.labelSelector = labelSelector;
        return this;
    }

    public io.k8s.api.authorization.v1.ResourceAttributes name(final String name) {
        this.name = name;
        return this;
    }

    public io.k8s.api.authorization.v1.ResourceAttributes namespace(final String namespace) {
        this.namespace = namespace;
        return this;
    }

    public io.k8s.api.authorization.v1.ResourceAttributes resource(final String resource) {
        this.resource = resource;
        return this;
    }

    public io.k8s.api.authorization.v1.ResourceAttributes subresource(final String subresource) {
        this.subresource = subresource;
        return this;
    }

    public io.k8s.api.authorization.v1.ResourceAttributes verb(final String verb) {
        this.verb = verb;
        return this;
    }

    public io.k8s.api.authorization.v1.ResourceAttributes version(final String version) {
        this.version = version;
        return this;
    }

    @Override
    public io.k8s.api.authorization.v1.ResourceAttributes validate() {
        return this;
    }
