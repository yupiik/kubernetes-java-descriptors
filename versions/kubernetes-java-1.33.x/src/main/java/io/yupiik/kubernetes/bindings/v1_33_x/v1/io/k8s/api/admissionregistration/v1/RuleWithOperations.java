...
public class io.k8s.api.admissionregistration.v1.RuleWithOperations implements Validable<io.k8s.api.admissionregistration.v1.RuleWithOperations>, Exportable {
    ...
    public io.k8s.api.admissionregistration.v1.RuleWithOperations() {
        // no-op
    }

    public io.k8s.api.admissionregistration.v1.RuleWithOperations(final List<String> apiGroups,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.admissionregistration.v1.RuleWithOperations)) {
            return false;
        }
        final io.k8s.api.admissionregistration.v1.RuleWithOperations __otherCasted = (io.k8s.api.admissionregistration.v1.RuleWithOperations) __other;
    ...
    public io.k8s.api.admissionregistration.v1.RuleWithOperations apiGroups(final List<String> apiGroups) {
        this.apiGroups = apiGroups;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.RuleWithOperations apiVersions(final List<String> apiVersions) {
        this.apiVersions = apiVersions;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.RuleWithOperations operations(final List<String> operations) {
        this.operations = operations;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.RuleWithOperations resources(final List<String> resources) {
        this.resources = resources;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.RuleWithOperations scope(final String scope) {
        this.scope = scope;
        return this;
    }

    @Override
    public io.k8s.api.admissionregistration.v1.RuleWithOperations validate() {
        return this;
    }
