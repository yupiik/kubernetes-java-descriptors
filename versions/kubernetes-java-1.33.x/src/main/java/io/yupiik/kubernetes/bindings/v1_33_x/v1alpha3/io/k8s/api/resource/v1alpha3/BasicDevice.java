...
public class io.k8s.api.resource.v1alpha3.BasicDevice implements Validable<io.k8s.api.resource.v1alpha3.BasicDevice>, Exportable {
    ...
    public io.k8s.api.resource.v1alpha3.BasicDevice(final Boolean allNodes,
    ...
    public io.k8s.api.resource.v1alpha3.BasicDevice allNodes(final Boolean allNodes) {
        this.allNodes = allNodes;
        return this;
    }
    ...
    public io.k8s.api.resource.v1alpha3.BasicDevice consumesCounters(final List<DeviceCounterConsumption> consumesCounters) {
        this.consumesCounters = consumesCounters;
        return this;
    }

    public io.k8s.api.resource.v1alpha3.BasicDevice nodeName(final String nodeName) {
        this.nodeName = nodeName;
        return this;
    }

    public io.k8s.api.resource.v1alpha3.BasicDevice nodeSelector(final NodeSelector nodeSelector) {
        this.nodeSelector = nodeSelector;
        return this;
    }

    public io.k8s.api.resource.v1alpha3.BasicDevice taints(final List<DeviceTaint> taints) {
        this.taints = taints;
        return this;
    }
