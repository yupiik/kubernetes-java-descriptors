...
public class io.k8s.api.resource.v1beta1.DeviceAllocationResult implements Validable<io.k8s.api.resource.v1beta1.DeviceAllocationResult>, Exportable {
    private List<DeviceAllocationConfiguration> config;
    private List<DeviceRequestAllocationResult> results;

    public io.k8s.api.resource.v1beta1.DeviceAllocationResult() {
        // no-op
    }

    public io.k8s.api.resource.v1beta1.DeviceAllocationResult(final List<DeviceAllocationConfiguration> config,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.resource.v1beta1.DeviceAllocationResult)) {
            return false;
        }
        final io.k8s.api.resource.v1beta1.DeviceAllocationResult __otherCasted = (io.k8s.api.resource.v1beta1.DeviceAllocationResult) __other;
        return Objects.equals(config, __otherCasted.config) &&
            Objects.equals(results, __otherCasted.results);
    }

    public io.k8s.api.resource.v1beta1.DeviceAllocationResult config(final List<DeviceAllocationConfiguration> config) {
        this.config = config;
        return this;
    }

    public io.k8s.api.resource.v1beta1.DeviceAllocationResult results(final List<DeviceRequestAllocationResult> results) {
        this.results = results;
        return this;
    }

    @Override
    public io.k8s.api.resource.v1beta1.DeviceAllocationResult validate() {
        return this;
    }
