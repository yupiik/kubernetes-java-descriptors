...
public class StorageClassMetadataOwnerReferences {
    ...
    public StorageClassMetadataOwnerReferences() {
        // no-op
    }

    public StorageClassMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StorageClassMetadataOwnerReferences)) {
            return false;
        }
        final StorageClassMetadataOwnerReferences __otherCasted = (StorageClassMetadataOwnerReferences) __other;
