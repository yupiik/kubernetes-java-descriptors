...
public class DaemonSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts {
    ...
    public DaemonSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts() {
        // no-op
    }

    public DaemonSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts)) {
            return false;
        }
        final DaemonSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts __otherCasted = (DaemonSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts) __other;
