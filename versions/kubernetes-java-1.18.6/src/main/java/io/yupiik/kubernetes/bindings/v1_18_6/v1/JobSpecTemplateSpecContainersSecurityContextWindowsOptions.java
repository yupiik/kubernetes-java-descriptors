...
public class JobSpecTemplateSpecContainersSecurityContextWindowsOptions {
    private String gmsaCredentialSpec;
    private String gmsaCredentialSpecName;
    private String runAsUserName;

    public JobSpecTemplateSpecContainersSecurityContextWindowsOptions() {
        // no-op
    }

    public JobSpecTemplateSpecContainersSecurityContextWindowsOptions(final String gmsaCredentialSpec,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobSpecTemplateSpecContainersSecurityContextWindowsOptions)) {
            return false;
        }
        final JobSpecTemplateSpecContainersSecurityContextWindowsOptions __otherCasted = (JobSpecTemplateSpecContainersSecurityContextWindowsOptions) __other;
