...
public class DaemonSetListItemsSpecTemplateMetadataManagedFields {
    ...
    public DaemonSetListItemsSpecTemplateMetadataManagedFields() {
        // no-op
    }

    public DaemonSetListItemsSpecTemplateMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetListItemsSpecTemplateMetadataManagedFields)) {
            return false;
        }
        final DaemonSetListItemsSpecTemplateMetadataManagedFields __otherCasted = (DaemonSetListItemsSpecTemplateMetadataManagedFields) __other;
