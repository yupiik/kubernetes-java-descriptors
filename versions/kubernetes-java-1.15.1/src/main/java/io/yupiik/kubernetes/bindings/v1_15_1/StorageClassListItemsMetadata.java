...
public class StorageClassListItemsMetadata {
    ...
    private StorageClassListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<StorageClassListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<StorageClassListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public StorageClassListItemsMetadata() {
        // no-op
    }

    public StorageClassListItemsMetadata(final Map<String, String> annotations,
                                         ...
                                         final StorageClassListItemsMetadataInitializers initializers,
                                         final Map<String, String> labels,
                                         final List<StorageClassListItemsMetadataManagedFields> managedFields,
                                         final String name,
                                         final String namespace,
                                         final List<StorageClassListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public StorageClassListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final StorageClassListItemsMetadataInitializers initializers) {
    ...
    public List<StorageClassListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<StorageClassListItemsMetadataManagedFields> managedFields) {
    ...
    public List<StorageClassListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<StorageClassListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StorageClassListItemsMetadata)) {
            return false;
        }
        final StorageClassListItemsMetadata __otherCasted = (StorageClassListItemsMetadata) __other;
