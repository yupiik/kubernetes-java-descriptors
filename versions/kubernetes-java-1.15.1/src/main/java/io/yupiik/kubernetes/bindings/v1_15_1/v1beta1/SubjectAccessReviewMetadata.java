...
public class SubjectAccessReviewMetadata {
    ...
    private SubjectAccessReviewMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<SubjectAccessReviewMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<SubjectAccessReviewMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public SubjectAccessReviewMetadata() {
        // no-op
    }

    public SubjectAccessReviewMetadata(final Map<String, String> annotations,
                                       ...
                                       final SubjectAccessReviewMetadataInitializers initializers,
                                       final Map<String, String> labels,
                                       final List<SubjectAccessReviewMetadataManagedFields> managedFields,
                                       final String name,
                                       final String namespace,
                                       final List<SubjectAccessReviewMetadataOwnerReferences> ownerReferences,
    ...
    public SubjectAccessReviewMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final SubjectAccessReviewMetadataInitializers initializers) {
    ...
    public List<SubjectAccessReviewMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<SubjectAccessReviewMetadataManagedFields> managedFields) {
    ...
    public List<SubjectAccessReviewMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<SubjectAccessReviewMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof SubjectAccessReviewMetadata)) {
            return false;
        }
        final SubjectAccessReviewMetadata __otherCasted = (SubjectAccessReviewMetadata) __other;
