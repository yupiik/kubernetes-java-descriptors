...
public class LimitRangeMetadataInitializersResultDetails {
    private List<LimitRangeMetadataInitializersResultDetailsCauses> causes;
    ...
    public LimitRangeMetadataInitializersResultDetails(final List<LimitRangeMetadataInitializersResultDetailsCauses> causes,
                                                       final String group,
                                                       final String kind,
                                                       final String name,
    ...
    public List<LimitRangeMetadataInitializersResultDetailsCauses> getCauses() {
        return causes;
    }

    public void setCauses(final List<LimitRangeMetadataInitializersResultDetailsCauses> causes) {
        this.causes = causes;
    }
