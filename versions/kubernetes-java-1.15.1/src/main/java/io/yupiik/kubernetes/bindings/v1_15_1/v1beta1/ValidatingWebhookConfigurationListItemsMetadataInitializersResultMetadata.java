...
public class ValidatingWebhookConfigurationListItemsMetadataInitializersResultMetadata {
    ...
    public ValidatingWebhookConfigurationListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public ValidatingWebhookConfigurationListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ValidatingWebhookConfigurationListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final ValidatingWebhookConfigurationListItemsMetadataInitializersResultMetadata __otherCasted = (ValidatingWebhookConfigurationListItemsMetadataInitializersResultMetadata) __other;
