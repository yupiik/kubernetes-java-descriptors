...
public class LocalSubjectAccessReviewMetadataInitializers {
    private List<LocalSubjectAccessReviewMetadataInitializersPending> pending;
    ...
    public LocalSubjectAccessReviewMetadataInitializers(final List<LocalSubjectAccessReviewMetadataInitializersPending> pending,
                                                        final LocalSubjectAccessReviewMetadataInitializersResult result) {
        // no-op
    }

    public List<LocalSubjectAccessReviewMetadataInitializersPending> getPending() {
        return pending;
    }

    public void setPending(final List<LocalSubjectAccessReviewMetadataInitializersPending> pending) {
