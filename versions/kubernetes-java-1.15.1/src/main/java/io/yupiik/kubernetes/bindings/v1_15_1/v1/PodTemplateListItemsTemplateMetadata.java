...
public class PodTemplateListItemsTemplateMetadata {
    ...
    private PodTemplateListItemsTemplateMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PodTemplateListItemsTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PodTemplateListItemsTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PodTemplateListItemsTemplateMetadata() {
        // no-op
    }

    public PodTemplateListItemsTemplateMetadata(final Map<String, String> annotations,
                                                ...
                                                final PodTemplateListItemsTemplateMetadataInitializers initializers,
                                                final Map<String, String> labels,
                                                final List<PodTemplateListItemsTemplateMetadataManagedFields> managedFields,
                                                final String name,
                                                final String namespace,
                                                final List<PodTemplateListItemsTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public PodTemplateListItemsTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PodTemplateListItemsTemplateMetadataInitializers initializers) {
    ...
    public List<PodTemplateListItemsTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PodTemplateListItemsTemplateMetadataManagedFields> managedFields) {
    ...
    public List<PodTemplateListItemsTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PodTemplateListItemsTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateListItemsTemplateMetadata)) {
            return false;
        }
        final PodTemplateListItemsTemplateMetadata __otherCasted = (PodTemplateListItemsTemplateMetadata) __other;
