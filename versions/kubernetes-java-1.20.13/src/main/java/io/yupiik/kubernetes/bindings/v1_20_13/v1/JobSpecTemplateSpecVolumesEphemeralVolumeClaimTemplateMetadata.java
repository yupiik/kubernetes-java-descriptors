...
public class JobSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadata {
    ...
    private List<JobSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<JobSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public JobSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadata() {
        // no-op
    }

    public JobSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadata(final Map<String, String> annotations,
                                                                          ...
                                                                          final List<JobSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> managedFields,
                                                                          final String name,
                                                                          final String namespace,
                                                                          final List<JobSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public List<JobSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<JobSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> managedFields) {
    ...
    public List<JobSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<JobSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadata)) {
            return false;
        }
        final JobSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadata __otherCasted = (JobSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadata) __other;
