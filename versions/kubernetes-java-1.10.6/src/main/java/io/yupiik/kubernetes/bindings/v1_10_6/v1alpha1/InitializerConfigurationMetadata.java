package io.yupiik.kubernetes.bindings.v1_10_6.v1alpha1;
...
public class InitializerConfigurationMetadata {
    ...
    private InitializerConfigurationMetadataInitializers initializers;
    ...
    public InitializerConfigurationMetadata() {
        // no-op
    }

    public InitializerConfigurationMetadata(final Map<String, String> annotations,
                                            ...
                                            final InitializerConfigurationMetadataInitializers initializers,
    ...
    public InitializerConfigurationMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final InitializerConfigurationMetadataInitializers initializers) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof InitializerConfigurationMetadata)) {
            return false;
        }
        final InitializerConfigurationMetadata __otherCasted = (InitializerConfigurationMetadata) __other;
