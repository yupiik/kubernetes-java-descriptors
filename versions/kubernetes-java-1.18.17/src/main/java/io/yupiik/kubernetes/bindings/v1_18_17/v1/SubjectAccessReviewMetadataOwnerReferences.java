...
public class SubjectAccessReviewMetadataOwnerReferences {
    ...
    public SubjectAccessReviewMetadataOwnerReferences() {
        // no-op
    }

    public SubjectAccessReviewMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof SubjectAccessReviewMetadataOwnerReferences)) {
            return false;
        }
        final SubjectAccessReviewMetadataOwnerReferences __otherCasted = (SubjectAccessReviewMetadataOwnerReferences) __other;
