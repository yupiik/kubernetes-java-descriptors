...
public class PodListItemsSpecVolumesFc {
    ...
    public PodListItemsSpecVolumesFc() {
        // no-op
    }

    public PodListItemsSpecVolumesFc(final String fsType,
                                     final Integer lun,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodListItemsSpecVolumesFc)) {
            return false;
        }
        final PodListItemsSpecVolumesFc __otherCasted = (PodListItemsSpecVolumesFc) __other;
