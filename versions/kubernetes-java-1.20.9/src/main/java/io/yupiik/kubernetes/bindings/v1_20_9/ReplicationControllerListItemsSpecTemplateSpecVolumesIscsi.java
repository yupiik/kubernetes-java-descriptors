...
public class ReplicationControllerListItemsSpecTemplateSpecVolumesIscsi {
    ...
    private ReplicationControllerListItemsSpecTemplateSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public ReplicationControllerListItemsSpecTemplateSpecVolumesIscsi() {
        // no-op
    }

    public ReplicationControllerListItemsSpecTemplateSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                                                      ...
                                                                      final ReplicationControllerListItemsSpecTemplateSpecVolumesIscsiSecretRef secretRef,
    ...
    public ReplicationControllerListItemsSpecTemplateSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final ReplicationControllerListItemsSpecTemplateSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicationControllerListItemsSpecTemplateSpecVolumesIscsi)) {
            return false;
        }
        final ReplicationControllerListItemsSpecTemplateSpecVolumesIscsi __otherCasted = (ReplicationControllerListItemsSpecTemplateSpecVolumesIscsi) __other;
