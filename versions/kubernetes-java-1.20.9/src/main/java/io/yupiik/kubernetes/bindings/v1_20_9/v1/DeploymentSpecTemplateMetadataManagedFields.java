...
public class DeploymentSpecTemplateMetadataManagedFields {
    ...
    public DeploymentSpecTemplateMetadataManagedFields() {
        // no-op
    }

    public DeploymentSpecTemplateMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentSpecTemplateMetadataManagedFields)) {
            return false;
        }
        final DeploymentSpecTemplateMetadataManagedFields __otherCasted = (DeploymentSpecTemplateMetadataManagedFields) __other;
