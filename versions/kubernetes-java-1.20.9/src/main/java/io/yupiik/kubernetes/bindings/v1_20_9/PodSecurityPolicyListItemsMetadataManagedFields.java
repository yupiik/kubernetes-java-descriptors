...
public class PodSecurityPolicyListItemsMetadataManagedFields {
    ...
    public PodSecurityPolicyListItemsMetadataManagedFields() {
        // no-op
    }

    public PodSecurityPolicyListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSecurityPolicyListItemsMetadataManagedFields)) {
            return false;
        }
        final PodSecurityPolicyListItemsMetadataManagedFields __otherCasted = (PodSecurityPolicyListItemsMetadataManagedFields) __other;
