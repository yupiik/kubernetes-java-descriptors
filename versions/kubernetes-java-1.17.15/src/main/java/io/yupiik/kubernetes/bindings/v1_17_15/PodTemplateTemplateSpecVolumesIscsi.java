...
public class PodTemplateTemplateSpecVolumesIscsi {
    ...
    private PodTemplateTemplateSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public PodTemplateTemplateSpecVolumesIscsi() {
        // no-op
    }

    public PodTemplateTemplateSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                               ...
                                               final PodTemplateTemplateSpecVolumesIscsiSecretRef secretRef,
    ...
    public PodTemplateTemplateSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final PodTemplateTemplateSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateTemplateSpecVolumesIscsi)) {
            return false;
        }
        final PodTemplateTemplateSpecVolumesIscsi __otherCasted = (PodTemplateTemplateSpecVolumesIscsi) __other;
