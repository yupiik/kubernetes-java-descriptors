...
public class PriorityLevelConfigurationListMetadata {
    ...
    public PriorityLevelConfigurationListMetadata() {
        // no-op
    }

    public PriorityLevelConfigurationListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PriorityLevelConfigurationListMetadata)) {
            return false;
        }
        final PriorityLevelConfigurationListMetadata __otherCasted = (PriorityLevelConfigurationListMetadata) __other;
