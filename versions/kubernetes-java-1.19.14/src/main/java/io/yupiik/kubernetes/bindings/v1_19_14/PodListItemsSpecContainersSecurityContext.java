...
public class PodListItemsSpecContainersSecurityContext {
    ...
    private PodListItemsSpecContainersSecurityContextSeccompProfile seccompProfile;
    ...
    public PodListItemsSpecContainersSecurityContext(final Boolean allowPrivilegeEscalation,
                                                     ...
                                                     final PodListItemsSpecContainersSecurityContextSeccompProfile seccompProfile,
    ...
    public PodListItemsSpecContainersSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final PodListItemsSpecContainersSecurityContextSeccompProfile seccompProfile) {
