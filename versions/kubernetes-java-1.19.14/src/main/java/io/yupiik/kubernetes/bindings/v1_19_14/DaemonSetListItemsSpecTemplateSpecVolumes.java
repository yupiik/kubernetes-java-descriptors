...
public class DaemonSetListItemsSpecTemplateSpecVolumes {
    ...
    private DaemonSetListItemsSpecTemplateSpecVolumesEphemeral ephemeral;
    ...
    public DaemonSetListItemsSpecTemplateSpecVolumes(final DaemonSetListItemsSpecTemplateSpecVolumesAwsElasticBlockStore awsElasticBlockStore,
                                                     ...
                                                     final DaemonSetListItemsSpecTemplateSpecVolumesEphemeral ephemeral,
    ...
    public DaemonSetListItemsSpecTemplateSpecVolumesEphemeral getEphemeral() {
        return ephemeral;
    }

    public void setEphemeral(final DaemonSetListItemsSpecTemplateSpecVolumesEphemeral ephemeral) {
