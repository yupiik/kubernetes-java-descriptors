...
public class PodPresetListItemsSpecVolumesIscsi {
    ...
    private PodPresetListItemsSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public PodPresetListItemsSpecVolumesIscsi() {
        // no-op
    }

    public PodPresetListItemsSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                              ...
                                              final PodPresetListItemsSpecVolumesIscsiSecretRef secretRef,
    ...
    public PodPresetListItemsSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final PodPresetListItemsSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodPresetListItemsSpecVolumesIscsi)) {
            return false;
        }
        final PodPresetListItemsSpecVolumesIscsi __otherCasted = (PodPresetListItemsSpecVolumesIscsi) __other;
