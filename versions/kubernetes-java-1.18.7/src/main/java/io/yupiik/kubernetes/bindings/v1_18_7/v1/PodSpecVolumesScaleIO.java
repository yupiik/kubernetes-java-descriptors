...
public class PodSpecVolumesScaleIO {
    private String fsType;
    private String gateway;
    private String protectionDomain;
    private Boolean readOnly;
    private PodSpecVolumesScaleIOSecretRef secretRef;
    ...
    public PodSpecVolumesScaleIO() {
        // no-op
    }

    public PodSpecVolumesScaleIO(final String fsType,
                                 final String gateway,
                                 final String protectionDomain,
                                 final Boolean readOnly,
                                 final PodSpecVolumesScaleIOSecretRef secretRef,
    ...
    public PodSpecVolumesScaleIOSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final PodSpecVolumesScaleIOSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSpecVolumesScaleIO)) {
            return false;
        }
        final PodSpecVolumesScaleIO __otherCasted = (PodSpecVolumesScaleIO) __other;
