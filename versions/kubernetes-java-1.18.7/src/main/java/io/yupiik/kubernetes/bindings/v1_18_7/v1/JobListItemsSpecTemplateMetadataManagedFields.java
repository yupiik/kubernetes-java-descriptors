...
public class JobListItemsSpecTemplateMetadataManagedFields {
    ...
    public JobListItemsSpecTemplateMetadataManagedFields() {
        // no-op
    }

    public JobListItemsSpecTemplateMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobListItemsSpecTemplateMetadataManagedFields)) {
            return false;
        }
        final JobListItemsSpecTemplateMetadataManagedFields __otherCasted = (JobListItemsSpecTemplateMetadataManagedFields) __other;
