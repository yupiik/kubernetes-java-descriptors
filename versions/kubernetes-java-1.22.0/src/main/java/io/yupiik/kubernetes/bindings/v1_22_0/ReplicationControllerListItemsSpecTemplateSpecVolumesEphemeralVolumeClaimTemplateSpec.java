...
public class ReplicationControllerListItemsSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateSpec {
    ...
    private ReplicationControllerListItemsSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateSpecDataSourceRef dataSourceRef;
    ...
    public ReplicationControllerListItemsSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateSpec(final List<String> accessModes,
                                                                                                 ...
                                                                                                 final ReplicationControllerListItemsSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateSpecDataSourceRef dataSourceRef,
    ...
    public ReplicationControllerListItemsSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateSpecDataSourceRef getDataSourceRef() {
        return dataSourceRef;
    }

    public void setDataSourceRef(final ReplicationControllerListItemsSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateSpecDataSourceRef dataSourceRef) {
