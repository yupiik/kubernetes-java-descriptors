...
public class PodDisruptionBudgetMetadataManagedFields {
    ...
    public PodDisruptionBudgetMetadataManagedFields() {
        // no-op
    }

    public PodDisruptionBudgetMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodDisruptionBudgetMetadataManagedFields)) {
            return false;
        }
        final PodDisruptionBudgetMetadataManagedFields __otherCasted = (PodDisruptionBudgetMetadataManagedFields) __other;
