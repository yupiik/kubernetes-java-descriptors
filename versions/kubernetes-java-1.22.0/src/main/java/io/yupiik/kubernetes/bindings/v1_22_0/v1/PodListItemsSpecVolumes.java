...
public class PodListItemsSpecVolumes {
    ...
    private PodListItemsSpecVolumesEphemeral ephemeral;
    ...
    public PodListItemsSpecVolumes(final PodListItemsSpecVolumesAwsElasticBlockStore awsElasticBlockStore,
                                   ...
                                   final PodListItemsSpecVolumesEphemeral ephemeral,
    ...
    public PodListItemsSpecVolumesEphemeral getEphemeral() {
        return ephemeral;
    }

    public void setEphemeral(final PodListItemsSpecVolumesEphemeral ephemeral) {
