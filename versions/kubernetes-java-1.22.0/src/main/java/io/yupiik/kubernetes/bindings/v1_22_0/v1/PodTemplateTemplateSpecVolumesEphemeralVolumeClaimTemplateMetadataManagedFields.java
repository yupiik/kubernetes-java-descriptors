...
public class PodTemplateTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields {
    ...
    public PodTemplateTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields() {
        // no-op
    }

    public PodTemplateTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields)) {
            return false;
        }
        final PodTemplateTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields __otherCasted = (PodTemplateTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields) __other;
