...
public class PersistentVolumeSpecIscsi {
    ...
    private PersistentVolumeSpecIscsiSecretRef secretRef;
    private String targetPortal;

    public PersistentVolumeSpecIscsi() {
        // no-op
    }

    public PersistentVolumeSpecIscsi(final Boolean chapAuthDiscovery,
                                     ...
                                     final PersistentVolumeSpecIscsiSecretRef secretRef,
    ...
    public PersistentVolumeSpecIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final PersistentVolumeSpecIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PersistentVolumeSpecIscsi)) {
            return false;
        }
        final PersistentVolumeSpecIscsi __otherCasted = (PersistentVolumeSpecIscsi) __other;
