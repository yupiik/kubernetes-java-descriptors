...
public class StatefulSetListItemsSpecTemplateSpecContainersVolumeMounts {
    ...
    public StatefulSetListItemsSpecTemplateSpecContainersVolumeMounts() {
        // no-op
    }

    public StatefulSetListItemsSpecTemplateSpecContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetListItemsSpecTemplateSpecContainersVolumeMounts)) {
            return false;
        }
        final StatefulSetListItemsSpecTemplateSpecContainersVolumeMounts __otherCasted = (StatefulSetListItemsSpecTemplateSpecContainersVolumeMounts) __other;
