...
public class ReplicationControllerSpecTemplateSpecInitContainersVolumeMounts {
    ...
    public ReplicationControllerSpecTemplateSpecInitContainersVolumeMounts() {
        // no-op
    }

    public ReplicationControllerSpecTemplateSpecInitContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicationControllerSpecTemplateSpecInitContainersVolumeMounts)) {
            return false;
        }
        final ReplicationControllerSpecTemplateSpecInitContainersVolumeMounts __otherCasted = (ReplicationControllerSpecTemplateSpecInitContainersVolumeMounts) __other;
