...
public class ResourceQuotaMetadata {
    ...
    private ResourceQuotaMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ResourceQuotaMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ResourceQuotaMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ResourceQuotaMetadata() {
        // no-op
    }

    public ResourceQuotaMetadata(final Map<String, String> annotations,
                                 ...
                                 final ResourceQuotaMetadataInitializers initializers,
                                 final Map<String, String> labels,
                                 final List<ResourceQuotaMetadataManagedFields> managedFields,
                                 final String name,
                                 final String namespace,
                                 final List<ResourceQuotaMetadataOwnerReferences> ownerReferences,
    ...
    public ResourceQuotaMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ResourceQuotaMetadataInitializers initializers) {
    ...
    public List<ResourceQuotaMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ResourceQuotaMetadataManagedFields> managedFields) {
    ...
    public List<ResourceQuotaMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ResourceQuotaMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ResourceQuotaMetadata)) {
            return false;
        }
        final ResourceQuotaMetadata __otherCasted = (ResourceQuotaMetadata) __other;
