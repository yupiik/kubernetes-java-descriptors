...
public class StatefulSetListItemsSpecTemplateMetadata {
    ...
    private StatefulSetListItemsSpecTemplateMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<StatefulSetListItemsSpecTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<StatefulSetListItemsSpecTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public StatefulSetListItemsSpecTemplateMetadata() {
        // no-op
    }

    public StatefulSetListItemsSpecTemplateMetadata(final Map<String, String> annotations,
                                                    ...
                                                    final StatefulSetListItemsSpecTemplateMetadataInitializers initializers,
                                                    final Map<String, String> labels,
                                                    final List<StatefulSetListItemsSpecTemplateMetadataManagedFields> managedFields,
                                                    final String name,
                                                    final String namespace,
                                                    final List<StatefulSetListItemsSpecTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public StatefulSetListItemsSpecTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final StatefulSetListItemsSpecTemplateMetadataInitializers initializers) {
    ...
    public List<StatefulSetListItemsSpecTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<StatefulSetListItemsSpecTemplateMetadataManagedFields> managedFields) {
    ...
    public List<StatefulSetListItemsSpecTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<StatefulSetListItemsSpecTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetListItemsSpecTemplateMetadata)) {
            return false;
        }
        final StatefulSetListItemsSpecTemplateMetadata __otherCasted = (StatefulSetListItemsSpecTemplateMetadata) __other;
