...
public class NodeListMetadata {
    ...
    public NodeListMetadata() {
        // no-op
    }

    public NodeListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NodeListMetadata)) {
            return false;
        }
        final NodeListMetadata __otherCasted = (NodeListMetadata) __other;
