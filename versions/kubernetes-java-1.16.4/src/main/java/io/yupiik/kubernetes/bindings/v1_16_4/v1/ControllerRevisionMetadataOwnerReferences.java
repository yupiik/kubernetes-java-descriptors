...
public class ControllerRevisionMetadataOwnerReferences {
    ...
    public ControllerRevisionMetadataOwnerReferences() {
        // no-op
    }

    public ControllerRevisionMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ControllerRevisionMetadataOwnerReferences)) {
            return false;
        }
        final ControllerRevisionMetadataOwnerReferences __otherCasted = (ControllerRevisionMetadataOwnerReferences) __other;
