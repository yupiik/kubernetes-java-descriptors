...
public class JobListItemsSpecTemplateSpecVolumesAzureDisk {
    ...
    public JobListItemsSpecTemplateSpecVolumesAzureDisk() {
        // no-op
    }

    public JobListItemsSpecTemplateSpecVolumesAzureDisk(final String cachingMode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobListItemsSpecTemplateSpecVolumesAzureDisk)) {
            return false;
        }
        final JobListItemsSpecTemplateSpecVolumesAzureDisk __otherCasted = (JobListItemsSpecTemplateSpecVolumesAzureDisk) __other;
