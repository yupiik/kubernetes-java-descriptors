...
public class EndpointSliceMetadata {
    ...
    private List<EndpointSliceMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<EndpointSliceMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public EndpointSliceMetadata() {
        // no-op
    }

    public EndpointSliceMetadata(final Map<String, String> annotations,
                                 ...
                                 final List<EndpointSliceMetadataManagedFields> managedFields,
                                 final String name,
                                 final String namespace,
                                 final List<EndpointSliceMetadataOwnerReferences> ownerReferences,
    ...
    public List<EndpointSliceMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<EndpointSliceMetadataManagedFields> managedFields) {
    ...
    public List<EndpointSliceMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<EndpointSliceMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EndpointSliceMetadata)) {
            return false;
        }
        final EndpointSliceMetadata __otherCasted = (EndpointSliceMetadata) __other;
