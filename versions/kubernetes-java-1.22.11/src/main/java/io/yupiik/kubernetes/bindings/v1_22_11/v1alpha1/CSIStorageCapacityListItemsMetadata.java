package io.yupiik.kubernetes.bindings.v1_22_11.v1alpha1;

import java.util.List;
import java.util.Map;
import java.util.Objects;

public class CSIStorageCapacityListItemsMetadata {
    ...
    private List<CSIStorageCapacityListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<CSIStorageCapacityListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public CSIStorageCapacityListItemsMetadata() {
        // no-op
    }

    public CSIStorageCapacityListItemsMetadata(final Map<String, String> annotations,
                                               ...
                                               final List<CSIStorageCapacityListItemsMetadataManagedFields> managedFields,
                                               final String name,
                                               final String namespace,
                                               final List<CSIStorageCapacityListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public List<CSIStorageCapacityListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<CSIStorageCapacityListItemsMetadataManagedFields> managedFields) {
    ...
    public List<CSIStorageCapacityListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<CSIStorageCapacityListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSIStorageCapacityListItemsMetadata)) {
            return false;
        }
        final CSIStorageCapacityListItemsMetadata __otherCasted = (CSIStorageCapacityListItemsMetadata) __other;
