...
public class VolumeAttachmentMetadataManagedFields {
    ...
    public VolumeAttachmentMetadataManagedFields() {
        // no-op
    }

    public VolumeAttachmentMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof VolumeAttachmentMetadataManagedFields)) {
            return false;
        }
        final VolumeAttachmentMetadataManagedFields __otherCasted = (VolumeAttachmentMetadataManagedFields) __other;
