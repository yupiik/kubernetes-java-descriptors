...
public class RoleMetadata {
    ...
    private List<RoleMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<RoleMetadataOwnerReferences> ownerReferences;
    ...
    public RoleMetadata(final Map<String, String> annotations,
                        ...
                        final List<RoleMetadataManagedFields> managedFields,
                        final String name,
                        final String namespace,
                        final List<RoleMetadataOwnerReferences> ownerReferences,
    ...
    public List<RoleMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<RoleMetadataManagedFields> managedFields) {
    ...
    public List<RoleMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<RoleMetadataOwnerReferences> ownerReferences) {
