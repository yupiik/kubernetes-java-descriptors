...
public class DeploymentListItemsMetadataManagedFields {
    ...
    public DeploymentListItemsMetadataManagedFields() {
        // no-op
    }

    public DeploymentListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentListItemsMetadataManagedFields)) {
            return false;
        }
        final DeploymentListItemsMetadataManagedFields __otherCasted = (DeploymentListItemsMetadataManagedFields) __other;
