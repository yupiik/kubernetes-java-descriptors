...
public class RoleListItemsMetadataManagedFields {
    ...
    public RoleListItemsMetadataManagedFields() {
        // no-op
    }

    public RoleListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RoleListItemsMetadataManagedFields)) {
            return false;
        }
        final RoleListItemsMetadataManagedFields __otherCasted = (RoleListItemsMetadataManagedFields) __other;
