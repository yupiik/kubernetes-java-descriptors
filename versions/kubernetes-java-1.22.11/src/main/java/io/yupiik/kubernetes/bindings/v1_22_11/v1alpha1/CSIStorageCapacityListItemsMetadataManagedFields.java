...
public class CSIStorageCapacityListItemsMetadataManagedFields {
    ...
    public CSIStorageCapacityListItemsMetadataManagedFields() {
        // no-op
    }

    public CSIStorageCapacityListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSIStorageCapacityListItemsMetadataManagedFields)) {
            return false;
        }
        final CSIStorageCapacityListItemsMetadataManagedFields __otherCasted = (CSIStorageCapacityListItemsMetadataManagedFields) __other;
