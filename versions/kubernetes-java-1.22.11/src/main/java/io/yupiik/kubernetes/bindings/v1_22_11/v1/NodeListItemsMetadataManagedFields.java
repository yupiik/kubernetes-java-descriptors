...
public class NodeListItemsMetadataManagedFields {
    ...
    public NodeListItemsMetadataManagedFields() {
        // no-op
    }

    public NodeListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NodeListItemsMetadataManagedFields)) {
            return false;
        }
        final NodeListItemsMetadataManagedFields __otherCasted = (NodeListItemsMetadataManagedFields) __other;
