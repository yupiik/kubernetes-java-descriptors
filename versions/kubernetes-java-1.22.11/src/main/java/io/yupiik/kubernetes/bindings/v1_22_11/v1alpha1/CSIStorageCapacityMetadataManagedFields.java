...
public class CSIStorageCapacityMetadataManagedFields {
    ...
    public CSIStorageCapacityMetadataManagedFields() {
        // no-op
    }

    public CSIStorageCapacityMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSIStorageCapacityMetadataManagedFields)) {
            return false;
        }
        final CSIStorageCapacityMetadataManagedFields __otherCasted = (CSIStorageCapacityMetadataManagedFields) __other;
