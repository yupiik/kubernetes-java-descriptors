...
public class ReplicationControllerSpecTemplateSpecEphemeralContainersStartupProbe {
    ...
    private ReplicationControllerSpecTemplateSpecEphemeralContainersStartupProbeGrpc grpc;
    ...
    public ReplicationControllerSpecTemplateSpecEphemeralContainersStartupProbe(final ReplicationControllerSpecTemplateSpecEphemeralContainersStartupProbeExec exec,
                                                                                ...
                                                                                final ReplicationControllerSpecTemplateSpecEphemeralContainersStartupProbeGrpc grpc,
    ...
    public ReplicationControllerSpecTemplateSpecEphemeralContainersStartupProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final ReplicationControllerSpecTemplateSpecEphemeralContainersStartupProbeGrpc grpc) {
        this.grpc = grpc;
    }
