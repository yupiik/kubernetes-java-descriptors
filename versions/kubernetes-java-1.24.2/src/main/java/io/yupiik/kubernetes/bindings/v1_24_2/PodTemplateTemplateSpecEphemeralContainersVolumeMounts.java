...
public class PodTemplateTemplateSpecEphemeralContainersVolumeMounts {
    ...
    public PodTemplateTemplateSpecEphemeralContainersVolumeMounts() {
        // no-op
    }

    public PodTemplateTemplateSpecEphemeralContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateTemplateSpecEphemeralContainersVolumeMounts)) {
            return false;
        }
        final PodTemplateTemplateSpecEphemeralContainersVolumeMounts __otherCasted = (PodTemplateTemplateSpecEphemeralContainersVolumeMounts) __other;
