...
public class RoleMetadataManagedFields {
    ...
    public RoleMetadataManagedFields() {
        // no-op
    }

    public RoleMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RoleMetadataManagedFields)) {
            return false;
        }
        final RoleMetadataManagedFields __otherCasted = (RoleMetadataManagedFields) __other;
