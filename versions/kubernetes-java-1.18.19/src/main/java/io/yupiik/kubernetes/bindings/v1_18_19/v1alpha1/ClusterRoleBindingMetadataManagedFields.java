...
public class ClusterRoleBindingMetadataManagedFields {
    ...
    public ClusterRoleBindingMetadataManagedFields() {
        // no-op
    }

    public ClusterRoleBindingMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ClusterRoleBindingMetadataManagedFields)) {
            return false;
        }
        final ClusterRoleBindingMetadataManagedFields __otherCasted = (ClusterRoleBindingMetadataManagedFields) __other;
