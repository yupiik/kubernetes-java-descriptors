...
public class HorizontalPodAutoscalerStatusCurrentMetrics {
    private HorizontalPodAutoscalerStatusCurrentMetricsContainerResource containerResource;
    ...
    public HorizontalPodAutoscalerStatusCurrentMetrics(final HorizontalPodAutoscalerStatusCurrentMetricsContainerResource containerResource,
                                                       final HorizontalPodAutoscalerStatusCurrentMetricsExternal external,
    ...
    public HorizontalPodAutoscalerStatusCurrentMetricsContainerResource getContainerResource() {
        return containerResource;
    }

    public void setContainerResource(final HorizontalPodAutoscalerStatusCurrentMetricsContainerResource containerResource) {
