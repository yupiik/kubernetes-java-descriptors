...
public class PodMetadataOwnerReferences {
    ...
    public PodMetadataOwnerReferences() {
        // no-op
    }

    public PodMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodMetadataOwnerReferences)) {
            return false;
        }
        final PodMetadataOwnerReferences __otherCasted = (PodMetadataOwnerReferences) __other;
