...
public class ScheduledJobMetadata {
    ...
    private ScheduledJobMetadataInitializers initializers;
    ...
    public ScheduledJobMetadata(final Map<String, String> annotations,
                                ...
                                final ScheduledJobMetadataInitializers initializers,
    ...
    public ScheduledJobMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ScheduledJobMetadataInitializers initializers) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ScheduledJobMetadata)) {
            return false;
        }
        final ScheduledJobMetadata __otherCasted = (ScheduledJobMetadata) __other;
