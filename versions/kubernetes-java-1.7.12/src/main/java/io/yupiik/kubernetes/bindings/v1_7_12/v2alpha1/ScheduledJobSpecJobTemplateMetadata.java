...
public class ScheduledJobSpecJobTemplateMetadata {
    ...
    private ScheduledJobSpecJobTemplateMetadataInitializers initializers;
    ...
    public ScheduledJobSpecJobTemplateMetadata() {
        // no-op
    }

    public ScheduledJobSpecJobTemplateMetadata(final Map<String, String> annotations,
                                               ...
                                               final ScheduledJobSpecJobTemplateMetadataInitializers initializers,
    ...
    public ScheduledJobSpecJobTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ScheduledJobSpecJobTemplateMetadataInitializers initializers) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ScheduledJobSpecJobTemplateMetadata)) {
            return false;
        }
        final ScheduledJobSpecJobTemplateMetadata __otherCasted = (ScheduledJobSpecJobTemplateMetadata) __other;
