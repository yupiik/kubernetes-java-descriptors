...
public class ServiceListItemsMetadataManagedFields {
    ...
    public ServiceListItemsMetadataManagedFields() {
        // no-op
    }

    public ServiceListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ServiceListItemsMetadataManagedFields)) {
            return false;
        }
        final ServiceListItemsMetadataManagedFields __otherCasted = (ServiceListItemsMetadataManagedFields) __other;
