...
public class DeploymentSpecTemplateSpecVolumesAzureDisk {
    ...
    public DeploymentSpecTemplateSpecVolumesAzureDisk() {
        // no-op
    }

    public DeploymentSpecTemplateSpecVolumesAzureDisk(final String cachingMode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentSpecTemplateSpecVolumesAzureDisk)) {
            return false;
        }
        final DeploymentSpecTemplateSpecVolumesAzureDisk __otherCasted = (DeploymentSpecTemplateSpecVolumesAzureDisk) __other;
