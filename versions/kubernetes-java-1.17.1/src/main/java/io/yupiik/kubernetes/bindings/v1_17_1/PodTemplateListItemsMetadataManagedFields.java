...
public class PodTemplateListItemsMetadataManagedFields {
    ...
    public PodTemplateListItemsMetadataManagedFields() {
        // no-op
    }

    public PodTemplateListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateListItemsMetadataManagedFields)) {
            return false;
        }
        final PodTemplateListItemsMetadataManagedFields __otherCasted = (PodTemplateListItemsMetadataManagedFields) __other;
