...
public class ServiceAccountListItemsMetadataManagedFields {
    ...
    public ServiceAccountListItemsMetadataManagedFields() {
        // no-op
    }

    public ServiceAccountListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ServiceAccountListItemsMetadataManagedFields)) {
            return false;
        }
        final ServiceAccountListItemsMetadataManagedFields __otherCasted = (ServiceAccountListItemsMetadataManagedFields) __other;
