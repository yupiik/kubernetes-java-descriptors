...
public class IngressMetadata {
    ...
    private IngressMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<IngressMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<IngressMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public IngressMetadata() {
        // no-op
    }

    public IngressMetadata(final Map<String, String> annotations,
                           ...
                           final IngressMetadataInitializers initializers,
                           final Map<String, String> labels,
                           final List<IngressMetadataManagedFields> managedFields,
                           final String name,
                           final String namespace,
                           final List<IngressMetadataOwnerReferences> ownerReferences,
    ...
    public IngressMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final IngressMetadataInitializers initializers) {
    ...
    public List<IngressMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<IngressMetadataManagedFields> managedFields) {
    ...
    public List<IngressMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<IngressMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof IngressMetadata)) {
            return false;
        }
        final IngressMetadata __otherCasted = (IngressMetadata) __other;
