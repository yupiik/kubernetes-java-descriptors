...
public class NetworkPolicyMetadata {
    ...
    private NetworkPolicyMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<NetworkPolicyMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<NetworkPolicyMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public NetworkPolicyMetadata() {
        // no-op
    }

    public NetworkPolicyMetadata(final Map<String, String> annotations,
                                 ...
                                 final NetworkPolicyMetadataInitializers initializers,
                                 final Map<String, String> labels,
                                 final List<NetworkPolicyMetadataManagedFields> managedFields,
                                 final String name,
                                 final String namespace,
                                 final List<NetworkPolicyMetadataOwnerReferences> ownerReferences,
    ...
    public NetworkPolicyMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final NetworkPolicyMetadataInitializers initializers) {
    ...
    public List<NetworkPolicyMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<NetworkPolicyMetadataManagedFields> managedFields) {
    ...
    public List<NetworkPolicyMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<NetworkPolicyMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NetworkPolicyMetadata)) {
            return false;
        }
        final NetworkPolicyMetadata __otherCasted = (NetworkPolicyMetadata) __other;
