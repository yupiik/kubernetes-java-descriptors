...
public class DeploymentMetadata {
    ...
    private DeploymentMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<DeploymentMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<DeploymentMetadataOwnerReferences> ownerReferences;
    ...
    public DeploymentMetadata(final Map<String, String> annotations,
                              ...
                              final DeploymentMetadataInitializers initializers,
                              final Map<String, String> labels,
                              final List<DeploymentMetadataManagedFields> managedFields,
                              final String name,
                              final String namespace,
                              final List<DeploymentMetadataOwnerReferences> ownerReferences,
    ...
    public DeploymentMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final DeploymentMetadataInitializers initializers) {
    ...
    public List<DeploymentMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<DeploymentMetadataManagedFields> managedFields) {
    ...
    public List<DeploymentMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<DeploymentMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentMetadata)) {
            return false;
        }
        final DeploymentMetadata __otherCasted = (DeploymentMetadata) __other;
