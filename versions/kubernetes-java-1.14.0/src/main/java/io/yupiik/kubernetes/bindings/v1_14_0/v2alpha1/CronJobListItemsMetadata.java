...
public class CronJobListItemsMetadata {
    ...
    private CronJobListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<CronJobListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<CronJobListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public CronJobListItemsMetadata() {
        // no-op
    }

    public CronJobListItemsMetadata(final Map<String, String> annotations,
                                    ...
                                    final CronJobListItemsMetadataInitializers initializers,
                                    final Map<String, String> labels,
                                    final List<CronJobListItemsMetadataManagedFields> managedFields,
                                    final String name,
                                    final String namespace,
                                    final List<CronJobListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public CronJobListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final CronJobListItemsMetadataInitializers initializers) {
    ...
    public List<CronJobListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<CronJobListItemsMetadataManagedFields> managedFields) {
    ...
    public List<CronJobListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<CronJobListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CronJobListItemsMetadata)) {
            return false;
        }
        final CronJobListItemsMetadata __otherCasted = (CronJobListItemsMetadata) __other;
