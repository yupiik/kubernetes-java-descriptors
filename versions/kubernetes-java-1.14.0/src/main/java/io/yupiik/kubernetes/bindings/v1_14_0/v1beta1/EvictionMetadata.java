...
public class EvictionMetadata {
    ...
    private EvictionMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<EvictionMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<EvictionMetadataOwnerReferences> ownerReferences;
    ...
    public EvictionMetadata(final Map<String, String> annotations,
                            ...
                            final EvictionMetadataInitializers initializers,
                            final Map<String, String> labels,
                            final List<EvictionMetadataManagedFields> managedFields,
                            final String name,
                            final String namespace,
                            final List<EvictionMetadataOwnerReferences> ownerReferences,
    ...
    public EvictionMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final EvictionMetadataInitializers initializers) {
    ...
    public List<EvictionMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<EvictionMetadataManagedFields> managedFields) {
    ...
    public List<EvictionMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<EvictionMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EvictionMetadata)) {
            return false;
        }
        final EvictionMetadata __otherCasted = (EvictionMetadata) __other;
