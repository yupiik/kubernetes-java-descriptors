...
public class CSINodeListItemsMetadata {
    ...
    private CSINodeListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<CSINodeListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<CSINodeListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public CSINodeListItemsMetadata() {
        // no-op
    }

    public CSINodeListItemsMetadata(final Map<String, String> annotations,
                                    ...
                                    final CSINodeListItemsMetadataInitializers initializers,
                                    final Map<String, String> labels,
                                    final List<CSINodeListItemsMetadataManagedFields> managedFields,
                                    final String name,
                                    final String namespace,
                                    final List<CSINodeListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public CSINodeListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final CSINodeListItemsMetadataInitializers initializers) {
    ...
    public List<CSINodeListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<CSINodeListItemsMetadataManagedFields> managedFields) {
    ...
    public List<CSINodeListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<CSINodeListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSINodeListItemsMetadata)) {
            return false;
        }
        final CSINodeListItemsMetadata __otherCasted = (CSINodeListItemsMetadata) __other;
