...
public class BindingMetadata {
    ...
    private BindingMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<BindingMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<BindingMetadataOwnerReferences> ownerReferences;
    ...
    public BindingMetadata(final Map<String, String> annotations,
                           ...
                           final BindingMetadataInitializers initializers,
                           final Map<String, String> labels,
                           final List<BindingMetadataManagedFields> managedFields,
                           final String name,
                           final String namespace,
                           final List<BindingMetadataOwnerReferences> ownerReferences,
    ...
    public BindingMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final BindingMetadataInitializers initializers) {
    ...
    public List<BindingMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<BindingMetadataManagedFields> managedFields) {
    ...
    public List<BindingMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<BindingMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof BindingMetadata)) {
            return false;
        }
        final BindingMetadata __otherCasted = (BindingMetadata) __other;
