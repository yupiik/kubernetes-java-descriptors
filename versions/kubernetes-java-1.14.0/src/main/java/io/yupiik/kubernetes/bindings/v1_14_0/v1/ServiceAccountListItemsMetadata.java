...
public class ServiceAccountListItemsMetadata {
    ...
    private ServiceAccountListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ServiceAccountListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ServiceAccountListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ServiceAccountListItemsMetadata() {
        // no-op
    }

    public ServiceAccountListItemsMetadata(final Map<String, String> annotations,
                                           ...
                                           final ServiceAccountListItemsMetadataInitializers initializers,
                                           final Map<String, String> labels,
                                           final List<ServiceAccountListItemsMetadataManagedFields> managedFields,
                                           final String name,
                                           final String namespace,
                                           final List<ServiceAccountListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public ServiceAccountListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ServiceAccountListItemsMetadataInitializers initializers) {
    ...
    public List<ServiceAccountListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ServiceAccountListItemsMetadataManagedFields> managedFields) {
    ...
    public List<ServiceAccountListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ServiceAccountListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ServiceAccountListItemsMetadata)) {
            return false;
        }
        final ServiceAccountListItemsMetadata __otherCasted = (ServiceAccountListItemsMetadata) __other;
