...
public class DeploymentStatusConditions {
    ...
    public DeploymentStatusConditions() {
        // no-op
    }

    public DeploymentStatusConditions(final String lastTransitionTime,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentStatusConditions)) {
            return false;
        }
        final DeploymentStatusConditions __otherCasted = (DeploymentStatusConditions) __other;
