...
public class ScheduledJobSpecJobTemplateSpecTemplateMetadata {
    ...
    private ScheduledJobSpecJobTemplateSpecTemplateMetadataInitializers initializers;
    ...
    public ScheduledJobSpecJobTemplateSpecTemplateMetadata() {
        // no-op
    }

    public ScheduledJobSpecJobTemplateSpecTemplateMetadata(final Map<String, String> annotations,
                                                           ...
                                                           final ScheduledJobSpecJobTemplateSpecTemplateMetadataInitializers initializers,
    ...
    public ScheduledJobSpecJobTemplateSpecTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ScheduledJobSpecJobTemplateSpecTemplateMetadataInitializers initializers) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ScheduledJobSpecJobTemplateSpecTemplateMetadata)) {
            return false;
        }
        final ScheduledJobSpecJobTemplateSpecTemplateMetadata __otherCasted = (ScheduledJobSpecJobTemplateSpecTemplateMetadata) __other;
