...
public class EndpointsMetadataManagedFields {
    ...
    public EndpointsMetadataManagedFields() {
        // no-op
    }

    public EndpointsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EndpointsMetadataManagedFields)) {
            return false;
        }
        final EndpointsMetadataManagedFields __otherCasted = (EndpointsMetadataManagedFields) __other;
