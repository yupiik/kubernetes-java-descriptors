...
public class ReplicationControllerMetadataManagedFields {
    ...
    public ReplicationControllerMetadataManagedFields() {
        // no-op
    }

    public ReplicationControllerMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicationControllerMetadataManagedFields)) {
            return false;
        }
        final ReplicationControllerMetadataManagedFields __otherCasted = (ReplicationControllerMetadataManagedFields) __other;
