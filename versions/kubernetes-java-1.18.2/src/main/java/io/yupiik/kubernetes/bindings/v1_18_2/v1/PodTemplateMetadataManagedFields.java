...
public class PodTemplateMetadataManagedFields {
    ...
    public PodTemplateMetadataManagedFields() {
        // no-op
    }

    public PodTemplateMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateMetadataManagedFields)) {
            return false;
        }
        final PodTemplateMetadataManagedFields __otherCasted = (PodTemplateMetadataManagedFields) __other;
