...
public class PodPresetSpecVolumeMounts {
    ...
    public PodPresetSpecVolumeMounts() {
        // no-op
    }

    public PodPresetSpecVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodPresetSpecVolumeMounts)) {
            return false;
        }
        final PodPresetSpecVolumeMounts __otherCasted = (PodPresetSpecVolumeMounts) __other;
