...
public class LimitRangeMetadataOwnerReferences {
    ...
    public LimitRangeMetadataOwnerReferences() {
        // no-op
    }

    public LimitRangeMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LimitRangeMetadataOwnerReferences)) {
            return false;
        }
        final LimitRangeMetadataOwnerReferences __otherCasted = (LimitRangeMetadataOwnerReferences) __other;
