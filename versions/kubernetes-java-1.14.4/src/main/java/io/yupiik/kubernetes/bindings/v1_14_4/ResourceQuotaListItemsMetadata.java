...
public class ResourceQuotaListItemsMetadata {
    ...
    private ResourceQuotaListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ResourceQuotaListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ResourceQuotaListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ResourceQuotaListItemsMetadata() {
        // no-op
    }

    public ResourceQuotaListItemsMetadata(final Map<String, String> annotations,
                                          ...
                                          final ResourceQuotaListItemsMetadataInitializers initializers,
                                          final Map<String, String> labels,
                                          final List<ResourceQuotaListItemsMetadataManagedFields> managedFields,
                                          final String name,
                                          final String namespace,
                                          final List<ResourceQuotaListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public ResourceQuotaListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ResourceQuotaListItemsMetadataInitializers initializers) {
    ...
    public List<ResourceQuotaListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ResourceQuotaListItemsMetadataManagedFields> managedFields) {
    ...
    public List<ResourceQuotaListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ResourceQuotaListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ResourceQuotaListItemsMetadata)) {
            return false;
        }
        final ResourceQuotaListItemsMetadata __otherCasted = (ResourceQuotaListItemsMetadata) __other;
