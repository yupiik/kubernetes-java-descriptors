...
public class StatefulSetListItemsSpecTemplateSpecVolumesVsphereVolume {
    private String fsType;
    private String storagePolicyID;
    private String storagePolicyName;
    private String volumePath;

    public StatefulSetListItemsSpecTemplateSpecVolumesVsphereVolume() {
        // no-op
    }

    public StatefulSetListItemsSpecTemplateSpecVolumesVsphereVolume(final String fsType,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetListItemsSpecTemplateSpecVolumesVsphereVolume)) {
            return false;
        }
        final StatefulSetListItemsSpecTemplateSpecVolumesVsphereVolume __otherCasted = (StatefulSetListItemsSpecTemplateSpecVolumesVsphereVolume) __other;
