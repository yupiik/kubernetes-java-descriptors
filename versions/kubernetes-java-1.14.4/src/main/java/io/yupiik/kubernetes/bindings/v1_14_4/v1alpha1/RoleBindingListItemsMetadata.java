package io.yupiik.kubernetes.bindings.v1_14_4.v1alpha1;

import java.util.List;
import java.util.Map;
import java.util.Objects;

public class RoleBindingListItemsMetadata {
    ...
    private RoleBindingListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<RoleBindingListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<RoleBindingListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public RoleBindingListItemsMetadata() {
        // no-op
    }

    public RoleBindingListItemsMetadata(final Map<String, String> annotations,
                                        ...
                                        final RoleBindingListItemsMetadataInitializers initializers,
                                        final Map<String, String> labels,
                                        final List<RoleBindingListItemsMetadataManagedFields> managedFields,
                                        final String name,
                                        final String namespace,
                                        final List<RoleBindingListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public RoleBindingListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final RoleBindingListItemsMetadataInitializers initializers) {
    ...
    public List<RoleBindingListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<RoleBindingListItemsMetadataManagedFields> managedFields) {
    ...
    public List<RoleBindingListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<RoleBindingListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RoleBindingListItemsMetadata)) {
            return false;
        }
        final RoleBindingListItemsMetadata __otherCasted = (RoleBindingListItemsMetadata) __other;
