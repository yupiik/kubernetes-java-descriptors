...
public class SubjectAccessReviewMetadataManagedFields {
    ...
    public SubjectAccessReviewMetadataManagedFields() {
        // no-op
    }

    public SubjectAccessReviewMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof SubjectAccessReviewMetadataManagedFields)) {
            return false;
        }
        final SubjectAccessReviewMetadataManagedFields __otherCasted = (SubjectAccessReviewMetadataManagedFields) __other;
