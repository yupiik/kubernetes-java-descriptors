...
public class JobSpecTemplateSpecInitContainersVolumeMounts {
    ...
    public JobSpecTemplateSpecInitContainersVolumeMounts() {
        // no-op
    }

    public JobSpecTemplateSpecInitContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobSpecTemplateSpecInitContainersVolumeMounts)) {
            return false;
        }
        final JobSpecTemplateSpecInitContainersVolumeMounts __otherCasted = (JobSpecTemplateSpecInitContainersVolumeMounts) __other;
