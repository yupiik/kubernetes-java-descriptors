...
public class PodPresetSpecVolumesEphemeralVolumeClaimTemplateMetadata {
    ...
    private List<PodPresetSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PodPresetSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PodPresetSpecVolumesEphemeralVolumeClaimTemplateMetadata() {
        // no-op
    }

    public PodPresetSpecVolumesEphemeralVolumeClaimTemplateMetadata(final Map<String, String> annotations,
                                                                    ...
                                                                    final List<PodPresetSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> managedFields,
                                                                    final String name,
                                                                    final String namespace,
                                                                    final List<PodPresetSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public List<PodPresetSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PodPresetSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields> managedFields) {
    ...
    public List<PodPresetSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PodPresetSpecVolumesEphemeralVolumeClaimTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodPresetSpecVolumesEphemeralVolumeClaimTemplateMetadata)) {
            return false;
        }
        final PodPresetSpecVolumesEphemeralVolumeClaimTemplateMetadata __otherCasted = (PodPresetSpecVolumesEphemeralVolumeClaimTemplateMetadata) __other;
