...
public class SecretListItemsMetadataManagedFields {
    ...
    public SecretListItemsMetadataManagedFields() {
        // no-op
    }

    public SecretListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof SecretListItemsMetadataManagedFields)) {
            return false;
        }
        final SecretListItemsMetadataManagedFields __otherCasted = (SecretListItemsMetadataManagedFields) __other;
