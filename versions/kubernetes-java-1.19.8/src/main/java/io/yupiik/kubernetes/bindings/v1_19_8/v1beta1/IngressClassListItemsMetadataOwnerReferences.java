...
public class IngressClassListItemsMetadataOwnerReferences {
    ...
    public IngressClassListItemsMetadataOwnerReferences() {
        // no-op
    }

    public IngressClassListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof IngressClassListItemsMetadataOwnerReferences)) {
            return false;
        }
        final IngressClassListItemsMetadataOwnerReferences __otherCasted = (IngressClassListItemsMetadataOwnerReferences) __other;
