...
public class CustomResourceDefinitionListItemsSpecNames {
    ...
    public CustomResourceDefinitionListItemsSpecNames() {
        // no-op
    }

    public CustomResourceDefinitionListItemsSpecNames(final List<String> categories,
                                                      final String kind,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CustomResourceDefinitionListItemsSpecNames)) {
            return false;
        }
        final CustomResourceDefinitionListItemsSpecNames __otherCasted = (CustomResourceDefinitionListItemsSpecNames) __other;
