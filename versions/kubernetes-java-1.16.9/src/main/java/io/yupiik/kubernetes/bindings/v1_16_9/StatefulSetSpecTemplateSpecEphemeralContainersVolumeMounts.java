...
public class StatefulSetSpecTemplateSpecEphemeralContainersVolumeMounts {
    ...
    public StatefulSetSpecTemplateSpecEphemeralContainersVolumeMounts() {
        // no-op
    }

    public StatefulSetSpecTemplateSpecEphemeralContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetSpecTemplateSpecEphemeralContainersVolumeMounts)) {
            return false;
        }
        final StatefulSetSpecTemplateSpecEphemeralContainersVolumeMounts __otherCasted = (StatefulSetSpecTemplateSpecEphemeralContainersVolumeMounts) __other;
