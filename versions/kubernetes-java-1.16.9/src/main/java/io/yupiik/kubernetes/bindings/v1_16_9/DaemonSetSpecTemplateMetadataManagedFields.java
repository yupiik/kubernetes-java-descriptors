...
public class DaemonSetSpecTemplateMetadataManagedFields {
    ...
    public DaemonSetSpecTemplateMetadataManagedFields() {
        // no-op
    }

    public DaemonSetSpecTemplateMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetSpecTemplateMetadataManagedFields)) {
            return false;
        }
        final DaemonSetSpecTemplateMetadataManagedFields __otherCasted = (DaemonSetSpecTemplateMetadataManagedFields) __other;
