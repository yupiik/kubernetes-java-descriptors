...
public class BindingMetadataManagedFields {
    ...
    public BindingMetadataManagedFields() {
        // no-op
    }

    public BindingMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof BindingMetadataManagedFields)) {
            return false;
        }
        final BindingMetadataManagedFields __otherCasted = (BindingMetadataManagedFields) __other;
