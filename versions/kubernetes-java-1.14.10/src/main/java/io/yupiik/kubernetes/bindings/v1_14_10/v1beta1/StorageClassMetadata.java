...
public class StorageClassMetadata {
    ...
    private StorageClassMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<StorageClassMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<StorageClassMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public StorageClassMetadata() {
        // no-op
    }

    public StorageClassMetadata(final Map<String, String> annotations,
                                ...
                                final StorageClassMetadataInitializers initializers,
                                final Map<String, String> labels,
                                final List<StorageClassMetadataManagedFields> managedFields,
                                final String name,
                                final String namespace,
                                final List<StorageClassMetadataOwnerReferences> ownerReferences,
    ...
    public StorageClassMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final StorageClassMetadataInitializers initializers) {
    ...
    public List<StorageClassMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<StorageClassMetadataManagedFields> managedFields) {
    ...
    public List<StorageClassMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<StorageClassMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StorageClassMetadata)) {
            return false;
        }
        final StorageClassMetadata __otherCasted = (StorageClassMetadata) __other;
