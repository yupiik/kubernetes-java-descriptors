...
public class CronJobMetadataInitializers {
    private List<CronJobMetadataInitializersPending> pending;
    ...
    public CronJobMetadataInitializers(final List<CronJobMetadataInitializersPending> pending,
                                       final CronJobMetadataInitializersResult result) {
        // no-op
    }

    public List<CronJobMetadataInitializersPending> getPending() {
        return pending;
    }

    public void setPending(final List<CronJobMetadataInitializersPending> pending) {
