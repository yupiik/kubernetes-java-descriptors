...
public class VolumeAttachmentMetadata {
    ...
    private VolumeAttachmentMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<VolumeAttachmentMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<VolumeAttachmentMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public VolumeAttachmentMetadata() {
        // no-op
    }

    public VolumeAttachmentMetadata(final Map<String, String> annotations,
                                    ...
                                    final VolumeAttachmentMetadataInitializers initializers,
                                    final Map<String, String> labels,
                                    final List<VolumeAttachmentMetadataManagedFields> managedFields,
                                    final String name,
                                    final String namespace,
                                    final List<VolumeAttachmentMetadataOwnerReferences> ownerReferences,
    ...
    public VolumeAttachmentMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final VolumeAttachmentMetadataInitializers initializers) {
    ...
    public List<VolumeAttachmentMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<VolumeAttachmentMetadataManagedFields> managedFields) {
    ...
    public List<VolumeAttachmentMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<VolumeAttachmentMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof VolumeAttachmentMetadata)) {
            return false;
        }
        final VolumeAttachmentMetadata __otherCasted = (VolumeAttachmentMetadata) __other;
