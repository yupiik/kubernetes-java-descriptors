...
public class ClusterRoleBindingListItemsMetadata {
    ...
    private ClusterRoleBindingListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ClusterRoleBindingListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ClusterRoleBindingListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ClusterRoleBindingListItemsMetadata() {
        // no-op
    }

    public ClusterRoleBindingListItemsMetadata(final Map<String, String> annotations,
                                               ...
                                               final ClusterRoleBindingListItemsMetadataInitializers initializers,
                                               final Map<String, String> labels,
                                               final List<ClusterRoleBindingListItemsMetadataManagedFields> managedFields,
                                               final String name,
                                               final String namespace,
                                               final List<ClusterRoleBindingListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public ClusterRoleBindingListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ClusterRoleBindingListItemsMetadataInitializers initializers) {
    ...
    public List<ClusterRoleBindingListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ClusterRoleBindingListItemsMetadataManagedFields> managedFields) {
    ...
    public List<ClusterRoleBindingListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ClusterRoleBindingListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ClusterRoleBindingListItemsMetadata)) {
            return false;
        }
        final ClusterRoleBindingListItemsMetadata __otherCasted = (ClusterRoleBindingListItemsMetadata) __other;
