...
public class APIServiceListItemsMetadata {
    ...
    private APIServiceListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<APIServiceListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<APIServiceListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public APIServiceListItemsMetadata() {
        // no-op
    }

    public APIServiceListItemsMetadata(final Map<String, String> annotations,
                                       ...
                                       final APIServiceListItemsMetadataInitializers initializers,
                                       final Map<String, String> labels,
                                       final List<APIServiceListItemsMetadataManagedFields> managedFields,
                                       final String name,
                                       final String namespace,
                                       final List<APIServiceListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public APIServiceListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final APIServiceListItemsMetadataInitializers initializers) {
    ...
    public List<APIServiceListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<APIServiceListItemsMetadataManagedFields> managedFields) {
    ...
    public List<APIServiceListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<APIServiceListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof APIServiceListItemsMetadata)) {
            return false;
        }
        final APIServiceListItemsMetadata __otherCasted = (APIServiceListItemsMetadata) __other;
