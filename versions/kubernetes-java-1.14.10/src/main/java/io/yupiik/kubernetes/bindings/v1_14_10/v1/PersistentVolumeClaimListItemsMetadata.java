...
public class PersistentVolumeClaimListItemsMetadata {
    ...
    private PersistentVolumeClaimListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PersistentVolumeClaimListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PersistentVolumeClaimListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PersistentVolumeClaimListItemsMetadata() {
        // no-op
    }

    public PersistentVolumeClaimListItemsMetadata(final Map<String, String> annotations,
                                                  ...
                                                  final PersistentVolumeClaimListItemsMetadataInitializers initializers,
                                                  final Map<String, String> labels,
                                                  final List<PersistentVolumeClaimListItemsMetadataManagedFields> managedFields,
                                                  final String name,
                                                  final String namespace,
                                                  final List<PersistentVolumeClaimListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public PersistentVolumeClaimListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PersistentVolumeClaimListItemsMetadataInitializers initializers) {
    ...
    public List<PersistentVolumeClaimListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PersistentVolumeClaimListItemsMetadataManagedFields> managedFields) {
    ...
    public List<PersistentVolumeClaimListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PersistentVolumeClaimListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PersistentVolumeClaimListItemsMetadata)) {
            return false;
        }
        final PersistentVolumeClaimListItemsMetadata __otherCasted = (PersistentVolumeClaimListItemsMetadata) __other;
