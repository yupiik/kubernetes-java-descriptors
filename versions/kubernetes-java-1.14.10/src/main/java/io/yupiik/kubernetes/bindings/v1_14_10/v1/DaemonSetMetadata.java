...
public class DaemonSetMetadata {
    ...
    private DaemonSetMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<DaemonSetMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<DaemonSetMetadataOwnerReferences> ownerReferences;
    ...
    public DaemonSetMetadata(final Map<String, String> annotations,
                             ...
                             final DaemonSetMetadataInitializers initializers,
                             final Map<String, String> labels,
                             final List<DaemonSetMetadataManagedFields> managedFields,
                             final String name,
                             final String namespace,
                             final List<DaemonSetMetadataOwnerReferences> ownerReferences,
    ...
    public DaemonSetMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final DaemonSetMetadataInitializers initializers) {
    ...
    public List<DaemonSetMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<DaemonSetMetadataManagedFields> managedFields) {
    ...
    public List<DaemonSetMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<DaemonSetMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetMetadata)) {
            return false;
        }
        final DaemonSetMetadata __otherCasted = (DaemonSetMetadata) __other;
