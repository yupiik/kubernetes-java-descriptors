...
public class DeploymentSpecTemplateSpecInitContainersVolumeMounts {
    ...
    public DeploymentSpecTemplateSpecInitContainersVolumeMounts() {
        // no-op
    }

    public DeploymentSpecTemplateSpecInitContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentSpecTemplateSpecInitContainersVolumeMounts)) {
            return false;
        }
        final DeploymentSpecTemplateSpecInitContainersVolumeMounts __otherCasted = (DeploymentSpecTemplateSpecInitContainersVolumeMounts) __other;
