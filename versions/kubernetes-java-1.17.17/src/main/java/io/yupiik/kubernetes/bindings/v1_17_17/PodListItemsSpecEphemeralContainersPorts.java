...
public class PodListItemsSpecEphemeralContainersPorts {
    ...
    public PodListItemsSpecEphemeralContainersPorts() {
        // no-op
    }

    public PodListItemsSpecEphemeralContainersPorts(final int containerPort,
                                                    final String hostIP,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodListItemsSpecEphemeralContainersPorts)) {
            return false;
        }
        final PodListItemsSpecEphemeralContainersPorts __otherCasted = (PodListItemsSpecEphemeralContainersPorts) __other;
