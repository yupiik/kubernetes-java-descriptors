...
public class LimitRangeListItemsMetadata {
    ...
    private LimitRangeListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<LimitRangeListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<LimitRangeListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public LimitRangeListItemsMetadata() {
        // no-op
    }

    public LimitRangeListItemsMetadata(final Map<String, String> annotations,
                                       ...
                                       final LimitRangeListItemsMetadataInitializers initializers,
                                       final Map<String, String> labels,
                                       final List<LimitRangeListItemsMetadataManagedFields> managedFields,
                                       final String name,
                                       final String namespace,
                                       final List<LimitRangeListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public LimitRangeListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final LimitRangeListItemsMetadataInitializers initializers) {
    ...
    public List<LimitRangeListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<LimitRangeListItemsMetadataManagedFields> managedFields) {
    ...
    public List<LimitRangeListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<LimitRangeListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LimitRangeListItemsMetadata)) {
            return false;
        }
        final LimitRangeListItemsMetadata __otherCasted = (LimitRangeListItemsMetadata) __other;
