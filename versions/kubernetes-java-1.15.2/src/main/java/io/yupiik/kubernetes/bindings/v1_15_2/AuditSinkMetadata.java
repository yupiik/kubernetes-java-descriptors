...
public class AuditSinkMetadata {
    ...
    private AuditSinkMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<AuditSinkMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<AuditSinkMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public AuditSinkMetadata() {
        // no-op
    }

    public AuditSinkMetadata(final Map<String, String> annotations,
                             ...
                             final AuditSinkMetadataInitializers initializers,
                             final Map<String, String> labels,
                             final List<AuditSinkMetadataManagedFields> managedFields,
                             final String name,
                             final String namespace,
                             final List<AuditSinkMetadataOwnerReferences> ownerReferences,
    ...
    public AuditSinkMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final AuditSinkMetadataInitializers initializers) {
    ...
    public List<AuditSinkMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<AuditSinkMetadataManagedFields> managedFields) {
    ...
    public List<AuditSinkMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<AuditSinkMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof AuditSinkMetadata)) {
            return false;
        }
        final AuditSinkMetadata __otherCasted = (AuditSinkMetadata) __other;
