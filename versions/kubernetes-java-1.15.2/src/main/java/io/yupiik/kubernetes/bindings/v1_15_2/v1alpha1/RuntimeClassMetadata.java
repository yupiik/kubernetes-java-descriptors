package io.yupiik.kubernetes.bindings.v1_15_2.v1alpha1;
...
public class RuntimeClassMetadata {
    ...
    private RuntimeClassMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<RuntimeClassMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<RuntimeClassMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public RuntimeClassMetadata() {
        // no-op
    }

    public RuntimeClassMetadata(final Map<String, String> annotations,
                                ...
                                final RuntimeClassMetadataInitializers initializers,
                                final Map<String, String> labels,
                                final List<RuntimeClassMetadataManagedFields> managedFields,
                                final String name,
                                final String namespace,
                                final List<RuntimeClassMetadataOwnerReferences> ownerReferences,
    ...
    public RuntimeClassMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final RuntimeClassMetadataInitializers initializers) {
    ...
    public List<RuntimeClassMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<RuntimeClassMetadataManagedFields> managedFields) {
    ...
    public List<RuntimeClassMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<RuntimeClassMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RuntimeClassMetadata)) {
            return false;
        }
        final RuntimeClassMetadata __otherCasted = (RuntimeClassMetadata) __other;
