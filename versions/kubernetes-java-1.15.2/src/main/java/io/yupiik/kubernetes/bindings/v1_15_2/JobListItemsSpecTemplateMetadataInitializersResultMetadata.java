...
public class JobListItemsSpecTemplateMetadataInitializersResultMetadata {
    ...
    public JobListItemsSpecTemplateMetadataInitializersResultMetadata() {
        // no-op
    }

    public JobListItemsSpecTemplateMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobListItemsSpecTemplateMetadataInitializersResultMetadata)) {
            return false;
        }
        final JobListItemsSpecTemplateMetadataInitializersResultMetadata __otherCasted = (JobListItemsSpecTemplateMetadataInitializersResultMetadata) __other;
