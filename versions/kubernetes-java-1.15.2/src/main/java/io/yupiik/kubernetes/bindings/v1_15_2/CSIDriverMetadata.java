...
public class CSIDriverMetadata {
    ...
    private CSIDriverMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<CSIDriverMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<CSIDriverMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public CSIDriverMetadata() {
        // no-op
    }

    public CSIDriverMetadata(final Map<String, String> annotations,
                             ...
                             final CSIDriverMetadataInitializers initializers,
                             final Map<String, String> labels,
                             final List<CSIDriverMetadataManagedFields> managedFields,
                             final String name,
                             final String namespace,
                             final List<CSIDriverMetadataOwnerReferences> ownerReferences,
    ...
    public CSIDriverMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final CSIDriverMetadataInitializers initializers) {
    ...
    public List<CSIDriverMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<CSIDriverMetadataManagedFields> managedFields) {
    ...
    public List<CSIDriverMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<CSIDriverMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSIDriverMetadata)) {
            return false;
        }
        final CSIDriverMetadata __otherCasted = (CSIDriverMetadata) __other;
