...
public class PodListItemsMetadata {
    ...
    private PodListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PodListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PodListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PodListItemsMetadata() {
        // no-op
    }

    public PodListItemsMetadata(final Map<String, String> annotations,
                                ...
                                final PodListItemsMetadataInitializers initializers,
                                final Map<String, String> labels,
                                final List<PodListItemsMetadataManagedFields> managedFields,
                                final String name,
                                final String namespace,
                                final List<PodListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public PodListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PodListItemsMetadataInitializers initializers) {
    ...
    public List<PodListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PodListItemsMetadataManagedFields> managedFields) {
    ...
    public List<PodListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PodListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodListItemsMetadata)) {
            return false;
        }
        final PodListItemsMetadata __otherCasted = (PodListItemsMetadata) __other;
