...
public class PodSpecVolumesQuobyte {
    ...
    public PodSpecVolumesQuobyte() {
        // no-op
    }

    public PodSpecVolumesQuobyte(final String group,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSpecVolumesQuobyte)) {
            return false;
        }
        final PodSpecVolumesQuobyte __otherCasted = (PodSpecVolumesQuobyte) __other;
