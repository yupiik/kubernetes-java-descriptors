...
public class CronJobListItemsMetadataInitializersResultMetadata {
    ...
    public CronJobListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public CronJobListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CronJobListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final CronJobListItemsMetadataInitializersResultMetadata __otherCasted = (CronJobListItemsMetadataInitializersResultMetadata) __other;
