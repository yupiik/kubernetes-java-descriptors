...
public class ClusterRoleListItemsMetadataInitializersResultMetadata {
    ...
    public ClusterRoleListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public ClusterRoleListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ClusterRoleListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final ClusterRoleListItemsMetadataInitializersResultMetadata __otherCasted = (ClusterRoleListItemsMetadataInitializersResultMetadata) __other;
