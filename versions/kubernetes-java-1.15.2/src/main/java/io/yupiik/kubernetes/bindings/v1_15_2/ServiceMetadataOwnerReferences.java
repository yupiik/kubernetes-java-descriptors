...
public class ServiceMetadataOwnerReferences {
    ...
    public ServiceMetadataOwnerReferences() {
        // no-op
    }

    public ServiceMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ServiceMetadataOwnerReferences)) {
            return false;
        }
        final ServiceMetadataOwnerReferences __otherCasted = (ServiceMetadataOwnerReferences) __other;
