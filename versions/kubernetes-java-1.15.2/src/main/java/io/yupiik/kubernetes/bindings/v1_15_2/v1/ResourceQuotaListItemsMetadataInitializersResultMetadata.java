...
public class ResourceQuotaListItemsMetadataInitializersResultMetadata {
    ...
    public ResourceQuotaListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public ResourceQuotaListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ResourceQuotaListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final ResourceQuotaListItemsMetadataInitializersResultMetadata __otherCasted = (ResourceQuotaListItemsMetadataInitializersResultMetadata) __other;
