...
public class PodTemplateMetadata {
    ...
    private PodTemplateMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PodTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PodTemplateMetadataOwnerReferences> ownerReferences;
    ...
    public PodTemplateMetadata(final Map<String, String> annotations,
                               ...
                               final PodTemplateMetadataInitializers initializers,
                               final Map<String, String> labels,
                               final List<PodTemplateMetadataManagedFields> managedFields,
                               final String name,
                               final String namespace,
                               final List<PodTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public PodTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PodTemplateMetadataInitializers initializers) {
    ...
    public List<PodTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PodTemplateMetadataManagedFields> managedFields) {
    ...
    public List<PodTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PodTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateMetadata)) {
            return false;
        }
        final PodTemplateMetadata __otherCasted = (PodTemplateMetadata) __other;
