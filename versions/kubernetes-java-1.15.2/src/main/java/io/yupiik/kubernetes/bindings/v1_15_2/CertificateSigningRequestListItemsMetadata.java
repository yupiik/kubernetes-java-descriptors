...
public class CertificateSigningRequestListItemsMetadata {
    ...
    private CertificateSigningRequestListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<CertificateSigningRequestListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<CertificateSigningRequestListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public CertificateSigningRequestListItemsMetadata() {
        // no-op
    }

    public CertificateSigningRequestListItemsMetadata(final Map<String, String> annotations,
                                                      ...
                                                      final CertificateSigningRequestListItemsMetadataInitializers initializers,
                                                      final Map<String, String> labels,
                                                      final List<CertificateSigningRequestListItemsMetadataManagedFields> managedFields,
                                                      final String name,
                                                      final String namespace,
                                                      final List<CertificateSigningRequestListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public CertificateSigningRequestListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final CertificateSigningRequestListItemsMetadataInitializers initializers) {
    ...
    public List<CertificateSigningRequestListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<CertificateSigningRequestListItemsMetadataManagedFields> managedFields) {
    ...
    public List<CertificateSigningRequestListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<CertificateSigningRequestListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CertificateSigningRequestListItemsMetadata)) {
            return false;
        }
        final CertificateSigningRequestListItemsMetadata __otherCasted = (CertificateSigningRequestListItemsMetadata) __other;
