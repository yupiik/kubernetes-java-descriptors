...
public class RuntimeClassListItemsMetadataInitializersResultMetadata {
    ...
    public RuntimeClassListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public RuntimeClassListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RuntimeClassListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final RuntimeClassListItemsMetadataInitializersResultMetadata __otherCasted = (RuntimeClassListItemsMetadataInitializersResultMetadata) __other;
