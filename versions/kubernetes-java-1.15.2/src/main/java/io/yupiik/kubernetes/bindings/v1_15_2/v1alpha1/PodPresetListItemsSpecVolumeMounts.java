...
public class PodPresetListItemsSpecVolumeMounts {
    ...
    public PodPresetListItemsSpecVolumeMounts() {
        // no-op
    }

    public PodPresetListItemsSpecVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodPresetListItemsSpecVolumeMounts)) {
            return false;
        }
        final PodPresetListItemsSpecVolumeMounts __otherCasted = (PodPresetListItemsSpecVolumeMounts) __other;
