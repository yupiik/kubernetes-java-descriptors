...
public class ReplicaSetSpecTemplateMetadata {
    ...
    private ReplicaSetSpecTemplateMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ReplicaSetSpecTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ReplicaSetSpecTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ReplicaSetSpecTemplateMetadata() {
        // no-op
    }

    public ReplicaSetSpecTemplateMetadata(final Map<String, String> annotations,
                                          ...
                                          final ReplicaSetSpecTemplateMetadataInitializers initializers,
                                          final Map<String, String> labels,
                                          final List<ReplicaSetSpecTemplateMetadataManagedFields> managedFields,
                                          final String name,
                                          final String namespace,
                                          final List<ReplicaSetSpecTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public ReplicaSetSpecTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ReplicaSetSpecTemplateMetadataInitializers initializers) {
    ...
    public List<ReplicaSetSpecTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ReplicaSetSpecTemplateMetadataManagedFields> managedFields) {
    ...
    public List<ReplicaSetSpecTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ReplicaSetSpecTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicaSetSpecTemplateMetadata)) {
            return false;
        }
        final ReplicaSetSpecTemplateMetadata __otherCasted = (ReplicaSetSpecTemplateMetadata) __other;
