...
public class HorizontalPodAutoscalerListMetadata {
    ...
    public HorizontalPodAutoscalerListMetadata() {
        // no-op
    }

    public HorizontalPodAutoscalerListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof HorizontalPodAutoscalerListMetadata)) {
            return false;
        }
        final HorizontalPodAutoscalerListMetadata __otherCasted = (HorizontalPodAutoscalerListMetadata) __other;
