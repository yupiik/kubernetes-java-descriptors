...
public class LimitRangeSpecLimits {
    ...
    public LimitRangeSpecLimits() {
        // no-op
    }

    public LimitRangeSpecLimits(final Map<String, String> defaultRequest,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LimitRangeSpecLimits)) {
            return false;
        }
        final LimitRangeSpecLimits __otherCasted = (LimitRangeSpecLimits) __other;
