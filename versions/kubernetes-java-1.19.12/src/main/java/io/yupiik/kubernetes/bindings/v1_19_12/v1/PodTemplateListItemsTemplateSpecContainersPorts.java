...
public class PodTemplateListItemsTemplateSpecContainersPorts {
    ...
    public PodTemplateListItemsTemplateSpecContainersPorts() {
        // no-op
    }

    public PodTemplateListItemsTemplateSpecContainersPorts(final int containerPort,
                                                           final String hostIP,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateListItemsTemplateSpecContainersPorts)) {
            return false;
        }
        final PodTemplateListItemsTemplateSpecContainersPorts __otherCasted = (PodTemplateListItemsTemplateSpecContainersPorts) __other;
