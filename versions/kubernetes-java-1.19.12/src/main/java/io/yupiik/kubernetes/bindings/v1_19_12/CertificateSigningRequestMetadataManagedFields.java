...
public class CertificateSigningRequestMetadataManagedFields {
    ...
    public CertificateSigningRequestMetadataManagedFields() {
        // no-op
    }

    public CertificateSigningRequestMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CertificateSigningRequestMetadataManagedFields)) {
            return false;
        }
        final CertificateSigningRequestMetadataManagedFields __otherCasted = (CertificateSigningRequestMetadataManagedFields) __other;
