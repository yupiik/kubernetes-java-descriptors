...
public class CSIDriverListItemsMetadataOwnerReferences {
    ...
    public CSIDriverListItemsMetadataOwnerReferences() {
        // no-op
    }

    public CSIDriverListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSIDriverListItemsMetadataOwnerReferences)) {
            return false;
        }
        final CSIDriverListItemsMetadataOwnerReferences __otherCasted = (CSIDriverListItemsMetadataOwnerReferences) __other;
