...
public class DeploymentListItemsSpecTemplateSpecVolumesVsphereVolume {
    private String fsType;
    private String storagePolicyID;
    private String storagePolicyName;
    private String volumePath;

    public DeploymentListItemsSpecTemplateSpecVolumesVsphereVolume() {
        // no-op
    }

    public DeploymentListItemsSpecTemplateSpecVolumesVsphereVolume(final String fsType,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentListItemsSpecTemplateSpecVolumesVsphereVolume)) {
            return false;
        }
        final DeploymentListItemsSpecTemplateSpecVolumesVsphereVolume __otherCasted = (DeploymentListItemsSpecTemplateSpecVolumesVsphereVolume) __other;
