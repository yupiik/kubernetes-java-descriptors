...
public class StatefulSetSpecTemplateSpecInitContainersStartupProbe {
    ...
    private StatefulSetSpecTemplateSpecInitContainersStartupProbeGrpc grpc;
    ...
    public StatefulSetSpecTemplateSpecInitContainersStartupProbe(final StatefulSetSpecTemplateSpecInitContainersStartupProbeExec exec,
                                                                 ...
                                                                 final StatefulSetSpecTemplateSpecInitContainersStartupProbeGrpc grpc,
    ...
    public StatefulSetSpecTemplateSpecInitContainersStartupProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final StatefulSetSpecTemplateSpecInitContainersStartupProbeGrpc grpc) {
        this.grpc = grpc;
    }
