...
public class StatefulSetSpecTemplateSpecEphemeralContainersSecurityContextWindowsOptions {
    private String gmsaCredentialSpec;
    private String gmsaCredentialSpecName;
    private Boolean hostProcess;
    private String runAsUserName;

    public StatefulSetSpecTemplateSpecEphemeralContainersSecurityContextWindowsOptions() {
        // no-op
    }

    public StatefulSetSpecTemplateSpecEphemeralContainersSecurityContextWindowsOptions(final String gmsaCredentialSpec,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetSpecTemplateSpecEphemeralContainersSecurityContextWindowsOptions)) {
            return false;
        }
        final StatefulSetSpecTemplateSpecEphemeralContainersSecurityContextWindowsOptions __otherCasted = (StatefulSetSpecTemplateSpecEphemeralContainersSecurityContextWindowsOptions) __other;
