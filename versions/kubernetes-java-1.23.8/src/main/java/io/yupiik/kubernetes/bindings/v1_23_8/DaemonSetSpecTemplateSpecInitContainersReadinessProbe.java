...
public class DaemonSetSpecTemplateSpecInitContainersReadinessProbe {
    ...
    private DaemonSetSpecTemplateSpecInitContainersReadinessProbeGrpc grpc;
    ...
    public DaemonSetSpecTemplateSpecInitContainersReadinessProbe(final DaemonSetSpecTemplateSpecInitContainersReadinessProbeExec exec,
                                                                 ...
                                                                 final DaemonSetSpecTemplateSpecInitContainersReadinessProbeGrpc grpc,
    ...
    public DaemonSetSpecTemplateSpecInitContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final DaemonSetSpecTemplateSpecInitContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
