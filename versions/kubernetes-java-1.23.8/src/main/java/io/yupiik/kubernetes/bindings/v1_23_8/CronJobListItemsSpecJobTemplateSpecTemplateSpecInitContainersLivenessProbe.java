...
public class CronJobListItemsSpecJobTemplateSpecTemplateSpecInitContainersLivenessProbe {
    ...
    private CronJobListItemsSpecJobTemplateSpecTemplateSpecInitContainersLivenessProbeGrpc grpc;
    ...
    public CronJobListItemsSpecJobTemplateSpecTemplateSpecInitContainersLivenessProbe(final CronJobListItemsSpecJobTemplateSpecTemplateSpecInitContainersLivenessProbeExec exec,
                                                                                      ...
                                                                                      final CronJobListItemsSpecJobTemplateSpecTemplateSpecInitContainersLivenessProbeGrpc grpc,
    ...
    public CronJobListItemsSpecJobTemplateSpecTemplateSpecInitContainersLivenessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final CronJobListItemsSpecJobTemplateSpecTemplateSpecInitContainersLivenessProbeGrpc grpc) {
        this.grpc = grpc;
    }
