...
public class ReplicationControllerSpecTemplateSpecEphemeralContainersVolumeMounts {
    ...
    public ReplicationControllerSpecTemplateSpecEphemeralContainersVolumeMounts() {
        // no-op
    }

    public ReplicationControllerSpecTemplateSpecEphemeralContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicationControllerSpecTemplateSpecEphemeralContainersVolumeMounts)) {
            return false;
        }
        final ReplicationControllerSpecTemplateSpecEphemeralContainersVolumeMounts __otherCasted = (ReplicationControllerSpecTemplateSpecEphemeralContainersVolumeMounts) __other;
