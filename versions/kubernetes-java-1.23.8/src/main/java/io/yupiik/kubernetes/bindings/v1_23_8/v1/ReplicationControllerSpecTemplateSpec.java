...
public class ReplicationControllerSpecTemplateSpec {
    ...
    private List<ReplicationControllerSpecTemplateSpecContainers> containers;
    private ReplicationControllerSpecTemplateSpecDnsConfig dnsConfig;
    private String dnsPolicy;
    private Boolean enableServiceLinks;
    private List<ReplicationControllerSpecTemplateSpecEphemeralContainers> ephemeralContainers;
    private List<ReplicationControllerSpecTemplateSpecHostAliases> hostAliases;
    private Boolean hostIPC;
    private Boolean hostNetwork;
    private Boolean hostPID;
    private String hostname;
    private List<ReplicationControllerSpecTemplateSpecImagePullSecrets> imagePullSecrets;
    private List<ReplicationControllerSpecTemplateSpecInitContainers> initContainers;
    private String nodeName;
    private Map<String, String> nodeSelector;
    private ReplicationControllerSpecTemplateSpecOs os;
    private Map<String, String> overhead;
    private String preemptionPolicy;
    private Integer priority;
    private String priorityClassName;
    private List<ReplicationControllerSpecTemplateSpecReadinessGates> readinessGates;
    ...
    private List<ReplicationControllerSpecTemplateSpecTolerations> tolerations;
    private List<ReplicationControllerSpecTemplateSpecTopologySpreadConstraints> topologySpreadConstraints;
    private List<ReplicationControllerSpecTemplateSpecVolumes> volumes;
    ...
    public ReplicationControllerSpecTemplateSpec(final Integer activeDeadlineSeconds,
                                                 ...
                                                 final List<ReplicationControllerSpecTemplateSpecContainers> containers,
                                                 final ReplicationControllerSpecTemplateSpecDnsConfig dnsConfig,
                                                 final String dnsPolicy,
                                                 final Boolean enableServiceLinks,
                                                 final List<ReplicationControllerSpecTemplateSpecEphemeralContainers> ephemeralContainers,
                                                 final List<ReplicationControllerSpecTemplateSpecHostAliases> hostAliases,
                                                 final Boolean hostIPC,
                                                 final Boolean hostNetwork,
                                                 final Boolean hostPID,
                                                 final String hostname,
                                                 final List<ReplicationControllerSpecTemplateSpecImagePullSecrets> imagePullSecrets,
                                                 final List<ReplicationControllerSpecTemplateSpecInitContainers> initContainers,
                                                 final String nodeName,
                                                 final Map<String, String> nodeSelector,
                                                 final ReplicationControllerSpecTemplateSpecOs os,
                                                 final Map<String, String> overhead,
                                                 final String preemptionPolicy,
                                                 final Integer priority,
                                                 final String priorityClassName,
                                                 final List<ReplicationControllerSpecTemplateSpecReadinessGates> readinessGates,
                                                 ...
                                                 final List<ReplicationControllerSpecTemplateSpecTolerations> tolerations,
                                                 final List<ReplicationControllerSpecTemplateSpecTopologySpreadConstraints> topologySpreadConstraints,
                                                 final List<ReplicationControllerSpecTemplateSpecVolumes> volumes) {
        // no-op
    }
    ...
    public List<ReplicationControllerSpecTemplateSpecContainers> getContainers() {
        return containers;
    }

    public void setContainers(final List<ReplicationControllerSpecTemplateSpecContainers> containers) {
    ...
    public List<ReplicationControllerSpecTemplateSpecEphemeralContainers> getEphemeralContainers() {
        return ephemeralContainers;
    }

    public void setEphemeralContainers(final List<ReplicationControllerSpecTemplateSpecEphemeralContainers> ephemeralContainers) {
        this.ephemeralContainers = ephemeralContainers;
    }

    public List<ReplicationControllerSpecTemplateSpecHostAliases> getHostAliases() {
        return hostAliases;
    }

    public void setHostAliases(final List<ReplicationControllerSpecTemplateSpecHostAliases> hostAliases) {
    ...
    public List<ReplicationControllerSpecTemplateSpecImagePullSecrets> getImagePullSecrets() {
        return imagePullSecrets;
    }

    public void setImagePullSecrets(final List<ReplicationControllerSpecTemplateSpecImagePullSecrets> imagePullSecrets) {
        this.imagePullSecrets = imagePullSecrets;
    }

    public List<ReplicationControllerSpecTemplateSpecInitContainers> getInitContainers() {
        return initContainers;
    }

    public void setInitContainers(final List<ReplicationControllerSpecTemplateSpecInitContainers> initContainers) {
    ...
    public ReplicationControllerSpecTemplateSpecOs getOs() {
        return os;
    }

    public void setOs(final ReplicationControllerSpecTemplateSpecOs os) {
        this.os = os;
    }
    ...
    public List<ReplicationControllerSpecTemplateSpecReadinessGates> getReadinessGates() {
        return readinessGates;
    }

    public void setReadinessGates(final List<ReplicationControllerSpecTemplateSpecReadinessGates> readinessGates) {
    ...
    public List<ReplicationControllerSpecTemplateSpecTolerations> getTolerations() {
        return tolerations;
    }

    public void setTolerations(final List<ReplicationControllerSpecTemplateSpecTolerations> tolerations) {
        this.tolerations = tolerations;
    }

    public List<ReplicationControllerSpecTemplateSpecTopologySpreadConstraints> getTopologySpreadConstraints() {
        return topologySpreadConstraints;
    }

    public void setTopologySpreadConstraints(final List<ReplicationControllerSpecTemplateSpecTopologySpreadConstraints> topologySpreadConstraints) {
        this.topologySpreadConstraints = topologySpreadConstraints;
    }

    public List<ReplicationControllerSpecTemplateSpecVolumes> getVolumes() {
        return volumes;
    }

    public void setVolumes(final List<ReplicationControllerSpecTemplateSpecVolumes> volumes) {
