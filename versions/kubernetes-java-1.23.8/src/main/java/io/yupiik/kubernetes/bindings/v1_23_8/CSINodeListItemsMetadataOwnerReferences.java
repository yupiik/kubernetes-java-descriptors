...
public class CSINodeListItemsMetadataOwnerReferences {
    ...
    public CSINodeListItemsMetadataOwnerReferences() {
        // no-op
    }

    public CSINodeListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSINodeListItemsMetadataOwnerReferences)) {
            return false;
        }
        final CSINodeListItemsMetadataOwnerReferences __otherCasted = (CSINodeListItemsMetadataOwnerReferences) __other;
