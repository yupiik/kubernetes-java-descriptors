...
public class DeploymentListItemsSpecTemplateSpecInitContainersReadinessProbe {
    ...
    private DeploymentListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc grpc;
    ...
    public DeploymentListItemsSpecTemplateSpecInitContainersReadinessProbe(final DeploymentListItemsSpecTemplateSpecInitContainersReadinessProbeExec exec,
                                                                           ...
                                                                           final DeploymentListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc grpc,
    ...
    public DeploymentListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final DeploymentListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
