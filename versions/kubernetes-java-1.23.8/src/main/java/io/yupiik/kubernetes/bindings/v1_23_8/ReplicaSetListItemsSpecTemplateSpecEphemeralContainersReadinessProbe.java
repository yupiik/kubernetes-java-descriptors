...
public class ReplicaSetListItemsSpecTemplateSpecEphemeralContainersReadinessProbe {
    ...
    private ReplicaSetListItemsSpecTemplateSpecEphemeralContainersReadinessProbeGrpc grpc;
    ...
    public ReplicaSetListItemsSpecTemplateSpecEphemeralContainersReadinessProbe(final ReplicaSetListItemsSpecTemplateSpecEphemeralContainersReadinessProbeExec exec,
                                                                                ...
                                                                                final ReplicaSetListItemsSpecTemplateSpecEphemeralContainersReadinessProbeGrpc grpc,
    ...
    public ReplicaSetListItemsSpecTemplateSpecEphemeralContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final ReplicaSetListItemsSpecTemplateSpecEphemeralContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
