...
public class EndpointsListItemsMetadataOwnerReferences {
    ...
    public EndpointsListItemsMetadataOwnerReferences() {
        // no-op
    }

    public EndpointsListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EndpointsListItemsMetadataOwnerReferences)) {
            return false;
        }
        final EndpointsListItemsMetadataOwnerReferences __otherCasted = (EndpointsListItemsMetadataOwnerReferences) __other;
