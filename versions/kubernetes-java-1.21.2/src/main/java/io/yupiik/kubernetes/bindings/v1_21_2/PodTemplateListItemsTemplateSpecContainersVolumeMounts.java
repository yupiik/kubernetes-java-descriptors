...
public class PodTemplateListItemsTemplateSpecContainersVolumeMounts {
    ...
    public PodTemplateListItemsTemplateSpecContainersVolumeMounts() {
        // no-op
    }

    public PodTemplateListItemsTemplateSpecContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateListItemsTemplateSpecContainersVolumeMounts)) {
            return false;
        }
        final PodTemplateListItemsTemplateSpecContainersVolumeMounts __otherCasted = (PodTemplateListItemsTemplateSpecContainersVolumeMounts) __other;
