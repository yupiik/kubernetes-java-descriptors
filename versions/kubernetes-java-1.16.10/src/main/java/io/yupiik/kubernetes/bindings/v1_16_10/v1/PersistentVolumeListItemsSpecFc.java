...
public class PersistentVolumeListItemsSpecFc {
    ...
    public PersistentVolumeListItemsSpecFc() {
        // no-op
    }

    public PersistentVolumeListItemsSpecFc(final String fsType,
                                           final Integer lun,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PersistentVolumeListItemsSpecFc)) {
            return false;
        }
        final PersistentVolumeListItemsSpecFc __otherCasted = (PersistentVolumeListItemsSpecFc) __other;
