...
public class ReplicaSetSpecTemplateSpecVolumesFc {
    ...
    public ReplicaSetSpecTemplateSpecVolumesFc() {
        // no-op
    }

    public ReplicaSetSpecTemplateSpecVolumesFc(final String fsType,
                                               final Integer lun,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicaSetSpecTemplateSpecVolumesFc)) {
            return false;
        }
        final ReplicaSetSpecTemplateSpecVolumesFc __otherCasted = (ReplicaSetSpecTemplateSpecVolumesFc) __other;
