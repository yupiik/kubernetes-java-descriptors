...
public class EvictionMetadataManagedFields {
    ...
    public EvictionMetadataManagedFields() {
        // no-op
    }

    public EvictionMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EvictionMetadataManagedFields)) {
            return false;
        }
        final EvictionMetadataManagedFields __otherCasted = (EvictionMetadataManagedFields) __other;
