...
public class DaemonSetMetadataOwnerReferences {
    ...
    public DaemonSetMetadataOwnerReferences() {
        // no-op
    }

    public DaemonSetMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetMetadataOwnerReferences)) {
            return false;
        }
        final DaemonSetMetadataOwnerReferences __otherCasted = (DaemonSetMetadataOwnerReferences) __other;
