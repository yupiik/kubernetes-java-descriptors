...
public class CronJobSpecJobTemplateMetadataManagedFields {
    ...
    public CronJobSpecJobTemplateMetadataManagedFields() {
        // no-op
    }

    public CronJobSpecJobTemplateMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CronJobSpecJobTemplateMetadataManagedFields)) {
            return false;
        }
        final CronJobSpecJobTemplateMetadataManagedFields __otherCasted = (CronJobSpecJobTemplateMetadataManagedFields) __other;
