...
public class PodTemplateListItemsTemplateSpecEphemeralContainersVolumeMounts {
    ...
    public PodTemplateListItemsTemplateSpecEphemeralContainersVolumeMounts() {
        // no-op
    }

    public PodTemplateListItemsTemplateSpecEphemeralContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateListItemsTemplateSpecEphemeralContainersVolumeMounts)) {
            return false;
        }
        final PodTemplateListItemsTemplateSpecEphemeralContainersVolumeMounts __otherCasted = (PodTemplateListItemsTemplateSpecEphemeralContainersVolumeMounts) __other;
