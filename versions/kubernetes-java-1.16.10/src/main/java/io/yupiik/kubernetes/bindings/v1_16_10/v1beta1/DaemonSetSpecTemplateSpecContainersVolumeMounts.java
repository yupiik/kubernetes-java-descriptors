...
public class DaemonSetSpecTemplateSpecContainersVolumeMounts {
    ...
    public DaemonSetSpecTemplateSpecContainersVolumeMounts() {
        // no-op
    }

    public DaemonSetSpecTemplateSpecContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetSpecTemplateSpecContainersVolumeMounts)) {
            return false;
        }
        final DaemonSetSpecTemplateSpecContainersVolumeMounts __otherCasted = (DaemonSetSpecTemplateSpecContainersVolumeMounts) __other;
