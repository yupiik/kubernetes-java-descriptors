...
public class io.k8s.api.resource.v1beta1.ResourceClaimStatus implements Validable<io.k8s.api.resource.v1beta1.ResourceClaimStatus>, Exportable {
    ...
    public io.k8s.api.resource.v1beta1.ResourceClaimStatus() {
        // no-op
    }

    public io.k8s.api.resource.v1beta1.ResourceClaimStatus(final AllocationResult allocation,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.resource.v1beta1.ResourceClaimStatus)) {
            return false;
        }
        final io.k8s.api.resource.v1beta1.ResourceClaimStatus __otherCasted = (io.k8s.api.resource.v1beta1.ResourceClaimStatus) __other;
    ...
    public io.k8s.api.resource.v1beta1.ResourceClaimStatus allocation(final AllocationResult allocation) {
        this.allocation = allocation;
        return this;
    }

    public io.k8s.api.resource.v1beta1.ResourceClaimStatus devices(final List<AllocatedDeviceStatus> devices) {
        this.devices = devices;
        return this;
    }

    public io.k8s.api.resource.v1beta1.ResourceClaimStatus reservedFor(final List<ResourceClaimConsumerReference> reservedFor) {
        this.reservedFor = reservedFor;
        return this;
    }

    @Override
    public io.k8s.api.resource.v1beta1.ResourceClaimStatus validate() {
        return this;
    }
