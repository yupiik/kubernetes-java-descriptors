...
public class io.k8s.api.storage.v1.VolumeAttachmentStatus implements Validable<io.k8s.api.storage.v1.VolumeAttachmentStatus>, Exportable {
    private VolumeError attachError;
    private boolean attached;
    private Map<String, String> attachmentMetadata;
    private VolumeError detachError;

    public io.k8s.api.storage.v1.VolumeAttachmentStatus() {
        // no-op
    }

    public io.k8s.api.storage.v1.VolumeAttachmentStatus(final VolumeError attachError,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.storage.v1.VolumeAttachmentStatus)) {
            return false;
        }
        final io.k8s.api.storage.v1.VolumeAttachmentStatus __otherCasted = (io.k8s.api.storage.v1.VolumeAttachmentStatus) __other;
    ...
    public io.k8s.api.storage.v1.VolumeAttachmentStatus attachError(final VolumeError attachError) {
        this.attachError = attachError;
        return this;
    }

    public io.k8s.api.storage.v1.VolumeAttachmentStatus attached(final boolean attached) {
        this.attached = attached;
        return this;
    }

    public io.k8s.api.storage.v1.VolumeAttachmentStatus attachmentMetadata(final Map<String, String> attachmentMetadata) {
        this.attachmentMetadata = attachmentMetadata;
        return this;
    }

    public io.k8s.api.storage.v1.VolumeAttachmentStatus detachError(final VolumeError detachError) {
        this.detachError = detachError;
        return this;
    }

    @Override
    public io.k8s.api.storage.v1.VolumeAttachmentStatus validate() {
        return this;
    }
