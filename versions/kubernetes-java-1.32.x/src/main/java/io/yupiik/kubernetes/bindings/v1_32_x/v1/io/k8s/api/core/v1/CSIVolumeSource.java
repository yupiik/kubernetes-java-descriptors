...
public class io.k8s.api.core.v1.CSIVolumeSource implements Validable<io.k8s.api.core.v1.CSIVolumeSource>, Exportable {
    ...
    public io.k8s.api.core.v1.CSIVolumeSource() {
        // no-op
    }

    public io.k8s.api.core.v1.CSIVolumeSource(final String driver,
                                              final String fsType,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.CSIVolumeSource)) {
            return false;
        }
        final io.k8s.api.core.v1.CSIVolumeSource __otherCasted = (io.k8s.api.core.v1.CSIVolumeSource) __other;
    ...
    public io.k8s.api.core.v1.CSIVolumeSource driver(final String driver) {
        this.driver = driver;
        return this;
    }

    public io.k8s.api.core.v1.CSIVolumeSource fsType(final String fsType) {
        this.fsType = fsType;
        return this;
    }

    public io.k8s.api.core.v1.CSIVolumeSource nodePublishSecretRef(final LocalObjectReference nodePublishSecretRef) {
        this.nodePublishSecretRef = nodePublishSecretRef;
        return this;
    }

    public io.k8s.api.core.v1.CSIVolumeSource readOnly(final Boolean readOnly) {
        this.readOnly = readOnly;
        return this;
    }

    public io.k8s.api.core.v1.CSIVolumeSource volumeAttributes(final Map<String, String> volumeAttributes) {
        this.volumeAttributes = volumeAttributes;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.CSIVolumeSource validate() {
