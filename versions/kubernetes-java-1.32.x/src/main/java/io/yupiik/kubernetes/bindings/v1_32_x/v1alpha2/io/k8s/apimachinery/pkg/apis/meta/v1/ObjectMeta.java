 ...
 * under the License.
 */
package io.yupiik.kubernetes.bindings.v1_32_x.v1alpha2;
...
public class io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta implements Validable<io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta>, Exportable {
    ...
    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta() {
        // no-op
    }

    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta(final Map<String, String> annotations,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta)) {
            return false;
        }
        final io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta __otherCasted = (io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta) __other;
    ...
    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta annotations(final Map<String, String> annotations) {
        this.annotations = annotations;
        return this;
    }

    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta creationTimestamp(final String creationTimestamp) {
        this.creationTimestamp = creationTimestamp;
        return this;
    }

    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta deletionGracePeriodSeconds(final Integer deletionGracePeriodSeconds) {
        this.deletionGracePeriodSeconds = deletionGracePeriodSeconds;
        return this;
    }

    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta deletionTimestamp(final String deletionTimestamp) {
        this.deletionTimestamp = deletionTimestamp;
        return this;
    }

    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta finalizers(final List<String> finalizers) {
        this.finalizers = finalizers;
        return this;
    }

    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta generateName(final String generateName) {
        this.generateName = generateName;
        return this;
    }

    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta generation(final Integer generation) {
        this.generation = generation;
        return this;
    }

    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta labels(final Map<String, String> labels) {
        this.labels = labels;
        return this;
    }

    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta managedFields(final List<ManagedFieldsEntry> managedFields) {
        this.managedFields = managedFields;
        return this;
    }

    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta name(final String name) {
        this.name = name;
        return this;
    }

    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta namespace(final String namespace) {
        this.namespace = namespace;
        return this;
    }

    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta ownerReferences(final List<OwnerReference> ownerReferences) {
        this.ownerReferences = ownerReferences;
        return this;
    }

    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta resourceVersion(final String resourceVersion) {
        this.resourceVersion = resourceVersion;
        return this;
    }

    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta selfLink(final String selfLink) {
        this.selfLink = selfLink;
        return this;
    }

    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta uid(final String uid) {
        this.uid = uid;
        return this;
    }

    @Override
    public io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta validate() {
        return this;
    }
