...
public class io.k8s.api.core.v1.ReplicationControllerStatus implements Validable<io.k8s.api.core.v1.ReplicationControllerStatus>, Exportable {
    ...
    public io.k8s.api.core.v1.ReplicationControllerStatus() {
        // no-op
    }

    public io.k8s.api.core.v1.ReplicationControllerStatus(final Integer availableReplicas,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.ReplicationControllerStatus)) {
            return false;
        }
        final io.k8s.api.core.v1.ReplicationControllerStatus __otherCasted = (io.k8s.api.core.v1.ReplicationControllerStatus) __other;
    ...
    public io.k8s.api.core.v1.ReplicationControllerStatus availableReplicas(final Integer availableReplicas) {
        this.availableReplicas = availableReplicas;
        return this;
    }

    public io.k8s.api.core.v1.ReplicationControllerStatus conditions(final List<ReplicationControllerCondition> conditions) {
        this.conditions = conditions;
        return this;
    }

    public io.k8s.api.core.v1.ReplicationControllerStatus fullyLabeledReplicas(final Integer fullyLabeledReplicas) {
        this.fullyLabeledReplicas = fullyLabeledReplicas;
        return this;
    }

    public io.k8s.api.core.v1.ReplicationControllerStatus observedGeneration(final Integer observedGeneration) {
        this.observedGeneration = observedGeneration;
        return this;
    }

    public io.k8s.api.core.v1.ReplicationControllerStatus readyReplicas(final Integer readyReplicas) {
        this.readyReplicas = readyReplicas;
        return this;
    }

    public io.k8s.api.core.v1.ReplicationControllerStatus replicas(final int replicas) {
        this.replicas = replicas;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.ReplicationControllerStatus validate() {
        return this;
    }
