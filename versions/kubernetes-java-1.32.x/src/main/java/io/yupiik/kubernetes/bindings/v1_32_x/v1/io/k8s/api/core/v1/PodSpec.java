...
public class io.k8s.api.core.v1.PodSpec implements Validable<io.k8s.api.core.v1.PodSpec>, Exportable {
    ...
    public io.k8s.api.core.v1.PodSpec() {
        // no-op
    }

    public io.k8s.api.core.v1.PodSpec(final Integer activeDeadlineSeconds,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.PodSpec)) {
            return false;
        }
        final io.k8s.api.core.v1.PodSpec __otherCasted = (io.k8s.api.core.v1.PodSpec) __other;
    ...
    public io.k8s.api.core.v1.PodSpec activeDeadlineSeconds(final Integer activeDeadlineSeconds) {
        this.activeDeadlineSeconds = activeDeadlineSeconds;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec affinity(final Affinity affinity) {
        this.affinity = affinity;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec automountServiceAccountToken(final Boolean automountServiceAccountToken) {
        this.automountServiceAccountToken = automountServiceAccountToken;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec containers(final List<Container> containers) {
        this.containers = containers;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec dnsConfig(final PodDNSConfig dnsConfig) {
        this.dnsConfig = dnsConfig;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec dnsPolicy(final String dnsPolicy) {
        this.dnsPolicy = dnsPolicy;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec enableServiceLinks(final Boolean enableServiceLinks) {
        this.enableServiceLinks = enableServiceLinks;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec ephemeralContainers(final List<EphemeralContainer> ephemeralContainers) {
        this.ephemeralContainers = ephemeralContainers;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec hostAliases(final List<HostAlias> hostAliases) {
        this.hostAliases = hostAliases;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec hostIPC(final Boolean hostIPC) {
        this.hostIPC = hostIPC;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec hostNetwork(final Boolean hostNetwork) {
        this.hostNetwork = hostNetwork;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec hostPID(final Boolean hostPID) {
        this.hostPID = hostPID;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec hostUsers(final Boolean hostUsers) {
        this.hostUsers = hostUsers;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec hostname(final String hostname) {
        this.hostname = hostname;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec imagePullSecrets(final List<LocalObjectReference> imagePullSecrets) {
        this.imagePullSecrets = imagePullSecrets;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec initContainers(final List<Container> initContainers) {
        this.initContainers = initContainers;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec nodeName(final String nodeName) {
        this.nodeName = nodeName;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec nodeSelector(final Map<String, String> nodeSelector) {
        this.nodeSelector = nodeSelector;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec os(final PodOS os) {
        this.os = os;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec overhead(final JsonObject overhead) {
        this.overhead = overhead;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec preemptionPolicy(final String preemptionPolicy) {
        this.preemptionPolicy = preemptionPolicy;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec priority(final Integer priority) {
        this.priority = priority;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec priorityClassName(final String priorityClassName) {
        this.priorityClassName = priorityClassName;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec readinessGates(final List<PodReadinessGate> readinessGates) {
        this.readinessGates = readinessGates;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec resourceClaims(final List<PodResourceClaim> resourceClaims) {
        this.resourceClaims = resourceClaims;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec resources(final ResourceRequirements resources) {
        this.resources = resources;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec restartPolicy(final String restartPolicy) {
        this.restartPolicy = restartPolicy;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec runtimeClassName(final String runtimeClassName) {
        this.runtimeClassName = runtimeClassName;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec schedulerName(final String schedulerName) {
        this.schedulerName = schedulerName;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec schedulingGates(final List<PodSchedulingGate> schedulingGates) {
        this.schedulingGates = schedulingGates;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec securityContext(final PodSecurityContext securityContext) {
        this.securityContext = securityContext;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec serviceAccount(final String serviceAccount) {
        this.serviceAccount = serviceAccount;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec serviceAccountName(final String serviceAccountName) {
        this.serviceAccountName = serviceAccountName;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec setHostnameAsFQDN(final Boolean setHostnameAsFQDN) {
        this.setHostnameAsFQDN = setHostnameAsFQDN;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec shareProcessNamespace(final Boolean shareProcessNamespace) {
        this.shareProcessNamespace = shareProcessNamespace;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec subdomain(final String subdomain) {
        this.subdomain = subdomain;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec terminationGracePeriodSeconds(final Integer terminationGracePeriodSeconds) {
        this.terminationGracePeriodSeconds = terminationGracePeriodSeconds;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec tolerations(final List<Toleration> tolerations) {
        this.tolerations = tolerations;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec topologySpreadConstraints(final List<TopologySpreadConstraint> topologySpreadConstraints) {
        this.topologySpreadConstraints = topologySpreadConstraints;
        return this;
    }

    public io.k8s.api.core.v1.PodSpec volumes(final List<Volume> volumes) {
        this.volumes = volumes;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.PodSpec validate() {
