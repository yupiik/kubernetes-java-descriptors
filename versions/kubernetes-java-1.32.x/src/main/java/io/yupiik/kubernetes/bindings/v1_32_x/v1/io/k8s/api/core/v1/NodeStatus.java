...
public class io.k8s.api.core.v1.NodeStatus implements Validable<io.k8s.api.core.v1.NodeStatus>, Exportable {
    ...
    public io.k8s.api.core.v1.NodeStatus features(final NodeFeatures features) {
        this.features = features;
        return this;
    }
    ...
    public io.k8s.api.core.v1.NodeStatus runtimeHandlers(final List<NodeRuntimeHandler> runtimeHandlers) {
        this.runtimeHandlers = runtimeHandlers;
        return this;
    }
