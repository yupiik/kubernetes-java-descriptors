...
public class io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration implements Validable<io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration>, Exportable {
    ...
    public io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration() {
        // no-op
    }

    public io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration(final Integer borrowingLimitPercent,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration)) {
            return false;
        }
        final io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration __otherCasted = (io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration) __other;
    ...
    public io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration borrowingLimitPercent(final Integer borrowingLimitPercent) {
        this.borrowingLimitPercent = borrowingLimitPercent;
        return this;
    }

    public io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration lendablePercent(final Integer lendablePercent) {
        this.lendablePercent = lendablePercent;
        return this;
    }

    public io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration limitResponse(final LimitResponse limitResponse) {
        this.limitResponse = limitResponse;
        return this;
    }

    public io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration nominalConcurrencyShares(final Integer nominalConcurrencyShares) {
        this.nominalConcurrencyShares = nominalConcurrencyShares;
        return this;
    }

    @Override
    public io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration validate() {
        return this;
    }
