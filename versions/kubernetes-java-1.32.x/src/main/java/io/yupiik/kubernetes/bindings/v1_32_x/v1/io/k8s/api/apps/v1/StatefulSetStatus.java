...
public class io.k8s.api.apps.v1.StatefulSetStatus implements Validable<io.k8s.api.apps.v1.StatefulSetStatus>, Exportable {
    ...
    public io.k8s.api.apps.v1.StatefulSetStatus() {
        // no-op
    }

    public io.k8s.api.apps.v1.StatefulSetStatus(final Integer availableReplicas,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.apps.v1.StatefulSetStatus)) {
            return false;
        }
        final io.k8s.api.apps.v1.StatefulSetStatus __otherCasted = (io.k8s.api.apps.v1.StatefulSetStatus) __other;
    ...
    public io.k8s.api.apps.v1.StatefulSetStatus availableReplicas(final Integer availableReplicas) {
        this.availableReplicas = availableReplicas;
        return this;
    }

    public io.k8s.api.apps.v1.StatefulSetStatus collisionCount(final Integer collisionCount) {
        this.collisionCount = collisionCount;
        return this;
    }

    public io.k8s.api.apps.v1.StatefulSetStatus conditions(final List<StatefulSetCondition> conditions) {
        this.conditions = conditions;
        return this;
    }

    public io.k8s.api.apps.v1.StatefulSetStatus currentReplicas(final Integer currentReplicas) {
        this.currentReplicas = currentReplicas;
        return this;
    }

    public io.k8s.api.apps.v1.StatefulSetStatus currentRevision(final String currentRevision) {
        this.currentRevision = currentRevision;
        return this;
    }

    public io.k8s.api.apps.v1.StatefulSetStatus observedGeneration(final Integer observedGeneration) {
        this.observedGeneration = observedGeneration;
        return this;
    }

    public io.k8s.api.apps.v1.StatefulSetStatus readyReplicas(final Integer readyReplicas) {
        this.readyReplicas = readyReplicas;
        return this;
    }

    public io.k8s.api.apps.v1.StatefulSetStatus replicas(final int replicas) {
        this.replicas = replicas;
        return this;
    }

    public io.k8s.api.apps.v1.StatefulSetStatus updateRevision(final String updateRevision) {
        this.updateRevision = updateRevision;
        return this;
    }

    public io.k8s.api.apps.v1.StatefulSetStatus updatedReplicas(final Integer updatedReplicas) {
        this.updatedReplicas = updatedReplicas;
        return this;
    }

    @Override
    public io.k8s.api.apps.v1.StatefulSetStatus validate() {
        return this;
    }
