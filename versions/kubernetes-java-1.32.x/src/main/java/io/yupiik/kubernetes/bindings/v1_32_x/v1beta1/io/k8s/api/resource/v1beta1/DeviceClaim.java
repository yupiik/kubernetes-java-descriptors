...
public class io.k8s.api.resource.v1beta1.DeviceClaim implements Validable<io.k8s.api.resource.v1beta1.DeviceClaim>, Exportable {
    private List<DeviceClaimConfiguration> config;
    private List<DeviceConstraint> constraints;
    private List<DeviceRequest> requests;

    public io.k8s.api.resource.v1beta1.DeviceClaim() {
        // no-op
    }

    public io.k8s.api.resource.v1beta1.DeviceClaim(final List<DeviceClaimConfiguration> config,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.resource.v1beta1.DeviceClaim)) {
            return false;
        }
        final io.k8s.api.resource.v1beta1.DeviceClaim __otherCasted = (io.k8s.api.resource.v1beta1.DeviceClaim) __other;
    ...
    public io.k8s.api.resource.v1beta1.DeviceClaim config(final List<DeviceClaimConfiguration> config) {
        this.config = config;
        return this;
    }

    public io.k8s.api.resource.v1beta1.DeviceClaim constraints(final List<DeviceConstraint> constraints) {
        this.constraints = constraints;
        return this;
    }

    public io.k8s.api.resource.v1beta1.DeviceClaim requests(final List<DeviceRequest> requests) {
        this.requests = requests;
        return this;
    }

    @Override
    public io.k8s.api.resource.v1beta1.DeviceClaim validate() {
        return this;
    }
