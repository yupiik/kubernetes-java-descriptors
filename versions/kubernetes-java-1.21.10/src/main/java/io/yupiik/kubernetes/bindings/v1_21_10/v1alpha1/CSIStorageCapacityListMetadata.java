...
public class CSIStorageCapacityListMetadata {
    ...
    public CSIStorageCapacityListMetadata() {
        // no-op
    }

    public CSIStorageCapacityListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSIStorageCapacityListMetadata)) {
            return false;
        }
        final CSIStorageCapacityListMetadata __otherCasted = (CSIStorageCapacityListMetadata) __other;
