...
public class StorageVersionMetadata {
    ...
    private List<StorageVersionMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<StorageVersionMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public StorageVersionMetadata() {
        // no-op
    }

    public StorageVersionMetadata(final Map<String, String> annotations,
                                  ...
                                  final List<StorageVersionMetadataManagedFields> managedFields,
                                  final String name,
                                  final String namespace,
                                  final List<StorageVersionMetadataOwnerReferences> ownerReferences,
    ...
    public List<StorageVersionMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<StorageVersionMetadataManagedFields> managedFields) {
    ...
    public List<StorageVersionMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<StorageVersionMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StorageVersionMetadata)) {
            return false;
        }
        final StorageVersionMetadata __otherCasted = (StorageVersionMetadata) __other;
