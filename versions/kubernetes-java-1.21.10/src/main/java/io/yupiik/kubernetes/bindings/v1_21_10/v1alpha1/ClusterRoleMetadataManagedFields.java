...
public class ClusterRoleMetadataManagedFields {
    ...
    public ClusterRoleMetadataManagedFields() {
        // no-op
    }

    public ClusterRoleMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ClusterRoleMetadataManagedFields)) {
            return false;
        }
        final ClusterRoleMetadataManagedFields __otherCasted = (ClusterRoleMetadataManagedFields) __other;
