...
public class ReplicationControllerSpecTemplateSpecInitContainersSecurityContext {
    ...
    private ReplicationControllerSpecTemplateSpecInitContainersSecurityContextSeccompProfile seccompProfile;
    ...
    public ReplicationControllerSpecTemplateSpecInitContainersSecurityContext(final Boolean allowPrivilegeEscalation,
                                                                              ...
                                                                              final ReplicationControllerSpecTemplateSpecInitContainersSecurityContextSeccompProfile seccompProfile,
    ...
    public ReplicationControllerSpecTemplateSpecInitContainersSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final ReplicationControllerSpecTemplateSpecInitContainersSecurityContextSeccompProfile seccompProfile) {
