...
public class EphemeralContainersMetadataManagedFields {
    ...
    public EphemeralContainersMetadataManagedFields() {
        // no-op
    }

    public EphemeralContainersMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EphemeralContainersMetadataManagedFields)) {
            return false;
        }
        final EphemeralContainersMetadataManagedFields __otherCasted = (EphemeralContainersMetadataManagedFields) __other;
