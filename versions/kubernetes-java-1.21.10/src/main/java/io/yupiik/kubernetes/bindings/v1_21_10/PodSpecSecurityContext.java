...
public class PodSpecSecurityContext {
    ...
    private PodSpecSecurityContextSeccompProfile seccompProfile;
    private List<Integer> supplementalGroups;
    private List<PodSpecSecurityContextSysctls> sysctls;
    private PodSpecSecurityContextWindowsOptions windowsOptions;
    ...
    public PodSpecSecurityContext(final Integer fsGroup,
                                  ...
                                  final PodSpecSecurityContextSeccompProfile seccompProfile,
                                  final List<Integer> supplementalGroups,
                                  final List<PodSpecSecurityContextSysctls> sysctls,
                                  final PodSpecSecurityContextWindowsOptions windowsOptions) {
        // no-op
    }
    ...
    public PodSpecSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final PodSpecSecurityContextSeccompProfile seccompProfile) {
    ...
    public List<PodSpecSecurityContextSysctls> getSysctls() {
        return sysctls;
    }

    public void setSysctls(final List<PodSpecSecurityContextSysctls> sysctls) {
        this.sysctls = sysctls;
    }

    public PodSpecSecurityContextWindowsOptions getWindowsOptions() {
        return windowsOptions;
    }

    public void setWindowsOptions(final PodSpecSecurityContextWindowsOptions windowsOptions) {
