...
public class BindingMetadataOwnerReferences {
    ...
    public BindingMetadataOwnerReferences() {
        // no-op
    }

    public BindingMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof BindingMetadataOwnerReferences)) {
            return false;
        }
        final BindingMetadataOwnerReferences __otherCasted = (BindingMetadataOwnerReferences) __other;
