...
public class PodSpecInitContainersSecurityContextWindowsOptions {
    private String gmsaCredentialSpec;
    private String gmsaCredentialSpecName;
    private String runAsUserName;

    public PodSpecInitContainersSecurityContextWindowsOptions() {
        // no-op
    }

    public PodSpecInitContainersSecurityContextWindowsOptions(final String gmsaCredentialSpec,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSpecInitContainersSecurityContextWindowsOptions)) {
            return false;
        }
        final PodSpecInitContainersSecurityContextWindowsOptions __otherCasted = (PodSpecInitContainersSecurityContextWindowsOptions) __other;
