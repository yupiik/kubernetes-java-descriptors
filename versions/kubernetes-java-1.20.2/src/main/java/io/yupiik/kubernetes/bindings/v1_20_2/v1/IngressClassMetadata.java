...
public class IngressClassMetadata {
    ...
    private List<IngressClassMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<IngressClassMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public IngressClassMetadata() {
        // no-op
    }

    public IngressClassMetadata(final Map<String, String> annotations,
                                ...
                                final List<IngressClassMetadataManagedFields> managedFields,
                                final String name,
                                final String namespace,
                                final List<IngressClassMetadataOwnerReferences> ownerReferences,
    ...
    public List<IngressClassMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<IngressClassMetadataManagedFields> managedFields) {
    ...
    public List<IngressClassMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<IngressClassMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof IngressClassMetadata)) {
            return false;
        }
        final IngressClassMetadata __otherCasted = (IngressClassMetadata) __other;
