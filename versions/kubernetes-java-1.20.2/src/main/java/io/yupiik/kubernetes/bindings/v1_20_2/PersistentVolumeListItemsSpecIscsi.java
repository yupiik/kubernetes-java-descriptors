...
public class PersistentVolumeListItemsSpecIscsi {
    ...
    private PersistentVolumeListItemsSpecIscsiSecretRef secretRef;
    private String targetPortal;

    public PersistentVolumeListItemsSpecIscsi() {
        // no-op
    }

    public PersistentVolumeListItemsSpecIscsi(final Boolean chapAuthDiscovery,
                                              ...
                                              final PersistentVolumeListItemsSpecIscsiSecretRef secretRef,
    ...
    public PersistentVolumeListItemsSpecIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final PersistentVolumeListItemsSpecIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PersistentVolumeListItemsSpecIscsi)) {
            return false;
        }
        final PersistentVolumeListItemsSpecIscsi __otherCasted = (PersistentVolumeListItemsSpecIscsi) __other;
