...
public class PodSpecEphemeralContainersVolumeMounts {
    ...
    public PodSpecEphemeralContainersVolumeMounts() {
        // no-op
    }

    public PodSpecEphemeralContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSpecEphemeralContainersVolumeMounts)) {
            return false;
        }
        final PodSpecEphemeralContainersVolumeMounts __otherCasted = (PodSpecEphemeralContainersVolumeMounts) __other;
