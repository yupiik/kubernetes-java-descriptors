...
public class SecretMetadataOwnerReferences {
    ...
    public SecretMetadataOwnerReferences() {
        // no-op
    }

    public SecretMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof SecretMetadataOwnerReferences)) {
            return false;
        }
        final SecretMetadataOwnerReferences __otherCasted = (SecretMetadataOwnerReferences) __other;
