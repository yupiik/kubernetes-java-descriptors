...
public class IngressClassMetadataOwnerReferences {
    ...
    public IngressClassMetadataOwnerReferences() {
        // no-op
    }

    public IngressClassMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof IngressClassMetadataOwnerReferences)) {
            return false;
        }
        final IngressClassMetadataOwnerReferences __otherCasted = (IngressClassMetadataOwnerReferences) __other;
