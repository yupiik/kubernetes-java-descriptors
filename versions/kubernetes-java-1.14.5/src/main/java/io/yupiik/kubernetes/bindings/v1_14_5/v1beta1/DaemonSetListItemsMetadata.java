...
public class DaemonSetListItemsMetadata {
    ...
    private DaemonSetListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<DaemonSetListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<DaemonSetListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public DaemonSetListItemsMetadata() {
        // no-op
    }

    public DaemonSetListItemsMetadata(final Map<String, String> annotations,
                                      ...
                                      final DaemonSetListItemsMetadataInitializers initializers,
                                      final Map<String, String> labels,
                                      final List<DaemonSetListItemsMetadataManagedFields> managedFields,
                                      final String name,
                                      final String namespace,
                                      final List<DaemonSetListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public DaemonSetListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final DaemonSetListItemsMetadataInitializers initializers) {
    ...
    public List<DaemonSetListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<DaemonSetListItemsMetadataManagedFields> managedFields) {
    ...
    public List<DaemonSetListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<DaemonSetListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetListItemsMetadata)) {
            return false;
        }
        final DaemonSetListItemsMetadata __otherCasted = (DaemonSetListItemsMetadata) __other;
