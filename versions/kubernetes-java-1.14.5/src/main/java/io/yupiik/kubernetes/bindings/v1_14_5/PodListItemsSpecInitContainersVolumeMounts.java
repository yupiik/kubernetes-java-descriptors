...
public class PodListItemsSpecInitContainersVolumeMounts {
    ...
    public PodListItemsSpecInitContainersVolumeMounts() {
        // no-op
    }

    public PodListItemsSpecInitContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodListItemsSpecInitContainersVolumeMounts)) {
            return false;
        }
        final PodListItemsSpecInitContainersVolumeMounts __otherCasted = (PodListItemsSpecInitContainersVolumeMounts) __other;
