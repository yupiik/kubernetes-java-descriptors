...
public class EventListItemsMetadata {
    ...
    private EventListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<EventListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<EventListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public EventListItemsMetadata() {
        // no-op
    }

    public EventListItemsMetadata(final Map<String, String> annotations,
                                  ...
                                  final EventListItemsMetadataInitializers initializers,
                                  final Map<String, String> labels,
                                  final List<EventListItemsMetadataManagedFields> managedFields,
                                  final String name,
                                  final String namespace,
                                  final List<EventListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public EventListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final EventListItemsMetadataInitializers initializers) {
    ...
    public List<EventListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<EventListItemsMetadataManagedFields> managedFields) {
    ...
    public List<EventListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<EventListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EventListItemsMetadata)) {
            return false;
        }
        final EventListItemsMetadata __otherCasted = (EventListItemsMetadata) __other;
