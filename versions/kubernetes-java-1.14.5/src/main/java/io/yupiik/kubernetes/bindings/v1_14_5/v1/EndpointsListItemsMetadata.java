...
public class EndpointsListItemsMetadata {
    ...
    private EndpointsListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<EndpointsListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<EndpointsListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public EndpointsListItemsMetadata() {
        // no-op
    }

    public EndpointsListItemsMetadata(final Map<String, String> annotations,
                                      ...
                                      final EndpointsListItemsMetadataInitializers initializers,
                                      final Map<String, String> labels,
                                      final List<EndpointsListItemsMetadataManagedFields> managedFields,
                                      final String name,
                                      final String namespace,
                                      final List<EndpointsListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public EndpointsListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final EndpointsListItemsMetadataInitializers initializers) {
    ...
    public List<EndpointsListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<EndpointsListItemsMetadataManagedFields> managedFields) {
    ...
    public List<EndpointsListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<EndpointsListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EndpointsListItemsMetadata)) {
            return false;
        }
        final EndpointsListItemsMetadata __otherCasted = (EndpointsListItemsMetadata) __other;
