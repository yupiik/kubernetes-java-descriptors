...
public class LeaseMetadataManagedFields {
    ...
    public LeaseMetadataManagedFields() {
        // no-op
    }

    public LeaseMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LeaseMetadataManagedFields)) {
            return false;
        }
        final LeaseMetadataManagedFields __otherCasted = (LeaseMetadataManagedFields) __other;
