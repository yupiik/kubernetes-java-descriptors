...
public class JobMetadataOwnerReferences {
    ...
    public JobMetadataOwnerReferences() {
        // no-op
    }

    public JobMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobMetadataOwnerReferences)) {
            return false;
        }
        final JobMetadataOwnerReferences __otherCasted = (JobMetadataOwnerReferences) __other;
