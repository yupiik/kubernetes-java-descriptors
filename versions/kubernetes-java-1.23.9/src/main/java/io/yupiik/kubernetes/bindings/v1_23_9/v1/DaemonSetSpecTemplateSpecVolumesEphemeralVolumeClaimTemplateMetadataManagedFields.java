...
public class DaemonSetSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields {
    ...
    public DaemonSetSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields() {
        // no-op
    }

    public DaemonSetSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields)) {
            return false;
        }
        final DaemonSetSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields __otherCasted = (DaemonSetSpecTemplateSpecVolumesEphemeralVolumeClaimTemplateMetadataManagedFields) __other;
