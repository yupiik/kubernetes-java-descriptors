...
public class ReplicationControllerSpecTemplateSpecContainersReadinessProbe {
    ...
    private ReplicationControllerSpecTemplateSpecContainersReadinessProbeGrpc grpc;
    ...
    public ReplicationControllerSpecTemplateSpecContainersReadinessProbe(final ReplicationControllerSpecTemplateSpecContainersReadinessProbeExec exec,
                                                                         ...
                                                                         final ReplicationControllerSpecTemplateSpecContainersReadinessProbeGrpc grpc,
    ...
    public ReplicationControllerSpecTemplateSpecContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final ReplicationControllerSpecTemplateSpecContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
