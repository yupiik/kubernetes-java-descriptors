...
public class DeploymentListItemsSpecTemplateSpecSecurityContext {
    ...
    private DeploymentListItemsSpecTemplateSpecSecurityContextSeccompProfile seccompProfile;
    ...
    public DeploymentListItemsSpecTemplateSpecSecurityContext(final Integer fsGroup,
                                                              ...
                                                              final DeploymentListItemsSpecTemplateSpecSecurityContextSeccompProfile seccompProfile,
    ...
    public DeploymentListItemsSpecTemplateSpecSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final DeploymentListItemsSpecTemplateSpecSecurityContextSeccompProfile seccompProfile) {
