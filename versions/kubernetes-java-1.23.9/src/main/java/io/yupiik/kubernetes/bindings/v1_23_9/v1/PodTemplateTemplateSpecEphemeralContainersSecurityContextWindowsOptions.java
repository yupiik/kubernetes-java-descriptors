...
public class PodTemplateTemplateSpecEphemeralContainersSecurityContextWindowsOptions {
    private String gmsaCredentialSpec;
    private String gmsaCredentialSpecName;
    private Boolean hostProcess;
    private String runAsUserName;

    public PodTemplateTemplateSpecEphemeralContainersSecurityContextWindowsOptions() {
        // no-op
    }

    public PodTemplateTemplateSpecEphemeralContainersSecurityContextWindowsOptions(final String gmsaCredentialSpec,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateTemplateSpecEphemeralContainersSecurityContextWindowsOptions)) {
            return false;
        }
        final PodTemplateTemplateSpecEphemeralContainersSecurityContextWindowsOptions __otherCasted = (PodTemplateTemplateSpecEphemeralContainersSecurityContextWindowsOptions) __other;
