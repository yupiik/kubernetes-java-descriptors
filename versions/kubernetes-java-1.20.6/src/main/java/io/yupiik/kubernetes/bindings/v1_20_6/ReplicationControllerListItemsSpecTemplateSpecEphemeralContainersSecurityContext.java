...
public class ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersSecurityContext {
    ...
    private ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersSecurityContextSeccompProfile seccompProfile;
    ...
    public ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersSecurityContext(final Boolean allowPrivilegeEscalation,
                                                                                            ...
                                                                                            final ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersSecurityContextSeccompProfile seccompProfile,
    ...
    public ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final ReplicationControllerListItemsSpecTemplateSpecEphemeralContainersSecurityContextSeccompProfile seccompProfile) {
