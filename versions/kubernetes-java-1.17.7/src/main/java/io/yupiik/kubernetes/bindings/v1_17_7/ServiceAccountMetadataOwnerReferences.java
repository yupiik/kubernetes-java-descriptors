...
public class ServiceAccountMetadataOwnerReferences {
    ...
    public ServiceAccountMetadataOwnerReferences() {
        // no-op
    }

    public ServiceAccountMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ServiceAccountMetadataOwnerReferences)) {
            return false;
        }
        final ServiceAccountMetadataOwnerReferences __otherCasted = (ServiceAccountMetadataOwnerReferences) __other;
