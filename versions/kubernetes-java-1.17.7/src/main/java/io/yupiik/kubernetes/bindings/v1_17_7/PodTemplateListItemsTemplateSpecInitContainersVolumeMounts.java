...
public class PodTemplateListItemsTemplateSpecInitContainersVolumeMounts {
    ...
    public PodTemplateListItemsTemplateSpecInitContainersVolumeMounts() {
        // no-op
    }

    public PodTemplateListItemsTemplateSpecInitContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateListItemsTemplateSpecInitContainersVolumeMounts)) {
            return false;
        }
        final PodTemplateListItemsTemplateSpecInitContainersVolumeMounts __otherCasted = (PodTemplateListItemsTemplateSpecInitContainersVolumeMounts) __other;
