...
public class io.k8s.api.admissionregistration.v1.NamedRuleWithOperations implements Validable<io.k8s.api.admissionregistration.v1.NamedRuleWithOperations>, Exportable {
    ...
    public io.k8s.api.admissionregistration.v1.NamedRuleWithOperations() {
        // no-op
    }

    public io.k8s.api.admissionregistration.v1.NamedRuleWithOperations(final List<String> apiGroups,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.admissionregistration.v1.NamedRuleWithOperations)) {
            return false;
        }
        final io.k8s.api.admissionregistration.v1.NamedRuleWithOperations __otherCasted = (io.k8s.api.admissionregistration.v1.NamedRuleWithOperations) __other;
    ...
    public io.k8s.api.admissionregistration.v1.NamedRuleWithOperations apiGroups(final List<String> apiGroups) {
        this.apiGroups = apiGroups;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.NamedRuleWithOperations apiVersions(final List<String> apiVersions) {
        this.apiVersions = apiVersions;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.NamedRuleWithOperations operations(final List<String> operations) {
        this.operations = operations;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.NamedRuleWithOperations resourceNames(final List<String> resourceNames) {
        this.resourceNames = resourceNames;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.NamedRuleWithOperations resources(final List<String> resources) {
        this.resources = resources;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.NamedRuleWithOperations scope(final String scope) {
        this.scope = scope;
        return this;
    }

    @Override
    public io.k8s.api.admissionregistration.v1.NamedRuleWithOperations validate() {
        return this;
    }
