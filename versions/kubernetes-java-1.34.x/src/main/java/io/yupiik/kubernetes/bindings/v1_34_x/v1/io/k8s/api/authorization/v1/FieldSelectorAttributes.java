...
public class io.k8s.api.authorization.v1.FieldSelectorAttributes implements Validable<io.k8s.api.authorization.v1.FieldSelectorAttributes>, Exportable {
    private String rawSelector;
    private List<FieldSelectorRequirement> requirements;

    public io.k8s.api.authorization.v1.FieldSelectorAttributes() {
        // no-op
    }

    public io.k8s.api.authorization.v1.FieldSelectorAttributes(final String rawSelector,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.authorization.v1.FieldSelectorAttributes)) {
            return false;
        }
        final io.k8s.api.authorization.v1.FieldSelectorAttributes __otherCasted = (io.k8s.api.authorization.v1.FieldSelectorAttributes) __other;
        return Objects.equals(rawSelector, __otherCasted.rawSelector) &&
            Objects.equals(requirements, __otherCasted.requirements);
    }

    public io.k8s.api.authorization.v1.FieldSelectorAttributes rawSelector(final String rawSelector) {
        this.rawSelector = rawSelector;
        return this;
    }

    public io.k8s.api.authorization.v1.FieldSelectorAttributes requirements(final List<FieldSelectorRequirement> requirements) {
        this.requirements = requirements;
        return this;
    }

    @Override
    public io.k8s.api.authorization.v1.FieldSelectorAttributes validate() {
        return this;
    }
