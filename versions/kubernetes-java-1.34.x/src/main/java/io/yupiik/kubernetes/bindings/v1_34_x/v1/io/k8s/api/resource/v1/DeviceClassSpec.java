...
public class io.k8s.api.resource.v1.DeviceClassSpec implements Validable<io.k8s.api.resource.v1.DeviceClassSpec>, Exportable {
    private List<DeviceClassConfiguration> config;
    private String extendedResourceName;
    private List<DeviceSelector> selectors;

    public io.k8s.api.resource.v1.DeviceClassSpec() {
        // no-op
    }

    public io.k8s.api.resource.v1.DeviceClassSpec(final List<DeviceClassConfiguration> config,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.resource.v1.DeviceClassSpec)) {
            return false;
        }
        final io.k8s.api.resource.v1.DeviceClassSpec __otherCasted = (io.k8s.api.resource.v1.DeviceClassSpec) __other;
    ...
    public io.k8s.api.resource.v1.DeviceClassSpec config(final List<DeviceClassConfiguration> config) {
        this.config = config;
        return this;
    }

    public io.k8s.api.resource.v1.DeviceClassSpec extendedResourceName(final String extendedResourceName) {
        this.extendedResourceName = extendedResourceName;
        return this;
    }

    public io.k8s.api.resource.v1.DeviceClassSpec selectors(final List<DeviceSelector> selectors) {
        this.selectors = selectors;
        return this;
    }

    @Override
    public io.k8s.api.resource.v1.DeviceClassSpec validate() {
        return this;
    }
