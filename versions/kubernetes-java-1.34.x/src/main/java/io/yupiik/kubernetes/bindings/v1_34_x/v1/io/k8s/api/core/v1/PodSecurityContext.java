...
public class io.k8s.api.core.v1.PodSecurityContext implements Validable<io.k8s.api.core.v1.PodSecurityContext>, Exportable {
    ...
    public io.k8s.api.core.v1.PodSecurityContext() {
        // no-op
    }

    public io.k8s.api.core.v1.PodSecurityContext(final AppArmorProfile appArmorProfile,
    ...
    public void setSeLinuxChangePolicy(final String seLinuxChangePolicy) {
        this.seLinuxChangePolicy = seLinuxChangePolicy;
    }
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.PodSecurityContext)) {
            return false;
        }
        final io.k8s.api.core.v1.PodSecurityContext __otherCasted = (io.k8s.api.core.v1.PodSecurityContext) __other;
        return Objects.equals(appArmorProfile, __otherCasted.appArmorProfile) &&
            ...
            Objects.equals(seLinuxChangePolicy, __otherCasted.seLinuxChangePolicy) &&
    ...
    public io.k8s.api.core.v1.PodSecurityContext appArmorProfile(final AppArmorProfile appArmorProfile) {
        this.appArmorProfile = appArmorProfile;
        return this;
    }

    public io.k8s.api.core.v1.PodSecurityContext fsGroup(final Integer fsGroup) {
        this.fsGroup = fsGroup;
        return this;
    }

    public io.k8s.api.core.v1.PodSecurityContext fsGroupChangePolicy(final String fsGroupChangePolicy) {
        this.fsGroupChangePolicy = fsGroupChangePolicy;
        return this;
    }

    public io.k8s.api.core.v1.PodSecurityContext runAsGroup(final Integer runAsGroup) {
        this.runAsGroup = runAsGroup;
        return this;
    }

    public io.k8s.api.core.v1.PodSecurityContext runAsNonRoot(final Boolean runAsNonRoot) {
        this.runAsNonRoot = runAsNonRoot;
        return this;
    }

    public io.k8s.api.core.v1.PodSecurityContext runAsUser(final Integer runAsUser) {
        this.runAsUser = runAsUser;
        return this;
    }

    public io.k8s.api.core.v1.PodSecurityContext seLinuxChangePolicy(final String seLinuxChangePolicy) {
        this.seLinuxChangePolicy = seLinuxChangePolicy;
        return this;
    }

    public io.k8s.api.core.v1.PodSecurityContext seLinuxOptions(final SELinuxOptions seLinuxOptions) {
        this.seLinuxOptions = seLinuxOptions;
        return this;
    }

    public io.k8s.api.core.v1.PodSecurityContext seccompProfile(final SeccompProfile seccompProfile) {
        this.seccompProfile = seccompProfile;
        return this;
    }

    public io.k8s.api.core.v1.PodSecurityContext supplementalGroups(final List<Integer> supplementalGroups) {
        this.supplementalGroups = supplementalGroups;
        return this;
    }

    public io.k8s.api.core.v1.PodSecurityContext supplementalGroupsPolicy(final String supplementalGroupsPolicy) {
        this.supplementalGroupsPolicy = supplementalGroupsPolicy;
        return this;
    }

    public io.k8s.api.core.v1.PodSecurityContext sysctls(final List<Sysctl> sysctls) {
        this.sysctls = sysctls;
        return this;
    }

    public io.k8s.api.core.v1.PodSecurityContext windowsOptions(final WindowsSecurityContextOptions windowsOptions) {
        this.windowsOptions = windowsOptions;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.PodSecurityContext validate() {
        return this;
    }
    ...
    public String asJson() {
        return Stream.of(
                    ...
                    (seLinuxChangePolicy != null ? "\"seLinuxChangePolicy\":\"" +  JsonStrings.escapeJson(seLinuxChangePolicy) + "\"" : ""),
