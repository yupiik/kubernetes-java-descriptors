...
public class io.k8s.api.resource.v1beta1.DeviceConstraint implements Validable<io.k8s.api.resource.v1beta1.DeviceConstraint>, Exportable {
    ...
    public io.k8s.api.resource.v1beta1.DeviceConstraint(final String distinctAttribute,
    ...
    public io.k8s.api.resource.v1beta1.DeviceConstraint distinctAttribute(final String distinctAttribute) {
        this.distinctAttribute = distinctAttribute;
        return this;
    }
