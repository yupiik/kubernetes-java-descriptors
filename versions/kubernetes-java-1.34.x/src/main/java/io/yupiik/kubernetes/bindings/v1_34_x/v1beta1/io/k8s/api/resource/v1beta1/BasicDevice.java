...
public class io.k8s.api.resource.v1beta1.BasicDevice implements Validable<io.k8s.api.resource.v1beta1.BasicDevice>, Exportable {
    ...
    public io.k8s.api.resource.v1beta1.BasicDevice() {
        // no-op
    }

    public io.k8s.api.resource.v1beta1.BasicDevice(final Boolean allNodes,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.resource.v1beta1.BasicDevice)) {
            return false;
        }
        final io.k8s.api.resource.v1beta1.BasicDevice __otherCasted = (io.k8s.api.resource.v1beta1.BasicDevice) __other;
    ...
    public io.k8s.api.resource.v1beta1.BasicDevice allNodes(final Boolean allNodes) {
        this.allNodes = allNodes;
        return this;
    }

    public io.k8s.api.resource.v1beta1.BasicDevice allowMultipleAllocations(final Boolean allowMultipleAllocations) {
        this.allowMultipleAllocations = allowMultipleAllocations;
        return this;
    }

    public io.k8s.api.resource.v1beta1.BasicDevice attributes(final JsonObject attributes) {
        this.attributes = attributes;
        return this;
    }

    public io.k8s.api.resource.v1beta1.BasicDevice bindingConditions(final List<String> bindingConditions) {
        this.bindingConditions = bindingConditions;
        return this;
    }

    public io.k8s.api.resource.v1beta1.BasicDevice bindingFailureConditions(final List<String> bindingFailureConditions) {
        this.bindingFailureConditions = bindingFailureConditions;
        return this;
    }

    public io.k8s.api.resource.v1beta1.BasicDevice bindsToNode(final Boolean bindsToNode) {
        this.bindsToNode = bindsToNode;
        return this;
    }

    public io.k8s.api.resource.v1beta1.BasicDevice capacity(final JsonObject capacity) {
        this.capacity = capacity;
        return this;
    }

    public io.k8s.api.resource.v1beta1.BasicDevice consumesCounters(final List<DeviceCounterConsumption> consumesCounters) {
        this.consumesCounters = consumesCounters;
        return this;
    }

    public io.k8s.api.resource.v1beta1.BasicDevice nodeName(final String nodeName) {
        this.nodeName = nodeName;
        return this;
    }

    public io.k8s.api.resource.v1beta1.BasicDevice nodeSelector(final NodeSelector nodeSelector) {
        this.nodeSelector = nodeSelector;
        return this;
    }

    public io.k8s.api.resource.v1beta1.BasicDevice taints(final List<DeviceTaint> taints) {
        this.taints = taints;
        return this;
    }

    @Override
    public io.k8s.api.resource.v1beta1.BasicDevice validate() {
        return this;
    }
