...
public class io.k8s.api.core.v1.FlexVolumeSource implements Validable<io.k8s.api.core.v1.FlexVolumeSource>, Exportable {
    ...
    public io.k8s.api.core.v1.FlexVolumeSource() {
        // no-op
    }

    public io.k8s.api.core.v1.FlexVolumeSource(final String driver,
                                               final String fsType,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.FlexVolumeSource)) {
            return false;
        }
        final io.k8s.api.core.v1.FlexVolumeSource __otherCasted = (io.k8s.api.core.v1.FlexVolumeSource) __other;
    ...
    public io.k8s.api.core.v1.FlexVolumeSource driver(final String driver) {
        this.driver = driver;
        return this;
    }

    public io.k8s.api.core.v1.FlexVolumeSource fsType(final String fsType) {
        this.fsType = fsType;
        return this;
    }

    public io.k8s.api.core.v1.FlexVolumeSource options(final Map<String, String> options) {
        this.options = options;
        return this;
    }

    public io.k8s.api.core.v1.FlexVolumeSource readOnly(final Boolean readOnly) {
        this.readOnly = readOnly;
        return this;
    }

    public io.k8s.api.core.v1.FlexVolumeSource secretRef(final LocalObjectReference secretRef) {
        this.secretRef = secretRef;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.FlexVolumeSource validate() {
