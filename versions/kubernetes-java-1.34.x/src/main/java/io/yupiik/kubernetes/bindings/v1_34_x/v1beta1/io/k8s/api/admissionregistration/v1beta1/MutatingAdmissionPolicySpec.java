...
public class io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec implements Validable<io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec>, Exportable {
    ...
    public io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec() {
        // no-op
    }

    public io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec(final String failurePolicy,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec)) {
            return false;
        }
        final io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec __otherCasted = (io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec) __other;
    ...
    public io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec failurePolicy(final String failurePolicy) {
        this.failurePolicy = failurePolicy;
        return this;
    }

    public io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec matchConditions(final List<MatchCondition> matchConditions) {
        this.matchConditions = matchConditions;
        return this;
    }

    public io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec matchConstraints(final MatchResources matchConstraints) {
        this.matchConstraints = matchConstraints;
        return this;
    }

    public io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec mutations(final List<Mutation> mutations) {
        this.mutations = mutations;
        return this;
    }

    public io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec paramKind(final ParamKind paramKind) {
        this.paramKind = paramKind;
        return this;
    }

    public io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec reinvocationPolicy(final String reinvocationPolicy) {
        this.reinvocationPolicy = reinvocationPolicy;
        return this;
    }

    public io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec variables(final List<Variable> variables) {
        this.variables = variables;
        return this;
    }

    @Override
    public io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec validate() {
        return this;
    }
