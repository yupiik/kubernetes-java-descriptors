...
public class io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec implements Validable<io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec>, Exportable {
    private MatchResources matchResources;
    private ParamRef paramRef;
    private String policyName;
    private List<String> validationActions;

    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec() {
        // no-op
    }

    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec(final MatchResources matchResources,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec)) {
            return false;
        }
        final io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec __otherCasted = (io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec) __other;
    ...
    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec matchResources(final MatchResources matchResources) {
        this.matchResources = matchResources;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec paramRef(final ParamRef paramRef) {
        this.paramRef = paramRef;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec policyName(final String policyName) {
        this.policyName = policyName;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec validationActions(final List<String> validationActions) {
        this.validationActions = validationActions;
        return this;
    }

    @Override
    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec validate() {
        return this;
    }
