...
public class LeaseListItemsMetadataManagedFields {
    ...
    public LeaseListItemsMetadataManagedFields() {
        // no-op
    }

    public LeaseListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LeaseListItemsMetadataManagedFields)) {
            return false;
        }
        final LeaseListItemsMetadataManagedFields __otherCasted = (LeaseListItemsMetadataManagedFields) __other;
