...
public class ResourceQuotaMetadataOwnerReferences {
    ...
    public ResourceQuotaMetadataOwnerReferences() {
        // no-op
    }

    public ResourceQuotaMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ResourceQuotaMetadataOwnerReferences)) {
            return false;
        }
        final ResourceQuotaMetadataOwnerReferences __otherCasted = (ResourceQuotaMetadataOwnerReferences) __other;
