...
public class PriorityClassMetadata {
    ...
    private PriorityClassMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PriorityClassMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PriorityClassMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PriorityClassMetadata() {
        // no-op
    }

    public PriorityClassMetadata(final Map<String, String> annotations,
                                 ...
                                 final PriorityClassMetadataInitializers initializers,
                                 final Map<String, String> labels,
                                 final List<PriorityClassMetadataManagedFields> managedFields,
                                 final String name,
                                 final String namespace,
                                 final List<PriorityClassMetadataOwnerReferences> ownerReferences,
    ...
    public PriorityClassMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PriorityClassMetadataInitializers initializers) {
    ...
    public List<PriorityClassMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PriorityClassMetadataManagedFields> managedFields) {
    ...
    public List<PriorityClassMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PriorityClassMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PriorityClassMetadata)) {
            return false;
        }
        final PriorityClassMetadata __otherCasted = (PriorityClassMetadata) __other;
