...
public class JobSpecTemplateMetadata {
    ...
    private JobSpecTemplateMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<JobSpecTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<JobSpecTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public JobSpecTemplateMetadata() {
        // no-op
    }

    public JobSpecTemplateMetadata(final Map<String, String> annotations,
                                   ...
                                   final JobSpecTemplateMetadataInitializers initializers,
                                   final Map<String, String> labels,
                                   final List<JobSpecTemplateMetadataManagedFields> managedFields,
                                   final String name,
                                   final String namespace,
                                   final List<JobSpecTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public JobSpecTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final JobSpecTemplateMetadataInitializers initializers) {
    ...
    public List<JobSpecTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<JobSpecTemplateMetadataManagedFields> managedFields) {
    ...
    public List<JobSpecTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<JobSpecTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobSpecTemplateMetadata)) {
            return false;
        }
        final JobSpecTemplateMetadata __otherCasted = (JobSpecTemplateMetadata) __other;
