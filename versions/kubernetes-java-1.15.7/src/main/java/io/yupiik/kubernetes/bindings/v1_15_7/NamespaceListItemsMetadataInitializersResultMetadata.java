...
public class NamespaceListItemsMetadataInitializersResultMetadata {
    ...
    public NamespaceListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public NamespaceListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NamespaceListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final NamespaceListItemsMetadataInitializersResultMetadata __otherCasted = (NamespaceListItemsMetadataInitializersResultMetadata) __other;
