...
public class PodDisruptionBudgetMetadata {
    ...
    private PodDisruptionBudgetMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PodDisruptionBudgetMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PodDisruptionBudgetMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PodDisruptionBudgetMetadata() {
        // no-op
    }

    public PodDisruptionBudgetMetadata(final Map<String, String> annotations,
                                       ...
                                       final PodDisruptionBudgetMetadataInitializers initializers,
                                       final Map<String, String> labels,
                                       final List<PodDisruptionBudgetMetadataManagedFields> managedFields,
                                       final String name,
                                       final String namespace,
                                       final List<PodDisruptionBudgetMetadataOwnerReferences> ownerReferences,
    ...
    public PodDisruptionBudgetMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PodDisruptionBudgetMetadataInitializers initializers) {
    ...
    public List<PodDisruptionBudgetMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PodDisruptionBudgetMetadataManagedFields> managedFields) {
    ...
    public List<PodDisruptionBudgetMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PodDisruptionBudgetMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodDisruptionBudgetMetadata)) {
            return false;
        }
        final PodDisruptionBudgetMetadata __otherCasted = (PodDisruptionBudgetMetadata) __other;
