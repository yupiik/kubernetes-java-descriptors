...
public class StatefulSetSpecTemplateMetadata {
    ...
    private StatefulSetSpecTemplateMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<StatefulSetSpecTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<StatefulSetSpecTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public StatefulSetSpecTemplateMetadata() {
        // no-op
    }

    public StatefulSetSpecTemplateMetadata(final Map<String, String> annotations,
                                           ...
                                           final StatefulSetSpecTemplateMetadataInitializers initializers,
                                           final Map<String, String> labels,
                                           final List<StatefulSetSpecTemplateMetadataManagedFields> managedFields,
                                           final String name,
                                           final String namespace,
                                           final List<StatefulSetSpecTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public StatefulSetSpecTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final StatefulSetSpecTemplateMetadataInitializers initializers) {
    ...
    public List<StatefulSetSpecTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<StatefulSetSpecTemplateMetadataManagedFields> managedFields) {
    ...
    public List<StatefulSetSpecTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<StatefulSetSpecTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetSpecTemplateMetadata)) {
            return false;
        }
        final StatefulSetSpecTemplateMetadata __otherCasted = (StatefulSetSpecTemplateMetadata) __other;
