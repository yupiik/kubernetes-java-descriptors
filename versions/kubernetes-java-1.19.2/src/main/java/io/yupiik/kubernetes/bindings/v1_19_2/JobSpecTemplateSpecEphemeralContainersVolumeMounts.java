...
public class JobSpecTemplateSpecEphemeralContainersVolumeMounts {
    ...
    public JobSpecTemplateSpecEphemeralContainersVolumeMounts() {
        // no-op
    }

    public JobSpecTemplateSpecEphemeralContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobSpecTemplateSpecEphemeralContainersVolumeMounts)) {
            return false;
        }
        final JobSpecTemplateSpecEphemeralContainersVolumeMounts __otherCasted = (JobSpecTemplateSpecEphemeralContainersVolumeMounts) __other;
