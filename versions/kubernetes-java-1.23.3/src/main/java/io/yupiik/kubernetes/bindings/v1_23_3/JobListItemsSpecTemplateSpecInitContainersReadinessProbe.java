...
public class JobListItemsSpecTemplateSpecInitContainersReadinessProbe {
    ...
    private JobListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc grpc;
    ...
    public JobListItemsSpecTemplateSpecInitContainersReadinessProbe(final JobListItemsSpecTemplateSpecInitContainersReadinessProbeExec exec,
                                                                    ...
                                                                    final JobListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc grpc,
    ...
    public JobListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final JobListItemsSpecTemplateSpecInitContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
