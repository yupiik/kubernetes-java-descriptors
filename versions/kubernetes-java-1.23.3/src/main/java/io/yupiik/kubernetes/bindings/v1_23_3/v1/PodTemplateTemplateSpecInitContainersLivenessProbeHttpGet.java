...
public class PodTemplateTemplateSpecInitContainersLivenessProbeHttpGet {
    ...
    private String path;
    private String port;
    private PodTemplateTemplateSpecInitContainersLivenessProbeHttpGetScheme scheme;
    ...
    public PodTemplateTemplateSpecInitContainersLivenessProbeHttpGet(final String host,
                                                                     ...
                                                                     final String path,
                                                                     final String port,
                                                                     final PodTemplateTemplateSpecInitContainersLivenessProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public PodTemplateTemplateSpecInitContainersLivenessProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final PodTemplateTemplateSpecInitContainersLivenessProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
