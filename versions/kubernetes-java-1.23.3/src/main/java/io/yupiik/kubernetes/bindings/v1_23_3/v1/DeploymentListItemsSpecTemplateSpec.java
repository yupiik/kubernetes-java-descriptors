...
public class DeploymentListItemsSpecTemplateSpec {
    ...
    private DeploymentListItemsSpecTemplateSpecDnsPolicy dnsPolicy;
    ...
    private DeploymentListItemsSpecTemplateSpecOs os;
    ...
    private DeploymentListItemsSpecTemplateSpecRestartPolicy restartPolicy;
    ...
    public DeploymentListItemsSpecTemplateSpec(final Integer activeDeadlineSeconds,
                                               ...
                                               final DeploymentListItemsSpecTemplateSpecDnsPolicy dnsPolicy,
                                               ...
                                               final DeploymentListItemsSpecTemplateSpecOs os,
                                               ...
                                               final DeploymentListItemsSpecTemplateSpecRestartPolicy restartPolicy,
    ...
    public DeploymentListItemsSpecTemplateSpecDnsPolicy getDnsPolicy() {
        return dnsPolicy;
    }

    public void setDnsPolicy(final DeploymentListItemsSpecTemplateSpecDnsPolicy dnsPolicy) {
    ...
    public DeploymentListItemsSpecTemplateSpecOs getOs() {
        return os;
    }

    public void setOs(final DeploymentListItemsSpecTemplateSpecOs os) {
        this.os = os;
    }
    ...
    public DeploymentListItemsSpecTemplateSpecRestartPolicy getRestartPolicy() {
        return restartPolicy;
    }

    public void setRestartPolicy(final DeploymentListItemsSpecTemplateSpecRestartPolicy restartPolicy) {
