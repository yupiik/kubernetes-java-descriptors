...
public class ReplicationControllerListItemsSpecTemplateSpecContainers {
    ...
    private ReplicationControllerListItemsSpecTemplateSpecContainersImagePullPolicy imagePullPolicy;
    ...
    private ReplicationControllerListItemsSpecTemplateSpecContainersStartupProbe startupProbe;
    private Boolean stdin;
    private Boolean stdinOnce;
    private String terminationMessagePath;
    private ReplicationControllerListItemsSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public ReplicationControllerListItemsSpecTemplateSpecContainers(final List<String> args,
                                                                    ...
                                                                    final String image,
                                                                    final ReplicationControllerListItemsSpecTemplateSpecContainersImagePullPolicy imagePullPolicy,
                                                                    ...
                                                                    final ReplicationControllerListItemsSpecTemplateSpecContainersStartupProbe startupProbe,
                                                                    final Boolean stdin,
                                                                    final Boolean stdinOnce,
                                                                    final String terminationMessagePath,
                                                                    final ReplicationControllerListItemsSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy,
                                                                    final Boolean tty,
    ...
    public ReplicationControllerListItemsSpecTemplateSpecContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final ReplicationControllerListItemsSpecTemplateSpecContainersImagePullPolicy imagePullPolicy) {
    ...
    public ReplicationControllerListItemsSpecTemplateSpecContainersStartupProbe getStartupProbe() {
        return startupProbe;
    }

    public void setStartupProbe(final ReplicationControllerListItemsSpecTemplateSpecContainersStartupProbe startupProbe) {
    ...
    public ReplicationControllerListItemsSpecTemplateSpecContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final ReplicationControllerListItemsSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy) {
