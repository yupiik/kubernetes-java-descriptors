...
public class PodSpecEphemeralContainers {
    ...
    private PodSpecEphemeralContainersImagePullPolicy imagePullPolicy;
    ...
    private PodSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public PodSpecEphemeralContainers(final List<String> args,
                                      ...
                                      final String image,
                                      final PodSpecEphemeralContainersImagePullPolicy imagePullPolicy,
                                      ...
                                      final PodSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy,
                                      final Boolean tty,
    ...
    public PodSpecEphemeralContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final PodSpecEphemeralContainersImagePullPolicy imagePullPolicy) {
    ...
    public PodSpecEphemeralContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final PodSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy) {
