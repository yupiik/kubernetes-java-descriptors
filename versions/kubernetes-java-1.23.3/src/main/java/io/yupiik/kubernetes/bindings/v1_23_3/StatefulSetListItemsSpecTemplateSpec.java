...
public class StatefulSetListItemsSpecTemplateSpec {
    ...
    private StatefulSetListItemsSpecTemplateSpecDnsPolicy dnsPolicy;
    ...
    private StatefulSetListItemsSpecTemplateSpecOs os;
    ...
    private StatefulSetListItemsSpecTemplateSpecRestartPolicy restartPolicy;
    ...
    public StatefulSetListItemsSpecTemplateSpec(final Integer activeDeadlineSeconds,
                                                ...
                                                final StatefulSetListItemsSpecTemplateSpecDnsPolicy dnsPolicy,
                                                ...
                                                final StatefulSetListItemsSpecTemplateSpecOs os,
                                                ...
                                                final StatefulSetListItemsSpecTemplateSpecRestartPolicy restartPolicy,
    ...
    public StatefulSetListItemsSpecTemplateSpecDnsPolicy getDnsPolicy() {
        return dnsPolicy;
    }

    public void setDnsPolicy(final StatefulSetListItemsSpecTemplateSpecDnsPolicy dnsPolicy) {
    ...
    public StatefulSetListItemsSpecTemplateSpecOs getOs() {
        return os;
    }

    public void setOs(final StatefulSetListItemsSpecTemplateSpecOs os) {
        this.os = os;
    }
    ...
    public StatefulSetListItemsSpecTemplateSpecRestartPolicy getRestartPolicy() {
        return restartPolicy;
    }

    public void setRestartPolicy(final StatefulSetListItemsSpecTemplateSpecRestartPolicy restartPolicy) {
