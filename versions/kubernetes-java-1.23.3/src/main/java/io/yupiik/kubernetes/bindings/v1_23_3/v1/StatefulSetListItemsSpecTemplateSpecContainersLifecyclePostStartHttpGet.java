...
public class StatefulSetListItemsSpecTemplateSpecContainersLifecyclePostStartHttpGet {
    ...
    private String path;
    private String port;
    private StatefulSetListItemsSpecTemplateSpecContainersLifecyclePostStartHttpGetScheme scheme;
    ...
    public StatefulSetListItemsSpecTemplateSpecContainersLifecyclePostStartHttpGet(final String host,
                                                                                   ...
                                                                                   final String path,
                                                                                   final String port,
                                                                                   final StatefulSetListItemsSpecTemplateSpecContainersLifecyclePostStartHttpGetScheme scheme) {
        // no-op
    }
    ...
    public StatefulSetListItemsSpecTemplateSpecContainersLifecyclePostStartHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final StatefulSetListItemsSpecTemplateSpecContainersLifecyclePostStartHttpGetScheme scheme) {
        this.scheme = scheme;
    }
