...
public class PodSpec implements Validable<PodSpec>, Exportable {
    ...
    private PodSpecDnsPolicy dnsPolicy;
    ...
    private PodSpecRestartPolicy restartPolicy;
    ...
    public PodSpec(final Integer activeDeadlineSeconds,
                   ...
                   final PodSpecDnsPolicy dnsPolicy,
                   ...
                   final PodSpecRestartPolicy restartPolicy,
    ...
    public PodSpecDnsPolicy getDnsPolicy() {
        return dnsPolicy;
    }

    public void setDnsPolicy(final PodSpecDnsPolicy dnsPolicy) {
        this.dnsPolicy = dnsPolicy;
    }
    ...
    public PodSpecRestartPolicy getRestartPolicy() {
        return restartPolicy;
    }

    public void setRestartPolicy(final PodSpecRestartPolicy restartPolicy) {
        this.restartPolicy = restartPolicy;
    }
    ...
    public PodSpec dnsPolicy(final PodSpecDnsPolicy dnsPolicy) {
        this.dnsPolicy = dnsPolicy;
        return this;
    }
    ...
    public PodSpec restartPolicy(final PodSpecRestartPolicy restartPolicy) {
        this.restartPolicy = restartPolicy;
        return this;
    }
    ...
    public String asJson() {
        return Stream.of(
                    ...
                    (dnsPolicy != null ? "\"dnsPolicy\":" + dnsPolicy.asJson() : ""),
                    ...
                    (restartPolicy != null ? "\"restartPolicy\":" + restartPolicy.asJson() : ""),
