...
public class CronJobSpecJobTemplateSpecTemplateSpecTopologySpreadConstraints {
    ...
    private CronJobSpecJobTemplateSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable whenUnsatisfiable;
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecTopologySpreadConstraints(final CronJobSpecJobTemplateSpecTemplateSpecTopologySpreadConstraintsLabelSelector labelSelector,
                                                                           ...
                                                                           final CronJobSpecJobTemplateSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable whenUnsatisfiable) {
        // no-op
    }
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable getWhenUnsatisfiable() {
        return whenUnsatisfiable;
    }

    public void setWhenUnsatisfiable(final CronJobSpecJobTemplateSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable whenUnsatisfiable) {
