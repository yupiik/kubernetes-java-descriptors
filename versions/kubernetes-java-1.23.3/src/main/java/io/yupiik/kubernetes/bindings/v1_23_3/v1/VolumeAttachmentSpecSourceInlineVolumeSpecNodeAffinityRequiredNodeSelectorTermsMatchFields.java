...
public class VolumeAttachmentSpecSourceInlineVolumeSpecNodeAffinityRequiredNodeSelectorTermsMatchFields {
    private String key;
    private VolumeAttachmentSpecSourceInlineVolumeSpecNodeAffinityRequiredNodeSelectorTermsMatchFieldsOperator operator;
    ...
    public VolumeAttachmentSpecSourceInlineVolumeSpecNodeAffinityRequiredNodeSelectorTermsMatchFields(final String key,
                                                                                                      final VolumeAttachmentSpecSourceInlineVolumeSpecNodeAffinityRequiredNodeSelectorTermsMatchFieldsOperator operator,
    ...
    public VolumeAttachmentSpecSourceInlineVolumeSpecNodeAffinityRequiredNodeSelectorTermsMatchFieldsOperator getOperator() {
        return operator;
    }

    public void setOperator(final VolumeAttachmentSpecSourceInlineVolumeSpecNodeAffinityRequiredNodeSelectorTermsMatchFieldsOperator operator) {
