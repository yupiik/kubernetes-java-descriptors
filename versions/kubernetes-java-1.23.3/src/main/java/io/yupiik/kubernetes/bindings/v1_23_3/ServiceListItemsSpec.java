...
public class ServiceListItemsSpec {
    ...
    private ServiceListItemsSpecExternalTrafficPolicy externalTrafficPolicy;
    ...
    private ServiceListItemsSpecSessionAffinity sessionAffinity;
    private ServiceListItemsSpecSessionAffinityConfig sessionAffinityConfig;
    private ServiceListItemsSpecType type;
    ...
    public ServiceListItemsSpec(final Boolean allocateLoadBalancerNodePorts,
                                ...
                                final ServiceListItemsSpecExternalTrafficPolicy externalTrafficPolicy,
                                ...
                                final ServiceListItemsSpecSessionAffinity sessionAffinity,
                                final ServiceListItemsSpecSessionAffinityConfig sessionAffinityConfig,
                                final ServiceListItemsSpecType type) {
        // no-op
    }
    ...
    public ServiceListItemsSpecExternalTrafficPolicy getExternalTrafficPolicy() {
        return externalTrafficPolicy;
    }

    public void setExternalTrafficPolicy(final ServiceListItemsSpecExternalTrafficPolicy externalTrafficPolicy) {
    ...
    public ServiceListItemsSpecSessionAffinity getSessionAffinity() {
        return sessionAffinity;
    }

    public void setSessionAffinity(final ServiceListItemsSpecSessionAffinity sessionAffinity) {
    ...
    public ServiceListItemsSpecType getType() {
        return type;
    }

    public void setType(final ServiceListItemsSpecType type) {
        this.type = type;
    }
