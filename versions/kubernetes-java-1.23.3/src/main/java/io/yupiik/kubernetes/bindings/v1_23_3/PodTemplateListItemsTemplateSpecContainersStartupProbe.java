...
public class PodTemplateListItemsTemplateSpecContainersStartupProbe {
    ...
    private PodTemplateListItemsTemplateSpecContainersStartupProbeGrpc grpc;
    ...
    public PodTemplateListItemsTemplateSpecContainersStartupProbe(final PodTemplateListItemsTemplateSpecContainersStartupProbeExec exec,
                                                                  ...
                                                                  final PodTemplateListItemsTemplateSpecContainersStartupProbeGrpc grpc,
    ...
    public PodTemplateListItemsTemplateSpecContainersStartupProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final PodTemplateListItemsTemplateSpecContainersStartupProbeGrpc grpc) {
        this.grpc = grpc;
    }
