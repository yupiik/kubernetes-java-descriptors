...
public class ReplicaSetListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGet {
    ...
    private String path;
    private String port;
    private ReplicaSetListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme scheme;
    ...
    public ReplicaSetListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGet(final String host,
                                                                                      ...
                                                                                      final String path,
                                                                                      final String port,
                                                                                      final ReplicaSetListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme scheme) {
        // no-op
    }
    ...
    public ReplicaSetListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final ReplicaSetListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme scheme) {
        this.scheme = scheme;
    }
