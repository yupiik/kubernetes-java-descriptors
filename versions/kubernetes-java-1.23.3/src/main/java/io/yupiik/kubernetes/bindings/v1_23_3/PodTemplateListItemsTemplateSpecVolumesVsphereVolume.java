...
public class PodTemplateListItemsTemplateSpecVolumesVsphereVolume {
    private String fsType;
    private String storagePolicyID;
    private String storagePolicyName;
    private String volumePath;

    public PodTemplateListItemsTemplateSpecVolumesVsphereVolume() {
        // no-op
    }

    public PodTemplateListItemsTemplateSpecVolumesVsphereVolume(final String fsType,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateListItemsTemplateSpecVolumesVsphereVolume)) {
            return false;
        }
        final PodTemplateListItemsTemplateSpecVolumesVsphereVolume __otherCasted = (PodTemplateListItemsTemplateSpecVolumesVsphereVolume) __other;
