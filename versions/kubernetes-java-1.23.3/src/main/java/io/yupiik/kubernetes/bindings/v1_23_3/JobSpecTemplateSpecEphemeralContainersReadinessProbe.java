...
public class JobSpecTemplateSpecEphemeralContainersReadinessProbe {
    ...
    private JobSpecTemplateSpecEphemeralContainersReadinessProbeGrpc grpc;
    ...
    public JobSpecTemplateSpecEphemeralContainersReadinessProbe(final JobSpecTemplateSpecEphemeralContainersReadinessProbeExec exec,
                                                                ...
                                                                final JobSpecTemplateSpecEphemeralContainersReadinessProbeGrpc grpc,
    ...
    public JobSpecTemplateSpecEphemeralContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final JobSpecTemplateSpecEphemeralContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
