...
public class ReplicaSetListItemsSpecTemplateSpecInitContainers {
    ...
    private ReplicaSetListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy;
    ...
    private ReplicaSetListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public ReplicaSetListItemsSpecTemplateSpecInitContainers(final List<String> args,
                                                             ...
                                                             final String image,
                                                             final ReplicaSetListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy,
                                                             ...
                                                             final ReplicaSetListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy,
                                                             final Boolean tty,
    ...
    public ReplicaSetListItemsSpecTemplateSpecInitContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final ReplicaSetListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy) {
    ...
    public ReplicaSetListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final ReplicaSetListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy) {
