...
public class StatefulSetListItemsSpec {
    ...
    private StatefulSetListItemsSpecPersistentVolumeClaimRetentionPolicy persistentVolumeClaimRetentionPolicy;
    private StatefulSetListItemsSpecPodManagementPolicy podManagementPolicy;
    ...
    public StatefulSetListItemsSpec(final Integer minReadySeconds,
                                    final StatefulSetListItemsSpecPersistentVolumeClaimRetentionPolicy persistentVolumeClaimRetentionPolicy,
                                    final StatefulSetListItemsSpecPodManagementPolicy podManagementPolicy,
    ...
    public StatefulSetListItemsSpecPersistentVolumeClaimRetentionPolicy getPersistentVolumeClaimRetentionPolicy() {
        return persistentVolumeClaimRetentionPolicy;
    }

    public void setPersistentVolumeClaimRetentionPolicy(final StatefulSetListItemsSpecPersistentVolumeClaimRetentionPolicy persistentVolumeClaimRetentionPolicy) {
        this.persistentVolumeClaimRetentionPolicy = persistentVolumeClaimRetentionPolicy;
    }

    public StatefulSetListItemsSpecPodManagementPolicy getPodManagementPolicy() {
        return podManagementPolicy;
    }

    public void setPodManagementPolicy(final StatefulSetListItemsSpecPodManagementPolicy podManagementPolicy) {
