...
public class ReplicaSetSpecTemplateSpecContainersReadinessProbeHttpGet {
    ...
    private String path;
    private String port;
    private ReplicaSetSpecTemplateSpecContainersReadinessProbeHttpGetScheme scheme;
    ...
    public ReplicaSetSpecTemplateSpecContainersReadinessProbeHttpGet(final String host,
                                                                     ...
                                                                     final String path,
                                                                     final String port,
                                                                     final ReplicaSetSpecTemplateSpecContainersReadinessProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public ReplicaSetSpecTemplateSpecContainersReadinessProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final ReplicaSetSpecTemplateSpecContainersReadinessProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
