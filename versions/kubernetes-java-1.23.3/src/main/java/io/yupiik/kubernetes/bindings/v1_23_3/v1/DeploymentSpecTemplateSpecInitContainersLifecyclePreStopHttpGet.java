...
public class DeploymentSpecTemplateSpecInitContainersLifecyclePreStopHttpGet {
    ...
    private String path;
    private String port;
    private DeploymentSpecTemplateSpecInitContainersLifecyclePreStopHttpGetScheme scheme;
    ...
    public DeploymentSpecTemplateSpecInitContainersLifecyclePreStopHttpGet(final String host,
                                                                           ...
                                                                           final String path,
                                                                           final String port,
                                                                           final DeploymentSpecTemplateSpecInitContainersLifecyclePreStopHttpGetScheme scheme) {
        // no-op
    }
    ...
    public DeploymentSpecTemplateSpecInitContainersLifecyclePreStopHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final DeploymentSpecTemplateSpecInitContainersLifecyclePreStopHttpGetScheme scheme) {
        this.scheme = scheme;
    }
