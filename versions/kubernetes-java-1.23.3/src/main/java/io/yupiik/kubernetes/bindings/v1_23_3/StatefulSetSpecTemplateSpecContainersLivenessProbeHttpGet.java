...
public class StatefulSetSpecTemplateSpecContainersLivenessProbeHttpGet {
    ...
    private String path;
    private String port;
    private StatefulSetSpecTemplateSpecContainersLivenessProbeHttpGetScheme scheme;
    ...
    public StatefulSetSpecTemplateSpecContainersLivenessProbeHttpGet(final String host,
                                                                     ...
                                                                     final String path,
                                                                     final String port,
                                                                     final StatefulSetSpecTemplateSpecContainersLivenessProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public StatefulSetSpecTemplateSpecContainersLivenessProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final StatefulSetSpecTemplateSpecContainersLivenessProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
