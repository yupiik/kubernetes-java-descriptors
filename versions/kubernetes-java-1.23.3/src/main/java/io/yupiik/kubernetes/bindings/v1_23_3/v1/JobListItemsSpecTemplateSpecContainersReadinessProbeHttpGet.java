...
public class JobListItemsSpecTemplateSpecContainersReadinessProbeHttpGet {
    ...
    private String path;
    private String port;
    private JobListItemsSpecTemplateSpecContainersReadinessProbeHttpGetScheme scheme;
    ...
    public JobListItemsSpecTemplateSpecContainersReadinessProbeHttpGet(final String host,
                                                                       ...
                                                                       final String path,
                                                                       final String port,
                                                                       final JobListItemsSpecTemplateSpecContainersReadinessProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public JobListItemsSpecTemplateSpecContainersReadinessProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final JobListItemsSpecTemplateSpecContainersReadinessProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
