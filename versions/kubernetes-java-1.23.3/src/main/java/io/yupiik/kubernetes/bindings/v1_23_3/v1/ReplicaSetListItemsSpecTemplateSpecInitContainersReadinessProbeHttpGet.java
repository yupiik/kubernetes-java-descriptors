...
public class ReplicaSetListItemsSpecTemplateSpecInitContainersReadinessProbeHttpGet {
    ...
    private String path;
    private String port;
    private ReplicaSetListItemsSpecTemplateSpecInitContainersReadinessProbeHttpGetScheme scheme;
    ...
    public ReplicaSetListItemsSpecTemplateSpecInitContainersReadinessProbeHttpGet(final String host,
                                                                                  ...
                                                                                  final String path,
                                                                                  final String port,
                                                                                  final ReplicaSetListItemsSpecTemplateSpecInitContainersReadinessProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public ReplicaSetListItemsSpecTemplateSpecInitContainersReadinessProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final ReplicaSetListItemsSpecTemplateSpecInitContainersReadinessProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
