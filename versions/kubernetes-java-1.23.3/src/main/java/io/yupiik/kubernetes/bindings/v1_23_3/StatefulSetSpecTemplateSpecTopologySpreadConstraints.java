...
public class StatefulSetSpecTemplateSpecTopologySpreadConstraints {
    ...
    private StatefulSetSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable whenUnsatisfiable;
    ...
    public StatefulSetSpecTemplateSpecTopologySpreadConstraints(final StatefulSetSpecTemplateSpecTopologySpreadConstraintsLabelSelector labelSelector,
                                                                ...
                                                                final StatefulSetSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable whenUnsatisfiable) {
        // no-op
    }
    ...
    public StatefulSetSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable getWhenUnsatisfiable() {
        return whenUnsatisfiable;
    }

    public void setWhenUnsatisfiable(final StatefulSetSpecTemplateSpecTopologySpreadConstraintsWhenUnsatisfiable whenUnsatisfiable) {
