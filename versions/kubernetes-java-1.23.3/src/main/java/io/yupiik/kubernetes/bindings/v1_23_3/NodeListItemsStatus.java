...
public class NodeListItemsStatus {
    ...
    private NodeListItemsStatusPhase phase;
    ...
    public NodeListItemsStatus(final List<NodeListItemsStatusAddresses> addresses,
                               ...
                               final NodeListItemsStatusPhase phase,
    ...
    public NodeListItemsStatusPhase getPhase() {
        return phase;
    }

    public void setPhase(final NodeListItemsStatusPhase phase) {
        this.phase = phase;
    }
