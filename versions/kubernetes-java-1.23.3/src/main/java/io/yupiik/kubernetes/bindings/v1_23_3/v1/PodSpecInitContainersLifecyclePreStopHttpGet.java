...
public class PodSpecInitContainersLifecyclePreStopHttpGet {
    ...
    private String path;
    private String port;
    private PodSpecInitContainersLifecyclePreStopHttpGetScheme scheme;
    ...
    public PodSpecInitContainersLifecyclePreStopHttpGet(final String host,
                                                        ...
                                                        final String path,
                                                        final String port,
                                                        final PodSpecInitContainersLifecyclePreStopHttpGetScheme scheme) {
        // no-op
    }
    ...
    public PodSpecInitContainersLifecyclePreStopHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final PodSpecInitContainersLifecyclePreStopHttpGetScheme scheme) {
        this.scheme = scheme;
    }
