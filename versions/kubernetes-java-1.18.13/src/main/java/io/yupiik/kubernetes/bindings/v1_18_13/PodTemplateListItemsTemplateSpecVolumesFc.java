...
public class PodTemplateListItemsTemplateSpecVolumesFc {
    ...
    public PodTemplateListItemsTemplateSpecVolumesFc() {
        // no-op
    }

    public PodTemplateListItemsTemplateSpecVolumesFc(final String fsType,
                                                     final Integer lun,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateListItemsTemplateSpecVolumesFc)) {
            return false;
        }
        final PodTemplateListItemsTemplateSpecVolumesFc __otherCasted = (PodTemplateListItemsTemplateSpecVolumesFc) __other;
