...
public class CSINodeListMetadata {
    ...
    public CSINodeListMetadata() {
        // no-op
    }

    public CSINodeListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSINodeListMetadata)) {
            return false;
        }
        final CSINodeListMetadata __otherCasted = (CSINodeListMetadata) __other;
