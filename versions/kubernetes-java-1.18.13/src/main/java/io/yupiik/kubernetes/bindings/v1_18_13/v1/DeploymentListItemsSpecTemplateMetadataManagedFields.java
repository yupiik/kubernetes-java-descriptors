...
public class DeploymentListItemsSpecTemplateMetadataManagedFields {
    ...
    public DeploymentListItemsSpecTemplateMetadataManagedFields() {
        // no-op
    }

    public DeploymentListItemsSpecTemplateMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentListItemsSpecTemplateMetadataManagedFields)) {
            return false;
        }
        final DeploymentListItemsSpecTemplateMetadataManagedFields __otherCasted = (DeploymentListItemsSpecTemplateMetadataManagedFields) __other;
