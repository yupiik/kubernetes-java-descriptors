...
public class LimitRangeMetadata {
    ...
    private LimitRangeMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<LimitRangeMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<LimitRangeMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public LimitRangeMetadata() {
        // no-op
    }

    public LimitRangeMetadata(final Map<String, String> annotations,
                              ...
                              final LimitRangeMetadataInitializers initializers,
                              final Map<String, String> labels,
                              final List<LimitRangeMetadataManagedFields> managedFields,
                              final String name,
                              final String namespace,
                              final List<LimitRangeMetadataOwnerReferences> ownerReferences,
    ...
    public LimitRangeMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final LimitRangeMetadataInitializers initializers) {
    ...
    public List<LimitRangeMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<LimitRangeMetadataManagedFields> managedFields) {
    ...
    public List<LimitRangeMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<LimitRangeMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LimitRangeMetadata)) {
            return false;
        }
        final LimitRangeMetadata __otherCasted = (LimitRangeMetadata) __other;
