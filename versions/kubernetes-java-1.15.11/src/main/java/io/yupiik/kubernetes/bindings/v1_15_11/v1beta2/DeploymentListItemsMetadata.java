...
public class DeploymentListItemsMetadata {
    ...
    private DeploymentListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<DeploymentListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<DeploymentListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public DeploymentListItemsMetadata() {
        // no-op
    }

    public DeploymentListItemsMetadata(final Map<String, String> annotations,
                                       ...
                                       final DeploymentListItemsMetadataInitializers initializers,
                                       final Map<String, String> labels,
                                       final List<DeploymentListItemsMetadataManagedFields> managedFields,
                                       final String name,
                                       final String namespace,
                                       final List<DeploymentListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public DeploymentListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final DeploymentListItemsMetadataInitializers initializers) {
    ...
    public List<DeploymentListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<DeploymentListItemsMetadataManagedFields> managedFields) {
    ...
    public List<DeploymentListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<DeploymentListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentListItemsMetadata)) {
            return false;
        }
        final DeploymentListItemsMetadata __otherCasted = (DeploymentListItemsMetadata) __other;
