...
public class PodTemplateListItemsMetadata {
    ...
    private PodTemplateListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PodTemplateListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PodTemplateListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PodTemplateListItemsMetadata() {
        // no-op
    }

    public PodTemplateListItemsMetadata(final Map<String, String> annotations,
                                        ...
                                        final PodTemplateListItemsMetadataInitializers initializers,
                                        final Map<String, String> labels,
                                        final List<PodTemplateListItemsMetadataManagedFields> managedFields,
                                        final String name,
                                        final String namespace,
                                        final List<PodTemplateListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public PodTemplateListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PodTemplateListItemsMetadataInitializers initializers) {
    ...
    public List<PodTemplateListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PodTemplateListItemsMetadataManagedFields> managedFields) {
    ...
    public List<PodTemplateListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PodTemplateListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateListItemsMetadata)) {
            return false;
        }
        final PodTemplateListItemsMetadata __otherCasted = (PodTemplateListItemsMetadata) __other;
