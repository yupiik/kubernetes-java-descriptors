...
public class ReplicaSetListItemsSpecTemplateSpecVolumesFc {
    ...
    public ReplicaSetListItemsSpecTemplateSpecVolumesFc() {
        // no-op
    }

    public ReplicaSetListItemsSpecTemplateSpecVolumesFc(final String fsType,
                                                        final Integer lun,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicaSetListItemsSpecTemplateSpecVolumesFc)) {
            return false;
        }
        final ReplicaSetListItemsSpecTemplateSpecVolumesFc __otherCasted = (ReplicaSetListItemsSpecTemplateSpecVolumesFc) __other;
