...
public class ConfigMapListItemsMetadataInitializersResultMetadata {
    ...
    public ConfigMapListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public ConfigMapListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ConfigMapListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final ConfigMapListItemsMetadataInitializersResultMetadata __otherCasted = (ConfigMapListItemsMetadataInitializersResultMetadata) __other;
