...
public class RuntimeClassListItemsMetadataManagedFields {
    ...
    public RuntimeClassListItemsMetadataManagedFields() {
        // no-op
    }

    public RuntimeClassListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RuntimeClassListItemsMetadataManagedFields)) {
            return false;
        }
        final RuntimeClassListItemsMetadataManagedFields __otherCasted = (RuntimeClassListItemsMetadataManagedFields) __other;
