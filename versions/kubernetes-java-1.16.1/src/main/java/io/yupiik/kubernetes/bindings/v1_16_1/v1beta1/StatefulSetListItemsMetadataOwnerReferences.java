...
public class StatefulSetListItemsMetadataOwnerReferences {
    ...
    public StatefulSetListItemsMetadataOwnerReferences() {
        // no-op
    }

    public StatefulSetListItemsMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetListItemsMetadataOwnerReferences)) {
            return false;
        }
        final StatefulSetListItemsMetadataOwnerReferences __otherCasted = (StatefulSetListItemsMetadataOwnerReferences) __other;
