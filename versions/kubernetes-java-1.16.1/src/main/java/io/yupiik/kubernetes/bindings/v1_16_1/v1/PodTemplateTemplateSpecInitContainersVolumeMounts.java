...
public class PodTemplateTemplateSpecInitContainersVolumeMounts {
    ...
    public PodTemplateTemplateSpecInitContainersVolumeMounts() {
        // no-op
    }

    public PodTemplateTemplateSpecInitContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateTemplateSpecInitContainersVolumeMounts)) {
            return false;
        }
        final PodTemplateTemplateSpecInitContainersVolumeMounts __otherCasted = (PodTemplateTemplateSpecInitContainersVolumeMounts) __other;
