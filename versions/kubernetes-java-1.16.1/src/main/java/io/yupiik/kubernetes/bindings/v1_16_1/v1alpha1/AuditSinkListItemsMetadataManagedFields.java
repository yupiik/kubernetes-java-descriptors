...
public class AuditSinkListItemsMetadataManagedFields {
    ...
    public AuditSinkListItemsMetadataManagedFields() {
        // no-op
    }

    public AuditSinkListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof AuditSinkListItemsMetadataManagedFields)) {
            return false;
        }
        final AuditSinkListItemsMetadataManagedFields __otherCasted = (AuditSinkListItemsMetadataManagedFields) __other;
