...
public class PodMetadataManagedFields {
    ...
    public PodMetadataManagedFields() {
        // no-op
    }

    public PodMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodMetadataManagedFields)) {
            return false;
        }
        final PodMetadataManagedFields __otherCasted = (PodMetadataManagedFields) __other;
