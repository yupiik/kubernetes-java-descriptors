...
public class JobListItemsSpecTemplateSpecVolumesFc {
    ...
    public JobListItemsSpecTemplateSpecVolumesFc() {
        // no-op
    }

    public JobListItemsSpecTemplateSpecVolumesFc(final String fsType,
                                                 final Integer lun,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobListItemsSpecTemplateSpecVolumesFc)) {
            return false;
        }
        final JobListItemsSpecTemplateSpecVolumesFc __otherCasted = (JobListItemsSpecTemplateSpecVolumesFc) __other;
