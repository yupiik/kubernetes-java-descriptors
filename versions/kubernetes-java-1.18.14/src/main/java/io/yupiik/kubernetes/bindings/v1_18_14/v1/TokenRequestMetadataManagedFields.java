...
public class TokenRequestMetadataManagedFields {
    ...
    public TokenRequestMetadataManagedFields() {
        // no-op
    }

    public TokenRequestMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof TokenRequestMetadataManagedFields)) {
            return false;
        }
        final TokenRequestMetadataManagedFields __otherCasted = (TokenRequestMetadataManagedFields) __other;
