...
public class PodListItemsSpecVolumesScaleIO {
    private String fsType;
    private String gateway;
    private String protectionDomain;
    private Boolean readOnly;
    private PodListItemsSpecVolumesScaleIOSecretRef secretRef;
    ...
    public PodListItemsSpecVolumesScaleIO() {
        // no-op
    }

    public PodListItemsSpecVolumesScaleIO(final String fsType,
                                          final String gateway,
                                          final String protectionDomain,
                                          final Boolean readOnly,
                                          final PodListItemsSpecVolumesScaleIOSecretRef secretRef,
    ...
    public PodListItemsSpecVolumesScaleIOSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final PodListItemsSpecVolumesScaleIOSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodListItemsSpecVolumesScaleIO)) {
            return false;
        }
        final PodListItemsSpecVolumesScaleIO __otherCasted = (PodListItemsSpecVolumesScaleIO) __other;
