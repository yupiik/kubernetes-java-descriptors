...
public class NetworkPolicyListItemsMetadata {
    ...
    private NetworkPolicyListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<NetworkPolicyListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<NetworkPolicyListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public NetworkPolicyListItemsMetadata() {
        // no-op
    }

    public NetworkPolicyListItemsMetadata(final Map<String, String> annotations,
                                          ...
                                          final NetworkPolicyListItemsMetadataInitializers initializers,
                                          final Map<String, String> labels,
                                          final List<NetworkPolicyListItemsMetadataManagedFields> managedFields,
                                          final String name,
                                          final String namespace,
                                          final List<NetworkPolicyListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public NetworkPolicyListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final NetworkPolicyListItemsMetadataInitializers initializers) {
    ...
    public List<NetworkPolicyListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<NetworkPolicyListItemsMetadataManagedFields> managedFields) {
    ...
    public List<NetworkPolicyListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<NetworkPolicyListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NetworkPolicyListItemsMetadata)) {
            return false;
        }
        final NetworkPolicyListItemsMetadata __otherCasted = (NetworkPolicyListItemsMetadata) __other;
