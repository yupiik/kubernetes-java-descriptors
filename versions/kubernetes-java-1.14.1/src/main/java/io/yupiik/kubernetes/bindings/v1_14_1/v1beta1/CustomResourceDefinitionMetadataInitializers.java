...
public class CustomResourceDefinitionMetadataInitializers {
    private List<CustomResourceDefinitionMetadataInitializersPending> pending;
    ...
    public CustomResourceDefinitionMetadataInitializers(final List<CustomResourceDefinitionMetadataInitializersPending> pending,
                                                        final CustomResourceDefinitionMetadataInitializersResult result) {
        // no-op
    }

    public List<CustomResourceDefinitionMetadataInitializersPending> getPending() {
        return pending;
    }

    public void setPending(final List<CustomResourceDefinitionMetadataInitializersPending> pending) {
