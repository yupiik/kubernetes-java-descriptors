...
public class DeploymentListItemsSpecTemplateMetadata {
    ...
    private DeploymentListItemsSpecTemplateMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<DeploymentListItemsSpecTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<DeploymentListItemsSpecTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public DeploymentListItemsSpecTemplateMetadata() {
        // no-op
    }

    public DeploymentListItemsSpecTemplateMetadata(final Map<String, String> annotations,
                                                   ...
                                                   final DeploymentListItemsSpecTemplateMetadataInitializers initializers,
                                                   final Map<String, String> labels,
                                                   final List<DeploymentListItemsSpecTemplateMetadataManagedFields> managedFields,
                                                   final String name,
                                                   final String namespace,
                                                   final List<DeploymentListItemsSpecTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public DeploymentListItemsSpecTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final DeploymentListItemsSpecTemplateMetadataInitializers initializers) {
    ...
    public List<DeploymentListItemsSpecTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<DeploymentListItemsSpecTemplateMetadataManagedFields> managedFields) {
    ...
    public List<DeploymentListItemsSpecTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<DeploymentListItemsSpecTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentListItemsSpecTemplateMetadata)) {
            return false;
        }
        final DeploymentListItemsSpecTemplateMetadata __otherCasted = (DeploymentListItemsSpecTemplateMetadata) __other;
