...
public class LeaseMetadataOwnerReferences {
    ...
    public LeaseMetadataOwnerReferences() {
        // no-op
    }

    public LeaseMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LeaseMetadataOwnerReferences)) {
            return false;
        }
        final LeaseMetadataOwnerReferences __otherCasted = (LeaseMetadataOwnerReferences) __other;
