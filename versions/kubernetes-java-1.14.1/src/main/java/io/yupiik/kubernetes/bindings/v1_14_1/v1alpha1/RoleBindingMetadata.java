...
public class RoleBindingMetadata {
    ...
    private RoleBindingMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<RoleBindingMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<RoleBindingMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public RoleBindingMetadata() {
        // no-op
    }

    public RoleBindingMetadata(final Map<String, String> annotations,
                               ...
                               final RoleBindingMetadataInitializers initializers,
                               final Map<String, String> labels,
                               final List<RoleBindingMetadataManagedFields> managedFields,
                               final String name,
                               final String namespace,
                               final List<RoleBindingMetadataOwnerReferences> ownerReferences,
    ...
    public RoleBindingMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final RoleBindingMetadataInitializers initializers) {
    ...
    public List<RoleBindingMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<RoleBindingMetadataManagedFields> managedFields) {
    ...
    public List<RoleBindingMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<RoleBindingMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RoleBindingMetadata)) {
            return false;
        }
        final RoleBindingMetadata __otherCasted = (RoleBindingMetadata) __other;
