package io.yupiik.kubernetes.bindings.v1_14_1.v1alpha1;

import java.util.List;
import java.util.Map;
import java.util.Objects;

public class RuntimeClassListItemsMetadata {
    ...
    private RuntimeClassListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<RuntimeClassListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<RuntimeClassListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public RuntimeClassListItemsMetadata() {
        // no-op
    }

    public RuntimeClassListItemsMetadata(final Map<String, String> annotations,
                                         ...
                                         final RuntimeClassListItemsMetadataInitializers initializers,
                                         final Map<String, String> labels,
                                         final List<RuntimeClassListItemsMetadataManagedFields> managedFields,
                                         final String name,
                                         final String namespace,
                                         final List<RuntimeClassListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public RuntimeClassListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final RuntimeClassListItemsMetadataInitializers initializers) {
    ...
    public List<RuntimeClassListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<RuntimeClassListItemsMetadataManagedFields> managedFields) {
    ...
    public List<RuntimeClassListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<RuntimeClassListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RuntimeClassListItemsMetadata)) {
            return false;
        }
        final RuntimeClassListItemsMetadata __otherCasted = (RuntimeClassListItemsMetadata) __other;
