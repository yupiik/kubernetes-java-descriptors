...
public class APIServiceMetadata {
    ...
    private APIServiceMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<APIServiceMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<APIServiceMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public APIServiceMetadata() {
        // no-op
    }

    public APIServiceMetadata(final Map<String, String> annotations,
                              ...
                              final APIServiceMetadataInitializers initializers,
                              final Map<String, String> labels,
                              final List<APIServiceMetadataManagedFields> managedFields,
                              final String name,
                              final String namespace,
                              final List<APIServiceMetadataOwnerReferences> ownerReferences,
    ...
    public APIServiceMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final APIServiceMetadataInitializers initializers) {
    ...
    public List<APIServiceMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<APIServiceMetadataManagedFields> managedFields) {
    ...
    public List<APIServiceMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<APIServiceMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof APIServiceMetadata)) {
            return false;
        }
        final APIServiceMetadata __otherCasted = (APIServiceMetadata) __other;
