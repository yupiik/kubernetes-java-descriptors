...
public class PodPresetListItemsMetadata {
    ...
    private PodPresetListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<PodPresetListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<PodPresetListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public PodPresetListItemsMetadata() {
        // no-op
    }

    public PodPresetListItemsMetadata(final Map<String, String> annotations,
                                      ...
                                      final PodPresetListItemsMetadataInitializers initializers,
                                      final Map<String, String> labels,
                                      final List<PodPresetListItemsMetadataManagedFields> managedFields,
                                      final String name,
                                      final String namespace,
                                      final List<PodPresetListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public PodPresetListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final PodPresetListItemsMetadataInitializers initializers) {
    ...
    public List<PodPresetListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<PodPresetListItemsMetadataManagedFields> managedFields) {
    ...
    public List<PodPresetListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<PodPresetListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodPresetListItemsMetadata)) {
            return false;
        }
        final PodPresetListItemsMetadata __otherCasted = (PodPresetListItemsMetadata) __other;
