...
public class CSINodeMetadata {
    ...
    private CSINodeMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<CSINodeMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<CSINodeMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public CSINodeMetadata() {
        // no-op
    }

    public CSINodeMetadata(final Map<String, String> annotations,
                           ...
                           final CSINodeMetadataInitializers initializers,
                           final Map<String, String> labels,
                           final List<CSINodeMetadataManagedFields> managedFields,
                           final String name,
                           final String namespace,
                           final List<CSINodeMetadataOwnerReferences> ownerReferences,
    ...
    public CSINodeMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final CSINodeMetadataInitializers initializers) {
    ...
    public List<CSINodeMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<CSINodeMetadataManagedFields> managedFields) {
    ...
    public List<CSINodeMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<CSINodeMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSINodeMetadata)) {
            return false;
        }
        final CSINodeMetadata __otherCasted = (CSINodeMetadata) __other;
