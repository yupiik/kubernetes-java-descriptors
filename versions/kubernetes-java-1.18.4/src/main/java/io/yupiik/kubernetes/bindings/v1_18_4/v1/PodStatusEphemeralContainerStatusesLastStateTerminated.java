...
public class PodStatusEphemeralContainerStatusesLastStateTerminated {
    ...
    public PodStatusEphemeralContainerStatusesLastStateTerminated() {
        // no-op
    }

    public PodStatusEphemeralContainerStatusesLastStateTerminated(final String containerID,
                                                                  final int exitCode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodStatusEphemeralContainerStatusesLastStateTerminated)) {
            return false;
        }
        final PodStatusEphemeralContainerStatusesLastStateTerminated __otherCasted = (PodStatusEphemeralContainerStatusesLastStateTerminated) __other;
