...
public class PodSpecVolumesIscsi {
    ...
    private PodSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public PodSpecVolumesIscsi() {
        // no-op
    }

    public PodSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                               ...
                               final PodSpecVolumesIscsiSecretRef secretRef,
    ...
    public PodSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final PodSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSpecVolumesIscsi)) {
            return false;
        }
        final PodSpecVolumesIscsi __otherCasted = (PodSpecVolumesIscsi) __other;
