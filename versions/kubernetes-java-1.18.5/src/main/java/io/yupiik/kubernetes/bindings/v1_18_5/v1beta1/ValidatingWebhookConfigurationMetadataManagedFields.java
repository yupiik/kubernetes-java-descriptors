...
public class ValidatingWebhookConfigurationMetadataManagedFields {
    ...
    public ValidatingWebhookConfigurationMetadataManagedFields() {
        // no-op
    }

    public ValidatingWebhookConfigurationMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ValidatingWebhookConfigurationMetadataManagedFields)) {
            return false;
        }
        final ValidatingWebhookConfigurationMetadataManagedFields __otherCasted = (ValidatingWebhookConfigurationMetadataManagedFields) __other;
