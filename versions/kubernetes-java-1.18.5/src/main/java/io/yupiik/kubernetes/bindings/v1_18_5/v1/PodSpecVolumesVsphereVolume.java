...
public class PodSpecVolumesVsphereVolume {
    private String fsType;
    private String storagePolicyID;
    private String storagePolicyName;
    private String volumePath;

    public PodSpecVolumesVsphereVolume() {
        // no-op
    }

    public PodSpecVolumesVsphereVolume(final String fsType,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSpecVolumesVsphereVolume)) {
            return false;
        }
        final PodSpecVolumesVsphereVolume __otherCasted = (PodSpecVolumesVsphereVolume) __other;
