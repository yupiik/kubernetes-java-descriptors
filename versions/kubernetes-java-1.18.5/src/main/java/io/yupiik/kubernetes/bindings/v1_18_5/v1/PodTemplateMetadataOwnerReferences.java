...
public class PodTemplateMetadataOwnerReferences {
    ...
    public PodTemplateMetadataOwnerReferences() {
        // no-op
    }

    public PodTemplateMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateMetadataOwnerReferences)) {
            return false;
        }
        final PodTemplateMetadataOwnerReferences __otherCasted = (PodTemplateMetadataOwnerReferences) __other;
