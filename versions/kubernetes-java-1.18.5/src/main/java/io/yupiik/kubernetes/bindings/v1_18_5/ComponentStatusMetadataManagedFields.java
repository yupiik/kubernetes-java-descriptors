...
public class ComponentStatusMetadataManagedFields {
    ...
    public ComponentStatusMetadataManagedFields() {
        // no-op
    }

    public ComponentStatusMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ComponentStatusMetadataManagedFields)) {
            return false;
        }
        final ComponentStatusMetadataManagedFields __otherCasted = (ComponentStatusMetadataManagedFields) __other;
