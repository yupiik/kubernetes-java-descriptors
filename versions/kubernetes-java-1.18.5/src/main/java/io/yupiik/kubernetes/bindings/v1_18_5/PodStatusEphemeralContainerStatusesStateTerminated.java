...
public class PodStatusEphemeralContainerStatusesStateTerminated {
    ...
    public PodStatusEphemeralContainerStatusesStateTerminated() {
        // no-op
    }

    public PodStatusEphemeralContainerStatusesStateTerminated(final String containerID,
                                                              final int exitCode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodStatusEphemeralContainerStatusesStateTerminated)) {
            return false;
        }
        final PodStatusEphemeralContainerStatusesStateTerminated __otherCasted = (PodStatusEphemeralContainerStatusesStateTerminated) __other;
