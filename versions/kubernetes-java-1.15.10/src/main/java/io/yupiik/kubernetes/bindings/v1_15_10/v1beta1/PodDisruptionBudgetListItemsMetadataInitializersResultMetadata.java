...
public class PodDisruptionBudgetListItemsMetadataInitializersResultMetadata {
    ...
    public PodDisruptionBudgetListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public PodDisruptionBudgetListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodDisruptionBudgetListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final PodDisruptionBudgetListItemsMetadataInitializersResultMetadata __otherCasted = (PodDisruptionBudgetListItemsMetadataInitializersResultMetadata) __other;
