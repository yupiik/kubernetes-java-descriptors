...
public class ServiceAccountMetadata {
    ...
    private ServiceAccountMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ServiceAccountMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ServiceAccountMetadataOwnerReferences> ownerReferences;
    ...
    public ServiceAccountMetadata(final Map<String, String> annotations,
                                  ...
                                  final ServiceAccountMetadataInitializers initializers,
                                  final Map<String, String> labels,
                                  final List<ServiceAccountMetadataManagedFields> managedFields,
                                  final String name,
                                  final String namespace,
                                  final List<ServiceAccountMetadataOwnerReferences> ownerReferences,
    ...
    public ServiceAccountMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ServiceAccountMetadataInitializers initializers) {
    ...
    public List<ServiceAccountMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ServiceAccountMetadataManagedFields> managedFields) {
    ...
    public List<ServiceAccountMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ServiceAccountMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ServiceAccountMetadata)) {
            return false;
        }
        final ServiceAccountMetadata __otherCasted = (ServiceAccountMetadata) __other;
