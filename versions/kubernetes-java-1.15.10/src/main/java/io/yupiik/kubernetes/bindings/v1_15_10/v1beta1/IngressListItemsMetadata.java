...
public class IngressListItemsMetadata {
    ...
    private IngressListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<IngressListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<IngressListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public IngressListItemsMetadata() {
        // no-op
    }

    public IngressListItemsMetadata(final Map<String, String> annotations,
                                    ...
                                    final IngressListItemsMetadataInitializers initializers,
                                    final Map<String, String> labels,
                                    final List<IngressListItemsMetadataManagedFields> managedFields,
                                    final String name,
                                    final String namespace,
                                    final List<IngressListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public IngressListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final IngressListItemsMetadataInitializers initializers) {
    ...
    public List<IngressListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<IngressListItemsMetadataManagedFields> managedFields) {
    ...
    public List<IngressListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<IngressListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof IngressListItemsMetadata)) {
            return false;
        }
        final IngressListItemsMetadata __otherCasted = (IngressListItemsMetadata) __other;
