...
public class DaemonSetListItemsSpecTemplateMetadata {
    ...
    private DaemonSetListItemsSpecTemplateMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<DaemonSetListItemsSpecTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<DaemonSetListItemsSpecTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public DaemonSetListItemsSpecTemplateMetadata() {
        // no-op
    }

    public DaemonSetListItemsSpecTemplateMetadata(final Map<String, String> annotations,
                                                  ...
                                                  final DaemonSetListItemsSpecTemplateMetadataInitializers initializers,
                                                  final Map<String, String> labels,
                                                  final List<DaemonSetListItemsSpecTemplateMetadataManagedFields> managedFields,
                                                  final String name,
                                                  final String namespace,
                                                  final List<DaemonSetListItemsSpecTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public DaemonSetListItemsSpecTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final DaemonSetListItemsSpecTemplateMetadataInitializers initializers) {
    ...
    public List<DaemonSetListItemsSpecTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<DaemonSetListItemsSpecTemplateMetadataManagedFields> managedFields) {
    ...
    public List<DaemonSetListItemsSpecTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<DaemonSetListItemsSpecTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetListItemsSpecTemplateMetadata)) {
            return false;
        }
        final DaemonSetListItemsSpecTemplateMetadata __otherCasted = (DaemonSetListItemsSpecTemplateMetadata) __other;
