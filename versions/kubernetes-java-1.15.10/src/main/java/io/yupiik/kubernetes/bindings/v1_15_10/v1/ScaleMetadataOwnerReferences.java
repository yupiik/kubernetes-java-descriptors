...
public class ScaleMetadataOwnerReferences {
    ...
    public ScaleMetadataOwnerReferences() {
        // no-op
    }

    public ScaleMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ScaleMetadataOwnerReferences)) {
            return false;
        }
        final ScaleMetadataOwnerReferences __otherCasted = (ScaleMetadataOwnerReferences) __other;
