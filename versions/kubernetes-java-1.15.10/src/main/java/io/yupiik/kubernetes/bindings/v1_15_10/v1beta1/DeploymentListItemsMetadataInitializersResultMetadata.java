...
public class DeploymentListItemsMetadataInitializersResultMetadata {
    ...
    public DeploymentListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public DeploymentListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final DeploymentListItemsMetadataInitializersResultMetadata __otherCasted = (DeploymentListItemsMetadataInitializersResultMetadata) __other;
