...
public class LeaseListItemsMetadata {
    ...
    private LeaseListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<LeaseListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<LeaseListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public LeaseListItemsMetadata() {
        // no-op
    }

    public LeaseListItemsMetadata(final Map<String, String> annotations,
                                  ...
                                  final LeaseListItemsMetadataInitializers initializers,
                                  final Map<String, String> labels,
                                  final List<LeaseListItemsMetadataManagedFields> managedFields,
                                  final String name,
                                  final String namespace,
                                  final List<LeaseListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public LeaseListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final LeaseListItemsMetadataInitializers initializers) {
    ...
    public List<LeaseListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<LeaseListItemsMetadataManagedFields> managedFields) {
    ...
    public List<LeaseListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<LeaseListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LeaseListItemsMetadata)) {
            return false;
        }
        final LeaseListItemsMetadata __otherCasted = (LeaseListItemsMetadata) __other;
