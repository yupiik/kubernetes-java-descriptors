...
public class ServiceMetadata {
    ...
    private ServiceMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ServiceMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ServiceMetadataOwnerReferences> ownerReferences;
    ...
    public ServiceMetadata(final Map<String, String> annotations,
                           ...
                           final ServiceMetadataInitializers initializers,
                           final Map<String, String> labels,
                           final List<ServiceMetadataManagedFields> managedFields,
                           final String name,
                           final String namespace,
                           final List<ServiceMetadataOwnerReferences> ownerReferences,
    ...
    public ServiceMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ServiceMetadataInitializers initializers) {
    ...
    public List<ServiceMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ServiceMetadataManagedFields> managedFields) {
    ...
    public List<ServiceMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ServiceMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ServiceMetadata)) {
            return false;
        }
        final ServiceMetadata __otherCasted = (ServiceMetadata) __other;
