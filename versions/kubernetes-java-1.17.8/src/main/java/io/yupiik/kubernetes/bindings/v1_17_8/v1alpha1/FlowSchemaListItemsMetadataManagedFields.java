...
public class FlowSchemaListItemsMetadataManagedFields {
    ...
    public FlowSchemaListItemsMetadataManagedFields() {
        // no-op
    }

    public FlowSchemaListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof FlowSchemaListItemsMetadataManagedFields)) {
            return false;
        }
        final FlowSchemaListItemsMetadataManagedFields __otherCasted = (FlowSchemaListItemsMetadataManagedFields) __other;
