...
public class PodPresetListItemsMetadataManagedFields {
    ...
    public PodPresetListItemsMetadataManagedFields() {
        // no-op
    }

    public PodPresetListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodPresetListItemsMetadataManagedFields)) {
            return false;
        }
        final PodPresetListItemsMetadataManagedFields __otherCasted = (PodPresetListItemsMetadataManagedFields) __other;
