...
public class JobListItemsSpecTemplateSpecSecurityContextWindowsOptions {
    private String gmsaCredentialSpec;
    private String gmsaCredentialSpecName;
    private String runAsUserName;

    public JobListItemsSpecTemplateSpecSecurityContextWindowsOptions() {
        // no-op
    }

    public JobListItemsSpecTemplateSpecSecurityContextWindowsOptions(final String gmsaCredentialSpec,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobListItemsSpecTemplateSpecSecurityContextWindowsOptions)) {
            return false;
        }
        final JobListItemsSpecTemplateSpecSecurityContextWindowsOptions __otherCasted = (JobListItemsSpecTemplateSpecSecurityContextWindowsOptions) __other;
