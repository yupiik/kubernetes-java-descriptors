...
public class CSIDriverMetadataManagedFields {
    ...
    public CSIDriverMetadataManagedFields() {
        // no-op
    }

    public CSIDriverMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSIDriverMetadataManagedFields)) {
            return false;
        }
        final CSIDriverMetadataManagedFields __otherCasted = (CSIDriverMetadataManagedFields) __other;
