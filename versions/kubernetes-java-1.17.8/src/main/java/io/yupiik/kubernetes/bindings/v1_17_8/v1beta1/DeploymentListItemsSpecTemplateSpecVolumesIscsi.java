...
public class DeploymentListItemsSpecTemplateSpecVolumesIscsi {
    ...
    private DeploymentListItemsSpecTemplateSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public DeploymentListItemsSpecTemplateSpecVolumesIscsi() {
        // no-op
    }

    public DeploymentListItemsSpecTemplateSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                                           ...
                                                           final DeploymentListItemsSpecTemplateSpecVolumesIscsiSecretRef secretRef,
    ...
    public DeploymentListItemsSpecTemplateSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final DeploymentListItemsSpecTemplateSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentListItemsSpecTemplateSpecVolumesIscsi)) {
            return false;
        }
        final DeploymentListItemsSpecTemplateSpecVolumesIscsi __otherCasted = (DeploymentListItemsSpecTemplateSpecVolumesIscsi) __other;
