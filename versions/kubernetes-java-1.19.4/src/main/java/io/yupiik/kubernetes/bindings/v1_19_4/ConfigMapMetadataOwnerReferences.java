...
public class ConfigMapMetadataOwnerReferences {
    ...
    public ConfigMapMetadataOwnerReferences() {
        // no-op
    }

    public ConfigMapMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ConfigMapMetadataOwnerReferences)) {
            return false;
        }
        final ConfigMapMetadataOwnerReferences __otherCasted = (ConfigMapMetadataOwnerReferences) __other;
