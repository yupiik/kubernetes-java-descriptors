...
public class RoleBindingListItemsMetadataManagedFields {
    ...
    public RoleBindingListItemsMetadataManagedFields() {
        // no-op
    }

    public RoleBindingListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RoleBindingListItemsMetadataManagedFields)) {
            return false;
        }
        final RoleBindingListItemsMetadataManagedFields __otherCasted = (RoleBindingListItemsMetadataManagedFields) __other;
