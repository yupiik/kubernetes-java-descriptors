...
public class FlowSchemaListMetadata {
    ...
    public FlowSchemaListMetadata() {
        // no-op
    }

    public FlowSchemaListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof FlowSchemaListMetadata)) {
            return false;
        }
        final FlowSchemaListMetadata __otherCasted = (FlowSchemaListMetadata) __other;
