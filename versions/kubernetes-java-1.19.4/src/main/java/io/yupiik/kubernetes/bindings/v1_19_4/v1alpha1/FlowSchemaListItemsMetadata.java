...
public class FlowSchemaListItemsMetadata {
    ...
    private List<FlowSchemaListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<FlowSchemaListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public FlowSchemaListItemsMetadata() {
        // no-op
    }

    public FlowSchemaListItemsMetadata(final Map<String, String> annotations,
                                       ...
                                       final List<FlowSchemaListItemsMetadataManagedFields> managedFields,
                                       final String name,
                                       final String namespace,
                                       final List<FlowSchemaListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public List<FlowSchemaListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<FlowSchemaListItemsMetadataManagedFields> managedFields) {
    ...
    public List<FlowSchemaListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<FlowSchemaListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof FlowSchemaListItemsMetadata)) {
            return false;
        }
        final FlowSchemaListItemsMetadata __otherCasted = (FlowSchemaListItemsMetadata) __other;
