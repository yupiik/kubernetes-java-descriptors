...
public class ReplicaSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts {
    ...
    public ReplicaSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts() {
        // no-op
    }

    public ReplicaSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicaSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts)) {
            return false;
        }
        final ReplicaSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts __otherCasted = (ReplicaSetListItemsSpecTemplateSpecEphemeralContainersVolumeMounts) __other;
