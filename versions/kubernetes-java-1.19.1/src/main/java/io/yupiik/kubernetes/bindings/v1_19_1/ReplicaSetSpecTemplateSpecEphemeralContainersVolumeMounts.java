...
public class ReplicaSetSpecTemplateSpecEphemeralContainersVolumeMounts {
    ...
    public ReplicaSetSpecTemplateSpecEphemeralContainersVolumeMounts() {
        // no-op
    }

    public ReplicaSetSpecTemplateSpecEphemeralContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicaSetSpecTemplateSpecEphemeralContainersVolumeMounts)) {
            return false;
        }
        final ReplicaSetSpecTemplateSpecEphemeralContainersVolumeMounts __otherCasted = (ReplicaSetSpecTemplateSpecEphemeralContainersVolumeMounts) __other;
