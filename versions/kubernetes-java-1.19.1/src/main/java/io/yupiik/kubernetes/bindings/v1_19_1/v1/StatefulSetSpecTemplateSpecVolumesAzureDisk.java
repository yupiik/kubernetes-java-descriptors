...
public class StatefulSetSpecTemplateSpecVolumesAzureDisk {
    ...
    public StatefulSetSpecTemplateSpecVolumesAzureDisk() {
        // no-op
    }

    public StatefulSetSpecTemplateSpecVolumesAzureDisk(final String cachingMode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetSpecTemplateSpecVolumesAzureDisk)) {
            return false;
        }
        final StatefulSetSpecTemplateSpecVolumesAzureDisk __otherCasted = (StatefulSetSpecTemplateSpecVolumesAzureDisk) __other;
