...
public class PodStatusInitContainerStatusesLastStateTerminated {
    ...
    public PodStatusInitContainerStatusesLastStateTerminated() {
        // no-op
    }

    public PodStatusInitContainerStatusesLastStateTerminated(final String containerID,
                                                             final int exitCode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodStatusInitContainerStatusesLastStateTerminated)) {
            return false;
        }
        final PodStatusInitContainerStatusesLastStateTerminated __otherCasted = (PodStatusInitContainerStatusesLastStateTerminated) __other;
