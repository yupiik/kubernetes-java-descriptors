...
public class PodListItemsSpecVolumesAzureDisk {
    ...
    public PodListItemsSpecVolumesAzureDisk() {
        // no-op
    }

    public PodListItemsSpecVolumesAzureDisk(final String cachingMode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodListItemsSpecVolumesAzureDisk)) {
            return false;
        }
        final PodListItemsSpecVolumesAzureDisk __otherCasted = (PodListItemsSpecVolumesAzureDisk) __other;
