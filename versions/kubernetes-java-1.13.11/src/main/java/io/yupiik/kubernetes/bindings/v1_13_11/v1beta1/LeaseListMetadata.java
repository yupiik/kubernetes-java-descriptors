...
public class LeaseListMetadata {
    @JsonbProperty("continue")
    private String continueValue;
    private String resourceVersion;
    private String selfLink;

    public LeaseListMetadata() {
        // no-op
    }

    public LeaseListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LeaseListMetadata)) {
            return false;
        }
        final LeaseListMetadata __otherCasted = (LeaseListMetadata) __other;
