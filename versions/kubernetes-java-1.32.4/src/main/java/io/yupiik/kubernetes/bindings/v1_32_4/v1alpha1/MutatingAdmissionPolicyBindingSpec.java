...
public class MutatingAdmissionPolicyBindingSpec implements Validable<MutatingAdmissionPolicyBindingSpec>, Exportable {
    ...
    public MutatingAdmissionPolicyBindingSpec(final MatchResources matchResources,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof MutatingAdmissionPolicyBindingSpec)) {
            return false;
        }
        final MutatingAdmissionPolicyBindingSpec __otherCasted = (MutatingAdmissionPolicyBindingSpec) __other;
    ...
    public MutatingAdmissionPolicyBindingSpec matchResources(final MatchResources matchResources) {
        this.matchResources = matchResources;
        return this;
    }

    public MutatingAdmissionPolicyBindingSpec paramRef(final ParamRef paramRef) {
        this.paramRef = paramRef;
        return this;
    }

    public MutatingAdmissionPolicyBindingSpec policyName(final String policyName) {
        this.policyName = policyName;
        return this;
    }

    @Override
    public MutatingAdmissionPolicyBindingSpec validate() {
        return this;
    }
