...
public class NodeListItemsStatusNodeInfo {
    ...
    public NodeListItemsStatusNodeInfo() {
        // no-op
    }

    public NodeListItemsStatusNodeInfo(final String architecture,
                                       final String bootID,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NodeListItemsStatusNodeInfo)) {
            return false;
        }
        final NodeListItemsStatusNodeInfo __otherCasted = (NodeListItemsStatusNodeInfo) __other;
