...
public class JobListItemsSpecTemplateSpecVolumesIscsi {
    ...
    private JobListItemsSpecTemplateSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public JobListItemsSpecTemplateSpecVolumesIscsi() {
        // no-op
    }

    public JobListItemsSpecTemplateSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                                    ...
                                                    final JobListItemsSpecTemplateSpecVolumesIscsiSecretRef secretRef,
    ...
    public JobListItemsSpecTemplateSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final JobListItemsSpecTemplateSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobListItemsSpecTemplateSpecVolumesIscsi)) {
            return false;
        }
        final JobListItemsSpecTemplateSpecVolumesIscsi __otherCasted = (JobListItemsSpecTemplateSpecVolumesIscsi) __other;
