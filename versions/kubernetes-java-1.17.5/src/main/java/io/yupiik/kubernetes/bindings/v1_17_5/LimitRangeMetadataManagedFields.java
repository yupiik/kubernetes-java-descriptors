...
public class LimitRangeMetadataManagedFields {
    ...
    public LimitRangeMetadataManagedFields() {
        // no-op
    }

    public LimitRangeMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof LimitRangeMetadataManagedFields)) {
            return false;
        }
        final LimitRangeMetadataManagedFields __otherCasted = (LimitRangeMetadataManagedFields) __other;
