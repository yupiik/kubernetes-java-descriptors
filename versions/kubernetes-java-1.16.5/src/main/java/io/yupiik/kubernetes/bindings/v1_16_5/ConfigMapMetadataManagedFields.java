...
public class ConfigMapMetadataManagedFields {
    ...
    public ConfigMapMetadataManagedFields() {
        // no-op
    }

    public ConfigMapMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ConfigMapMetadataManagedFields)) {
            return false;
        }
        final ConfigMapMetadataManagedFields __otherCasted = (ConfigMapMetadataManagedFields) __other;
