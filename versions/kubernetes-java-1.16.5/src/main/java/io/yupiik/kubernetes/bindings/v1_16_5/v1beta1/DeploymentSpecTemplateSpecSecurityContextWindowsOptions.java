...
public class DeploymentSpecTemplateSpecSecurityContextWindowsOptions {
    private String gmsaCredentialSpec;
    private String gmsaCredentialSpecName;
    private String runAsUserName;

    public DeploymentSpecTemplateSpecSecurityContextWindowsOptions() {
        // no-op
    }

    public DeploymentSpecTemplateSpecSecurityContextWindowsOptions(final String gmsaCredentialSpec,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DeploymentSpecTemplateSpecSecurityContextWindowsOptions)) {
            return false;
        }
        final DeploymentSpecTemplateSpecSecurityContextWindowsOptions __otherCasted = (DeploymentSpecTemplateSpecSecurityContextWindowsOptions) __other;
