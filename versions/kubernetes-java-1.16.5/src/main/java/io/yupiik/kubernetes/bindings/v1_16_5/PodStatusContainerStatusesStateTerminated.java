...
public class PodStatusContainerStatusesStateTerminated {
    ...
    public PodStatusContainerStatusesStateTerminated() {
        // no-op
    }

    public PodStatusContainerStatusesStateTerminated(final String containerID,
                                                     final int exitCode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodStatusContainerStatusesStateTerminated)) {
            return false;
        }
        final PodStatusContainerStatusesStateTerminated __otherCasted = (PodStatusContainerStatusesStateTerminated) __other;
