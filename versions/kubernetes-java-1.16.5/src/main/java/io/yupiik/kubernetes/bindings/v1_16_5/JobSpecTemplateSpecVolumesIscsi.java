...
public class JobSpecTemplateSpecVolumesIscsi {
    ...
    private JobSpecTemplateSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public JobSpecTemplateSpecVolumesIscsi() {
        // no-op
    }

    public JobSpecTemplateSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                           ...
                                           final JobSpecTemplateSpecVolumesIscsiSecretRef secretRef,
    ...
    public JobSpecTemplateSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final JobSpecTemplateSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobSpecTemplateSpecVolumesIscsi)) {
            return false;
        }
        final JobSpecTemplateSpecVolumesIscsi __otherCasted = (JobSpecTemplateSpecVolumesIscsi) __other;
