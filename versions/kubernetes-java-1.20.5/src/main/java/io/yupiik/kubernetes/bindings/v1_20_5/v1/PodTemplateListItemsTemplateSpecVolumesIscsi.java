...
public class PodTemplateListItemsTemplateSpecVolumesIscsi {
    ...
    private PodTemplateListItemsTemplateSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public PodTemplateListItemsTemplateSpecVolumesIscsi() {
        // no-op
    }

    public PodTemplateListItemsTemplateSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                                        ...
                                                        final PodTemplateListItemsTemplateSpecVolumesIscsiSecretRef secretRef,
    ...
    public PodTemplateListItemsTemplateSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final PodTemplateListItemsTemplateSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodTemplateListItemsTemplateSpecVolumesIscsi)) {
            return false;
        }
        final PodTemplateListItemsTemplateSpecVolumesIscsi __otherCasted = (PodTemplateListItemsTemplateSpecVolumesIscsi) __other;
