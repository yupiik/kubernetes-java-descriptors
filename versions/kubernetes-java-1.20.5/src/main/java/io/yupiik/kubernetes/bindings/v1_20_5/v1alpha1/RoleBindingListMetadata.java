...
public class RoleBindingListMetadata {
    ...
    public RoleBindingListMetadata() {
        // no-op
    }

    public RoleBindingListMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RoleBindingListMetadata)) {
            return false;
        }
        final RoleBindingListMetadata __otherCasted = (RoleBindingListMetadata) __other;
