...
public class PersistentVolumeClaimMetadataManagedFields {
    ...
    public PersistentVolumeClaimMetadataManagedFields() {
        // no-op
    }

    public PersistentVolumeClaimMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PersistentVolumeClaimMetadataManagedFields)) {
            return false;
        }
        final PersistentVolumeClaimMetadataManagedFields __otherCasted = (PersistentVolumeClaimMetadataManagedFields) __other;
