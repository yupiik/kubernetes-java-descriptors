...
public class CustomResourceDefinitionMetadataManagedFields {
    ...
    public CustomResourceDefinitionMetadataManagedFields() {
        // no-op
    }

    public CustomResourceDefinitionMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CustomResourceDefinitionMetadataManagedFields)) {
            return false;
        }
        final CustomResourceDefinitionMetadataManagedFields __otherCasted = (CustomResourceDefinitionMetadataManagedFields) __other;
