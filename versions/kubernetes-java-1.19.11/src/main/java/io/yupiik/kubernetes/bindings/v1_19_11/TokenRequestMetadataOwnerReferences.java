...
public class TokenRequestMetadataOwnerReferences {
    ...
    public TokenRequestMetadataOwnerReferences() {
        // no-op
    }

    public TokenRequestMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof TokenRequestMetadataOwnerReferences)) {
            return false;
        }
        final TokenRequestMetadataOwnerReferences __otherCasted = (TokenRequestMetadataOwnerReferences) __other;
