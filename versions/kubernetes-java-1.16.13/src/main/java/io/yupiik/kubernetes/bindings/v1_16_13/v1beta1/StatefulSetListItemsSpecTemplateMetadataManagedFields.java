...
public class StatefulSetListItemsSpecTemplateMetadataManagedFields {
    ...
    public StatefulSetListItemsSpecTemplateMetadataManagedFields() {
        // no-op
    }

    public StatefulSetListItemsSpecTemplateMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StatefulSetListItemsSpecTemplateMetadataManagedFields)) {
            return false;
        }
        final StatefulSetListItemsSpecTemplateMetadataManagedFields __otherCasted = (StatefulSetListItemsSpecTemplateMetadataManagedFields) __other;
