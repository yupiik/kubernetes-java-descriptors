...
public class TokenReviewMetadataManagedFields {
    ...
    public TokenReviewMetadataManagedFields() {
        // no-op
    }

    public TokenReviewMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof TokenReviewMetadataManagedFields)) {
            return false;
        }
        final TokenReviewMetadataManagedFields __otherCasted = (TokenReviewMetadataManagedFields) __other;
