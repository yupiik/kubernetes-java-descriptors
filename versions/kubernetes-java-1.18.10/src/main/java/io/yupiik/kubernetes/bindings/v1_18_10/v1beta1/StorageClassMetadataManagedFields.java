...
public class StorageClassMetadataManagedFields {
    ...
    public StorageClassMetadataManagedFields() {
        // no-op
    }

    public StorageClassMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof StorageClassMetadataManagedFields)) {
            return false;
        }
        final StorageClassMetadataManagedFields __otherCasted = (StorageClassMetadataManagedFields) __other;
