...
public class ValidatingWebhookConfigurationWebhooksRules {
    ...
    public ValidatingWebhookConfigurationWebhooksRules() {
        // no-op
    }

    public ValidatingWebhookConfigurationWebhooksRules(final List<String> apiGroups,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ValidatingWebhookConfigurationWebhooksRules)) {
            return false;
        }
        final ValidatingWebhookConfigurationWebhooksRules __otherCasted = (ValidatingWebhookConfigurationWebhooksRules) __other;
