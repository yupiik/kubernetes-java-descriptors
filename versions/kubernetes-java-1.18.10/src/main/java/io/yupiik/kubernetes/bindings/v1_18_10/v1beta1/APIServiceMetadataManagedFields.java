...
public class APIServiceMetadataManagedFields {
    ...
    public APIServiceMetadataManagedFields() {
        // no-op
    }

    public APIServiceMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof APIServiceMetadataManagedFields)) {
            return false;
        }
        final APIServiceMetadataManagedFields __otherCasted = (APIServiceMetadataManagedFields) __other;
