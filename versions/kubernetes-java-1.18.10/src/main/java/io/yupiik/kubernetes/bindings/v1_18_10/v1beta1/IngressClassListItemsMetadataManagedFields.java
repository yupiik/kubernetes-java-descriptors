...
public class IngressClassListItemsMetadataManagedFields {
    ...
    public IngressClassListItemsMetadataManagedFields() {
        // no-op
    }

    public IngressClassListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof IngressClassListItemsMetadataManagedFields)) {
            return false;
        }
        final IngressClassListItemsMetadataManagedFields __otherCasted = (IngressClassListItemsMetadataManagedFields) __other;
