...
public class SelfSubjectRulesReviewMetadataManagedFields {
    ...
    public SelfSubjectRulesReviewMetadataManagedFields() {
        // no-op
    }

    public SelfSubjectRulesReviewMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof SelfSubjectRulesReviewMetadataManagedFields)) {
            return false;
        }
        final SelfSubjectRulesReviewMetadataManagedFields __otherCasted = (SelfSubjectRulesReviewMetadataManagedFields) __other;
