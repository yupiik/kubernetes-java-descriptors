...
public class SelfSubjectAccessReviewMetadataManagedFields {
    ...
    public SelfSubjectAccessReviewMetadataManagedFields() {
        // no-op
    }

    public SelfSubjectAccessReviewMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof SelfSubjectAccessReviewMetadataManagedFields)) {
            return false;
        }
        final SelfSubjectAccessReviewMetadataManagedFields __otherCasted = (SelfSubjectAccessReviewMetadataManagedFields) __other;
