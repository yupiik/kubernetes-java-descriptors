...
public class IngressMetadataManagedFields {
    ...
    public IngressMetadataManagedFields() {
        // no-op
    }

    public IngressMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof IngressMetadataManagedFields)) {
            return false;
        }
        final IngressMetadataManagedFields __otherCasted = (IngressMetadataManagedFields) __other;
