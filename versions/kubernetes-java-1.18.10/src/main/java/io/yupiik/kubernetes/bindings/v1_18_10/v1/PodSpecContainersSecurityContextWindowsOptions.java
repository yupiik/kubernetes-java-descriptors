...
public class PodSpecContainersSecurityContextWindowsOptions {
    private String gmsaCredentialSpec;
    private String gmsaCredentialSpecName;
    private String runAsUserName;

    public PodSpecContainersSecurityContextWindowsOptions() {
        // no-op
    }

    public PodSpecContainersSecurityContextWindowsOptions(final String gmsaCredentialSpec,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSpecContainersSecurityContextWindowsOptions)) {
            return false;
        }
        final PodSpecContainersSecurityContextWindowsOptions __otherCasted = (PodSpecContainersSecurityContextWindowsOptions) __other;
