...
public class ValidatingWebhookConfigurationMetadata {
    ...
    private List<ValidatingWebhookConfigurationMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ValidatingWebhookConfigurationMetadataOwnerReferences> ownerReferences;
    ...
    public ValidatingWebhookConfigurationMetadata(final Map<String, String> annotations,
                                                  ...
                                                  final List<ValidatingWebhookConfigurationMetadataManagedFields> managedFields,
                                                  final String name,
                                                  final String namespace,
                                                  final List<ValidatingWebhookConfigurationMetadataOwnerReferences> ownerReferences,
    ...
    public List<ValidatingWebhookConfigurationMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ValidatingWebhookConfigurationMetadataManagedFields> managedFields) {
    ...
    public List<ValidatingWebhookConfigurationMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ValidatingWebhookConfigurationMetadataOwnerReferences> ownerReferences) {
