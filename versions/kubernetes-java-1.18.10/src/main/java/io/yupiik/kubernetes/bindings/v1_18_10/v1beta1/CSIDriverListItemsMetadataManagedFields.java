...
public class CSIDriverListItemsMetadataManagedFields {
    ...
    public CSIDriverListItemsMetadataManagedFields() {
        // no-op
    }

    public CSIDriverListItemsMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSIDriverListItemsMetadataManagedFields)) {
            return false;
        }
        final CSIDriverListItemsMetadataManagedFields __otherCasted = (CSIDriverListItemsMetadataManagedFields) __other;
