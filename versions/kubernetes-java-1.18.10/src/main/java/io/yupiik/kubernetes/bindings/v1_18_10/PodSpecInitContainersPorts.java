...
public class PodSpecInitContainersPorts {
    ...
    public PodSpecInitContainersPorts() {
        // no-op
    }

    public PodSpecInitContainersPorts(final int containerPort,
                                      final String hostIP,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSpecInitContainersPorts)) {
            return false;
        }
        final PodSpecInitContainersPorts __otherCasted = (PodSpecInitContainersPorts) __other;
