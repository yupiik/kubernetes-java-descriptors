...
public class DaemonSetSpecTemplateSpecVolumesIscsi {
    ...
    private DaemonSetSpecTemplateSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public DaemonSetSpecTemplateSpecVolumesIscsi() {
        // no-op
    }

    public DaemonSetSpecTemplateSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                                 ...
                                                 final DaemonSetSpecTemplateSpecVolumesIscsiSecretRef secretRef,
    ...
    public DaemonSetSpecTemplateSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final DaemonSetSpecTemplateSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetSpecTemplateSpecVolumesIscsi)) {
            return false;
        }
        final DaemonSetSpecTemplateSpecVolumesIscsi __otherCasted = (DaemonSetSpecTemplateSpecVolumesIscsi) __other;
