...
public class PersistentVolumeSpecAzureDisk {
    ...
    public PersistentVolumeSpecAzureDisk() {
        // no-op
    }

    public PersistentVolumeSpecAzureDisk(final String cachingMode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PersistentVolumeSpecAzureDisk)) {
            return false;
        }
        final PersistentVolumeSpecAzureDisk __otherCasted = (PersistentVolumeSpecAzureDisk) __other;
