...
public class ConfigMapMetadata {
    ...
    private ConfigMapMetadataInitializers initializers;
    ...
    public ConfigMapMetadata(final Map<String, String> annotations,
                             ...
                             final ConfigMapMetadataInitializers initializers,
    ...
    public ConfigMapMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ConfigMapMetadataInitializers initializers) {
