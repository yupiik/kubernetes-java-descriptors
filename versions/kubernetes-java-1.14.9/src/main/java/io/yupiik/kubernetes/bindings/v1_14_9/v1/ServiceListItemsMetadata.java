...
public class ServiceListItemsMetadata {
    ...
    private ServiceListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ServiceListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ServiceListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ServiceListItemsMetadata() {
        // no-op
    }

    public ServiceListItemsMetadata(final Map<String, String> annotations,
                                    ...
                                    final ServiceListItemsMetadataInitializers initializers,
                                    final Map<String, String> labels,
                                    final List<ServiceListItemsMetadataManagedFields> managedFields,
                                    final String name,
                                    final String namespace,
                                    final List<ServiceListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public ServiceListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ServiceListItemsMetadataInitializers initializers) {
    ...
    public List<ServiceListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ServiceListItemsMetadataManagedFields> managedFields) {
    ...
    public List<ServiceListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ServiceListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ServiceListItemsMetadata)) {
            return false;
        }
        final ServiceListItemsMetadata __otherCasted = (ServiceListItemsMetadata) __other;
