...
public class SelfSubjectAccessReviewMetadata {
    ...
    private SelfSubjectAccessReviewMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<SelfSubjectAccessReviewMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<SelfSubjectAccessReviewMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public SelfSubjectAccessReviewMetadata() {
        // no-op
    }

    public SelfSubjectAccessReviewMetadata(final Map<String, String> annotations,
                                           ...
                                           final SelfSubjectAccessReviewMetadataInitializers initializers,
                                           final Map<String, String> labels,
                                           final List<SelfSubjectAccessReviewMetadataManagedFields> managedFields,
                                           final String name,
                                           final String namespace,
                                           final List<SelfSubjectAccessReviewMetadataOwnerReferences> ownerReferences,
    ...
    public SelfSubjectAccessReviewMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final SelfSubjectAccessReviewMetadataInitializers initializers) {
    ...
    public List<SelfSubjectAccessReviewMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<SelfSubjectAccessReviewMetadataManagedFields> managedFields) {
    ...
    public List<SelfSubjectAccessReviewMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<SelfSubjectAccessReviewMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof SelfSubjectAccessReviewMetadata)) {
            return false;
        }
        final SelfSubjectAccessReviewMetadata __otherCasted = (SelfSubjectAccessReviewMetadata) __other;
