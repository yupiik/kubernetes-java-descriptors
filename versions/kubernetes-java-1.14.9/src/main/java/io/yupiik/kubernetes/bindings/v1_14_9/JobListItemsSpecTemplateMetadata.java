...
public class JobListItemsSpecTemplateMetadata {
    ...
    private JobListItemsSpecTemplateMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<JobListItemsSpecTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<JobListItemsSpecTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public JobListItemsSpecTemplateMetadata() {
        // no-op
    }

    public JobListItemsSpecTemplateMetadata(final Map<String, String> annotations,
                                            ...
                                            final JobListItemsSpecTemplateMetadataInitializers initializers,
                                            final Map<String, String> labels,
                                            final List<JobListItemsSpecTemplateMetadataManagedFields> managedFields,
                                            final String name,
                                            final String namespace,
                                            final List<JobListItemsSpecTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public JobListItemsSpecTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final JobListItemsSpecTemplateMetadataInitializers initializers) {
    ...
    public List<JobListItemsSpecTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<JobListItemsSpecTemplateMetadataManagedFields> managedFields) {
    ...
    public List<JobListItemsSpecTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<JobListItemsSpecTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobListItemsSpecTemplateMetadata)) {
            return false;
        }
        final JobListItemsSpecTemplateMetadata __otherCasted = (JobListItemsSpecTemplateMetadata) __other;
