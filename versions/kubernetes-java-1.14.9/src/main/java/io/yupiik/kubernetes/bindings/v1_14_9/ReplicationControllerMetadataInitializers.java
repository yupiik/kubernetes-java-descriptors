...
public class ReplicationControllerMetadataInitializers {
    private List<ReplicationControllerMetadataInitializersPending> pending;
    ...
    public ReplicationControllerMetadataInitializers(final List<ReplicationControllerMetadataInitializersPending> pending,
                                                     final ReplicationControllerMetadataInitializersResult result) {
        // no-op
    }

    public List<ReplicationControllerMetadataInitializersPending> getPending() {
        return pending;
    }

    public void setPending(final List<ReplicationControllerMetadataInitializersPending> pending) {
