...
public class PodSpecVolumesFc {
    ...
    public PodSpecVolumesFc() {
        // no-op
    }

    public PodSpecVolumesFc(final String fsType,
                            final Integer lun,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodSpecVolumesFc)) {
            return false;
        }
        final PodSpecVolumesFc __otherCasted = (PodSpecVolumesFc) __other;
