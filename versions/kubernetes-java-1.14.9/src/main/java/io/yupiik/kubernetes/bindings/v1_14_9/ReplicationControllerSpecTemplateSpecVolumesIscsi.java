...
public class ReplicationControllerSpecTemplateSpecVolumesIscsi {
    ...
    private ReplicationControllerSpecTemplateSpecVolumesIscsiSecretRef secretRef;
    private String targetPortal;

    public ReplicationControllerSpecTemplateSpecVolumesIscsi() {
        // no-op
    }

    public ReplicationControllerSpecTemplateSpecVolumesIscsi(final Boolean chapAuthDiscovery,
                                                             ...
                                                             final ReplicationControllerSpecTemplateSpecVolumesIscsiSecretRef secretRef,
    ...
    public ReplicationControllerSpecTemplateSpecVolumesIscsiSecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(final ReplicationControllerSpecTemplateSpecVolumesIscsiSecretRef secretRef) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicationControllerSpecTemplateSpecVolumesIscsi)) {
            return false;
        }
        final ReplicationControllerSpecTemplateSpecVolumesIscsi __otherCasted = (ReplicationControllerSpecTemplateSpecVolumesIscsi) __other;
