...
public class EphemeralContainersEphemeralContainersPorts {
    ...
    public EphemeralContainersEphemeralContainersPorts() {
        // no-op
    }

    public EphemeralContainersEphemeralContainersPorts(final int containerPort,
                                                       final String hostIP,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EphemeralContainersEphemeralContainersPorts)) {
            return false;
        }
        final EphemeralContainersEphemeralContainersPorts __otherCasted = (EphemeralContainersEphemeralContainersPorts) __other;
