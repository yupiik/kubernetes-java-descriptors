...
public class ReplicaSetMetadataManagedFields {
    ...
    public ReplicaSetMetadataManagedFields() {
        // no-op
    }

    public ReplicaSetMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicaSetMetadataManagedFields)) {
            return false;
        }
        final ReplicaSetMetadataManagedFields __otherCasted = (ReplicaSetMetadataManagedFields) __other;
