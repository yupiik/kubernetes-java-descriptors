...
public class ExternalAdmissionHookConfigurationMetadata {
    ...
    private ExternalAdmissionHookConfigurationMetadataInitializers initializers;
    ...
    public ExternalAdmissionHookConfigurationMetadata() {
        // no-op
    }

    public ExternalAdmissionHookConfigurationMetadata(final Map<String, String> annotations,
                                                      ...
                                                      final ExternalAdmissionHookConfigurationMetadataInitializers initializers,
    ...
    public ExternalAdmissionHookConfigurationMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ExternalAdmissionHookConfigurationMetadataInitializers initializers) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ExternalAdmissionHookConfigurationMetadata)) {
            return false;
        }
        final ExternalAdmissionHookConfigurationMetadata __otherCasted = (ExternalAdmissionHookConfigurationMetadata) __other;
