...
public class JobSpecTemplateMetadataManagedFields {
    ...
    public JobSpecTemplateMetadataManagedFields() {
        // no-op
    }

    public JobSpecTemplateMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobSpecTemplateMetadataManagedFields)) {
            return false;
        }
        final JobSpecTemplateMetadataManagedFields __otherCasted = (JobSpecTemplateMetadataManagedFields) __other;
