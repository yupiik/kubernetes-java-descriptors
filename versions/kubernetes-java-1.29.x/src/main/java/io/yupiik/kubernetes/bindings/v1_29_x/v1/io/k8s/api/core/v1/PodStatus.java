...
public class io.k8s.api.core.v1.PodStatus implements Validable<io.k8s.api.core.v1.PodStatus>, Exportable {
    ...
    public io.k8s.api.core.v1.PodStatus() {
        // no-op
    }

    public io.k8s.api.core.v1.PodStatus(final List<PodCondition> conditions,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.PodStatus)) {
            return false;
        }
        final io.k8s.api.core.v1.PodStatus __otherCasted = (io.k8s.api.core.v1.PodStatus) __other;
    ...
    public io.k8s.api.core.v1.PodStatus conditions(final List<PodCondition> conditions) {
        this.conditions = conditions;
        return this;
    }

    public io.k8s.api.core.v1.PodStatus containerStatuses(final List<ContainerStatus> containerStatuses) {
        this.containerStatuses = containerStatuses;
        return this;
    }

    public io.k8s.api.core.v1.PodStatus ephemeralContainerStatuses(final List<ContainerStatus> ephemeralContainerStatuses) {
        this.ephemeralContainerStatuses = ephemeralContainerStatuses;
        return this;
    }

    public io.k8s.api.core.v1.PodStatus hostIP(final String hostIP) {
        this.hostIP = hostIP;
        return this;
    }

    public io.k8s.api.core.v1.PodStatus hostIPs(final List<HostIP> hostIPs) {
        this.hostIPs = hostIPs;
        return this;
    }

    public io.k8s.api.core.v1.PodStatus initContainerStatuses(final List<ContainerStatus> initContainerStatuses) {
        this.initContainerStatuses = initContainerStatuses;
        return this;
    }

    public io.k8s.api.core.v1.PodStatus message(final String message) {
        this.message = message;
        return this;
    }

    public io.k8s.api.core.v1.PodStatus nominatedNodeName(final String nominatedNodeName) {
        this.nominatedNodeName = nominatedNodeName;
        return this;
    }

    public io.k8s.api.core.v1.PodStatus phase(final String phase) {
        this.phase = phase;
        return this;
    }

    public io.k8s.api.core.v1.PodStatus podIP(final String podIP) {
        this.podIP = podIP;
        return this;
    }

    public io.k8s.api.core.v1.PodStatus podIPs(final List<PodIP> podIPs) {
        this.podIPs = podIPs;
        return this;
    }

    public io.k8s.api.core.v1.PodStatus qosClass(final String qosClass) {
        this.qosClass = qosClass;
        return this;
    }

    public io.k8s.api.core.v1.PodStatus reason(final String reason) {
        this.reason = reason;
        return this;
    }

    public io.k8s.api.core.v1.PodStatus resize(final String resize) {
        this.resize = resize;
        return this;
    }

    public io.k8s.api.core.v1.PodStatus resourceClaimStatuses(final List<PodResourceClaimStatus> resourceClaimStatuses) {
        this.resourceClaimStatuses = resourceClaimStatuses;
        return this;
    }

    public io.k8s.api.core.v1.PodStatus startTime(final String startTime) {
        this.startTime = startTime;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.PodStatus validate() {
        return this;
    }
