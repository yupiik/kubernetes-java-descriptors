...
public class io.k8s.api.core.v1.SecurityContext implements Validable<io.k8s.api.core.v1.SecurityContext>, Exportable {
    ...
    public io.k8s.api.core.v1.SecurityContext() {
        // no-op
    }

    public io.k8s.api.core.v1.SecurityContext(final Boolean allowPrivilegeEscalation,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.SecurityContext)) {
            return false;
        }
        final io.k8s.api.core.v1.SecurityContext __otherCasted = (io.k8s.api.core.v1.SecurityContext) __other;
    ...
    public io.k8s.api.core.v1.SecurityContext allowPrivilegeEscalation(final Boolean allowPrivilegeEscalation) {
        this.allowPrivilegeEscalation = allowPrivilegeEscalation;
        return this;
    }

    public io.k8s.api.core.v1.SecurityContext capabilities(final Capabilities capabilities) {
        this.capabilities = capabilities;
        return this;
    }

    public io.k8s.api.core.v1.SecurityContext privileged(final Boolean privileged) {
        this.privileged = privileged;
        return this;
    }

    public io.k8s.api.core.v1.SecurityContext procMount(final String procMount) {
        this.procMount = procMount;
        return this;
    }

    public io.k8s.api.core.v1.SecurityContext readOnlyRootFilesystem(final Boolean readOnlyRootFilesystem) {
        this.readOnlyRootFilesystem = readOnlyRootFilesystem;
        return this;
    }

    public io.k8s.api.core.v1.SecurityContext runAsGroup(final Integer runAsGroup) {
        this.runAsGroup = runAsGroup;
        return this;
    }

    public io.k8s.api.core.v1.SecurityContext runAsNonRoot(final Boolean runAsNonRoot) {
        this.runAsNonRoot = runAsNonRoot;
        return this;
    }

    public io.k8s.api.core.v1.SecurityContext runAsUser(final Integer runAsUser) {
        this.runAsUser = runAsUser;
        return this;
    }

    public io.k8s.api.core.v1.SecurityContext seLinuxOptions(final SELinuxOptions seLinuxOptions) {
        this.seLinuxOptions = seLinuxOptions;
        return this;
    }

    public io.k8s.api.core.v1.SecurityContext seccompProfile(final SeccompProfile seccompProfile) {
        this.seccompProfile = seccompProfile;
        return this;
    }

    public io.k8s.api.core.v1.SecurityContext windowsOptions(final WindowsSecurityContextOptions windowsOptions) {
        this.windowsOptions = windowsOptions;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.SecurityContext validate() {
        return this;
    }
