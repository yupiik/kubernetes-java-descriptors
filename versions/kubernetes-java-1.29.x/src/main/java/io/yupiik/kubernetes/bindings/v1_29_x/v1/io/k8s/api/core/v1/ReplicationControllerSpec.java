...
public class io.k8s.api.core.v1.ReplicationControllerSpec implements Validable<io.k8s.api.core.v1.ReplicationControllerSpec>, Exportable {
    private Integer minReadySeconds;
    private Integer replicas;
    private Map<String, String> selector;
    private PodTemplateSpec template;

    public io.k8s.api.core.v1.ReplicationControllerSpec() {
        // no-op
    }

    public io.k8s.api.core.v1.ReplicationControllerSpec(final Integer minReadySeconds,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.ReplicationControllerSpec)) {
            return false;
        }
        final io.k8s.api.core.v1.ReplicationControllerSpec __otherCasted = (io.k8s.api.core.v1.ReplicationControllerSpec) __other;
    ...
    public io.k8s.api.core.v1.ReplicationControllerSpec minReadySeconds(final Integer minReadySeconds) {
        this.minReadySeconds = minReadySeconds;
        return this;
    }

    public io.k8s.api.core.v1.ReplicationControllerSpec replicas(final Integer replicas) {
        this.replicas = replicas;
        return this;
    }

    public io.k8s.api.core.v1.ReplicationControllerSpec selector(final Map<String, String> selector) {
        this.selector = selector;
        return this;
    }

    public io.k8s.api.core.v1.ReplicationControllerSpec template(final PodTemplateSpec template) {
        this.template = template;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.ReplicationControllerSpec validate() {
        return this;
    }
