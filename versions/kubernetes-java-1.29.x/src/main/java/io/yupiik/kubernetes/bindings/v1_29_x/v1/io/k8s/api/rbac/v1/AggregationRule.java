...
public class io.k8s.api.rbac.v1.AggregationRule implements Validable<io.k8s.api.rbac.v1.AggregationRule>, Exportable {
    private List<LabelSelector> clusterRoleSelectors;

    public io.k8s.api.rbac.v1.AggregationRule() {
        // no-op
    }

    public io.k8s.api.rbac.v1.AggregationRule(final List<LabelSelector> clusterRoleSelectors) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.rbac.v1.AggregationRule)) {
            return false;
        }
        final io.k8s.api.rbac.v1.AggregationRule __otherCasted = (io.k8s.api.rbac.v1.AggregationRule) __other;
        return Objects.equals(clusterRoleSelectors, __otherCasted.clusterRoleSelectors);
    }

    public io.k8s.api.rbac.v1.AggregationRule clusterRoleSelectors(final List<LabelSelector> clusterRoleSelectors) {
        this.clusterRoleSelectors = clusterRoleSelectors;
        return this;
    }

    @Override
    public io.k8s.api.rbac.v1.AggregationRule validate() {
        return this;
    }
