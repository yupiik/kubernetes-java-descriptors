...
public class io.k8s.api.apps.v1.DaemonSetStatus implements Validable<io.k8s.api.apps.v1.DaemonSetStatus>, Exportable {
    ...
    public io.k8s.api.apps.v1.DaemonSetStatus() {
        // no-op
    }

    public io.k8s.api.apps.v1.DaemonSetStatus(final Integer collisionCount,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.apps.v1.DaemonSetStatus)) {
            return false;
        }
        final io.k8s.api.apps.v1.DaemonSetStatus __otherCasted = (io.k8s.api.apps.v1.DaemonSetStatus) __other;
    ...
    public io.k8s.api.apps.v1.DaemonSetStatus collisionCount(final Integer collisionCount) {
        this.collisionCount = collisionCount;
        return this;
    }

    public io.k8s.api.apps.v1.DaemonSetStatus conditions(final List<DaemonSetCondition> conditions) {
        this.conditions = conditions;
        return this;
    }

    public io.k8s.api.apps.v1.DaemonSetStatus currentNumberScheduled(final int currentNumberScheduled) {
        this.currentNumberScheduled = currentNumberScheduled;
        return this;
    }

    public io.k8s.api.apps.v1.DaemonSetStatus desiredNumberScheduled(final int desiredNumberScheduled) {
        this.desiredNumberScheduled = desiredNumberScheduled;
        return this;
    }

    public io.k8s.api.apps.v1.DaemonSetStatus numberAvailable(final Integer numberAvailable) {
        this.numberAvailable = numberAvailable;
        return this;
    }

    public io.k8s.api.apps.v1.DaemonSetStatus numberMisscheduled(final int numberMisscheduled) {
        this.numberMisscheduled = numberMisscheduled;
        return this;
    }

    public io.k8s.api.apps.v1.DaemonSetStatus numberReady(final int numberReady) {
        this.numberReady = numberReady;
        return this;
    }

    public io.k8s.api.apps.v1.DaemonSetStatus numberUnavailable(final Integer numberUnavailable) {
        this.numberUnavailable = numberUnavailable;
        return this;
    }

    public io.k8s.api.apps.v1.DaemonSetStatus observedGeneration(final Integer observedGeneration) {
        this.observedGeneration = observedGeneration;
        return this;
    }

    public io.k8s.api.apps.v1.DaemonSetStatus updatedNumberScheduled(final Integer updatedNumberScheduled) {
        this.updatedNumberScheduled = updatedNumberScheduled;
        return this;
    }

    @Override
    public io.k8s.api.apps.v1.DaemonSetStatus validate() {
        return this;
    }
