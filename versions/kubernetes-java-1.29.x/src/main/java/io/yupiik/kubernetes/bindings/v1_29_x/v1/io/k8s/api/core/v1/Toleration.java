...
public class io.k8s.api.core.v1.Toleration implements Validable<io.k8s.api.core.v1.Toleration>, Exportable {
    ...
    public io.k8s.api.core.v1.Toleration() {
        // no-op
    }

    public io.k8s.api.core.v1.Toleration(final String effect,
                                         final String key,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.Toleration)) {
            return false;
        }
        final io.k8s.api.core.v1.Toleration __otherCasted = (io.k8s.api.core.v1.Toleration) __other;
    ...
    public io.k8s.api.core.v1.Toleration effect(final String effect) {
        this.effect = effect;
        return this;
    }

    public io.k8s.api.core.v1.Toleration key(final String key) {
        this.key = key;
        return this;
    }

    public io.k8s.api.core.v1.Toleration operator(final String operator) {
        this.operator = operator;
        return this;
    }

    public io.k8s.api.core.v1.Toleration tolerationSeconds(final Integer tolerationSeconds) {
        this.tolerationSeconds = tolerationSeconds;
        return this;
    }

    public io.k8s.api.core.v1.Toleration value(final String value) {
        this.value = value;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.Toleration validate() {
        return this;
    }
