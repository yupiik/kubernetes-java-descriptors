...
public class io.k8s.api.core.v1.ResourceRequirements implements Validable<io.k8s.api.core.v1.ResourceRequirements>, Exportable {
    private List<ResourceClaim> claims;
    private JsonObject limits;
    private JsonObject requests;

    public io.k8s.api.core.v1.ResourceRequirements() {
        // no-op
    }

    public io.k8s.api.core.v1.ResourceRequirements(final List<ResourceClaim> claims,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.ResourceRequirements)) {
            return false;
        }
        final io.k8s.api.core.v1.ResourceRequirements __otherCasted = (io.k8s.api.core.v1.ResourceRequirements) __other;
    ...
    public io.k8s.api.core.v1.ResourceRequirements claims(final List<ResourceClaim> claims) {
        this.claims = claims;
        return this;
    }

    public io.k8s.api.core.v1.ResourceRequirements limits(final JsonObject limits) {
        this.limits = limits;
        return this;
    }

    public io.k8s.api.core.v1.ResourceRequirements requests(final JsonObject requests) {
        this.requests = requests;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.ResourceRequirements validate() {
        return this;
    }
