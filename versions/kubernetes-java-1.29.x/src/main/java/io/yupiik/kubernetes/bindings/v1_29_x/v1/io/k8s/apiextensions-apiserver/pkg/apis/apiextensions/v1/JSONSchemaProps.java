...
public class io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps implements Validable<io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps>, Exportable {
    ...
    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps() {
        // no-op
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps(final JsonValue additionalItems,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps)) {
            return false;
        }
        final io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps __otherCasted = (io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps) __other;
    ...
    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps additionalItems(final JsonValue additionalItems) {
        this.additionalItems = additionalItems;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps additionalProperties(final JsonValue additionalProperties) {
        this.additionalProperties = additionalProperties;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps allOf(final List<JSONSchemaProps> allOf) {
        this.allOf = allOf;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps anyOf(final List<JSONSchemaProps> anyOf) {
        this.anyOf = anyOf;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps defaultValue(final JsonValue defaultValue) {
        this.defaultValue = defaultValue;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps definitions(final JsonObject definitions) {
        this.definitions = definitions;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps dependencies(final JsonObject dependencies) {
        this.dependencies = dependencies;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps description(final String description) {
        this.description = description;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps enumValue(final List<JsonValue> enumValue) {
        this.enumValue = enumValue;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps example(final JsonValue example) {
        this.example = example;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps exclusiveMaximum(final Boolean exclusiveMaximum) {
        this.exclusiveMaximum = exclusiveMaximum;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps exclusiveMinimum(final Boolean exclusiveMinimum) {
        this.exclusiveMinimum = exclusiveMinimum;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps externalDocs(final ExternalDocumentation externalDocs) {
        this.externalDocs = externalDocs;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps format(final String format) {
        this.format = format;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps id(final String id) {
        this.id = id;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps items(final JsonValue items) {
        this.items = items;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps maxItems(final Integer maxItems) {
        this.maxItems = maxItems;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps maxLength(final Integer maxLength) {
        this.maxLength = maxLength;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps maxProperties(final Integer maxProperties) {
        this.maxProperties = maxProperties;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps maximum(final Double maximum) {
        this.maximum = maximum;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps minItems(final Integer minItems) {
        this.minItems = minItems;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps minLength(final Integer minLength) {
        this.minLength = minLength;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps minProperties(final Integer minProperties) {
        this.minProperties = minProperties;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps minimum(final Double minimum) {
        this.minimum = minimum;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps multipleOf(final Double multipleOf) {
        this.multipleOf = multipleOf;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps not(final JSONSchemaProps not) {
        this.not = not;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps nullable(final Boolean nullable) {
        this.nullable = nullable;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps oneOf(final List<JSONSchemaProps> oneOf) {
        this.oneOf = oneOf;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps pattern(final String pattern) {
        this.pattern = pattern;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps patternProperties(final JsonObject patternProperties) {
        this.patternProperties = patternProperties;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps properties(final JsonObject properties) {
        this.properties = properties;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps ref(final String ref) {
        this.ref = ref;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps required(final List<String> required) {
        this.required = required;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps schema(final String schema) {
        this.schema = schema;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps title(final String title) {
        this.title = title;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps type(final String type) {
        this.type = type;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps uniqueItems(final Boolean uniqueItems) {
        this.uniqueItems = uniqueItems;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps xKubernetesEmbeddedResource(final Boolean xKubernetesEmbeddedResource) {
        this.xKubernetesEmbeddedResource = xKubernetesEmbeddedResource;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps xKubernetesIntOrString(final Boolean xKubernetesIntOrString) {
        this.xKubernetesIntOrString = xKubernetesIntOrString;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps xKubernetesListMapKeys(final List<String> xKubernetesListMapKeys) {
        this.xKubernetesListMapKeys = xKubernetesListMapKeys;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps xKubernetesListType(final String xKubernetesListType) {
        this.xKubernetesListType = xKubernetesListType;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps xKubernetesMapType(final String xKubernetesMapType) {
        this.xKubernetesMapType = xKubernetesMapType;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps xKubernetesPreserveUnknownFields(final Boolean xKubernetesPreserveUnknownFields) {
        this.xKubernetesPreserveUnknownFields = xKubernetesPreserveUnknownFields;
        return this;
    }

    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps xKubernetesValidations(final List<ValidationRule> xKubernetesValidations) {
        this.xKubernetesValidations = xKubernetesValidations;
        return this;
    }

    @Override
    public io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps validate() {
        return this;
    }
