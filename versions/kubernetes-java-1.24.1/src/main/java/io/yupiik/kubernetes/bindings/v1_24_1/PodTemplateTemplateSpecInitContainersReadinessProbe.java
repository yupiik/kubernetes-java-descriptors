...
public class PodTemplateTemplateSpecInitContainersReadinessProbe {
    ...
    private PodTemplateTemplateSpecInitContainersReadinessProbeGrpc grpc;
    ...
    public PodTemplateTemplateSpecInitContainersReadinessProbe(final PodTemplateTemplateSpecInitContainersReadinessProbeExec exec,
                                                               ...
                                                               final PodTemplateTemplateSpecInitContainersReadinessProbeGrpc grpc,
    ...
    public PodTemplateTemplateSpecInitContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final PodTemplateTemplateSpecInitContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
