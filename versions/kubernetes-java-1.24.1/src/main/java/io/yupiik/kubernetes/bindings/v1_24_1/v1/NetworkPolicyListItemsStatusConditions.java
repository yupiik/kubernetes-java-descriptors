...
public class NetworkPolicyListItemsStatusConditions {
    ...
    public NetworkPolicyListItemsStatusConditions() {
        // no-op
    }

    public NetworkPolicyListItemsStatusConditions(final String lastTransitionTime,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NetworkPolicyListItemsStatusConditions)) {
            return false;
        }
        final NetworkPolicyListItemsStatusConditions __otherCasted = (NetworkPolicyListItemsStatusConditions) __other;
