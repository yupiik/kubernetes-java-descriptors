...
public class ReplicaSetSpecTemplateSpecContainersReadinessProbe {
    ...
    private ReplicaSetSpecTemplateSpecContainersReadinessProbeGrpc grpc;
    ...
    public ReplicaSetSpecTemplateSpecContainersReadinessProbe(final ReplicaSetSpecTemplateSpecContainersReadinessProbeExec exec,
                                                              ...
                                                              final ReplicaSetSpecTemplateSpecContainersReadinessProbeGrpc grpc,
    ...
    public ReplicaSetSpecTemplateSpecContainersReadinessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final ReplicaSetSpecTemplateSpecContainersReadinessProbeGrpc grpc) {
        this.grpc = grpc;
    }
