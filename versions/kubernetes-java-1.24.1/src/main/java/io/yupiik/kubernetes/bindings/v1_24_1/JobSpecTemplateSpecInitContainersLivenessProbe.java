...
public class JobSpecTemplateSpecInitContainersLivenessProbe {
    ...
    private JobSpecTemplateSpecInitContainersLivenessProbeGrpc grpc;
    ...
    public JobSpecTemplateSpecInitContainersLivenessProbe(final JobSpecTemplateSpecInitContainersLivenessProbeExec exec,
                                                          ...
                                                          final JobSpecTemplateSpecInitContainersLivenessProbeGrpc grpc,
    ...
    public JobSpecTemplateSpecInitContainersLivenessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final JobSpecTemplateSpecInitContainersLivenessProbeGrpc grpc) {
        this.grpc = grpc;
    }
