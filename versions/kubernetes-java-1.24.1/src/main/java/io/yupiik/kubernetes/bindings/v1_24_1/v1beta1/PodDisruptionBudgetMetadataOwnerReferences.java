...
public class PodDisruptionBudgetMetadataOwnerReferences {
    ...
    public PodDisruptionBudgetMetadataOwnerReferences() {
        // no-op
    }

    public PodDisruptionBudgetMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodDisruptionBudgetMetadataOwnerReferences)) {
            return false;
        }
        final PodDisruptionBudgetMetadataOwnerReferences __otherCasted = (PodDisruptionBudgetMetadataOwnerReferences) __other;
