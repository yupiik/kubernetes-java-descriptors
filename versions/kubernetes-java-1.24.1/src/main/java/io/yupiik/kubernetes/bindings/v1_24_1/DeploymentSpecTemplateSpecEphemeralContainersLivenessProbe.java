...
public class DeploymentSpecTemplateSpecEphemeralContainersLivenessProbe {
    ...
    private DeploymentSpecTemplateSpecEphemeralContainersLivenessProbeGrpc grpc;
    ...
    public DeploymentSpecTemplateSpecEphemeralContainersLivenessProbe(final DeploymentSpecTemplateSpecEphemeralContainersLivenessProbeExec exec,
                                                                      ...
                                                                      final DeploymentSpecTemplateSpecEphemeralContainersLivenessProbeGrpc grpc,
    ...
    public DeploymentSpecTemplateSpecEphemeralContainersLivenessProbeGrpc getGrpc() {
        return grpc;
    }

    public void setGrpc(final DeploymentSpecTemplateSpecEphemeralContainersLivenessProbeGrpc grpc) {
        this.grpc = grpc;
    }
