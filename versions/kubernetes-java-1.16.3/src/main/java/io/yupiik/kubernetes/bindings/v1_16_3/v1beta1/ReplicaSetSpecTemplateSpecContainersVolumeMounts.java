...
public class ReplicaSetSpecTemplateSpecContainersVolumeMounts {
    ...
    public ReplicaSetSpecTemplateSpecContainersVolumeMounts() {
        // no-op
    }

    public ReplicaSetSpecTemplateSpecContainersVolumeMounts(final String mountPath,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicaSetSpecTemplateSpecContainersVolumeMounts)) {
            return false;
        }
        final ReplicaSetSpecTemplateSpecContainersVolumeMounts __otherCasted = (ReplicaSetSpecTemplateSpecContainersVolumeMounts) __other;
