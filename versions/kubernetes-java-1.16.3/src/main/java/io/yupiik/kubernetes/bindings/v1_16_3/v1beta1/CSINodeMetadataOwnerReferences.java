...
public class CSINodeMetadataOwnerReferences {
    ...
    public CSINodeMetadataOwnerReferences() {
        // no-op
    }

    public CSINodeMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSINodeMetadataOwnerReferences)) {
            return false;
        }
        final CSINodeMetadataOwnerReferences __otherCasted = (CSINodeMetadataOwnerReferences) __other;
