...
public class NodeStatus implements Validable<NodeStatus>, Exportable {
    ...
    private List<String> declaredFeatures;
    ...
    public void setDeclaredFeatures(final List<String> declaredFeatures) {
        this.declaredFeatures = declaredFeatures;
    }
    ...
    public boolean equals(final Object __other) {
        ...
        return Objects.equals(addresses, __otherCasted.addresses) &&
            ...
            Objects.equals(declaredFeatures, __otherCasted.declaredFeatures) &&
    ...
    public NodeStatus declaredFeatures(final List<String> declaredFeatures) {
        this.declaredFeatures = declaredFeatures;
        return this;
    }
    ...
    public String asJson() {
        return Stream.of(
                    ...
                    (declaredFeatures != null ? "\"declaredFeatures\":" + declaredFeatures.stream().map(__it -> __it == null ? "null" : ("\"" + JsonStrings.escapeJson(__it) + "\"")).collect(joining(",", "[", "]")) : ""),
