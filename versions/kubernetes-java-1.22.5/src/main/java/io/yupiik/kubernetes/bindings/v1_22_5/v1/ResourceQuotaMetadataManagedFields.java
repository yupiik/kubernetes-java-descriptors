...
public class ResourceQuotaMetadataManagedFields {
    ...
    public ResourceQuotaMetadataManagedFields() {
        // no-op
    }

    public ResourceQuotaMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ResourceQuotaMetadataManagedFields)) {
            return false;
        }
        final ResourceQuotaMetadataManagedFields __otherCasted = (ResourceQuotaMetadataManagedFields) __other;
