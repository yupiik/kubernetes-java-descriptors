...
public class FlowSchemaListItemsSpecRulesResourceRules {
    ...
    public FlowSchemaListItemsSpecRulesResourceRules() {
        // no-op
    }

    public FlowSchemaListItemsSpecRulesResourceRules(final List<String> apiGroups,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof FlowSchemaListItemsSpecRulesResourceRules)) {
            return false;
        }
        final FlowSchemaListItemsSpecRulesResourceRules __otherCasted = (FlowSchemaListItemsSpecRulesResourceRules) __other;
