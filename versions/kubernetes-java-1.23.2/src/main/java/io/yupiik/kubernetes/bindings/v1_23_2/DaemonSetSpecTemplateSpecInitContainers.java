...
public class DaemonSetSpecTemplateSpecInitContainers {
    ...
    private DaemonSetSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy;
    ...
    private DaemonSetSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public DaemonSetSpecTemplateSpecInitContainers(final List<String> args,
                                                   ...
                                                   final String image,
                                                   final DaemonSetSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy,
                                                   ...
                                                   final DaemonSetSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy,
                                                   final Boolean tty,
    ...
    public DaemonSetSpecTemplateSpecInitContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final DaemonSetSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy) {
    ...
    public DaemonSetSpecTemplateSpecInitContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final DaemonSetSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy) {
