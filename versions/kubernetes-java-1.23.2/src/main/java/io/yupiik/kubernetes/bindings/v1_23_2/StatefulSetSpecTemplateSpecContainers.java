...
public class StatefulSetSpecTemplateSpecContainers {
    ...
    private StatefulSetSpecTemplateSpecContainersImagePullPolicy imagePullPolicy;
    ...
    private StatefulSetSpecTemplateSpecContainersStartupProbe startupProbe;
    private Boolean stdin;
    private Boolean stdinOnce;
    private String terminationMessagePath;
    private StatefulSetSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public StatefulSetSpecTemplateSpecContainers(final List<String> args,
                                                 ...
                                                 final String image,
                                                 final StatefulSetSpecTemplateSpecContainersImagePullPolicy imagePullPolicy,
                                                 ...
                                                 final StatefulSetSpecTemplateSpecContainersStartupProbe startupProbe,
                                                 final Boolean stdin,
                                                 final Boolean stdinOnce,
                                                 final String terminationMessagePath,
                                                 final StatefulSetSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy,
                                                 final Boolean tty,
    ...
    public StatefulSetSpecTemplateSpecContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final StatefulSetSpecTemplateSpecContainersImagePullPolicy imagePullPolicy) {
    ...
    public StatefulSetSpecTemplateSpecContainersStartupProbe getStartupProbe() {
        return startupProbe;
    }

    public void setStartupProbe(final StatefulSetSpecTemplateSpecContainersStartupProbe startupProbe) {
    ...
    public StatefulSetSpecTemplateSpecContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final StatefulSetSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy) {
