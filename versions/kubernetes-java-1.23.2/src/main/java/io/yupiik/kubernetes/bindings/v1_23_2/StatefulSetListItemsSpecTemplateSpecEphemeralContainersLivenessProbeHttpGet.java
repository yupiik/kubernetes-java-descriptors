...
public class StatefulSetListItemsSpecTemplateSpecEphemeralContainersLivenessProbeHttpGet {
    ...
    private String path;
    private String port;
    private StatefulSetListItemsSpecTemplateSpecEphemeralContainersLivenessProbeHttpGetScheme scheme;
    ...
    public StatefulSetListItemsSpecTemplateSpecEphemeralContainersLivenessProbeHttpGet(final String host,
                                                                                       ...
                                                                                       final String path,
                                                                                       final String port,
                                                                                       final StatefulSetListItemsSpecTemplateSpecEphemeralContainersLivenessProbeHttpGetScheme scheme) {
        // no-op
    }
    ...
    public StatefulSetListItemsSpecTemplateSpecEphemeralContainersLivenessProbeHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final StatefulSetListItemsSpecTemplateSpecEphemeralContainersLivenessProbeHttpGetScheme scheme) {
        this.scheme = scheme;
    }
