...
public class PodSpecContainers {
    ...
    private PodSpecContainersImagePullPolicy imagePullPolicy;
    ...
    private PodSpecContainersStartupProbe startupProbe;
    private Boolean stdin;
    private Boolean stdinOnce;
    private String terminationMessagePath;
    private PodSpecContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public PodSpecContainers(final List<String> args,
                             ...
                             final String image,
                             final PodSpecContainersImagePullPolicy imagePullPolicy,
                             ...
                             final PodSpecContainersStartupProbe startupProbe,
                             final Boolean stdin,
                             final Boolean stdinOnce,
                             final String terminationMessagePath,
                             final PodSpecContainersTerminationMessagePolicy terminationMessagePolicy,
                             final Boolean tty,
    ...
    public PodSpecContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final PodSpecContainersImagePullPolicy imagePullPolicy) {
    ...
    public PodSpecContainersStartupProbe getStartupProbe() {
        return startupProbe;
    }

    public void setStartupProbe(final PodSpecContainersStartupProbe startupProbe) {
    ...
    public PodSpecContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final PodSpecContainersTerminationMessagePolicy terminationMessagePolicy) {
