...
public class ReplicationControllerSpecTemplateSpecVolumesFc {
    ...
    public ReplicationControllerSpecTemplateSpecVolumesFc() {
        // no-op
    }

    public ReplicationControllerSpecTemplateSpecVolumesFc(final String fsType,
                                                          final Integer lun,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ReplicationControllerSpecTemplateSpecVolumesFc)) {
            return false;
        }
        final ReplicationControllerSpecTemplateSpecVolumesFc __otherCasted = (ReplicationControllerSpecTemplateSpecVolumesFc) __other;
