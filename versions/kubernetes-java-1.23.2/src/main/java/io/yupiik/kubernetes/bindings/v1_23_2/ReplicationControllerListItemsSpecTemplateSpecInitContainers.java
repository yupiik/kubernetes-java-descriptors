...
public class ReplicationControllerListItemsSpecTemplateSpecInitContainers {
    ...
    private ReplicationControllerListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy;
    ...
    private ReplicationControllerListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public ReplicationControllerListItemsSpecTemplateSpecInitContainers(final List<String> args,
                                                                        ...
                                                                        final String image,
                                                                        final ReplicationControllerListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy,
                                                                        ...
                                                                        final ReplicationControllerListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy,
                                                                        final Boolean tty,
    ...
    public ReplicationControllerListItemsSpecTemplateSpecInitContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final ReplicationControllerListItemsSpecTemplateSpecInitContainersImagePullPolicy imagePullPolicy) {
    ...
    public ReplicationControllerListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final ReplicationControllerListItemsSpecTemplateSpecInitContainersTerminationMessagePolicy terminationMessagePolicy) {
