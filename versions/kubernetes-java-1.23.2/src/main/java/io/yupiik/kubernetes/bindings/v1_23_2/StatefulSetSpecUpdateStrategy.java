...
public class StatefulSetSpecUpdateStrategy {
    ...
    private StatefulSetSpecUpdateStrategyType type;
    ...
    public StatefulSetSpecUpdateStrategy(final StatefulSetSpecUpdateStrategyRollingUpdate rollingUpdate,
                                         final StatefulSetSpecUpdateStrategyType type) {
        // no-op
    }
    ...
    public StatefulSetSpecUpdateStrategyType getType() {
        return type;
    }

    public void setType(final StatefulSetSpecUpdateStrategyType type) {
        this.type = type;
    }
