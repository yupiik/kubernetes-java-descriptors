...
public class DaemonSetListItemsSpecUpdateStrategy {
    ...
    private DaemonSetListItemsSpecUpdateStrategyType type;
    ...
    public DaemonSetListItemsSpecUpdateStrategy(final DaemonSetListItemsSpecUpdateStrategyRollingUpdate rollingUpdate,
                                                final DaemonSetListItemsSpecUpdateStrategyType type) {
        // no-op
    }
    ...
    public DaemonSetListItemsSpecUpdateStrategyType getType() {
        return type;
    }

    public void setType(final DaemonSetListItemsSpecUpdateStrategyType type) {
        this.type = type;
    }
