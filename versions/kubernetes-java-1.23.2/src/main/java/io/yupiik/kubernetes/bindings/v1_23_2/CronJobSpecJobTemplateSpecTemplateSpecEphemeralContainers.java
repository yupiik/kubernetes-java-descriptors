...
public class CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainers {
    ...
    private CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy;
    ...
    private CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainers(final List<String> args,
                                                                     ...
                                                                     final String image,
                                                                     final CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy,
                                                                     ...
                                                                     final CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy,
                                                                     final Boolean tty,
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy) {
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final CronJobSpecJobTemplateSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy) {
