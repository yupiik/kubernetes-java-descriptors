...
public class PodCondition implements Validable<PodCondition> {
    private String lastProbeTime;
    private String lastTransitionTime;
    private String message;
    private String reason;
    private String status;
    private PodConditionType type;
    ...
    public PodConditionType getType() {
        return type;
    }

    public void setType(final PodConditionType type) {
        this.type = type;
    }
    ...
    public PodCondition type(final PodConditionType type) {
        this.type = type;
        return this;
    }
