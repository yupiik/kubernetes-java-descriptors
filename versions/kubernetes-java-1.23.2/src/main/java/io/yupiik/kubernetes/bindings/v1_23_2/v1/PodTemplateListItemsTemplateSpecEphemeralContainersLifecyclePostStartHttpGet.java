...
public class PodTemplateListItemsTemplateSpecEphemeralContainersLifecyclePostStartHttpGet {
    ...
    private String path;
    private String port;
    private PodTemplateListItemsTemplateSpecEphemeralContainersLifecyclePostStartHttpGetScheme scheme;
    ...
    public PodTemplateListItemsTemplateSpecEphemeralContainersLifecyclePostStartHttpGet(final String host,
                                                                                        ...
                                                                                        final String path,
                                                                                        final String port,
                                                                                        final PodTemplateListItemsTemplateSpecEphemeralContainersLifecyclePostStartHttpGetScheme scheme) {
        // no-op
    }
    ...
    public PodTemplateListItemsTemplateSpecEphemeralContainersLifecyclePostStartHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final PodTemplateListItemsTemplateSpecEphemeralContainersLifecyclePostStartHttpGetScheme scheme) {
        this.scheme = scheme;
    }
