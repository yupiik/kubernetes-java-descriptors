...
public class LimitRangeListItemsSpecLimits {
    ...
    private LimitRangeListItemsSpecLimitsType type;
    ...
    public LimitRangeListItemsSpecLimits(final Map<String, String> defaultRequest,
                                         ...
                                         final LimitRangeListItemsSpecLimitsType type) {
        // no-op
    }
    ...
    public LimitRangeListItemsSpecLimitsType getType() {
        return type;
    }

    public void setType(final LimitRangeListItemsSpecLimitsType type) {
        this.type = type;
    }
