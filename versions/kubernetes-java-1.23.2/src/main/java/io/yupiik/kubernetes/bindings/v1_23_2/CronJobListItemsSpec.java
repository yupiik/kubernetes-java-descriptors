...
public class CronJobListItemsSpec {
    private CronJobListItemsSpecConcurrencyPolicy concurrencyPolicy;
    ...
    public CronJobListItemsSpec(final CronJobListItemsSpecConcurrencyPolicy concurrencyPolicy,
    ...
    public CronJobListItemsSpecConcurrencyPolicy getConcurrencyPolicy() {
        return concurrencyPolicy;
    }

    public void setConcurrencyPolicy(final CronJobListItemsSpecConcurrencyPolicy concurrencyPolicy) {
