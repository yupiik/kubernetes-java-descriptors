...
public class JobSpecTemplateSpecEphemeralContainers {
    ...
    private JobSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy;
    ...
    private JobSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public JobSpecTemplateSpecEphemeralContainers(final List<String> args,
                                                  ...
                                                  final String image,
                                                  final JobSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy,
                                                  ...
                                                  final JobSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy,
                                                  final Boolean tty,
    ...
    public JobSpecTemplateSpecEphemeralContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final JobSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy) {
    ...
    public JobSpecTemplateSpecEphemeralContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final JobSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy) {
