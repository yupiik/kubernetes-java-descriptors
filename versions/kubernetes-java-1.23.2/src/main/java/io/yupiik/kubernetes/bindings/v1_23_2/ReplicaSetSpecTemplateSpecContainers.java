...
public class ReplicaSetSpecTemplateSpecContainers {
    ...
    private ReplicaSetSpecTemplateSpecContainersImagePullPolicy imagePullPolicy;
    ...
    private ReplicaSetSpecTemplateSpecContainersStartupProbe startupProbe;
    private Boolean stdin;
    private Boolean stdinOnce;
    private String terminationMessagePath;
    private ReplicaSetSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public ReplicaSetSpecTemplateSpecContainers(final List<String> args,
                                                ...
                                                final String image,
                                                final ReplicaSetSpecTemplateSpecContainersImagePullPolicy imagePullPolicy,
                                                ...
                                                final ReplicaSetSpecTemplateSpecContainersStartupProbe startupProbe,
                                                final Boolean stdin,
                                                final Boolean stdinOnce,
                                                final String terminationMessagePath,
                                                final ReplicaSetSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy,
                                                final Boolean tty,
    ...
    public ReplicaSetSpecTemplateSpecContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final ReplicaSetSpecTemplateSpecContainersImagePullPolicy imagePullPolicy) {
    ...
    public ReplicaSetSpecTemplateSpecContainersStartupProbe getStartupProbe() {
        return startupProbe;
    }

    public void setStartupProbe(final ReplicaSetSpecTemplateSpecContainersStartupProbe startupProbe) {
    ...
    public ReplicaSetSpecTemplateSpecContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final ReplicaSetSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy) {
