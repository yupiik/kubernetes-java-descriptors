...
public class NodeMetadataManagedFields {
    ...
    public NodeMetadataManagedFields() {
        // no-op
    }

    public NodeMetadataManagedFields(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NodeMetadataManagedFields)) {
            return false;
        }
        final NodeMetadataManagedFields __otherCasted = (NodeMetadataManagedFields) __other;
