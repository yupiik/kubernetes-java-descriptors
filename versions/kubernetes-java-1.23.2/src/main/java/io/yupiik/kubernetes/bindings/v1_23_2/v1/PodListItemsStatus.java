...
public class PodListItemsStatus {
    ...
    private PodListItemsStatusPhase phase;
    private String podIP;
    private List<PodListItemsStatusPodIPs> podIPs;
    private PodListItemsStatusQosClass qosClass;
    ...
    public PodListItemsStatus(final List<PodListItemsStatusConditions> conditions,
                              ...
                              final PodListItemsStatusPhase phase,
                              final String podIP,
                              final List<PodListItemsStatusPodIPs> podIPs,
                              final PodListItemsStatusQosClass qosClass,
                              final String reason,
    ...
    public PodListItemsStatusPhase getPhase() {
        return phase;
    }

    public void setPhase(final PodListItemsStatusPhase phase) {
        this.phase = phase;
    }
    ...
    public PodListItemsStatusQosClass getQosClass() {
        return qosClass;
    }

    public void setQosClass(final PodListItemsStatusQosClass qosClass) {
