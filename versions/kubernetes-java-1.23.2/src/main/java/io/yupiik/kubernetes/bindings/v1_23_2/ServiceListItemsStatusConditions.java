...
public class ServiceListItemsStatusConditions {
    ...
    public ServiceListItemsStatusConditions() {
        // no-op
    }

    public ServiceListItemsStatusConditions(final String lastTransitionTime,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ServiceListItemsStatusConditions)) {
            return false;
        }
        final ServiceListItemsStatusConditions __otherCasted = (ServiceListItemsStatusConditions) __other;
