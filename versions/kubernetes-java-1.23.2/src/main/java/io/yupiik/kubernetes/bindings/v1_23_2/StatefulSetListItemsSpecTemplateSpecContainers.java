...
public class StatefulSetListItemsSpecTemplateSpecContainers {
    ...
    private StatefulSetListItemsSpecTemplateSpecContainersImagePullPolicy imagePullPolicy;
    ...
    private StatefulSetListItemsSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public StatefulSetListItemsSpecTemplateSpecContainers(final List<String> args,
                                                          ...
                                                          final String image,
                                                          final StatefulSetListItemsSpecTemplateSpecContainersImagePullPolicy imagePullPolicy,
                                                          ...
                                                          final StatefulSetListItemsSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy,
                                                          final Boolean tty,
    ...
    public StatefulSetListItemsSpecTemplateSpecContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final StatefulSetListItemsSpecTemplateSpecContainersImagePullPolicy imagePullPolicy) {
    ...
    public StatefulSetListItemsSpecTemplateSpecContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final StatefulSetListItemsSpecTemplateSpecContainersTerminationMessagePolicy terminationMessagePolicy) {
