...
public class DaemonSetListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGet {
    ...
    private String path;
    private String port;
    private DaemonSetListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme scheme;
    ...
    public DaemonSetListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGet(final String host,
                                                                                     ...
                                                                                     final String path,
                                                                                     final String port,
                                                                                     final DaemonSetListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme scheme) {
        // no-op
    }
    ...
    public DaemonSetListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme getScheme() {
        return scheme;
    }

    public void setScheme(final DaemonSetListItemsSpecTemplateSpecInitContainersLifecyclePostStartHttpGetScheme scheme) {
        this.scheme = scheme;
    }
