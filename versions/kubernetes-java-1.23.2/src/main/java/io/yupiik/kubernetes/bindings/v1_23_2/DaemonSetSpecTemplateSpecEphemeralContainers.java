...
public class DaemonSetSpecTemplateSpecEphemeralContainers {
    ...
    private DaemonSetSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy;
    ...
    private DaemonSetSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public DaemonSetSpecTemplateSpecEphemeralContainers(final List<String> args,
                                                        ...
                                                        final String image,
                                                        final DaemonSetSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy,
                                                        ...
                                                        final DaemonSetSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy,
                                                        final Boolean tty,
    ...
    public DaemonSetSpecTemplateSpecEphemeralContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final DaemonSetSpecTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy) {
    ...
    public DaemonSetSpecTemplateSpecEphemeralContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final DaemonSetSpecTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy) {
