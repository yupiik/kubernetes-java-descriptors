...
public class PodTemplateTemplateSpecEphemeralContainers {
    ...
    private PodTemplateTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy;
    ...
    private PodTemplateTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy;
    private Boolean tty;
    ...
    public PodTemplateTemplateSpecEphemeralContainers(final List<String> args,
                                                      ...
                                                      final String image,
                                                      final PodTemplateTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy,
                                                      ...
                                                      final PodTemplateTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy,
                                                      final Boolean tty,
    ...
    public PodTemplateTemplateSpecEphemeralContainersImagePullPolicy getImagePullPolicy() {
        return imagePullPolicy;
    }

    public void setImagePullPolicy(final PodTemplateTemplateSpecEphemeralContainersImagePullPolicy imagePullPolicy) {
    ...
    public PodTemplateTemplateSpecEphemeralContainersTerminationMessagePolicy getTerminationMessagePolicy() {
        return terminationMessagePolicy;
    }

    public void setTerminationMessagePolicy(final PodTemplateTemplateSpecEphemeralContainersTerminationMessagePolicy terminationMessagePolicy) {
