...
public class DaemonSetSpecTemplateSpecContainersSecurityContext {
    ...
    private DaemonSetSpecTemplateSpecContainersSecurityContextSeccompProfile seccompProfile;
    ...
    public DaemonSetSpecTemplateSpecContainersSecurityContext(final Boolean allowPrivilegeEscalation,
                                                              ...
                                                              final DaemonSetSpecTemplateSpecContainersSecurityContextSeccompProfile seccompProfile,
    ...
    public DaemonSetSpecTemplateSpecContainersSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final DaemonSetSpecTemplateSpecContainersSecurityContextSeccompProfile seccompProfile) {
