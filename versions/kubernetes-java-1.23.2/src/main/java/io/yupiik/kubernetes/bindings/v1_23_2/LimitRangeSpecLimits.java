...
public class LimitRangeSpecLimits {
    ...
    private LimitRangeSpecLimitsType type;
    ...
    public LimitRangeSpecLimits(final Map<String, String> defaultRequest,
                                ...
                                final LimitRangeSpecLimitsType type) {
        // no-op
    }
    ...
    public LimitRangeSpecLimitsType getType() {
        return type;
    }

    public void setType(final LimitRangeSpecLimitsType type) {
        this.type = type;
    }
