...
public class NodeListItemsStatusConfigActiveConfigMap {
    ...
    public NodeListItemsStatusConfigActiveConfigMap() {
        // no-op
    }

    public NodeListItemsStatusConfigActiveConfigMap(final String kubeletConfigKey,
                                                    final String name,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NodeListItemsStatusConfigActiveConfigMap)) {
            return false;
        }
        final NodeListItemsStatusConfigActiveConfigMap __otherCasted = (NodeListItemsStatusConfigActiveConfigMap) __other;
