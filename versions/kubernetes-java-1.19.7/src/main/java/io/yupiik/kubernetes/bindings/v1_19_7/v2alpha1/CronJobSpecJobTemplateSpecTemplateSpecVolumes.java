...
public class CronJobSpecJobTemplateSpecTemplateSpecVolumes {
    ...
    private CronJobSpecJobTemplateSpecTemplateSpecVolumesEphemeral ephemeral;
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecVolumes(final CronJobSpecJobTemplateSpecTemplateSpecVolumesAwsElasticBlockStore awsElasticBlockStore,
                                                         ...
                                                         final CronJobSpecJobTemplateSpecTemplateSpecVolumesEphemeral ephemeral,
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecVolumesEphemeral getEphemeral() {
        return ephemeral;
    }

    public void setEphemeral(final CronJobSpecJobTemplateSpecTemplateSpecVolumesEphemeral ephemeral) {
