...
public class io.k8s.api.core.v1.PodDNSConfig implements Validable<io.k8s.api.core.v1.PodDNSConfig>, Exportable {
    private List<String> nameservers;
    private List<PodDNSConfigOption> options;
    private List<String> searches;

    public io.k8s.api.core.v1.PodDNSConfig() {
        // no-op
    }

    public io.k8s.api.core.v1.PodDNSConfig(final List<String> nameservers,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.PodDNSConfig)) {
            return false;
        }
        final io.k8s.api.core.v1.PodDNSConfig __otherCasted = (io.k8s.api.core.v1.PodDNSConfig) __other;
    ...
    public io.k8s.api.core.v1.PodDNSConfig nameservers(final List<String> nameservers) {
        this.nameservers = nameservers;
        return this;
    }

    public io.k8s.api.core.v1.PodDNSConfig options(final List<PodDNSConfigOption> options) {
        this.options = options;
        return this;
    }

    public io.k8s.api.core.v1.PodDNSConfig searches(final List<String> searches) {
        this.searches = searches;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.PodDNSConfig validate() {
        return this;
    }
