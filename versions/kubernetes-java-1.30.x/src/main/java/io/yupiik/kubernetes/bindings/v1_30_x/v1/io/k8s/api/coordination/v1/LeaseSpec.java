...
public class io.k8s.api.coordination.v1.LeaseSpec implements Validable<io.k8s.api.coordination.v1.LeaseSpec>, Exportable {
    ...
    public io.k8s.api.coordination.v1.LeaseSpec() {
        // no-op
    }

    public io.k8s.api.coordination.v1.LeaseSpec(final String acquireTime,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.coordination.v1.LeaseSpec)) {
            return false;
        }
        final io.k8s.api.coordination.v1.LeaseSpec __otherCasted = (io.k8s.api.coordination.v1.LeaseSpec) __other;
    ...
    public io.k8s.api.coordination.v1.LeaseSpec acquireTime(final String acquireTime) {
        this.acquireTime = acquireTime;
        return this;
    }

    public io.k8s.api.coordination.v1.LeaseSpec holderIdentity(final String holderIdentity) {
        this.holderIdentity = holderIdentity;
        return this;
    }

    public io.k8s.api.coordination.v1.LeaseSpec leaseDurationSeconds(final Integer leaseDurationSeconds) {
        this.leaseDurationSeconds = leaseDurationSeconds;
        return this;
    }

    public io.k8s.api.coordination.v1.LeaseSpec leaseTransitions(final Integer leaseTransitions) {
        this.leaseTransitions = leaseTransitions;
        return this;
    }

    public io.k8s.api.coordination.v1.LeaseSpec renewTime(final String renewTime) {
        this.renewTime = renewTime;
        return this;
    }

    @Override
    public io.k8s.api.coordination.v1.LeaseSpec validate() {
        return this;
    }
