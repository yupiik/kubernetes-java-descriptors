...
public class io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec implements Validable<io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec>, Exportable {
    ...
    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec() {
        // no-op
    }

    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec(final List<AuditAnnotation> auditAnnotations,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec)) {
            return false;
        }
        final io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec __otherCasted = (io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec) __other;
    ...
    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec auditAnnotations(final List<AuditAnnotation> auditAnnotations) {
        this.auditAnnotations = auditAnnotations;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec failurePolicy(final String failurePolicy) {
        this.failurePolicy = failurePolicy;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec matchConditions(final List<MatchCondition> matchConditions) {
        this.matchConditions = matchConditions;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec matchConstraints(final MatchResources matchConstraints) {
        this.matchConstraints = matchConstraints;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec paramKind(final ParamKind paramKind) {
        this.paramKind = paramKind;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec validations(final List<Validation> validations) {
        this.validations = validations;
        return this;
    }

    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec variables(final List<Variable> variables) {
        this.variables = variables;
        return this;
    }

    @Override
    public io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec validate() {
        return this;
    }
