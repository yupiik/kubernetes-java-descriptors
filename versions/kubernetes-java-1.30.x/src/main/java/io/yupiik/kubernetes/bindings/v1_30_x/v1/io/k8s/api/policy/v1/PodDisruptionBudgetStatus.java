...
public class io.k8s.api.policy.v1.PodDisruptionBudgetStatus implements Validable<io.k8s.api.policy.v1.PodDisruptionBudgetStatus>, Exportable {
    ...
    public io.k8s.api.policy.v1.PodDisruptionBudgetStatus() {
        // no-op
    }

    public io.k8s.api.policy.v1.PodDisruptionBudgetStatus(final List<Condition> conditions,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.policy.v1.PodDisruptionBudgetStatus)) {
            return false;
        }
        final io.k8s.api.policy.v1.PodDisruptionBudgetStatus __otherCasted = (io.k8s.api.policy.v1.PodDisruptionBudgetStatus) __other;
    ...
    public io.k8s.api.policy.v1.PodDisruptionBudgetStatus conditions(final List<Condition> conditions) {
        this.conditions = conditions;
        return this;
    }

    public io.k8s.api.policy.v1.PodDisruptionBudgetStatus currentHealthy(final int currentHealthy) {
        this.currentHealthy = currentHealthy;
        return this;
    }

    public io.k8s.api.policy.v1.PodDisruptionBudgetStatus desiredHealthy(final int desiredHealthy) {
        this.desiredHealthy = desiredHealthy;
        return this;
    }

    public io.k8s.api.policy.v1.PodDisruptionBudgetStatus disruptedPods(final JsonObject disruptedPods) {
        this.disruptedPods = disruptedPods;
        return this;
    }

    public io.k8s.api.policy.v1.PodDisruptionBudgetStatus disruptionsAllowed(final int disruptionsAllowed) {
        this.disruptionsAllowed = disruptionsAllowed;
        return this;
    }

    public io.k8s.api.policy.v1.PodDisruptionBudgetStatus expectedPods(final int expectedPods) {
        this.expectedPods = expectedPods;
        return this;
    }

    public io.k8s.api.policy.v1.PodDisruptionBudgetStatus observedGeneration(final Integer observedGeneration) {
        this.observedGeneration = observedGeneration;
        return this;
    }

    @Override
    public io.k8s.api.policy.v1.PodDisruptionBudgetStatus validate() {
        return this;
    }
