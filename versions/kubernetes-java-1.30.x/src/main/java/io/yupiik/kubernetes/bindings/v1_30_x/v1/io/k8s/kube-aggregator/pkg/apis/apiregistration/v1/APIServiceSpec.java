...
public class io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec implements Validable<io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec>, Exportable {
    ...
    public io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec() {
        // no-op
    }

    public io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec(final String caBundle,
                                                                             final String group,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec)) {
            return false;
        }
        final io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec __otherCasted = (io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec) __other;
    ...
    public io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec caBundle(final String caBundle) {
        this.caBundle = caBundle;
        return this;
    }

    public io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec group(final String group) {
        this.group = group;
        return this;
    }

    public io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec groupPriorityMinimum(final int groupPriorityMinimum) {
        this.groupPriorityMinimum = groupPriorityMinimum;
        return this;
    }

    public io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec insecureSkipTLSVerify(final Boolean insecureSkipTLSVerify) {
        this.insecureSkipTLSVerify = insecureSkipTLSVerify;
        return this;
    }

    public io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec service(final ServiceReference service) {
        this.service = service;
        return this;
    }

    public io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec version(final String version) {
        this.version = version;
        return this;
    }

    public io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec versionPriority(final int versionPriority) {
        this.versionPriority = versionPriority;
        return this;
    }

    @Override
    public io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec validate() {
        return this;
    }
