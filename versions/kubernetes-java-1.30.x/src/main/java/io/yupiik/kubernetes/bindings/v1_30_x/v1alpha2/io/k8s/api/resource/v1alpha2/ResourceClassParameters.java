...
public class io.k8s.api.resource.v1alpha2.ResourceClassParameters implements Validable<io.k8s.api.resource.v1alpha2.ResourceClassParameters>, Exportable {
    ...
    public io.k8s.api.resource.v1alpha2.ResourceClassParameters() {
        // no-op
    }

    public io.k8s.api.resource.v1alpha2.ResourceClassParameters(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.resource.v1alpha2.ResourceClassParameters)) {
            return false;
        }
        final io.k8s.api.resource.v1alpha2.ResourceClassParameters __otherCasted = (io.k8s.api.resource.v1alpha2.ResourceClassParameters) __other;
    ...
    public io.k8s.api.resource.v1alpha2.ResourceClassParameters apiVersion(final String apiVersion) {
        this.apiVersion = apiVersion;
        return this;
    }

    public io.k8s.api.resource.v1alpha2.ResourceClassParameters filters(final List<ResourceFilter> filters) {
        this.filters = filters;
        return this;
    }

    public io.k8s.api.resource.v1alpha2.ResourceClassParameters generatedFrom(final ResourceClassParametersReference generatedFrom) {
        this.generatedFrom = generatedFrom;
        return this;
    }

    public io.k8s.api.resource.v1alpha2.ResourceClassParameters kind(final String kind) {
        this.kind = kind;
        return this;
    }

    public io.k8s.api.resource.v1alpha2.ResourceClassParameters metadata(final ObjectMeta metadata) {
        this.metadata = metadata;
        return this;
    }

    public io.k8s.api.resource.v1alpha2.ResourceClassParameters vendorParameters(final List<VendorParameters> vendorParameters) {
        this.vendorParameters = vendorParameters;
        return this;
    }

    @Override
    public io.k8s.api.resource.v1alpha2.ResourceClassParameters validate() {
        if (kind == null) {
