...
public class io.k8s.api.core.v1.ServiceSpec implements Validable<io.k8s.api.core.v1.ServiceSpec>, Exportable {
    ...
    public io.k8s.api.core.v1.ServiceSpec() {
        // no-op
    }

    public io.k8s.api.core.v1.ServiceSpec(final Boolean allocateLoadBalancerNodePorts,
    ...
    public void setTrafficDistribution(final String trafficDistribution) {
        this.trafficDistribution = trafficDistribution;
    }
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof io.k8s.api.core.v1.ServiceSpec)) {
            return false;
        }
        final io.k8s.api.core.v1.ServiceSpec __otherCasted = (io.k8s.api.core.v1.ServiceSpec) __other;
        return Objects.equals(allocateLoadBalancerNodePorts, __otherCasted.allocateLoadBalancerNodePorts) &&
            ...
            Objects.equals(trafficDistribution, __otherCasted.trafficDistribution) &&
            Objects.equals(type, __otherCasted.type);
    }

    public io.k8s.api.core.v1.ServiceSpec allocateLoadBalancerNodePorts(final Boolean allocateLoadBalancerNodePorts) {
        this.allocateLoadBalancerNodePorts = allocateLoadBalancerNodePorts;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec clusterIP(final String clusterIP) {
        this.clusterIP = clusterIP;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec clusterIPs(final List<String> clusterIPs) {
        this.clusterIPs = clusterIPs;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec externalIPs(final List<String> externalIPs) {
        this.externalIPs = externalIPs;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec externalName(final String externalName) {
        this.externalName = externalName;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec externalTrafficPolicy(final String externalTrafficPolicy) {
        this.externalTrafficPolicy = externalTrafficPolicy;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec healthCheckNodePort(final Integer healthCheckNodePort) {
        this.healthCheckNodePort = healthCheckNodePort;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec internalTrafficPolicy(final String internalTrafficPolicy) {
        this.internalTrafficPolicy = internalTrafficPolicy;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec ipFamilies(final List<String> ipFamilies) {
        this.ipFamilies = ipFamilies;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec ipFamilyPolicy(final String ipFamilyPolicy) {
        this.ipFamilyPolicy = ipFamilyPolicy;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec loadBalancerClass(final String loadBalancerClass) {
        this.loadBalancerClass = loadBalancerClass;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec loadBalancerIP(final String loadBalancerIP) {
        this.loadBalancerIP = loadBalancerIP;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec loadBalancerSourceRanges(final List<String> loadBalancerSourceRanges) {
        this.loadBalancerSourceRanges = loadBalancerSourceRanges;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec ports(final List<ServicePort> ports) {
        this.ports = ports;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec publishNotReadyAddresses(final Boolean publishNotReadyAddresses) {
        this.publishNotReadyAddresses = publishNotReadyAddresses;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec selector(final Map<String, String> selector) {
        this.selector = selector;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec sessionAffinity(final String sessionAffinity) {
        this.sessionAffinity = sessionAffinity;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec sessionAffinityConfig(final SessionAffinityConfig sessionAffinityConfig) {
        this.sessionAffinityConfig = sessionAffinityConfig;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec trafficDistribution(final String trafficDistribution) {
        this.trafficDistribution = trafficDistribution;
        return this;
    }

    public io.k8s.api.core.v1.ServiceSpec type(final String type) {
        this.type = type;
        return this;
    }

    @Override
    public io.k8s.api.core.v1.ServiceSpec validate() {
        return this;
    }
    ...
    public String asJson() {
        return Stream.of(
                    ...
                    (trafficDistribution != null ? "\"trafficDistribution\":\"" +  JsonStrings.escapeJson(trafficDistribution) + "\"" : ""),
