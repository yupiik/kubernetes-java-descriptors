...
public class ComponentStatusListItemsMetadata {
    ...
    private ComponentStatusListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<ComponentStatusListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<ComponentStatusListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public ComponentStatusListItemsMetadata() {
        // no-op
    }

    public ComponentStatusListItemsMetadata(final Map<String, String> annotations,
                                            ...
                                            final ComponentStatusListItemsMetadataInitializers initializers,
                                            final Map<String, String> labels,
                                            final List<ComponentStatusListItemsMetadataManagedFields> managedFields,
                                            final String name,
                                            final String namespace,
                                            final List<ComponentStatusListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public ComponentStatusListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final ComponentStatusListItemsMetadataInitializers initializers) {
    ...
    public List<ComponentStatusListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<ComponentStatusListItemsMetadataManagedFields> managedFields) {
    ...
    public List<ComponentStatusListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<ComponentStatusListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ComponentStatusListItemsMetadata)) {
            return false;
        }
        final ComponentStatusListItemsMetadata __otherCasted = (ComponentStatusListItemsMetadata) __other;
