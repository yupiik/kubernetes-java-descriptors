...
public class ServiceListItemsMetadataInitializersResultMetadata {
    ...
    public ServiceListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public ServiceListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ServiceListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final ServiceListItemsMetadataInitializersResultMetadata __otherCasted = (ServiceListItemsMetadataInitializersResultMetadata) __other;
