...
public class NetworkPolicyMetadataOwnerReferences {
    ...
    public NetworkPolicyMetadataOwnerReferences() {
        // no-op
    }

    public NetworkPolicyMetadataOwnerReferences(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof NetworkPolicyMetadataOwnerReferences)) {
            return false;
        }
        final NetworkPolicyMetadataOwnerReferences __otherCasted = (NetworkPolicyMetadataOwnerReferences) __other;
