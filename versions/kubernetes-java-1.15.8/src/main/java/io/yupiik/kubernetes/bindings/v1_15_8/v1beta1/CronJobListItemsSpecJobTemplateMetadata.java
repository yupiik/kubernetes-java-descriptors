...
public class CronJobListItemsSpecJobTemplateMetadata {
    ...
    private CronJobListItemsSpecJobTemplateMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<CronJobListItemsSpecJobTemplateMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<CronJobListItemsSpecJobTemplateMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public CronJobListItemsSpecJobTemplateMetadata() {
        // no-op
    }

    public CronJobListItemsSpecJobTemplateMetadata(final Map<String, String> annotations,
                                                   ...
                                                   final CronJobListItemsSpecJobTemplateMetadataInitializers initializers,
                                                   final Map<String, String> labels,
                                                   final List<CronJobListItemsSpecJobTemplateMetadataManagedFields> managedFields,
                                                   final String name,
                                                   final String namespace,
                                                   final List<CronJobListItemsSpecJobTemplateMetadataOwnerReferences> ownerReferences,
    ...
    public CronJobListItemsSpecJobTemplateMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final CronJobListItemsSpecJobTemplateMetadataInitializers initializers) {
    ...
    public List<CronJobListItemsSpecJobTemplateMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<CronJobListItemsSpecJobTemplateMetadataManagedFields> managedFields) {
    ...
    public List<CronJobListItemsSpecJobTemplateMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<CronJobListItemsSpecJobTemplateMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CronJobListItemsSpecJobTemplateMetadata)) {
            return false;
        }
        final CronJobListItemsSpecJobTemplateMetadata __otherCasted = (CronJobListItemsSpecJobTemplateMetadata) __other;
