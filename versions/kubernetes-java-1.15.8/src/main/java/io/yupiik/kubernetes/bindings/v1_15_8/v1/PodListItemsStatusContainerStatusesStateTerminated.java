...
public class PodListItemsStatusContainerStatusesStateTerminated {
    ...
    public PodListItemsStatusContainerStatusesStateTerminated() {
        // no-op
    }

    public PodListItemsStatusContainerStatusesStateTerminated(final String containerID,
                                                              final int exitCode,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof PodListItemsStatusContainerStatusesStateTerminated)) {
            return false;
        }
        final PodListItemsStatusContainerStatusesStateTerminated __otherCasted = (PodListItemsStatusContainerStatusesStateTerminated) __other;
