...
public class CSINodeListItemsMetadataInitializersResultMetadata {
    ...
    public CSINodeListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public CSINodeListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof CSINodeListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final CSINodeListItemsMetadataInitializersResultMetadata __otherCasted = (CSINodeListItemsMetadataInitializersResultMetadata) __other;
