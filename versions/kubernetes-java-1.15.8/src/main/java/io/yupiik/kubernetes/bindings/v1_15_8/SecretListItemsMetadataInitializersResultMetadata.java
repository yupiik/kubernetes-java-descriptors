...
public class SecretListItemsMetadataInitializersResultMetadata {
    ...
    public SecretListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public SecretListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof SecretListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final SecretListItemsMetadataInitializersResultMetadata __otherCasted = (SecretListItemsMetadataInitializersResultMetadata) __other;
