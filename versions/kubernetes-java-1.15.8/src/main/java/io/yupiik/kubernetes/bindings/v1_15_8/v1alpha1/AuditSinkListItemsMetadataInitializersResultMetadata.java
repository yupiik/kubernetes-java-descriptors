...
public class AuditSinkListItemsMetadataInitializersResultMetadata {
    ...
    public AuditSinkListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public AuditSinkListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof AuditSinkListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final AuditSinkListItemsMetadataInitializersResultMetadata __otherCasted = (AuditSinkListItemsMetadataInitializersResultMetadata) __other;
