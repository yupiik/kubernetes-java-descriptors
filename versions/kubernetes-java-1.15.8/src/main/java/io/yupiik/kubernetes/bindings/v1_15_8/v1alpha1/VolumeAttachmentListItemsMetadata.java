package io.yupiik.kubernetes.bindings.v1_15_8.v1alpha1;

import java.util.List;
import java.util.Map;
import java.util.Objects;

public class VolumeAttachmentListItemsMetadata {
    ...
    private VolumeAttachmentListItemsMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<VolumeAttachmentListItemsMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<VolumeAttachmentListItemsMetadataOwnerReferences> ownerReferences;
    private String resourceVersion;
    private String selfLink;
    private String uid;

    public VolumeAttachmentListItemsMetadata() {
        // no-op
    }

    public VolumeAttachmentListItemsMetadata(final Map<String, String> annotations,
                                             ...
                                             final VolumeAttachmentListItemsMetadataInitializers initializers,
                                             final Map<String, String> labels,
                                             final List<VolumeAttachmentListItemsMetadataManagedFields> managedFields,
                                             final String name,
                                             final String namespace,
                                             final List<VolumeAttachmentListItemsMetadataOwnerReferences> ownerReferences,
    ...
    public VolumeAttachmentListItemsMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final VolumeAttachmentListItemsMetadataInitializers initializers) {
    ...
    public List<VolumeAttachmentListItemsMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<VolumeAttachmentListItemsMetadataManagedFields> managedFields) {
    ...
    public List<VolumeAttachmentListItemsMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<VolumeAttachmentListItemsMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof VolumeAttachmentListItemsMetadata)) {
            return false;
        }
        final VolumeAttachmentListItemsMetadata __otherCasted = (VolumeAttachmentListItemsMetadata) __other;
