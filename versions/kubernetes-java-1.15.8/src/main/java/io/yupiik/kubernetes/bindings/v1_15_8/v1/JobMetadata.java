...
public class JobMetadata {
    ...
    private JobMetadataInitializers initializers;
    private Map<String, String> labels;
    private List<JobMetadataManagedFields> managedFields;
    private String name;
    private String namespace;
    private List<JobMetadataOwnerReferences> ownerReferences;
    ...
    public JobMetadata(final Map<String, String> annotations,
                       ...
                       final JobMetadataInitializers initializers,
                       final Map<String, String> labels,
                       final List<JobMetadataManagedFields> managedFields,
                       final String name,
                       final String namespace,
                       final List<JobMetadataOwnerReferences> ownerReferences,
    ...
    public JobMetadataInitializers getInitializers() {
        return initializers;
    }

    public void setInitializers(final JobMetadataInitializers initializers) {
    ...
    public List<JobMetadataManagedFields> getManagedFields() {
        return managedFields;
    }

    public void setManagedFields(final List<JobMetadataManagedFields> managedFields) {
    ...
    public List<JobMetadataOwnerReferences> getOwnerReferences() {
        return ownerReferences;
    }

    public void setOwnerReferences(final List<JobMetadataOwnerReferences> ownerReferences) {
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof JobMetadata)) {
            return false;
        }
        final JobMetadata __otherCasted = (JobMetadata) __other;
