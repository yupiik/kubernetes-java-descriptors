...
public class RoleBindingListItemsMetadataInitializersResultMetadata {
    ...
    public RoleBindingListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public RoleBindingListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RoleBindingListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final RoleBindingListItemsMetadataInitializersResultMetadata __otherCasted = (RoleBindingListItemsMetadataInitializersResultMetadata) __other;
