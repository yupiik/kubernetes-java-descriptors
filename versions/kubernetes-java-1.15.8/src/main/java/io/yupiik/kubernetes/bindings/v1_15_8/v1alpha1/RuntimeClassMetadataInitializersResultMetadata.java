...
public class RuntimeClassMetadataInitializersResultMetadata {
    ...
    public RuntimeClassMetadataInitializersResultMetadata() {
        // no-op
    }

    public RuntimeClassMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof RuntimeClassMetadataInitializersResultMetadata)) {
            return false;
        }
        final RuntimeClassMetadataInitializersResultMetadata __otherCasted = (RuntimeClassMetadataInitializersResultMetadata) __other;
