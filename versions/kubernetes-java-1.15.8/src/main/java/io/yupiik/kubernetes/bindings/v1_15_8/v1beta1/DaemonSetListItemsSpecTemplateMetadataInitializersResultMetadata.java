...
public class DaemonSetListItemsSpecTemplateMetadataInitializersResultMetadata {
    ...
    public DaemonSetListItemsSpecTemplateMetadataInitializersResultMetadata() {
        // no-op
    }

    public DaemonSetListItemsSpecTemplateMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof DaemonSetListItemsSpecTemplateMetadataInitializersResultMetadata)) {
            return false;
        }
        final DaemonSetListItemsSpecTemplateMetadataInitializersResultMetadata __otherCasted = (DaemonSetListItemsSpecTemplateMetadataInitializersResultMetadata) __other;
