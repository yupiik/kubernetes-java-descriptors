...
public class ClusterRoleBindingListItemsMetadataInitializersResultMetadata {
    ...
    public ClusterRoleBindingListItemsMetadataInitializersResultMetadata() {
        // no-op
    }

    public ClusterRoleBindingListItemsMetadataInitializersResultMetadata(final String continueValue,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof ClusterRoleBindingListItemsMetadataInitializersResultMetadata)) {
            return false;
        }
        final ClusterRoleBindingListItemsMetadataInitializersResultMetadata __otherCasted = (ClusterRoleBindingListItemsMetadataInitializersResultMetadata) __other;
