...
public class CronJobSpecJobTemplateSpecTemplateSpecInitContainersSecurityContext {
    ...
    private CronJobSpecJobTemplateSpecTemplateSpecInitContainersSecurityContextSeccompProfile seccompProfile;
    private CronJobSpecJobTemplateSpecTemplateSpecInitContainersSecurityContextWindowsOptions windowsOptions;
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecInitContainersSecurityContext(final Boolean allowPrivilegeEscalation,
                                                                               ...
                                                                               final CronJobSpecJobTemplateSpecTemplateSpecInitContainersSecurityContextSeccompProfile seccompProfile,
                                                                               final CronJobSpecJobTemplateSpecTemplateSpecInitContainersSecurityContextWindowsOptions windowsOptions) {
        // no-op
    }
    ...
    public CronJobSpecJobTemplateSpecTemplateSpecInitContainersSecurityContextSeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(final CronJobSpecJobTemplateSpecTemplateSpecInitContainersSecurityContextSeccompProfile seccompProfile) {
        this.seccompProfile = seccompProfile;
    }

    public CronJobSpecJobTemplateSpecTemplateSpecInitContainersSecurityContextWindowsOptions getWindowsOptions() {
        return windowsOptions;
    }

    public void setWindowsOptions(final CronJobSpecJobTemplateSpecTemplateSpecInitContainersSecurityContextWindowsOptions windowsOptions) {
