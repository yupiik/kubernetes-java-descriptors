...
public class EventInvolvedObject {
    ...
    public EventInvolvedObject() {
        // no-op
    }

    public EventInvolvedObject(final String apiVersion,
    ...
    public boolean equals(final Object __other) {
        if (!(__other instanceof EventInvolvedObject)) {
            return false;
        }
        final EventInvolvedObject __otherCasted = (EventInvolvedObject) __other;
