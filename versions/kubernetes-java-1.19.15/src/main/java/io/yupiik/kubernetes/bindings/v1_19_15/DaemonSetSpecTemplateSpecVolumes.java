...
public class DaemonSetSpecTemplateSpecVolumes {
    ...
    private DaemonSetSpecTemplateSpecVolumesEphemeral ephemeral;
    ...
    public DaemonSetSpecTemplateSpecVolumes(final DaemonSetSpecTemplateSpecVolumesAwsElasticBlockStore awsElasticBlockStore,
                                            ...
                                            final DaemonSetSpecTemplateSpecVolumesEphemeral ephemeral,
    ...
    public DaemonSetSpecTemplateSpecVolumesEphemeral getEphemeral() {
        return ephemeral;
    }

    public void setEphemeral(final DaemonSetSpecTemplateSpecVolumesEphemeral ephemeral) {
